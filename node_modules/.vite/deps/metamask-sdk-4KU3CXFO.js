...
import {
  lookup
} from "./chunk-WUFVYCCX.js";
import {
  require_browser
} from "./chunk-XPCMXA3P.js";
import {
  init_esm_browser,
  v4_default,
  validate_default
} from "./chunk-WSIE5WWB.js";
import {
  __commonJS,
  __glob,
  __toESM,
...
function m(e7, t2, n2, r2, i) {
  var o, s, a2 = 8 * i - r2 - 1, c2 = (1 << a2) - 1, l2 = c2 >> 1, d2 = -7, u2 = n2 ? i - 1 : 0, h2 = n2 ? -1 : 1, f2 = e7[t2 + u2];
...
function y(e7, t2, n2, r2, i, o) {
  var s, a2, c2, l2 = 8 * o - i - 1, d2 = (1 << l2) - 1, u2 = d2 >> 1, h2 = 23 === i ? Math.pow(2, -24) - Math.pow(2, -77) : 0, f2 = r2 ? 0 : o - 1, p2 = r2 ? 1 : -1, g2 = t2 < 0 || 0 === t2 && 1 / t2 < 0 ? 1 : 0;
...
function D(e7, t2, n2, r2) {
  return oe(re(t2, e7.length - n2), e7, n2, r2);
}
...
S.prototype.slice = function(e7, t2) {
  ...
  if (t2 >>>= 0, n2 = void 0 === n2 ? this.length : n2 >>> 0, e7 || (e7 = 0), "number" == typeof e7) for (o = t2; o < n2; ++o) this[o] = e7;
    ...
    var s = I(e7) ? e7 : re(new S(e7, r2).toString()), a2 = s.length;
...
var xt = class extends bt.HashMD {
  ...
  get() {
    const { Ah: e7, Al: t2, Bh: n2, Bl: r2, Ch: i, Cl: o, Dh: s, Dl: a2, Eh: c2, El: l2, Fh: d2, Fl: u2, Gh: h2, Gl: f2, Hh: p2, Hl: g2 } = this;
    return [e7, t2, n2, r2, i, o, s, a2, c2, l2, d2, u2, h2, f2, p2, g2];
  }
  set(e7, t2, n2, r2, i, o, s, a2, c2, l2, d2, u2, h2, f2, p2, g2) {
    this.Ah = 0 | e7, this.Al = 0 | t2, this.Bh = 0 | n2, this.Bl = 0 | r2, this.Ch = 0 | i, this.Cl = 0 | o, this.Dh = 0 | s, this.Dl = 0 | a2, this.Eh = 0 | c2, this.El = 0 | l2, this.Fh = 0 | d2, this.Fl = 0 | u2, this.Gh = 0 | h2, this.Gl = 0 | f2, this.Hh = 0 | p2, this.Hl = 0 | g2;
  }
  process(e7, t2) {
    ...
    let { Ah: n2, Al: r2, Bh: i, Bl: o, Ch: s, Cl: a2, Dh: c2, Dl: l2, Eh: d2, El: u2, Fh: h2, Fl: f2, Gh: p2, Gl: g2, Hh: m2, Hl: y2 } = this;
    for (let e8 = 0; e8 < 80; e8++) {
      const t3 = wt.default.rotrSH(d2, u2, 14) ^ wt.default.rotrSH(d2, u2, 18) ^ wt.default.rotrBH(d2, u2, 41), v2 = wt.default.rotrSL(d2, u2, 14) ^ wt.default.rotrSL(d2, u2, 18) ^ wt.default.rotrBL(d2, u2, 41), b2 = d2 & h2 ^ ~d2 & p2, w2 = u2 & f2 ^ ~u2 & g2, E2 = wt.default.add5L(y2, v2, w2, St[e8], kt[e8]), C2 = wt.default.add5H(E2, m2, t3, b2, Ct[e8], _t[e8]), S2 = 0 | E2, _2 = wt.default.rotrSH(n2, r2, 28) ^ wt.default.rotrBH(n2, r2, 34) ^ wt.default.rotrBH(n2, r2, 39), k2 = wt.default.rotrSL(n2, r2, 28) ^ wt.default.rotrBL(n2, r2, 34) ^ wt.default.rotrBL(n2, r2, 39), x2 = n2 & i ^ n2 & s ^ i & s, M2 = r2 & o ^ r2 & a2 ^ o & a2;
      m2 = 0 | p2, y2 = 0 | g2, p2 = 0 | h2, g2 = 0 | f2, h2 = 0 | d2, f2 = 0 | u2, { h: d2, l: u2 } = wt.default.add(0 | c2, 0 | l2, 0 | C2, 0 | S2), c2 = 0 | s, l2 = 0 | a2, s = 0 | i, a2 = 0 | o, i = 0 | n2, o = 0 | r2;
      const A2 = wt.default.add3L(S2, k2, M2);
      n2 = wt.default.add3H(A2, C2, _2, x2), r2 = 0 | A2;
    }
    ({ h: n2, l: r2 } = wt.default.add(0 | this.Ah, 0 | this.Al, 0 | n2, 0 | r2)), { h: i, l: o } = wt.default.add(0 | this.Bh, 0 | this.Bl, 0 | i, 0 | o), { h: s, l: a2 } = wt.default.add(0 | this.Ch, 0 | this.Cl, 0 | s, 0 | a2), { h: c2, l: l2 } = wt.default.add(0 | this.Dh, 0 | this.Dl, 0 | c2, 0 | l2), { h: d2, l: u2 } = wt.default.add(0 | this.Eh, 0 | this.El, 0 | d2, 0 | u2), { h: h2, l: f2 } = wt.default.add(0 | this.Fh, 0 | this.Fl, 0 | h2, 0 | f2), { h: p2, l: g2 } = wt.default.add(0 | this.Gh, 0 | this.Gl, 0 | p2, 0 | g2), { h: m2, l: y2 } = wt.default.add(0 | this.Hh, 0 | this.Hl, 0 | m2, 0 | y2), this.set(n2, r2, i, o, s, a2, c2, l2, d2, u2, h2, f2, p2, g2, m2, y2);
  }
  roundClean() {
    _t.fill(0), kt.fill(0);
  }
...
Object.defineProperty(Pt, "__esModule", { value: true }), Pt.wNAF = function(e7, t2) {
  ...
  return { constTimeNegate: n2, unsafeLadder(t3, n3) {
    ...
    for (let e8 = 0; e8 < s; e8++) {
      ...
      0 === i2 ? l2 = l2.add(n2(p2, r3[s2])) : c2 = c2.add(n2(g2, r3[f2]));
    }
    return { p: c2, f: l2 };
  }, wNAFCached(e8, t3, n3) {
...
Object.defineProperty(Rt, "__esModule", { value: true }), Rt.twistedEdwards = function(e7) {
  ...
  class b2 {
    ...
    double() {
      const { a: e8 } = t2, { ex: n3, ey: r3, ez: i2 } = this, o2 = d2(n3 * n3), s2 = d2(r3 * r3), a3 = d2(Ln * d2(i2 * i2)), c3 = d2(e8 * o2), l3 = n3 + r3, u3 = d2(d2(l3 * l3) - o2 - s2), h3 = c3 + s2, f3 = h3 - a3, p3 = c3 - s2, g3 = d2(u3 * f3), m3 = d2(h3 * p3), y3 = d2(u3 * p3), v3 = d2(f3 * h3);
    ...
    add(e8) {
      ...
      if (n3 === BigInt(-1)) {
        ...
        const r4 = d2(s2 * Ln * h3), f4 = d2(a3 * Ln * u3), p4 = f4 + r4, g4 = t3 + e9, m3 = f4 - r4, y4 = d2(p4 * n4), v4 = d2(g4 * m3), w4 = d2(p4 * m3), E4 = d2(n4 * g4);
        return new b2(y4, v4, E4, w4);
      }
      const f3 = d2(i2 * c3), p3 = d2(o2 * l3), g3 = d2(a3 * r3 * h3), y3 = d2(s2 * u3), v3 = d2((i2 + o2) * (c3 + l3) - f3 - p3), w3 = y3 - g3, E3 = y3 + g3, C3 = d2(p3 - n3 * f3), S3 = d2(v3 * w3), _3 = d2(E3 * C3), k3 = d2(v3 * C3), x3 = d2(w3 * E3);
    ...
    static fromHex(e8, r3 = false) {
      ...
      a3[s2 - 1] = -129 & c3;
      const u3 = An.bytesToNumberLE(a3), f3 = r3 ? l2 : n2.ORDER;
  ...
  function k2(e8) {
    ...
    const n3 = (0, In.ensureBytes)("hashed private key", o(e8), 2 * t3), r3 = f2(n3.slice(0, t3)), i2 = n3.slice(t3, 2 * t3), s2 = _2(r3), c3 = w2.multiply(s2), l3 = c3.toRawBytes();
  ...
  function h2(e8, t3) {
    const h3 = function(e9) {
      ...
      for (let e10 = BigInt(i - 1); e10 >= Gn; e10--) {
        ...
        const n3 = u3 + h4, i2 = r2(n3 * n3), c3 = u3 - h4, m3 = r2(c3 * c3), y2 = i2 - m3, v2 = f4 + p4, b2 = r2((f4 - p4) * n3), w2 = r2(v2 * c3), E2 = b2 + w2, C2 = b2 - w2;
        f4 = r2(E2 * E2), p4 = r2(s2 * r2(C2 * C2)), u3 = r2(i2 * m3), h4 = r2(y2 * (i2 + r2(d2 * y2)));
      }
...
!function(e7) {
  ...
  const t2 = Le, n2 = Fe, r2 = Rt, i = Nn, o = Lt, s = qn, a2 = Ot, c2 = BigInt("57896044618658097711785492504343953926634992332820282019728792003956564819949"), l2 = BigInt("19681161376707505956807079304988542015446066515923890162744021073123829784752"), d2 = BigInt(0), u2 = BigInt(1), h2 = BigInt(2), f2 = BigInt(3), p2 = BigInt(5), g2 = BigInt(8);
  function m2(e8) {
    const t3 = BigInt(10), n3 = BigInt(20), r3 = BigInt(40), i2 = BigInt(80), s2 = c2, a3 = e8 * e8 % s2 * e8 % s2, l3 = (0, o.pow2)(a3, h2, s2) * a3 % s2, d3 = (0, o.pow2)(l3, u2, s2) * e8 % s2, f3 = (0, o.pow2)(d3, p2, s2) * d3 % s2, g3 = (0, o.pow2)(f3, t3, s2) * f3 % s2, m3 = (0, o.pow2)(g3, n3, s2) * g3 % s2, y3 = (0, o.pow2)(m3, r3, s2) * m3 % s2, v3 = (0, o.pow2)(y3, i2, s2) * y3 % s2, b3 = (0, o.pow2)(v3, i2, s2) * y3 % s2, w3 = (0, o.pow2)(b3, t3, s2) * f3 % s2;
  ...
  function B2(t3) {
    ...
    (0, o.isNegativeLE)(f3, r3) || (f3 = i2(-f3)), d3 || (h3 = f3), d3 || (c3 = s2);
  ...
  class K2 {
    ...
    static fromHex(t3) {
      ...
      const h3 = s2(l3 * l3), f3 = s2(u2 + n3 * h3), p3 = s2(u2 - n3 * h3), g3 = s2(f3 * f3), m3 = s2(p3 * p3), y3 = s2(n3 * r3 * g3 - m3), { isValid: v3, value: b3 } = N2(s2(y3 * m3)), w3 = s2(b3 * p3), E3 = s2(b3 * w3 * y3);
      let C3 = s2((l3 + l3) * w3);
    ...
    toRawBytes() {
      ...
      const s2 = e7.ed25519.CURVE.Fp.ORDER, c3 = e7.ed25519.CURVE.Fp.create, l3 = c3(c3(r3 + n3) * c3(r3 - n3)), d3 = c3(t3 * n3), u3 = c3(d3 * d3), { value: h3 } = N2(c3(l3 * u3)), f3 = c3(h3 * l3), p3 = c3(h3 * d3), g3 = c3(f3 * p3 * i2);
      let m3;
      if ((0, o.isNegativeLE)(i2 * g3, s2)) {
        let e8 = c3(n3 * R2), r4 = c3(t3 * R2);
        t3 = e8, n3 = r4, m3 = c3(f3 * L2);
      } else m3 = p3;
...
!function(e7) {
  Object.defineProperty(e7, "__esModule", { value: true }), e7.DER = void 0, e7.weierstrassPoints = f2, e7.weierstrass = function(s2) {
    ...
    return y2.BASE._setWindowSize(8), { CURVE: a3, getPublicKey: function(e8, t3 = true) {
      ...
      u4 && (n3 = a3.hash(n3));
      const { r: p4, s: v3 } = h4, b3 = A2(n3), w3 = m2(v3), E3 = g2(b3 * w3), C3 = g2(p4 * w3), S3 = y2.BASE.multiplyAndAddUnsafe(f3, E3, C3)?.toAffine();
      if (!S3) return false;
      const k3 = g2(S3.x);
      return k3 === p4;
  ...
  function f2(e8) {
    ...
    class v2 {
      ...
      double() {
        ...
        let c3 = s2.ZERO, l3 = s2.ZERO, d4 = s2.ZERO, h4 = s2.mul(r3, r3), f4 = s2.mul(i2, i2), p4 = s2.mul(a4, a4), g3 = s2.mul(r3, i2);
        return g3 = s2.add(g3, g3), d4 = s2.mul(r3, a4), d4 = s2.add(d4, d4), c3 = s2.mul(e9, d4), l3 = s2.mul(n3, p4), l3 = s2.add(c3, l3), c3 = s2.sub(f4, l3), l3 = s2.add(f4, l3), l3 = s2.mul(c3, l3), c3 = s2.mul(g3, c3), d4 = s2.mul(n3, d4), p4 = s2.mul(e9, p4), g3 = s2.sub(h4, p4), g3 = s2.mul(e9, g3), g3 = s2.add(g3, d4), d4 = s2.add(h4, h4), h4 = s2.add(d4, h4), h4 = s2.add(h4, p4), h4 = s2.mul(h4, g3), l3 = s2.add(l3, h4), p4 = s2.mul(i2, a4), p4 = s2.add(p4, p4), h4 = s2.mul(p4, g3), c3 = s2.sub(c3, h4), d4 = s2.mul(p4, f4), d4 = s2.add(d4, d4), d4 = s2.add(d4, d4), new v2(c3, l3, d4);
      }
      add(e9) {
        g2(e9);
        ...
        let C2 = s2.add(i2, c3);
        return E2 = s2.mul(E2, C2), C2 = s2.add(m3, b3), E2 = s2.sub(E2, C2), C2 = s2.add(n3, r3), l3 = s2.add(a4, c3), C2 = s2.mul(C2, l3), l3 = s2.add(y3, b3), C2 = s2.sub(C2, l3), h4 = s2.mul(f4, E2), l3 = s2.mul(p4, b3), h4 = s2.add(l3, h4), l3 = s2.sub(y3, h4), h4 = s2.add(y3, h4), d4 = s2.mul(l3, h4), y3 = s2.add(m3, m3), y3 = s2.add(y3, m3), b3 = s2.mul(f4, b3), E2 = s2.mul(p4, E2), y3 = s2.add(y3, b3), b3 = s2.sub(m3, b3), b3 = s2.mul(f4, b3), E2 = s2.add(E2, b3), m3 = s2.mul(y3, E2), d4 = s2.add(d4, m3), m3 = s2.mul(C2, E2), l3 = s2.mul(w3, l3), l3 = s2.sub(l3, m3), m3 = s2.mul(w3, y3), h4 = s2.mul(C2, h4), h4 = s2.add(h4, m3), new v2(l3, d4, h4);
      }
      subtract(e9) {
  ...
  function p2(e8, t3) {
    ...
    const i2 = r3, o2 = d2 << i2 - l2 - l2, s2 = o2 * d2, a3 = (n3 - l2) / s2, f3 = (a3 - l2) / d2, p3 = s2 - l2, g2 = o2, m2 = e8.pow(t3, a3), y2 = e8.pow(t3, (a3 + l2) / d2);
    let v2 = (t4, n4) => {
...
!function(e7) {
  ...
  function f2(e8) {
    const t3 = c2, n3 = BigInt(3), r3 = BigInt(6), i2 = BigInt(11), s2 = BigInt(22), a3 = BigInt(23), l3 = BigInt(44), d3 = BigInt(88), h3 = e8 * e8 * e8 % t3, f3 = h3 * h3 * e8 % t3, g3 = (0, o.pow2)(f3, n3, t3) * f3 % t3, m3 = (0, o.pow2)(g3, n3, t3) * f3 % t3, y3 = (0, o.pow2)(m3, u2, t3) * h3 % t3, v3 = (0, o.pow2)(y3, i2, t3) * y3 % t3, b3 = (0, o.pow2)(v3, s2, t3) * v3 % t3, w3 = (0, o.pow2)(b3, l3, t3) * b3 % t3, E3 = (0, o.pow2)(w3, d3, t3) * w3 % t3, C3 = (0, o.pow2)(E3, l3, t3) * b3 % t3, S3 = (0, o.pow2)(C3, n3, t3) * f3 % t3, _3 = (0, o.pow2)(S3, a3, t3) * v3 % t3, k3 = (0, o.pow2)(_3, r3, t3) * h3 % t3, x3 = (0, o.pow2)(k3, u2, t3);
  ...
  e7.secp256k1 = (0, r2.createCurve)({ a: BigInt(0), b: BigInt(7), Fp: p2, n: l2, Gx: BigInt("55066263022277343669578718895168534326250603453777594175500187360389116729240"), Gy: BigInt("32670510020758816978083085130507043184471273380659243275938904335757337482424"), h: BigInt(1), lowS: true, endo: { beta: BigInt("0x7ae96a2b657c07106e64479eac3434e99cf0497512f58995c1396c28719501ee"), splitScalar: (e8) => {
    ...
    let f3 = (0, o.mod)(e8 - c3 * n3 - u3 * i2, t3), p3 = (0, o.mod)(-c3 * r3 - u3 * s2, t3);
  ...
  _updateBlock(e7, t2, n2, r2) {
    ...
    for (const f2 of [e7, t2, n2, r2]) for (let e8 = 0; e8 < 4; e8++) {
      ...
      for (let e9 = 8 / i - 1; e9 >= 0; e9--) {
        const n3 = t3 >>> i * e9 & u2, { s0: r3, s1: f3, s2: p2, s3: g2 } = o[h2 * s + n3];
...
function si(e7, t2, n2, r2) {
  ...
  if (f2 < i) {
    ...
    for (let e9 = f2, o2 = 0; e9 < i; e9++, o2++) r2[e9] = n2[e9] ^ t3[o2];
    (0, Br.clean)(e8);
  }
  return r2;
}
...
_r.ctr = (0, Br.wrapCipher)({ blockSize: 16, nonceLength: 16 }, function(e7, t2) {
  ...
  function n2(n3, r2, i) {
    ...
    for (let e8 = 0; e8 + 4 <= l2.length; ) {
      const { s0: t3, s1: n4, s2: r3, s3: i2 } = ri(s, f2, p2, g2, m2);
      d2[e8 + 0] = l2[e8 + 0] ^ t3, d2[e8 + 1] = l2[e8 + 1] ^ n4, d2[e8 + 2] = l2[e8 + 2] ^ r3, d2[e8 + 3] = l2[e8 + 3] ^ i2, f2 = u2[e8++], p2 = u2[e8++], g2 = u2[e8++], m2 = u2[e8++];
    }
...
_r.siv = (0, Br.wrapCipher)({ blockSize: 16, nonceLength: 12, tagLength: 16 }, function(e7, t2, n2) {
  ...
  function a2() {
    ...
    const f2 = { authKey: i2, encKey: Qr(r3) };
...
var ji = class {
  ...
  process(e7, t2, n2 = false) {
    const r2 = n2 ? 0 : 2048, { h: i, r: o } = this, s = o[0], a2 = o[1], c2 = o[2], l2 = o[3], d2 = o[4], u2 = o[5], h2 = o[6], f2 = o[7], p2 = o[8], g2 = o[9], m2 = Ki(e7, t2 + 0), y2 = Ki(e7, t2 + 2), v2 = Ki(e7, t2 + 4), b2 = Ki(e7, t2 + 6), w2 = Ki(e7, t2 + 8), E2 = Ki(e7, t2 + 10), C2 = Ki(e7, t2 + 12), S2 = Ki(e7, t2 + 14);
    let _2 = i[0] + (8191 & m2), k2 = i[1] + (8191 & (m2 >>> 13 | y2 << 3)), x2 = i[2] + (8191 & (y2 >>> 10 | v2 << 6)), M2 = i[3] + (8191 & (v2 >>> 7 | b2 << 9)), A2 = i[4] + (8191 & (b2 >>> 4 | w2 << 12)), I2 = i[5] + (w2 >>> 1 & 8191), R2 = i[6] + (8191 & (w2 >>> 14 | E2 << 2)), P2 = i[7] + (8191 & (E2 >>> 11 | C2 << 5)), L2 = i[8] + (8191 & (C2 >>> 8 | S2 << 8)), O2 = i[9] + (S2 >>> 5 | r2), T2 = 0, N2 = T2 + _2 * s + k2 * (5 * g2) + x2 * (5 * p2) + M2 * (5 * f2) + A2 * (5 * h2);
...
Di.poly1305 = Ui((e7) => new ji(e7)), function(e7) {
  ...
  function o(e8, n3, r3, i2, o2, s2 = 20) {
    let a3 = e8[0], c3 = e8[1], l3 = e8[2], d3 = e8[3], u2 = n3[0], h2 = n3[1], f2 = n3[2], p2 = n3[3], g2 = n3[4], m2 = n3[5], y2 = n3[6], v2 = n3[7], b2 = o2, w2 = r3[0], E2 = r3[1], C2 = r3[2], S2 = a3, _2 = c3, k2 = l3, x2 = d3, M2 = u2, A2 = h2, I2 = f2, R2 = p2, P2 = g2, L2 = m2, O2 = y2, T2 = v2, N2 = b2, D2 = w2, $2 = E2, B2 = C2;
  ...
  function s(e8, n3, r3, i2) {
    let o2 = e8[0], s2 = e8[1], a3 = e8[2], c3 = e8[3], l3 = n3[0], d3 = n3[1], u2 = n3[2], h2 = n3[3], f2 = n3[4], p2 = n3[5], g2 = n3[6], m2 = n3[7], y2 = r3[0], v2 = r3[1], b2 = r3[2], w2 = r3[3];
  ...
  e7._poly1305_aead = (e8) => (t3, r3, o2) => {
    ...
    return (0, n2.bytes)(t3, 32), (0, n2.bytes)(r3), { encrypt(a3, c3) {
      ...
      const h2 = a3.subarray(0, -16), f2 = a3.subarray(-16), p2 = d2(e8, t3, r3, h2, o2);
...
var Oo = [{ event: bo.CLIENTS_CONNECTED, handler: function(e7, t2) {
  ...
  return (n2) => {
    var r2, i, o, s, a2, c2, l2, d2, u2, h2, f2, p2, g2, m2, y2, v2, b2, w2;
...
var Xo = class extends import_eventemitter2.EventEmitter2 {
  constructor(e7) {
    ...
    const { platformType: n2, communicationLayerPreference: r2, otherPublicKey: i, reconnect: o, walletInfo: s, dappMetadata: a2, protocolVersion: c2, transports: l2, context: d2, relayPersistence: u2, ecies: h2, analytics: f2 = false, storage: p2, sdkVersion: g2, communicationServerUrl: m2 = ho, logging: y2, autoConnect: v2 = { timeout: go } } = e7;
...
function Ld() {
  ...
  return kd = function(e8) {
    var u3, f3 = Object.create(p2, (t2(u3 = {}, l2, { value: e8, writable: true }), t2(u3, r2, { value: null, writable: true }), t2(u3, i, { value: null, writable: true }), t2(u3, o, { value: null, writable: true }), t2(u3, s, { value: e8._readableState.endEmitted, writable: true }), t2(u3, c2, { value: function(e9, t3) {
      var n3 = f3[l2].read();
      n3 ? (f3[a2] = null, f3[r2] = null, f3[i] = null, e9(d2(n3, false))) : (f3[r2] = e9, f3[i] = t3);
    }, writable: true }), u3));
    return f3[a2] = null, n2(e8, function(e9) {
      if (e9 && "ERR_STREAM_PREMATURE_CLOSE" !== e9.code) {
        var t3 = f3[i];
        return null !== t3 && (f3[a2] = null, f3[r2] = null, f3[i] = null, t3(e9)), void (f3[o] = e9);
      }
      var n3 = f3[r2];
      null !== n3 && (f3[a2] = null, f3[r2] = null, f3[i] = null, n3(d2(void 0, true))), f3[s] = true;
...
function Od() {
  ...
  return E2.prototype.read = function(e8) {
    ...
    }(e8, "error", h3), e8.once("close", f3), e8.once("finish", p3), e8.emit("pipe", r3), i2.flowing || (o("pipe resume"), r3.resume()), e8;
...
var wh = ({ checkInstallationOnAllCalls: t2 = false, communicationLayerPreference: n2, injectProvider: r2, shouldShimWeb3: i, platformManager: o, installer: s, sdk: c2, remoteConnection: l2, debug: d2 }) => a(void 0, void 0, void 0, function* () {
  ...
  const w2 = !(!r2 || p2 === Bo.NonBrowser || p2 === Bo.ReactNative), E2 = zu.init({ shouldSetOnWindow: w2, connectionStream: f2, shouldShimWeb3: i, sdkInstance: c2 });
  let C2 = false;
  const S2 = (e7) => {
    C2 = e7;
    ...
    if (N2 && T2) try {
      const t3 = null === (f3 = null == r3 ? void 0 : r3[0]) || void 0 === f3 ? void 0 : f3.params, i3 = yield (({ rpcEndpoint: t4, method: n4, sdkInfo: r4, params: i4 }) => a(void 0, void 0, void 0, function* () {
...
function ef(e7) {
  var n2, r2, i, o, s, c2, l2, d2, u2, h2, f2;
  return a(this, void 0, void 0, function* () {
    const { options: p2 } = e7;
...
var dp = (e7, t2, n2 = false) => {
  ...
  null === a2 ? (np(e7, t2, op = "svg" === s || "foreignObject" !== s && op), null !== i && null !== o ? ((e8, t3, n3, r3, i2 = false) => {
    let o2, s2 = 0, a3 = 0, c2 = t3.length - 1, l2 = t3[0], d2 = t3[c2], u2 = r3.length - 1, h2 = r3[0], f2 = r3[u2];
    for (; s2 <= c2 && a3 <= u2; ) null == l2 ? l2 = t3[++s2] : null == d2 ? d2 = t3[--c2] : null == h2 ? h2 = r3[++a3] : null == f2 ? f2 = r3[--u2] : lp(l2, h2, i2) ? (dp(l2, h2, i2), l2 = t3[++s2], h2 = r3[++a3]) : lp(d2, f2, i2) ? (dp(d2, f2, i2), d2 = t3[--c2], f2 = r3[--u2]) : lp(l2, f2, i2) ? (dp(l2, f2, i2), up(e8, l2.$elm$, d2.$elm$.nextSibling), l2 = t3[++s2], f2 = r3[--u2]) : lp(d2, h2, i2) ? (dp(d2, h2, i2), up(e8, d2.$elm$, l2.$elm$), d2 = t3[--c2], h2 = r3[++a3]) : (o2 = sp(t3 && t3[a3], n3, a3), h2 = r3[++a3], o2 && up(l2.$elm$.parentNode, o2, l2.$elm$));
...
eventemitter2/lib/eventemitter2.js:
   ...
   *)
*/
//# sourceMappingURL=metamask-sdk-4KU3CXFO.js.map
