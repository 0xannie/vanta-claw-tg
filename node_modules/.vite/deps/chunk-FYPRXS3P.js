...
var controller6 = {
  ...
  getAuthConnector(chainNamespace) {
    ...
    const authConnector = state12.connectors.find((c3) => c3.id === ConstantsUtil.CONNECTOR_ID.AUTH);
    if (!authConnector) {
      return void 0;
    }
  ...
  getAnnouncedConnectorRdns() {
    return state12.connectors.filter((c3) => c3.type === "ANNOUNCED").map((c3) => c3.info?.rdns);
  },
  getConnectorById(id) {
    return state12.allConnectors.find((c3) => c3.id === id);
  },
  getConnector(id, rdns) {
    const connectorsByNamespace = state12.allConnectors.filter((c3) => c3.chain === ChainController.state.activeChain);
...
var controller9 = {
  ...
  setConnections(connections, chainNamespace) {
    state15.connections.set(chainNamespace, connections);
  },
...
var controller12 = {
  ...
  setPreferredAccountType(preferredAccountType, chain) {
    ChainController.setAccountProp("preferredAccountTypes", {
      ...state19.preferredAccountTypes,
      [chain]: preferredAccountType
    }, chain);
  },
  setPreferredAccountTypes(preferredAccountTypes) {
    state19.preferredAccountTypes = preferredAccountTypes;
  },
...
// node_modules/@reown/appkit-controllers/node_modules/unstorage/dist/shared/unstorage.CoCt7NXC.mjs
...
*/
//# sourceMappingURL=chunk-FYPRXS3P.js.map
