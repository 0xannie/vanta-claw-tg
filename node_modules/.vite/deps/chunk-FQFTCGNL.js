...
// node_modules/@orderly.network/react-app/dist/index.mjs
...
function getDisplaySide(side) {
  if (side === "BUY") {
    return i18n_default.t("common.buy");
  } else if (side === "SELL") {
    return i18n_default.t("common.sell");
  }
...
function getOrderExecutionReportMsg(data, symbolsInfo) {
  ...
  const displayQuantity = "algo_type" in data && data.algo_type === AlgoOrderRootType.POSITIONAL_TP_SL ? i18n_default.t("tpsl.entirePosition") : base_dp === void 0 ? quantity : parseNumber(quantity, { dp: base_dp });
  let title = "";
  let msg = "";
  switch (status) {
    case OrderStatus.NEW:
      ...
      if (isScaledOrder) {
        title = i18n_default.t("orders.status.scaledSubOrderOpened.toast.title");
        msg = `${displaySide} ${displaySymbol} ${displayQuantity}`;
      } else {
        title = i18n_default.t("orders.status.opened.toast.title");
        msg = `${displaySide} ${displaySymbol} ${displayQuantity}`;
      }
      break;
    ...
    case OrderStatus.PARTIAL_FILLED:
      ...
      title = i18n_default.t("orders.status.filled.toast.title");
      msg = `${displaySide} ${displaySymbol} ${displayTotalExecutedQuantity} / ${displayQuantity}`;
      break;
    case OrderStatus.CANCELLED:
      title = i18n_default.t("orders.status.canceled.toast.title");
      msg = `${displaySide} ${displaySymbol} ${displayQuantity}`;
      break;
    case OrderStatus.REJECTED:
      title = i18n_default.t("orders.status.rejected.toast.title");
      msg = `${displaySide} ${displaySymbol} ${displayQuantity}`;
      break;
    case OrderStatus.REPLACED:
      ...
      if (algo_type === AlgoOrderRootType.TRAILING_STOP) {
        ...
        if (fieldChange.is_activated && fieldChange.extreme_price && activated_price) {
          title = i18n_default.t("orders.trailingStop.activated");
        ...
        title = i18n_default.t("orders.status.replaced.toast.title");
...
var useExecutionReport = () => {
  ...
  const symbolsInfoRef = (0, import_react.useRef)({});
      ...
      if (title && msg) {
        Vt.success(
          (0, import_jsx_runtime.jsxs)("div", { children: [
            ...
            (0, import_jsx_runtime.jsx)("div", { className: "orderly-text-white/[0.54] orderly-text-xs", children: msg }),
...
var useAppConfig = () => {
  return (0, import_react.useContext)(AppConfigContext);
};
var AppConfigProvider = (props) => {
  return (0, import_jsx_runtime.jsx)(AppConfigContext.Provider, { value: props, children: props.children });
};
  ...
  (0, import_react.useEffect)(() => {
    const unsubscribe = ws.privateSubscribe(
      ...
      },
      {
        onMessage(data) {
          if (data.convertId) {
            Vt.success(t("transfer.convert.completed"));
          }
        }
      }
    );
...
function useCurrentChainId(defaultChain) {
  ...
  const [currentChainId, setCurrentChainId] = (0, import_react.useState)();
...
function useSettleEvent() {
  ...
  useSettleSubscription({
    onMessage: (data) => {
      ...
      switch (status) {
        case "COMPLETED":
          Vt.success(t("settle.settlement.completed"));
          break;
        case "FAILED":
          Vt.error(t("settle.settlement.failed"));
          break;
      }
    }
  });
...
var useWalletStateHandle = (options) => {
  ...
  useEventEmitter();
  const isManualConnect = (0, import_react.useRef)(false);
  useConfig("brokerId");
  ...
  const currentWalletAddress = (0, import_react.useMemo)(() => {
    return connectedWallet?.accounts?.[0]?.address;
  }, [connectedWallet]);
  const currentChain = (0, import_react.useMemo)(() => {
...
var AppStateContext = (0, import_react.createContext)({
  setCurrentChainId: (chainId) => {
  },
  restrictedInfo: {},
...
var useAppContext = () => {
  return (0, import_react.useContext)(AppStateContext);
};
var AppStateProvider = (props) => {
  const [showAnnouncement, setShowAnnouncement] = (0, import_react.useState)(false);
  ...
  return (0, import_jsx_runtime.jsx)(AppStateContext.Provider, { value: memoizedValue, children: props.children });
};
...
var OrderlyAppProvider = (props) => {
  ...
  return (0, import_jsx_runtime.jsx)(AppConfigProvider, { appIcons, brokerName: props.brokerName, children: (0, import_jsx_runtime.jsx)(
    OrderlyThemeProvider,
    {
      components,
      overrides: props.overrides,
      children: (0, import_jsx_runtime.jsxs)(OrderlyConfigProvider, { ...configProps, children: [
        (0, import_jsx_runtime.jsx)(ExecutionReportListener, {}),
        (0, import_jsx_runtime.jsx)(
          AppStateProvider,
          {
            ...
            onRouteChange: props.onRouteChange,
            widgetConfigs,
            children: (0, import_jsx_runtime.jsx)(LocaleProvider, { locale: uiLocale, children: (0, import_jsx_runtime.jsx)(TooltipProvider, { delayDuration: 300, children: (0, import_jsx_runtime.jsx)(ModalProvider, { children: props.children }) }) })
          }
        ),
...
function useOrderEntryFormErrorMsg(errors) {
  ...
  const getErrorMsg = (0, import_react.useCallback)(
    (key, customValue) => {
    ...
    if (this.state.hasError) {
      return (0, import_jsx_runtime.jsxs)(
        Flex,
        {
          ...
          itemAlign: "center",
          justify: "center",
          className: M("oui-h-screen oui-px-[10%]", this.props.className),
          children: [
            this.props.icon || (0, import_jsx_runtime.jsx)(Icon, {}),
            (0, import_jsx_runtime.jsx)(
              Text2,
              {
                className: M(
                ...
                intensity: 80,
                weight: "bold",
                children: this.props.title || i18n_default.t("errorBoundary.title")
              }
            ),
            (0, import_jsx_runtime.jsx)(
              Text2,
              {
                ...
                weight: "semibold",
                intensity: 36,
                children: this.props.description || i18n_default.t("errorBoundary.description")
              }
            ),
            (0, import_jsx_runtime.jsxs)(
              Button,
              {
                ...
                size: "md",
                children: [
                  (0, import_jsx_runtime.jsx)(RefreshIcon, { className: "oui-mr-1" }),
                  this.props.refreshButtonText || i18n_default.t("errorBoundary.refresh")
                ]
              }
            )
          ]
        ...
        (0, import_jsx_runtime.jsxs)("defs", { children: [
          (0, import_jsx_runtime.jsxs)(
            "linearGradient",
            {
              ...
              children: [
                (0, import_jsx_runtime.jsx)("stop", { stopColor: "#1B1D22" }),
                (0, import_jsx_runtime.jsx)("stop", { offset: "1", stopColor: "#26292E" })
              ]
            }
          ),
          (0, import_jsx_runtime.jsxs)(
            "linearGradient",
            {
              ...
              children: [
                ...
                (0, import_jsx_runtime.jsx)("stop", { offset: "1", stopColor: "rgb(var(--oui-gradient-brand-start))" })
              ]
            }
          ),
          (0, import_jsx_runtime.jsxs)(
...
function useCanTrade() {
  const { state } = useAccount();
  const { wrongNetwork, disabledConnect } = useAppContext();
  const canTrade = (0, import_react.useMemo)(() => {
...
//# sourceMappingURL=chunk-FQFTCGNL.js.map
