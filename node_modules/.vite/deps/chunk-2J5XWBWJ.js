...
var ICONS = {
  add: async () => (await import("./add-LYTS7XTK.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-MC5UDQWA.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-ALUMW7MK.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-SS2BKID3.js")).appStoreSvg,
  apple: async () => (await import("./apple-ZNETSVX6.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-SXZAQHME.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-5X6PNNPS.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-NCZ7SFKL.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-JDGGKC2V.js")).arrowTopSvg,
  bank: async () => (await import("./bank-6F3NYCA5.js")).bankSvg,
  browser: async () => (await import("./browser-KYUOD4XB.js")).browserSvg,
  card: async () => (await import("./card-PA2QKYXZ.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-PJQOWKKV.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-OENX5NRZ.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-U453BK5G.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-PRNYOVNT.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-Y67JDKES.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-EL6O7FPV.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-G5Z5V5QU.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-FPUIRRIE.js")).clockSvg,
  close: async () => (await import("./close-ENKLHN3V.js")).closeSvg,
  compass: async () => (await import("./compass-OGFYNIIT.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-QMHM7BWC.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-QB5BKBYS.js")).copySvg,
  cursor: async () => (await import("./cursor-JTMYCOYG.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-RHKFFWZ3.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-CARTQ4JU.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-UJYGVNHZ.js")).disconnectSvg,
  discord: async () => (await import("./discord-GKHDFWSW.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-JRXUMBB4.js")).etherscanSvg,
  extension: async () => (await import("./extension-G4BY2ER4.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-TA5GD2GW.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-KEFGHLIX.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-NR43JUYR.js")).farcasterSvg,
  filters: async () => (await import("./filters-IYLOLAFC.js")).filtersSvg,
  github: async () => (await import("./github-TYXNRHF7.js")).githubSvg,
  google: async () => (await import("./google-FUA3DTUC.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-ZLLTW3VD.js")).helpCircleSvg,
  image: async () => (await import("./image-KRKSW7YL.js")).imageSvg,
  id: async () => (await import("./id-NXOXQO3Y.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-7LFRWZTQ.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-EYYWNR6V.js")).lightbulbSvg,
  mail: async () => (await import("./mail-HPHQ6JSA.js")).mailSvg,
  mobile: async () => (await import("./mobile-TA7CP452.js")).mobileSvg,
  more: async () => (await import("./more-7PQ6X7VZ.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-LQG7C2RJ.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-KYIZXNLU.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-VP6TLUOZ.js")).offSvg,
  playStore: async () => (await import("./play-store-7WKYENI2.js")).playStoreSvg,
  plus: async () => (await import("./plus-D2YYOULC.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-YHJ225G5.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-NPV2WTAS.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-2QXSMGZR.js")).refreshSvg,
  search: async () => (await import("./search-YXOAOI2Y.js")).searchSvg,
  send: async () => (await import("./send-IOX53HGG.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-ULANRSQH.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-WKLFJO5A.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-PUPBKE3F.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-LX5XYULW.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-4TPIS7DZ.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-6KZILHOV.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-TZ6DSLZ7.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-ASXLUT3F.js")).twitchSvg,
  twitter: async () => (await import("./x-U5HDJ7I5.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-N3EZTCBA.js")).twitterIconSvg,
  verify: async () => (await import("./verify-2Z24H6UA.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-GIUECSK5.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-2VACVN5Y.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-COXAKSFD.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-COXAKSFD.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-COXAKSFD.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-A5Y6WNXC.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-V25AO4SJ.js")).warningCircleSvg,
  x: async () => (await import("./x-U5HDJ7I5.js")).xSvg,
  info: async () => (await import("./info-ETORNMYP.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-WLEPNU7O.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-PUPRCI7G.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-2J5XWBWJ.js.map
