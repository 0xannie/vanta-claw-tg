...
var import_wallet_adapter_mobile2 = __toESM(require_index_browser(), 1);
...
function useStandardWalletAdapters(adapters) {
  ...
  const [standardAdapters, setStandardAdapters] = (0, import_react2.useState)(() => wrapWalletsWithAdapters(get2()));
  ...
  (0, import_react2.useEffect)(() => () => standardAdapters.forEach((adapter) => adapter.destroy()), []);
...
var import_wallet_adapter_mobile = __toESM(require_index_browser(), 1);
var Environment;
...
var ConnectionContext = (0, import_react3.createContext)({});
function useConnection() {
  return (0, import_react3.useContext)(ConnectionContext);
}
...
function useLocalStorage(key, defaultState) {
  const state = (0, import_react4.useState)(() => {
    try {
  ...
  const value = state[0];
  const isFirstRenderRef = (0, import_react4.useRef)(true);
...
function WalletProviderBase({ children, wallets: adapters, adapter, isUnloadingRef, onAutoConnectRequest, onConnectError, onError, onSelectWallet }) {
  const isConnectingRef = (0, import_react5.useRef)(false);
  const [connecting, setConnecting] = (0, import_react5.useState)(false);
  const isDisconnectingRef = (0, import_react5.useRef)(false);
  const [disconnecting, setDisconnecting] = (0, import_react5.useState)(false);
  const [publicKey, setPublicKey] = (0, import_react5.useState)(() => adapter?.publicKey ?? null);
  const [connected, setConnected] = (0, import_react5.useState)(() => adapter?.connected ?? false);
  ...
  const handleErrorRef = (0, import_react5.useRef)((error, adapter2) => {
  ...
  const [wallets2, setWallets] = (0, import_react5.useState)(() => adapters.map((adapter2) => ({
    adapter: adapter2,
  ...
  const wallet = (0, import_react5.useMemo)(() => wallets2.find((wallet2) => wallet2.adapter === adapter) ?? null, [adapter, wallets2]);
  (0, import_react5.useEffect)(() => {
    if (!adapter)
      return;
  ...
  const didAttemptAutoConnectRef = (0, import_react5.useRef)(false);
  (0, import_react5.useEffect)(() => {
    return () => {
  ...
  const sendTransaction = (0, import_react5.useCallback)(async (transaction, connection, options) => {
    if (!adapter)
  ...
  const signTransaction = (0, import_react5.useMemo)(() => adapter && "signTransaction" in adapter ? async (transaction) => {
    if (!connected)
      throw handleErrorRef.current(new WalletNotConnectedError(), adapter);
    return await adapter.signTransaction(transaction);
  } : void 0, [adapter, connected]);
  const signAllTransactions = (0, import_react5.useMemo)(() => adapter && "signAllTransactions" in adapter ? async (transactions) => {
    if (!connected)
      throw handleErrorRef.current(new WalletNotConnectedError(), adapter);
    return await adapter.signAllTransactions(transactions);
  } : void 0, [adapter, connected]);
  const signMessage = (0, import_react5.useMemo)(() => adapter && "signMessage" in adapter ? async (message) => {
    if (!connected)
      throw handleErrorRef.current(new WalletNotConnectedError(), adapter);
    return await adapter.signMessage(message);
  } : void 0, [adapter, connected]);
  const signIn = (0, import_react5.useMemo)(() => adapter && "signIn" in adapter ? async (input) => {
  ...
  return import_react5.default.createElement(WalletContext.Provider, { value: {
...
function WalletProvider({ children, wallets: adapters, autoConnect, localStorageKey = "walletName", onError }) {
  ...
  const mobileWalletAdapter = (0, import_react6.useMemo)(() => {
  ...
  const adaptersWithMobileWalletAdapter = (0, import_react6.useMemo)(() => {
  ...
  const adapter = (0, import_react6.useMemo)(() => adaptersWithMobileWalletAdapter.find((a) => a.name === walletName) ?? null, [adaptersWithMobileWalletAdapter, walletName]);
  const changeWallet = (0, import_react6.useCallback)((nextWalletName) => {
  ...
  const hasUserSelectedAWallet = (0, import_react6.useRef)(false);
  const handleAutoConnectRequest = (0, import_react6.useMemo)(() => {
  ...
  const isUnloadingRef = (0, import_react6.useRef)(false);
  (0, import_react6.useEffect)(() => {
  ...
  const handleConnectError = (0, import_react6.useCallback)(() => {
    if (adapter) {
      changeWallet(null);
    }
  }, [adapter, changeWallet]);
  const selectWallet = (0, import_react6.useCallback)((walletName2) => {
    hasUserSelectedAWallet.current = true;
    changeWallet(walletName2);
  }, [changeWallet]);
  return import_react6.default.createElement(WalletProviderBase, { wallets: adaptersWithMobileWalletAdapter, adapter, isUnloadingRef, onAutoConnectRequest: handleAutoConnectRequest, onConnectError: handleConnectError, onError, onSelectWallet: selectWallet }, children);
}
...
//# sourceMappingURL=chunk-G2TPAVLT.js.map
