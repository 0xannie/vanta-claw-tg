...
import {
  require_hash
} from "./chunk-SR5T5QTJ.js";
import {
  require_bn
} from "./chunk-Y3BGTO6U.js";
import {
  init_hmac
} from "./chunk-DYEGVO7E.js";
import {
  init_sha2
} from "./chunk-FDCKJXHS.js";
import {
  init_utils
} from "./chunk-TFQH4EAC.js";
import {
  __commonJS,
  __export,
  __toESM,
...
var version = "abstract-signer/5.8.0";
...
var version2 = "signing-key/5.8.0";
...
var version3 = "transactions/5.8.0";
...
function _fetchData(connection, body, processFunc) {
  ...
  logger4.assertArgument(attemptLimit > 0 && attemptLimit % 1 === 0, "invalid connection throttle limit", "connection.throttleLimit", attemptLimit);
  const throttleCallback = typeof connection === "object" ? connection.throttleCallback : null;
  const throttleSlotInterval = typeof connection === "object" && typeof connection.throttleSlotInterval === "number" ? connection.throttleSlotInterval : 100;
  logger4.assertArgument(throttleSlotInterval > 0 && throttleSlotInterval % 1 === 0, "invalid connection throttle slot interval", "connection.throttleSlotInterval", throttleSlotInterval);
  ...
  if (typeof connection === "string") {
    ...
    if (connection == null || connection.url == null) {
      logger4.throwArgumentError("missing URL", "connection.url", connection);
    }
    url = connection.url;
    ...
    if (connection.user != null && connection.password != null) {
      if (url.substring(0, 6) !== "https:" && connection.allowInsecureAuthentication !== true) {
        logger4.throwError("basic authentication requires a secure https url", Logger.errors.INVALID_ARGUMENT, { argument: "url", url, user: connection.user, password: "[REDACTED]" });
      }
  ...
  if (dataMatch) {
    try {
      ...
      logger4.throwError("processing response error", Logger.errors.SERVER_ERROR, {
    ...
    const promise = new Promise(function(resolve, reject) {
      if (timeout) {
        timer2 = setTimeout(() => {
          ...
          timer2 = null;
          reject(logger4.makeError("timeout", Logger.errors.TIMEOUT, {
  ...
  const runningFetch = function() {
    return __awaiter3(this, void 0, void 0, function* () {
      for (let attempt = 0; attempt < attemptLimit; attempt++) {
        ...
        try {
          ...
          if (response == null) {
            ...
            logger4.throwError("missing response", Logger.errors.SERVER_ERROR, {
              requestBody: bodyify(options.body, flatHeaders["content-type"]),
              requestMethod: options.method,
              serverError: error,
              url
        ...
        if (allow304 && response.statusCode === 304) {
          ...
          runningTimeout.cancel();
          logger4.throwError("bad response", Logger.errors.SERVER_ERROR, {
      ...
      return logger4.throwError("failed response", Logger.errors.SERVER_ERROR, {
        requestBody: bodyify(options.body, flatHeaders["content-type"]),
        requestMethod: options.method,
        url
      });
  ...
  let processJsonFunc = (value, response) => {
    ...
    if (value != null) {
      try {
        ...
        logger4.throwError("invalid JSON", Logger.errors.SERVER_ERROR, {
          body: value,
          error
        });
      }
...
var version6 = "abstract-provider/5.8.0";
...
var BaseX = class {
  constructor(alphabet3) {
    ...
    for (let i = 0; i < alphabet3.length; i++) {
      this._alphabetMap[alphabet3.charAt(i)] = i;
    }
  }
  encode(value) {
...
var logger7 = new Logger(version4);
var Formatter = class _Formatter {
  ...
  getDefaultFormats() {
    ...
    formats.receipt = {
      ...
      root: _Formatter.allowNull(hex3),
      gasUsed: bigNumber,
    ...
    formats.block = {
      ...
      number,
      timestamp: number,
      nonce: _Formatter.allowNull(hex3),
  ...
  hex(value, strict) {
    ...
    return logger7.throwArgumentError("invalid hash", "value", value);
  }
  data(value, strict) {
      ...
      if (result.root.length <= 4) {
        ...
        if (value2 === 0 || value2 === 1) {
          if (result.status != null && result.status !== value2) {
            logger7.throwArgumentError("alt-root-status/status mismatch", "value", { root: result.root, status: result.status });
          }
          result.status = value2;
          delete result.root;
        } else {
          logger7.throwArgumentError("invalid alt-root-status", "value.root", result.root);
        }
      } else if (result.root.length !== 66) {
        logger7.throwArgumentError("invalid root hash", "value.root", result.root);
      }
    }
...
var logger8 = new Logger(version4);
...
function checkTopic(topic) {
  ...
  if (hexDataLength(topic) !== 32) {
    logger8.throwArgumentError("invalid topic", "topic", topic);
  }
...
function getIpfsLink(link) {
  if (link.match(/^ipfs:\/\/ipfs\//i)) {
    ...
    logger8.throwArgumentError("unsupported IPFS format", "link", link);
  }
...
var Resolver = class {
    ...
    return __awaiter5(this, void 0, void 0, function* () {
      ...
      try {
        ...
        if (arrayify(result).length % 32 === 4) {
          logger8.throwError("resolver threw error", Logger.errors.CALL_EXCEPTION, {
            transaction: tx,
            data: result
          });
        }
  ...
  _getAddress(coinType, hexBytes) {
    ...
    if (coinInfo == null) {
      logger8.throwError(`unsupported coin type: ${coinType}`, Logger.errors.UNSUPPORTED_OPERATION, {
  ...
  getAddress(coinType) {
    return __awaiter5(this, void 0, void 0, function* () {
      ...
      if (address == null) {
        logger8.throwError(`invalid or unsupported coin data`, Logger.errors.UNSUPPORTED_OPERATION, {
          operation: `getAddress(${coinType})`,
          coinType,
          data: hexBytes
        });
  ...
  getContentHash() {
    return __awaiter5(this, void 0, void 0, function* () {
      ...
      return logger8.throwError(`invalid or unsupported content hash data`, Logger.errors.UNSUPPORTED_OPERATION, {
...
var BaseProvider = class extends Provider {
  ...
  constructor(network) {
    ...
    if (network instanceof Promise) {
      ...
      if (knownNetwork) {
        ...
        logger8.throwArgumentError("invalid network", "network", network);
      }
    }
  ...
  _ready() {
    return __awaiter5(this, void 0, void 0, function* () {
      if (this._network == null) {
        ...
        if (!network) {
          logger8.throwError("no network detected", Logger.errors.UNKNOWN_ERROR, {});
        }
        if (this._network == null) {
          if (this.anyNetwork) {
    ...
    return __awaiter5(this, void 0, void 0, function* () {
      ...
      for (let i = 0; i < urls.length; i++) {
        ...
        if (result.status >= 400 && result.status < 500) {
          return logger8.throwError(`response not found during CCIP fetch: ${errorMessage}`, Logger.errors.SERVER_ERROR, { url, errorMessage });
        }
        errorMessages.push(errorMessage);
      }
      return logger8.throwError(`error encountered during CCIP fetch: ${errorMessages.map((m) => JSON.stringify(m)).join(", ")}`, Logger.errors.SERVER_ERROR, {
        urls,
        errorMessages
      });
    });
  ...
  poll() {
    return __awaiter5(this, void 0, void 0, function* () {
      ...
      if (Math.abs(this._emitted.block - blockNumber) > 1e3) {
        logger8.warn(`network block skew detected; skipping block events (emitted=${this._emitted.block} blockNumber${blockNumber})`);
        this.emit("error", logger8.makeError("network block skew detected", Logger.errors.NETWORK_ERROR, {
          blockNumber,
          event: "blockSkew",
  ...
  detectNetwork() {
    return __awaiter5(this, void 0, void 0, function* () {
      return logger8.throwError("provider does not support network detection", Logger.errors.UNSUPPORTED_OPERATION, {
  ...
  getNetwork() {
    return __awaiter5(this, void 0, void 0, function* () {
      ...
      if (network.chainId !== currentNetwork.chainId) {
        ...
        const error = logger8.makeError("underlying network changed", Logger.errors.NETWORK_ERROR, {
          event: "changed",
          network,
    ...
    return __awaiter5(this, void 0, void 0, function* () {
      ...
      return new Promise((resolve, reject) => {
        ...
        if (replaceable) {
          ...
          const replaceHandler = (blockNumber) => __awaiter5(this, void 0, void 0, function* () {
            if (done) {
              return;
            }
            yield stall(1e3);
            this.getTransactionCount(replaceable.from).then((nonce) => __awaiter5(this, void 0, void 0, function* () {
              if (done) {
                return;
              }
                ...
                while (scannedBlock <= blockNumber) {
                  ...
                  for (let ti = 0; ti < block.transactions.length; ti++) {
                    ...
                    if (tx.from === replaceable.from && tx.nonce === replaceable.nonce) {
                      ...
                      reject(logger8.makeError("transaction was replaced", Logger.errors.TRANSACTION_REPLACED, {
        ...
        if (typeof timeout === "number" && timeout > 0) {
          const timer2 = setTimeout(() => {
            ...
            reject(logger8.makeError("timeout exceeded", Logger.errors.TIMEOUT, { timeout }));
          }, timeout);
          if (timer2.unref) {
            timer2.unref();
          }
  ...
  getGasPrice() {
    return __awaiter5(this, void 0, void 0, function* () {
      ...
      try {
        ...
        return logger8.throwError("bad result from backend", Logger.errors.SERVER_ERROR, {
          method: "getGasPrice",
          result,
          error
        });
  ...
  _wrapTransaction(tx, hash2, startBlock) {
    ...
    if (hash2 != null && tx.hash !== hash2) {
      logger8.throwError("Transaction hash mismatch from Provider.sendTransaction.", Logger.errors.UNKNOWN_ERROR, { expectedHash: tx.hash, returnedHash: hash2 });
    }
    result.wait = (confirms, timeout) => __awaiter5(this, void 0, void 0, function* () {
      if (confirms == null) {
        confirms = 1;
      }
      if (timeout == null) {
      ...
      if (receipt.status === 0) {
        logger8.throwError("transaction failed", Logger.errors.CALL_EXCEPTION, {
  ...
  _call(transaction, blockTag, attempt) {
    return __awaiter5(this, void 0, void 0, function* () {
      if (attempt >= MAX_CCIP_REDIRECTS) {
        logger8.throwError("CCIP read exceeded maximum redirections", Logger.errors.SERVER_ERROR, {
          redirects: attempt,
          transaction
        });
      }
      ...
      if (attempt >= 0 && blockTag === "latest" && txSender != null && result.substring(0, 10) === "0x556f1830" && hexDataLength(result) % 32 === 4) {
        try {
          ...
          if (!BigNumber.from(sender).eq(txSender)) {
            logger8.throwError("CCIP Read sender did not match", Logger.errors.CALL_EXCEPTION, {
              name: "OffchainLookup",
          ...
          for (let u = 0; u < urlsLength; u++) {
            ...
            if (url == null) {
              logger8.throwError("CCIP Read contained corrupt URL string", Logger.errors.CALL_EXCEPTION, {
                name: "OffchainLookup",
                signature: "OffchainLookup(address,string[],bytes,bytes4,bytes)",
                transaction,
                data: result
          ...
          if (!BigNumber.from(hexDataSlice(data, 100, 128)).isZero()) {
            logger8.throwError("CCIP Read callback selector included junk", Logger.errors.CALL_EXCEPTION, {
              name: "OffchainLookup",
              signature: "OffchainLookup(address,string[],bytes,bytes4,bytes)",
              transaction,
              data: result
          ...
          if (ccipResult == null) {
            logger8.throwError("CCIP Read disabled or provided no URLs", Logger.errors.CALL_EXCEPTION, {
              name: "OffchainLookup",
              signature: "OffchainLookup(address,string[],bytes,bytes4,bytes)",
              transaction,
              data: result
  ...
  _getAddress(addressOrName) {
    return __awaiter5(this, void 0, void 0, function* () {
      ...
      if (typeof addressOrName !== "string") {
        logger8.throwArgumentError("invalid address or ENS name", "name", addressOrName);
      }
      const address = yield this.resolveName(addressOrName);
      if (address == null) {
        logger8.throwError("ENS name not configured", Logger.errors.UNSUPPORTED_OPERATION, {
    ...
    return __awaiter5(this, void 0, void 0, function* () {
      ...
      if (isHexString(blockHashOrBlockTag, 32)) {
        ...
        try {
          ...
          logger8.throwArgumentError("invalid block hash or block tag", "blockHashOrBlockTag", blockHashOrBlockTag);
        }
      }
      return poll(() => __awaiter5(this, void 0, void 0, function* () {
  ...
  _getBlockTag(blockTag) {
    return __awaiter5(this, void 0, void 0, function* () {
      ...
      if (typeof blockTag === "number" && blockTag < 0) {
        if (blockTag % 1) {
          logger8.throwArgumentError("invalid BlockTag", "blockTag", blockTag);
        }
  ...
  _getResolver(name, operation) {
    return __awaiter5(this, void 0, void 0, function* () {
      ...
      if (!network.ensAddress) {
        logger8.throwError("network does not support ENS", Logger.errors.UNSUPPORTED_OPERATION, { operation, network: network.name });
      }
      try {
  ...
  resolveName(name) {
    return __awaiter5(this, void 0, void 0, function* () {
      ...
      if (typeof name !== "string") {
        logger8.throwArgumentError("invalid ENS name", "name", name);
      }
  ...
  perform(method, params) {
    return logger8.throwError(method + " not implemented", Logger.errors.NOT_IMPLEMENTED, { operation: method });
  }
  _startEvent(event) {
...
var logger9 = new Logger(version4);
...
function checkError(method, error, params) {
  ...
  if (method === "call") {
    ...
    logger9.throwError("missing revert data in call exception; Transaction reverted without a reason string", Logger.errors.CALL_EXCEPTION, {
      data: "0x",
      transaction,
      error
    });
  ...
  if (method === "estimateGas") {
    ...
    if (result) {
      logger9.throwError("cannot estimate gas; transaction may fail or may require manual gas limit", Logger.errors.UNPREDICTABLE_GAS_LIMIT, {
  ...
  if (message.match(/insufficient funds|base fee exceeds gas limit|InsufficientFunds/i)) {
    logger9.throwError("insufficient funds for intrinsic transaction cost", Logger.errors.INSUFFICIENT_FUNDS, {
      error,
      method,
      transaction
    });
  ...
  if (message.match(/nonce (is )?too low/i)) {
    logger9.throwError("nonce has already been used", Logger.errors.NONCE_EXPIRED, {
      error,
      method,
      transaction
    });
  ...
  if (message.match(/replacement transaction underpriced|transaction gas price.*too low/i)) {
    logger9.throwError("replacement fee too low", Logger.errors.REPLACEMENT_UNDERPRICED, {
      error,
      method,
      transaction
    });
  ...
  if (message.match(/only replay-protected/i)) {
    logger9.throwError("legacy pre-eip-155 transactions not supported", Logger.errors.UNSUPPORTED_OPERATION, {
      error,
      method,
      transaction
    });
...
var JsonRpcSigner = class extends Signer {
  ...
  connect(provider) {
    return logger9.throwError("cannot alter JSON-RPC Signer connection", Logger.errors.UNSUPPORTED_OPERATION, {
      operation: "connect"
    });
  }
  connectUnchecked() {
  ...
  getAddress() {
    ...
    return this.provider.send("eth_accounts", []).then((accounts) => {
      if (accounts.length <= this._index) {
        logger9.throwError("unknown account #" + this._index, Logger.errors.UNSUPPORTED_OPERATION, {
  ...
  sendUncheckedTransaction(transaction) {
    ...
    if (transaction.to != null) {
      transaction.to = Promise.resolve(transaction.to).then((to) => __awaiter6(this, void 0, void 0, function* () {
        if (to == null) {
          return null;
        }
    ...
    return resolveProperties({
      ...
      return this.provider.send("eth_sendTransaction", [hexTx]).then((hash2) => {
        ...
        if (typeof error.message === "string" && error.message.match(/user denied/i)) {
          logger9.throwError("user rejected transaction", Logger.errors.ACTION_REJECTED, {
  ...
  signTransaction(transaction) {
    return logger9.throwError("signing transactions is unsupported", Logger.errors.UNSUPPORTED_OPERATION, {
  ...
  sendTransaction(transaction) {
    return __awaiter6(this, void 0, void 0, function* () {
      ...
      try {
        return yield poll(() => __awaiter6(this, void 0, void 0, function* () {
  ...
  signMessage(message) {
    return __awaiter6(this, void 0, void 0, function* () {
      ...
      try {
        ...
        if (typeof error.message === "string" && error.message.match(/user denied/i)) {
          logger9.throwError("user rejected signing", Logger.errors.ACTION_REJECTED, {
            action: "signMessage",
            from: address,
            messageData: message
          });
...
var JsonRpcProvider = class extends BaseProvider {
    ...
    return __awaiter6(this, void 0, void 0, function* () {
      ...
      if (chainId != null) {
        ...
        try {
          ...
          return logger9.throwError("could not detect network", Logger.errors.NETWORK_ERROR, {
            chainId,
  ...
  perform(method, params) {
    return __awaiter6(this, void 0, void 0, function* () {
      ...
      if (args == null) {
        logger9.throwError(method + " not implemented", Logger.errors.NOT_IMPLEMENTED, { operation: method });
      }
      try {
...
var logger10 = new Logger(version4);
...
var UrlJsonRpcProvider = class _UrlJsonRpcProvider extends StaticJsonRpcProvider {
  constructor(network, apiKey) {
    logger10.checkAbstract(new.target, _UrlJsonRpcProvider);
  ...
  _startPending() {
    logger10.warn("WARNING: API provider does not support pending filters");
  }
  isCommunityResource() {
    return false;
  }
  getSigner(address) {
    return logger10.throwError("API provider does not support signing", Logger.errors.UNSUPPORTED_OPERATION, { operation: "getSigner" });
  }
  listAccounts() {
  ...
  static getUrl(network, apiKey) {
    return logger10.throwError("not implemented; sub-classes must override getUrl", Logger.errors.NOT_IMPLEMENTED, {
      operation: "getUrl"
    });
  }
};
...
try {
  ...
  const logger26 = new Logger(version4);
  WS = function() {
    logger26.throwError("WebSockets not supported in this environment", Logger.errors.UNSUPPORTED_OPERATION, {
...
var logger11 = new Logger(version4);
var NextId = 1;
...
// node_modules/@ethersproject/providers/lib.esm/alchemy-provider.js
var logger12 = new Logger(version4);
...
var AlchemyProvider = class extends UrlJsonRpcProvider {
  ...
  static getApiKey(apiKey) {
    ...
    if (apiKey && typeof apiKey !== "string") {
      logger12.throwArgumentError("invalid apiKey", "apiKey", apiKey);
    }
    return apiKey;
  }
  static getUrl(network, apiKey) {
    ...
    switch (network.name) {
      ...
      case "optimism-sepolia":
        ...
        break;
      default:
        logger12.throwArgumentError("unsupported network", "network", arguments[0]);
    }
    return {
      allowGzip: true,
...
var logger13 = new Logger(version4);
...
function getHost(name) {
  ...
  return logger13.throwArgumentError("unsupported network", "name", name);
}
...
var logger14 = new Logger(version4);
var CloudflareProvider = class extends UrlJsonRpcProvider {
  static getApiKey(apiKey) {
    if (apiKey != null) {
      logger14.throwArgumentError("apiKey not supported for cloudflare", "apiKey", apiKey);
    }
    return null;
  }
  static getUrl(network, apiKey) {
...
var logger15 = new Logger(version4);
...
function checkError2(method, error, transaction) {
  if (method === "call" && error.code === Logger.errors.SERVER_ERROR) {
    ...
    if (e && (e.message.match(/reverted/i) || e.message.match(/VM execution error/i))) {
      ...
      logger15.throwError("missing revert data in call exception", Logger.errors.CALL_EXCEPTION, {
        error,
        data: "0x"
      });
    }
        ...
        case "getLogs": {
          ...
          if (params.filter.topics && params.filter.topics.length > 0) {
            if (params.filter.topics.length > 1) {
              logger15.throwError("unsupported topic count", Logger.errors.UNSUPPORTED_OPERATION, { topics: params.filter.topics });
            }
            if (params.filter.topics.length === 1) {
              const topic0 = params.filter.topics[0];
              if (typeof topic0 !== "string" || topic0.length !== 66) {
                logger15.throwError("unsupported topic format", Logger.errors.UNSUPPORTED_OPERATION, { topic0 });
              }
              args.topic0 = topic0;
            }
          }
...
var version8 = "random/5.8.0";

// node_modules/@ethersproject/random/lib.esm/random.js
var logger16 = new Logger(version8);
function getGlobal() {
...
if (!crypto || !crypto.getRandomValues) {
  logger16.warn("WARNING: Missing strong random number source");
  crypto = {
    getRandomValues: function(buffer) {
      return logger16.throwError("no secure random source avaialble", Logger.errors.UNSUPPORTED_OPERATION, {
...
function randomBytes(length) {
  if (length <= 0 || length > 1024 || length % 1 || length != length) {
    logger16.throwArgumentError("invalid length", "length", length);
  }
...
var logger17 = new Logger(version4);
function now() {
  return (/* @__PURE__ */ new Date()).getTime();
}
...
var logger18 = new Logger(version4);
...
var logger19 = new Logger(version4);
...
var logger20 = new Logger(version4);
  ...
  static getUrl(network, apiKey) {
    ...
    switch (network.name) {
      ...
      case "xdai":
        ...
        break;
      default:
        logger21.throwArgumentError("unsupported network", "network", arguments[0]);
    }
...
var logger22 = new Logger(version4);
var _nextId = 1;
...
// node_modules/@ethersproject/providers/lib.esm/index.js
var logger23 = new Logger(version4);
...
var logger24 = new Logger(version9);
...
function resolveName(resolver, nameOrPromise) {
  return __awaiter12(this, void 0, void 0, function* () {
    ...
    if (typeof name !== "string") {
      logger24.throwArgumentError("invalid address or ENS name", "name", name);
    }
    try {
    ...
    if (!resolver) {
      logger24.throwError("a provider or signer is needed to resolve ENS names", Logger.errors.UNSUPPORTED_OPERATION, {
        operation: "resolveName"
      });
    }
    const address = yield resolver.resolveName(name);
    if (address == null) {
      logger24.throwArgumentError("resolver or addr is not configured for ENS name", "name", name);
    }
    return address;
  });
}
function resolveAddresses(resolver, value, paramType) {
  return __awaiter12(this, void 0, void 0, function* () {
    ...
    if (paramType.baseType === "array") {
      if (!Array.isArray(value)) {
        return Promise.reject(logger24.makeError("invalid value for array", Logger.errors.INVALID_ARGUMENT, {
          argument: "value",
          value
        }));
      }
...
function populateTransaction(contract, fragment, args) {
  return __awaiter12(this, void 0, void 0, function* () {
    ...
    logger24.checkArgumentCount(args.length, fragment.inputs.length, "passed to contract");
    if (contract.signer) {
      if (overrides.from) {
        overrides.from = resolveProperties({
          override: resolveName(contract.signer, overrides.from),
          signer: contract.signer.getAddress()
        }).then((check) => __awaiter12(this, void 0, void 0, function* () {
          if (getAddress(check.signer) !== check.override) {
            logger24.throwError("Contract with a Signer cannot override from", Logger.errors.UNSUPPORTED_OPERATION, {
    ...
    if (ro.value) {
      ...
      if (!roValue.isZero() && !fragment.payable) {
        logger24.throwError("non-payable method cannot override value", Logger.errors.UNSUPPORTED_OPERATION, {
    ...
    if (leftovers.length) {
      logger24.throwError(`cannot override ${leftovers.map((l) => JSON.stringify(l)).join(",")}`, Logger.errors.UNSUPPORTED_OPERATION, {
        operation: "overrides",
        overrides: leftovers
      });
    }
...
function buildEstimate(contract, fragment) {
  ...
  return function(...args) {
    return __awaiter12(this, void 0, void 0, function* () {
      if (!signerOrProvider) {
        logger24.throwError("estimate require a provider or signer", Logger.errors.UNSUPPORTED_OPERATION, {
...
function buildSend(contract, fragment) {
  return function(...args) {
    return __awaiter12(this, void 0, void 0, function* () {
      if (!contract.signer) {
        logger24.throwError("sending a transaction requires a signer", Logger.errors.UNSUPPORTED_OPERATION, {
...
var FragmentRunningEvent = class extends RunningEvent {
  constructor(address, contractInterface, fragment, topics) {
    ...
    if (topics) {
      if (topic !== topics[0]) {
        logger24.throwArgumentError("topic mismatch", "topics", topics);
      }
...
var BaseContract = class {
  constructor(addressOrName, contractInterface, signerOrProvider) {
    ...
    if (signerOrProvider == null) {
      ...
      logger24.throwArgumentError("invalid signer or provider", "signerOrProvider", signerOrProvider);
    }
    ...
    defineReadOnly(this, "filters", {});
    {
      ...
      Object.keys(uniqueFilters).forEach((name) => {
        ...
        if (filters.length === 1) {
          ...
          logger24.warn(`Duplicate definition of ${name} (${filters.join(", ")})`);
        }
      });
    }
    ...
    if (addressOrName == null) {
      logger24.throwArgumentError("invalid contract address or ENS name", "addressOrName", addressOrName);
    }
    ...
    if (this.provider) {
      ...
      try {
        ...
        logger24.throwError("provider is required to use ENS name as contract address", Logger.errors.UNSUPPORTED_OPERATION, {
    ...
    Object.keys(this.interface.functions).forEach((signature2) => {
      ...
      if (uniqueSignatures[signature2]) {
        logger24.warn(`Duplicate ABI entry for ${JSON.stringify(signature2)}`);
        return;
      }
    ...
    if (!this._deployedPromise) {
      if (this.deployTransaction) {
        ...
        this._deployedPromise = this.provider.getCode(this.address, blockTag).then((code) => {
          if (code === "0x") {
            logger24.throwError("contract not deployed", Logger.errors.UNSUPPORTED_OPERATION, {
  ...
  fallback(overrides) {
    if (!this.signer) {
      logger24.throwError("sending a transactions require a signer", Logger.errors.UNSUPPORTED_OPERATION, { operation: "sendTransaction(fallback)" });
    }
    ...
    ["from", "to"].forEach(function(key2) {
      ...
      logger24.throwError("cannot override " + key2, Logger.errors.UNSUPPORTED_OPERATION, { operation: key2 });
    });
  ...
  _addEventListener(runningEvent, listener, once) {
    if (!this.provider) {
      logger24.throwError("events require a provider or a signer with a provider", Logger.errors.UNSUPPORTED_OPERATION, { operation: "once" });
    }
  ...
  queryFilter(event, fromBlockOrBlockhash, toBlock) {
    ...
    if (typeof fromBlockOrBlockhash === "string" && isHexString(fromBlockOrBlockhash, 32)) {
      if (toBlock != null) {
        logger24.throwArgumentError("cannot specify toBlock with blockhash", "toBlock", toBlock);
      }
...
var ContractFactory = class {
  constructor(contractInterface, bytecode, signer) {
    ...
    if (!isHexString(bytecodeHex) || bytecodeHex.length % 2) {
      logger24.throwArgumentError("invalid bytecode", "bytecode", bytecode);
    }
    if (signer && !Signer.isSigner(signer)) {
      logger24.throwArgumentError("invalid signer", "signer", signer);
    }
  ...
  getDeployTransaction(...args) {
    ...
    if (tx.value) {
      ...
      if (!value.isZero() && !this.interface.deploy.payable) {
        logger24.throwError("non-payable constructor cannot override value", Logger.errors.UNSUPPORTED_OPERATION, {
          operation: "overrides.value",
          value: tx.value
        });
      }
    }
    logger24.checkArgumentCount(args.length, this.interface.deploy.inputs.length, " in Contract constructor");
  ...
  static fromSolidity(compilerOutput, signer) {
    if (compilerOutput == null) {
      logger24.throwError("missing compiler output", Logger.errors.MISSING_ARGUMENT, { argument: "compilerOutput" });
    }
...
// node_modules/@ethersproject/units/lib.esm/index.js
var logger25 = new Logger(version10);
var names = [
  "wei",
  "kwei",
  "mwei",
...
var base32nopad2 = chain2(radix22(5), alphabet2("ABCDEFGHIJKLMNOPQRSTUVWXYZ234567"), join2(""));
var base32hex2 = chain2(radix22(5), alphabet2("0123456789ABCDEFGHIJKLMNOPQRSTUV"), padding2(5), join2(""));
var base32hexnopad2 = chain2(radix22(5), alphabet2("0123456789ABCDEFGHIJKLMNOPQRSTUV"), join2(""));
...
var hex2 = hasHexBuiltin ? hexBuiltin : chain2(radix22(4), alphabet2("0123456789abcdef"), join2(""), normalize2((s) => {
...
*/
//# sourceMappingURL=chunk-T5TCU7DB.js.map
