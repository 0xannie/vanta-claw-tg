...
var chainIdToViemImport = async (w3oChain) => {
  const viemChains = await import("./chains-WANFDOZN.js");
  ...
  switch (id) {
    ...
    default: {
      const { extractChain, defineChain } = await import("./_esm-O2CDBGZZ.js");
...
//# sourceMappingURL=chunk-VTDZDEXS.js.map
