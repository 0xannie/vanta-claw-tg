...
import {
  ...
  validate
} from "./chunk-VTDZDEXS.js";
import {
  require_joi_browser_min
} from "./chunk-4VYMQJR2.js";
import {
  __commonJS,
  __toESM,
  require_dist,
...
var metamask = {
  ...
  getIcon: async () => (await import("./metamask-GODDHQDW.js")).default,
...
var infinitywallet = {
  ...
  getIcon: async () => (await import("./infinitywallet-26YBNR4P.js")).default,
...
var exodus = {
  ...
  getIcon: async () => (await import("./exodus-A35PWSQQ.js")).default,
...
var frontier = {
  ...
  getIcon: async () => (await import("./frontier-XVM64WRH.js")).default,
  getInterface: async () => ({
...
var brave = {
  ...
  getIcon: async () => (await import("./brave-EVMGANQU.js")).default,
...
var binance = {
  ...
  getIcon: async () => (await import("./binance-7DE5H7XB.js")).default,
  getInterface: async () => {
    let tempBNBProvider = {
      ...window.BinanceChain
    };
...
var coinbase = {
  ...
  getIcon: async () => (await import("./coinbase-NC5OKQEJ.js")).default,
  getInterface: async () => {
...
var detected = {
  ...
  getIcon: async () => (await import("./detected-CNBYNYDL.js")).default,
  getInterface: async () => ({
...
var trust = {
  ...
  getIcon: async () => (await import("./trust-KOBAG6FQ.js")).default,
  getInterface: async () => {
...
var opera = {
  ...
  getIcon: async () => (await import("./opera-TSXURNPT.js")).default,
  getInterface: async () => ({
...
var status = {
  ...
  getIcon: async () => (await import("./status-63VEYHZV.js")).default,
  getInterface: async () => {
...
var alphawallet = {
  ...
  getIcon: async () => (await import("./alphawallet-CB2JEG6G.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var apexwallet = {
  ...
  getIcon: async () => (await import("./apexwallet-J6FQRFHV.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
...
var atoken = {
  ...
  getIcon: async () => (await import("./atoken-LGZZCEKG.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["mobile"]
...
var bifrostwallet = {
  ...
  getIcon: async () => (await import("./bifrostwallet-IXYDLPHA.js")).default,
...
var bitpie = {
  ...
  getIcon: async () => (await import("./bitpie-HG53UJ5P.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var blockwallet = {
  ...
  getIcon: async () => (await import("./blockwallet-JY2VHR64.js")).default,
...
var frame = {
  ...
  getIcon: async () => (await import("./frame-QCF3DPCV.js")).default,
  getInterface: async () => {
    const provider = window.ethereum;
...
var huobiwallet = {
  ...
  getIcon: async () => (await import("./huobiwallet-QJFS3PCE.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var hyperpay = {
  ...
  getIcon: async () => (await import("./hyperpay-3ZRGX7KJ.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var imtoken = {
  ...
  getIcon: async () => (await import("./imtoken-N53RM3DS.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      eth_selectAccounts: UNSUPPORTED_METHOD
    })
...
var liquality = {
  ...
  getIcon: async () => (await import("./liquality-F7AYTCU4.js")).default,
  getInterface: async () => {
...
var meetone = {
  ...
  getIcon: async () => (await import("./meetone-4TWXRJJA.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["mobile"]
...
var mykey = {
  ...
  getIcon: async () => (await import("./mykey-HC7HTKKU.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["mobile"]
...
var ownbit = {
  ...
  getIcon: async () => (await import("./ownbit-W7YASPOA.js")).default,
  getInterface: async () => {
    const provider = createEIP1193Provider(window.ethereum, {
      eth_chainId: ({ baseRequest }) => baseRequest({ method: "eth_chainId" }).then((id) => `0x${parseInt(id).toString(16)}`),
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
...
var tokenpocket = {
  ...
  getIcon: async () => (await import("./tokenpocket-SFVVDO4Y.js")).default,
...
var tp = {
  ...
  getIcon: async () => (await import("./tp-LP2NHLHE.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var xdefi = {
  ...
  getIcon: async () => (await import("./xdefi-DN2M4KEJ.js")).default,
  getInterface: async () => ({
...
var oneInch = {
  ...
  getIcon: async () => (await import("./oneInch-KCW7AJKS.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["mobile"]
...
var tokenary = {
  ...
  getIcon: async () => (await import("./tokenary-VAJAABJN.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["all"]
...
var tally = {
  ...
  getIcon: async () => (await import("./tallywallet-6PNCFXLK.js")).default,
  getInterface: async () => ({
...
var zeal = {
  ...
  getIcon: async () => (await import("./zeal-NEFNMRDA.js")).default,
  getInterface: async () => ({
...
var rabby = {
  ...
  getIcon: async () => (await import("./rabby-6X7GPP46.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
...
var mathwallet = {
  ...
  getIcon: async () => (await import("./mathwallet-4N6DTKTN.js")).default,
...
var bitget = {
  ...
  getIcon: async () => (await import("./bitget-UHDX4OXE.js")).default,
  getInterface: async () => ({
...
var sequence = {
  ...
  getIcon: async () => (await import("./sequence-PEV6JPQQ.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["all"]
...
var core = {
  ...
  getIcon: async () => (await import("./core-EZHDD6VH.js")).default,
...
var bitski = {
  ...
  getIcon: async () => (await import("./bitski-HB5NRDPK.js")).default,
  getInterface: async () => ({
...
var zerion = {
  ...
  getIcon: async () => (await import("./zerion-CJWYVWSW.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["all"]
...
var enkrypt = {
  ...
  getIcon: async () => (await import("./enkrypt-XCWXOQSF.js")).default,
  getInterface: async () => {
...
var phantom = {
  ...
  getIcon: async () => (await import("./phantom-IPYCSKAJ.js")).default,
  getInterface: async () => ({
...
var safepal = {
  ...
  getIcon: async () => (await import("./safepal-YQB2AT6N.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["all"]
...
var rainbow = {
  ...
  getIcon: async () => (await import("./rainbow-XYLW2PJJ.js")).default,
...
var okxwallet = {
  ...
  getIcon: async () => (await import("./okxwallet-GX7YULTR.js")).default,
  getInterface: async () => ({
...
var defiwallet = {
  ...
  getIcon: async () => (await import("./defiwallet-DEQAJD2K.js")).default,
  getInterface: async () => ({
...
var safeheron = {
  ...
  getIcon: async () => (await import("./safeheron-NYTPWFMJ.js")).default,
  getInterface: async () => ({
...
var talisman = {
  ...
  getIcon: async () => (await import("./talisman-CSDRVRF3.js")).default,
  getInterface: async () => ({
...
var ronin = {
  ...
  getIcon: async () => (await import("./roninwallet-HYAOCTV4.js")).default,
  getInterface: async () => ({
...
var onekey = {
  ...
  getIcon: async () => (await import("./onekey-T3ITWTBO.js")).default,
  getInterface: async () => ({
...
var fordefi = {
  ...
  getIcon: async () => (await import("./fordefi-EWMG3TA6.js")).default,
...
var coin98wallet = {
  ...
  getIcon: async () => (await import("./coin98wallet-E3YVHECB.js")).default,
  getInterface: async () => {
    const ethereumInjectionExists = window.hasOwnProperty(InjectedNameSpace.Ethereum);
    let provider;
...
var subwallet = {
  ...
  getIcon: async () => (await import("./subwallet-EAFCM6QU.js")).default,
  getInterface: async () => ({
...
var kayros = {
  ...
  getIcon: async () => (await import("./kayros-Z7G2SWQS.js")).default,
  getInterface: async () => ({
...
var foxwallet = {
  ...
  getIcon: async () => (await import("./foxwallet-QNIFXISY.js")).default,
  getInterface: async () => ({
...
var Lif3Wallet = {
  ...
  getIcon: async () => (await import("./lif3wallet-7RPQETXB.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var zodiacPilot = {
  ...
  getIcon: async () => (await import("./zodiacpilot-FNY7UII3.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["desktop"],
...
var stablewallet = {
  ...
  getIcon: async () => (await import("./stablewallet-AIWRUD5L.js")).default,
...
var echooo = {
  ...
  getIcon: async () => (await import("./echooo-DECAPB4U.js")).default,
...
var keplr = {
  ...
  getIcon: async () => (await import("./keplr-3UXSVZIQ.js")).default,
...
var isWalletAvailable = (provider, checkProviderIdentity, device) => {
  ...
  return Array.isArray(provider.providers) && !!provider.providers?.some((provider2) => checkProviderIdentity({ provider: provider2, device }));
};
...
//# sourceMappingURL=chunk-ZIDU6EIK.js.map
