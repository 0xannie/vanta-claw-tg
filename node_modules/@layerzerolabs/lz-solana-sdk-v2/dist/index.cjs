...
var EndpointPDADeriver = class {
  ...
  defaultSendLibraryConfig(dstEndpointId) {
    return web314.PublicKey.findProgramAddressSync(
      [
        ...
        new BN__default.default(dstEndpointId).toArrayLike(Buffer, "be", 4)
      ],
      this.program
    );
  }
  ...
  defaultReceiveLibraryConfig(srcEndpointId) {
    return web314.PublicKey.findProgramAddressSync(
      [
        ...
        // U32 to Uint8Array([0,0,0,0])
        new BN__default.default(srcEndpointId).toArrayLike(Buffer, "be", 4)
      ],
      this.program
    );
  }
  ...
  defaultMessageLib() {
    return this.messageLibraryInfo(web314.PublicKey.default);
  }
  ...
  nonce(localOapp, remoteChainId, remoteOapp) {
    return web314.PublicKey.findProgramAddressSync(
      [
        ...
        localOapp.toBytes(),
        // U32 to Uint8Array([0,0,0,0])
        new BN__default.default(remoteChainId).toArrayLike(Buffer, "be", 4),
        remoteOapp
      ],
      this.program
    );
  ...
  payloadHash(receiver, srcEid, sender, nonce) {
    return web314.PublicKey.findProgramAddressSync(
      [
        ...
        receiver.toBytes(),
        new BN__default.default(srcEid).toArrayLike(Buffer, "be", 4),
        sender,
        new BN__default.default(nonce).toArrayLike(Buffer, "be", 8)
      ],
      this.program
    );
  }
  composedMessage(from, guid, index, to, messageHash) {
    return web314.PublicKey.findProgramAddressSync(
      [
        ...
        to.toBytes(),
        guid,
        new BN__default.default(index).toArrayLike(Buffer, "be", 2),
        messageHash
      ],
      this.program
    );
...
var ComposeMessageState = class _ComposeMessageState {
   ...
   */
  static gpaBuilder(programId = new web314__namespace.PublicKey(
    "76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6"
  )) {
    return beetSolana85__namespace.GpaBuilder.fromStruct(programId, composeMessageStateBeet);
  }
  /**
...
var composeMessageStateBeet = new beet159__namespace.BeetStruct(
  [
    ["accountDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
    ["received", beet159__namespace.bool],
...
var EndpointSettings = class _EndpointSettings {
  ...
  static gpaBuilder(programId = new web314__namespace.PublicKey(
    ...
    return beetSolana85__namespace.GpaBuilder.fromStruct(programId, endpointSettingsBeet);
  }
  /**
...
var endpointSettingsBeet = new beet159__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
    ["eid", beet159__namespace.u32],
    ["bump", beet159__namespace.u8],
    ["admin", beetSolana85__namespace.publicKey],
    ["lzTokenMint", beet159__namespace.coption(beetSolana85__namespace.publicKey)]
  ],
...
var messageLibTypeBeet = beet159__namespace.fixedScalarEnum(
  MessageLibType
);
...
var MessageLibInfo = class _MessageLibInfo {
  ...
  static gpaBuilder(programId = new web314__namespace.PublicKey(
    ...
    return beetSolana85__namespace.GpaBuilder.fromStruct(programId, messageLibInfoBeet);
  }
  /**
...
var messageLibInfoBeet = new beet159__namespace.BeetStruct(
  [
    ["accountDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
    ["messageLibType", messageLibTypeBeet],
    ["bump", beet159__namespace.u8],
    ["messageLibBump", beet159__namespace.u8]
  ],
...
var Nonce = class _Nonce {
  ...
  static gpaBuilder(programId = new web314__namespace.PublicKey(
    ...
    return beetSolana85__namespace.GpaBuilder.fromStruct(programId, nonceBeet);
  }
  /**
...
var nonceBeet = new beet159__namespace.BeetStruct(
  [
    ["accountDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
    ["bump", beet159__namespace.u8],
    ["outboundNonce", beet159__namespace.u64],
    ["inboundNonce", beet159__namespace.u64]
  ],
  Nonce.fromArgs,
  "Nonce"
);
...
var OAppRegistry = class _OAppRegistry {
  ...
  static gpaBuilder(programId = new web314__namespace.PublicKey(
    ...
    return beetSolana85__namespace.GpaBuilder.fromStruct(programId, oAppRegistryBeet);
  }
  /**
...
var oAppRegistryBeet = new beet159__namespace.BeetStruct(
  [
    ["accountDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var PayloadHash = class _PayloadHash {
  ...
  static gpaBuilder(programId = new web314__namespace.PublicKey(
    ...
    return beetSolana85__namespace.GpaBuilder.fromStruct(programId, payloadHashBeet);
  }
  /**
...
var payloadHashBeet = new beet159__namespace.BeetStruct(
  [
    ["accountDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
    ["hash", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
    ["bump", beet159__namespace.u8]
  ],
...
var PendingInboundNonce = class _PendingInboundNonce {
  ...
  static gpaBuilder(programId = new web314__namespace.PublicKey(
    ...
    return beetSolana85__namespace.GpaBuilder.fromStruct(programId, pendingInboundNonceBeet);
  }
  /**
...
var pendingInboundNonceBeet = new beet159__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
    ["nonces", beet159__namespace.array(beet159__namespace.u64)],
    ["bump", beet159__namespace.u8]
  ],
  PendingInboundNonce.fromArgs,
  "PendingInboundNonce"
);
var receiveLibraryTimeoutBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["messageLib", beetSolana85__namespace.publicKey],
    ["expiry", beet159__namespace.u64]
  ],
...
var ReceiveLibraryConfig = class _ReceiveLibraryConfig {
  ...
  static gpaBuilder(programId = new web314__namespace.PublicKey(
    ...
    return beetSolana85__namespace.GpaBuilder.fromStruct(programId, receiveLibraryConfigBeet);
  }
  /**
...
var receiveLibraryConfigBeet = new beet159__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
    ["messageLib", beetSolana85__namespace.publicKey],
    ["timeout", beet159__namespace.coption(receiveLibraryTimeoutBeet)],
    ["bump", beet159__namespace.u8]
  ],
...
var SendLibraryConfig = class _SendLibraryConfig {
  ...
  static gpaBuilder(programId = new web314__namespace.PublicKey(
    ...
    return beetSolana85__namespace.GpaBuilder.fromStruct(programId, sendLibraryConfigBeet);
  }
  /**
...
var sendLibraryConfigBeet = new beet159__namespace.BeetStruct(
  [
    ["accountDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
    ["messageLib", beetSolana85__namespace.publicKey],
    ["bump", beet159__namespace.u8]
...
var burnParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana85__namespace.publicKey],
    ...
    ["payloadHash", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)]
  ],
  "BurnParams"
);

// src/generated/endpoint/instructions/burn.ts
var burnStruct = new beet159__namespace.BeetArgsStruct(
  [
...
var clearParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["receiver", beetSolana85__namespace.publicKey],
    ["srcEid", beet159__namespace.u32],
    ["sender", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
...
var clearStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var clearComposeParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["from", beetSolana85__namespace.publicKey],
    ["guid", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
    ["index", beet159__namespace.u16],
    ["message", beet159__namespace.bytes]
  ],
  "ClearComposeParams"
);
...
var clearComposeStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var initConfigParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["oapp", beetSolana85__namespace.publicKey],
    ["eid", beet159__namespace.u32]
  ],
  "InitConfigParams"
);
...
var initConfigStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var initDefaultReceiveLibraryParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["eid", beet159__namespace.u32],
    ["newLib", beetSolana85__namespace.publicKey]
  ],
  "InitDefaultReceiveLibraryParams"
);

// src/generated/endpoint/instructions/initDefaultReceiveLibrary.ts
var initDefaultReceiveLibraryStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var initDefaultSendLibraryParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["eid", beet159__namespace.u32],
    ["newLib", beetSolana85__namespace.publicKey]
  ],
...
var initDefaultSendLibraryStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var initEndpointParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["eid", beet159__namespace.u32],
    ["admin", beetSolana85__namespace.publicKey]
  ],
...
var initEndpointStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var initNonceParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["localOapp", beetSolana85__namespace.publicKey],
    ["remoteEid", beet159__namespace.u32],
    ["remoteOapp", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)]
  ],
  "InitNonceParams"
);

// src/generated/endpoint/instructions/initNonce.ts
var initNonceStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var initReceiveLibraryParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana85__namespace.publicKey],
    ["eid", beet159__namespace.u32]
  ],
...
var initReceiveLibraryStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var initSendLibraryParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["sender", beetSolana85__namespace.publicKey],
    ["eid", beet159__namespace.u32]
  ],
...
var initSendLibraryStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var initVerifyParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["srcEid", beet159__namespace.u32],
    ["sender", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
    ["receiver", beetSolana85__namespace.publicKey],
...
var initVerifyStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var lzComposeAlertParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["from", beetSolana85__namespace.publicKey],
    ["to", beetSolana85__namespace.publicKey],
    ["guid", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
    ["index", beet159__namespace.u16],
    ["computeUnits", beet159__namespace.u64],
    ["value", beet159__namespace.u64],
    ["message", beet159__namespace.bytes],
    ["extraData", beet159__namespace.bytes],
    ["reason", beet159__namespace.bytes]
  ],
  "LzComposeAlertParams"
);

// src/generated/endpoint/instructions/lzComposeAlert.ts
var lzComposeAlertStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var lzReceiveAlertParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["receiver", beetSolana85__namespace.publicKey],
    ["srcEid", beet159__namespace.u32],
    ["sender", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
...
var lzReceiveAlertStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var nilifyParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana85__namespace.publicKey],
    ["srcEid", beet159__namespace.u32],
    ["sender", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
...
var nilifyStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var quoteParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["sender", beetSolana85__namespace.publicKey],
    ["dstEid", beet159__namespace.u32],
    ["receiver", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
    ["message", beet159__namespace.bytes],
...
var quoteStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var registerLibraryParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["libProgram", beetSolana85__namespace.publicKey],
...
var registerLibraryStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var registerOAppParamsBeet = new beet159__namespace.BeetArgsStruct(
  [["delegate", beetSolana85__namespace.publicKey]],
  "RegisterOAppParams"
);

// src/generated/endpoint/instructions/registerOapp.ts
var registerOappStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var sendParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["dstEid", beet159__namespace.u32],
    ["receiver", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
    ["message", beet159__namespace.bytes],
...
var sendStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var sendComposeParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["to", beetSolana85__namespace.publicKey],
    ["guid", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
    ["index", beet159__namespace.u16],
...
var sendComposeStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var setConfigParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["oapp", beetSolana85__namespace.publicKey],
    ["eid", beet159__namespace.u32],
    ["configType", beet159__namespace.u32],
    ["config", beet159__namespace.bytes]
  ],
  "SetConfigParams"
);

// src/generated/endpoint/instructions/setConfig.ts
var setConfigStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var setDefaultReceiveLibraryParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["eid", beet159__namespace.u32],
    ["newLib", beetSolana85__namespace.publicKey],
    ["gracePeriod", beet159__namespace.u64]
  ],
  "SetDefaultReceiveLibraryParams"
);

// src/generated/endpoint/instructions/setDefaultReceiveLibrary.ts
var setDefaultReceiveLibraryStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var setDefaultReceiveLibraryTimeoutParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["eid", beet159__namespace.u32],
    ["lib", beetSolana85__namespace.publicKey],
    ["expiry", beet159__namespace.u64]
  ],
...
var setDefaultReceiveLibraryTimeoutStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var setDefaultSendLibraryParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["eid", beet159__namespace.u32],
    ["newLib", beetSolana85__namespace.publicKey]
  ],
...
var setDefaultSendLibraryStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var setDelegateParamsBeet = new beet159__namespace.BeetArgsStruct(
  [["delegate", beetSolana85__namespace.publicKey]],
  "SetDelegateParams"
);

// src/generated/endpoint/instructions/setDelegate.ts
var setDelegateStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var setLzTokenParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [["lzToken", beet159__namespace.coption(beetSolana85__namespace.publicKey)]],
  "SetLzTokenParams"
);

// src/generated/endpoint/instructions/setLzToken.ts
var setLzTokenStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var setReceiveLibraryParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana85__namespace.publicKey],
    ["eid", beet159__namespace.u32],
    ["newLib", beetSolana85__namespace.publicKey],
...
var setReceiveLibraryStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var setReceiveLibraryTimeoutParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana85__namespace.publicKey],
    ["eid", beet159__namespace.u32],
    ["lib", beetSolana85__namespace.publicKey],
...
var setReceiveLibraryTimeoutStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var setSendLibraryParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["sender", beetSolana85__namespace.publicKey],
    ["eid", beet159__namespace.u32],
    ["newLib", beetSolana85__namespace.publicKey]
...
var setSendLibraryStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var skipParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana85__namespace.publicKey],
    ["srcEid", beet159__namespace.u32],
    ["sender", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
...
var skipStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var transferAdminParamsBeet = new beet159__namespace.BeetArgsStruct(
  [["admin", beetSolana85__namespace.publicKey]],
  "TransferAdminParams"
);

// src/generated/endpoint/instructions/transferAdmin.ts
var transferAdminStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var verifyParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["srcEid", beet159__namespace.u32],
    ["sender", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
    ["receiver", beetSolana85__namespace.publicKey],
...
var verifyStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var withdrawRentParamsBeet = new beet159__namespace.BeetArgsStruct(
  [["amount", beet159__namespace.u64]],
  "WithdrawRentParams"
);

// src/generated/endpoint/instructions/withdrawRent.ts
var withdrawRentStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var messagingFeeBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["nativeFee", beet159__namespace.u64],
    ["lzTokenFee", beet159__namespace.u64]
  ],
...
var messagingReceiptBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["guid", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
    ["nonce", beet159__namespace.u64],
...
var PROGRAM_ID = new web314.PublicKey(PROGRAM_ADDRESS);
...
var adminTransferredEventBeet = new beet159__namespace.BeetArgsStruct(
  [["newAdmin", beetSolana85__namespace.publicKey]],
  "AdminTransferredEvent"
);
var composeDeliveredEventBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["from", beetSolana85__namespace.publicKey],
    ["to", beetSolana85__namespace.publicKey],
    ["guid", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
...
var composeSentEventBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["from", beetSolana85__namespace.publicKey],
    ["to", beetSolana85__namespace.publicKey],
    ["guid", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
...
var defaultReceiveLibrarySetEventBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["eid", beet159__namespace.u32],
    ["newLib", beetSolana85__namespace.publicKey]
  ],
...
var defaultReceiveLibraryTimeoutSetEventBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["eid", beet159__namespace.u32],
    ["timeout", beet159__namespace.coption(receiveLibraryTimeoutBeet)]
  ],
...
var defaultSendLibrarySetEventBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["eid", beet159__namespace.u32],
    ["newLib", beetSolana85__namespace.publicKey]
  ],
...
var delegateSetEventBeet = new beet159__namespace.BeetArgsStruct(
  [["newDelegate", beetSolana85__namespace.publicKey]],
  "DelegateSetEvent"
);
var inboundNonceSkippedEventBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["srcEid", beet159__namespace.u32],
    ["sender", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
    ["receiver", beetSolana85__namespace.publicKey],
...
var libraryRegisteredEventBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["newLib", beetSolana85__namespace.publicKey],
    ["newLibProgram", beetSolana85__namespace.publicKey]
  ],
  "LibraryRegisteredEvent"
);
var lzComposeAlertEventBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["executor", beetSolana85__namespace.publicKey],
    ["from", beetSolana85__namespace.publicKey],
    ["to", beetSolana85__namespace.publicKey],
    ["guid", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
    ["index", beet159__namespace.u16],
...
var lzReceiveAlertEventBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["receiver", beetSolana85__namespace.publicKey],
    ["executor", beetSolana85__namespace.publicKey],
    ["srcEid", beet159__namespace.u32],
...
var lzTokenSetEventBeet = new beet159__namespace.FixableBeetArgsStruct(
  [["token", beet159__namespace.coption(beetSolana85__namespace.publicKey)]],
  "LzTokenSetEvent"
);
var oAppRegisteredEventBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["oapp", beetSolana85__namespace.publicKey],
    ["delegate", beetSolana85__namespace.publicKey]
  ],
...
var packetBurntEventBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["srcEid", beet159__namespace.u32],
    ["sender", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
    ["receiver", beetSolana85__namespace.publicKey],
...
var packetDeliveredEventBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["srcEid", beet159__namespace.u32],
    ["sender", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
    ["receiver", beetSolana85__namespace.publicKey],
...
var packetNilifiedEventBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["srcEid", beet159__namespace.u32],
    ["sender", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
    ["receiver", beetSolana85__namespace.publicKey],
...
var packetSentEventBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["encodedPacket", beet159__namespace.bytes],
    ["options", beet159__namespace.bytes],
    ["sendLibrary", beetSolana85__namespace.publicKey]
  ],
  "PacketSentEvent"
);
var packetVerifiedEventBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["srcEid", beet159__namespace.u32],
    ["sender", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
    ["receiver", beetSolana85__namespace.publicKey],
...
var receiveLibrarySetEventBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana85__namespace.publicKey],
    ["eid", beet159__namespace.u32],
    ["newLib", beetSolana85__namespace.publicKey]
...
var receiveLibraryTimeoutSetEventBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["receiver", beetSolana85__namespace.publicKey],
    ["eid", beet159__namespace.u32],
    ["timeout", beet159__namespace.coption(receiveLibraryTimeoutBeet)]
...
var rentWithdrawnEventBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana85__namespace.publicKey],
    ["amount", beet159__namespace.u64]
  ],
...
var sendLibrarySetEventBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["sender", beetSolana85__namespace.publicKey],
    ["eid", beet159__namespace.u32],
    ["newLib", beetSolana85__namespace.publicKey]
    ...
    const ix = createSkipInstruction(
      ...
      },
      {
        params: {
          ...
          nonce: new BN__default.default(nonce)
        }
      },
      this.program
    );
...
var MessageLib = class _MessageLib {
  ...
  static gpaBuilder(programId = new web314__namespace.PublicKey(
    ...
    return beetSolana85__namespace.GpaBuilder.fromStruct(programId, messageLibBeet);
  }
  /**
...
var messageLibBeet = new beet159__namespace.BeetStruct(
  [
    ["accountDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
    ["eid", beet159__namespace.u32],
    ["endpoint", beetSolana85__namespace.publicKey],
    ["endpointProgram", beetSolana85__namespace.publicKey],
    ["bump", beet159__namespace.u8],
    ["admin", beetSolana85__namespace.publicKey],
    ["fee", beet159__namespace.u64],
    ["lzTokenFee", beet159__namespace.u64],
    ["wlCaller", beetSolana85__namespace.publicKey]
  ],
  MessageLib.fromArgs,
  "MessageLib"
);
...
var ReceiveConfigStore = class _ReceiveConfigStore {
  ...
  static gpaBuilder(programId = new web314__namespace.PublicKey(
    ...
    return beetSolana85__namespace.GpaBuilder.fromStruct(programId, receiveConfigStoreBeet);
  }
  /**
...
var receiveConfigStoreBeet = new beet159__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
    ["bump", beet159__namespace.u8],
    ["data", beet159__namespace.bytes]
  ],
...
var SendConfigStore = class _SendConfigStore {
  ...
  static gpaBuilder(programId = new web314__namespace.PublicKey(
    ...
    return beetSolana85__namespace.GpaBuilder.fromStruct(programId, sendConfigStoreBeet);
  }
  /**
...
var sendConfigStoreBeet = new beet159__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
    ["bump", beet159__namespace.u8],
    ["data", beet159__namespace.bytes]
...
var initConfigParamsBeet2 = new beet159__namespace.BeetArgsStruct(
  [
    ["oapp", beetSolana85__namespace.publicKey],
    ["eid", beet159__namespace.u32]
  ],
...
var initConfigStruct2 = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var initDefaultConfigParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["eid", beet159__namespace.u32],
    ["sendConfig", beet159__namespace.coption(beet159__namespace.bytes)],
    ["receiveConfig", beet159__namespace.coption(beet159__namespace.bytes)]
  ],
  "InitDefaultConfigParams"
);

// src/generated/simple_messagelib/instructions/initDefaultConfig.ts
var initDefaultConfigStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var initMessageLibParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["eid", beet159__namespace.u32],
    ["endpoint", beetSolana85__namespace.publicKey],
    ["endpointProgram", beetSolana85__namespace.publicKey],
...
var initMessageLibStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var packetBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["nonce", beet159__namespace.u64],
    ["srcEid", beet159__namespace.u32],
    ["sender", beetSolana85__namespace.publicKey],
...
var quoteParamsBeet2 = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["packet", packetBeet],
    ["options", beet159__namespace.bytes],
    ["payInLzToken", beet159__namespace.bool]
...
var quoteStruct2 = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var revertCallStruct = new beet159__namespace.BeetArgsStruct(
  [["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)]],
...
var sendParamsBeet2 = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["packet", packetBeet],
    ["options", beet159__namespace.bytes],
    ["nativeFee", beet159__namespace.u64]
...
var sendStruct2 = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var sendWithLzTokenParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["packet", packetBeet],
    ["options", beet159__namespace.bytes],
    ["nativeFee", beet159__namespace.u64],
    ["lzTokenFee", beet159__namespace.u64],
    ["lzTokenMint", beetSolana85__namespace.publicKey]
  ],
  "SendWithLzTokenParams"
);

// src/generated/simple_messagelib/instructions/sendWithLzToken.ts
var sendWithLzTokenStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var setConfigParamsBeet2 = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["oapp", beetSolana85__namespace.publicKey],
    ["eid", beet159__namespace.u32],
    ["configType", beet159__namespace.u32],
...
var setConfigStruct2 = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var setDefaultConfigParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["eid", beet159__namespace.u32],
    ["sendConfig", beet159__namespace.coption(beet159__namespace.bytes)],
    ["receiveConfig", beet159__namespace.coption(beet159__namespace.bytes)]
...
var setDefaultConfigStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var setFeeParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["fee", beet159__namespace.u64],
    ["lzTokenFee", beet159__namespace.u64]
  ],
...
var setFeeStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var setWlCallerParamsBeet = new beet159__namespace.BeetArgsStruct(
  [["newCaller", beetSolana85__namespace.publicKey]],
  "SetWlCallerParams"
);

// src/generated/simple_messagelib/instructions/setWlCaller.ts
var setWlCallerStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var transferAdminParamsBeet2 = new beet159__namespace.BeetArgsStruct(
  [["admin", beetSolana85__namespace.publicKey]],
  "TransferAdminParams"
);

// src/generated/simple_messagelib/instructions/transferAdmin.ts
var transferAdminStruct2 = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var validatePacketParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [["packet", beet159__namespace.bytes]],
  "ValidatePacketParams"
);

// src/generated/simple_messagelib/instructions/validatePacket.ts
var validatePacketStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var versionStruct = new beet159__namespace.BeetArgsStruct(
  [["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)]],
...
var withdrawFeesParamsBeet = new beet159__namespace.BeetArgsStruct(
  [["amount", beet159__namespace.u64]],
  "WithdrawFeesParams"
);

// src/generated/simple_messagelib/instructions/withdrawFees.ts
var withdrawFeesStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var messagingFeeBeet2 = new beet159__namespace.BeetArgsStruct(
  [
    ["nativeFee", beet159__namespace.u64],
    ["lzTokenFee", beet159__namespace.u64]
  ],
...
var versionBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["major", beet159__namespace.u64],
    ["minor", beet159__namespace.u8],
    ["endpointVersion", beet159__namespace.u8]
  ],
  "Version"
);
var PROGRAM_ADDRESS2 = "6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy";
var PROGRAM_ID2 = new web314.PublicKey(PROGRAM_ADDRESS2);
...
var SimpleMessageLib = class {
  ...
  async getSendIXAccountMetaForCPI(_connection, payer, _path) {
    ...
    const cpiAccounts = createSendInstructionAccounts2(
      {
        endpoint: web314.PublicKey.default,
        // useless
        messageLib: msgLib,
        payer
      },
...
var multisigBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["signers", beet159__namespace.array(beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 64))],
    ["quorum", beet159__namespace.u8]
  ],
  "Multisig"
);
var aclBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["allowList", beet159__namespace.array(beetSolana85__namespace.publicKey)],
    ["denyList", beet159__namespace.array(beetSolana85__namespace.publicKey)]
  ],
  "Acl"
);
var dstConfigBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["eid", beet159__namespace.u32],
    ["dstGas", beet159__namespace.u32],
    ["multiplierBps", beet159__namespace.coption(beet159__namespace.u16)],
    ["floorMarginUsd", beet159__namespace.coption(beet159__namespace.u128)]
  ],
  "DstConfig"
);
...
var DvnConfig = class _DvnConfig {
  ...
  static gpaBuilder(programId = new web314__namespace.PublicKey(
    ...
    return beetSolana85__namespace.GpaBuilder.fromStruct(programId, dvnConfigBeet);
  }
  /**
...
var dvnConfigBeet = new beet159__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
    ["vid", beet159__namespace.u32],
    ["bump", beet159__namespace.u8],
    ["multisig", multisigBeet],
    ["acl", aclBeet],
    ["paused", beet159__namespace.bool],
    ["msglibs", beet159__namespace.array(beetSolana85__namespace.publicKey)],
    ["admins", beet159__namespace.array(beetSolana85__namespace.publicKey)],
    ["priceFeed", beetSolana85__namespace.publicKey],
    ["dstConfigs", beet159__namespace.array(dstConfigBeet)],
    ["defaultMultiplierBps", beet159__namespace.u16]
  ],
  DvnConfig.fromArgs,
  "DvnConfig"
);
...
var ExecuteHash = class _ExecuteHash {
  ...
  static gpaBuilder(programId = new web314__namespace.PublicKey(
    ...
    return beetSolana85__namespace.GpaBuilder.fromStruct(programId, executeHashBeet);
  }
  /**
...
var executeHashBeet = new beet159__namespace.BeetStruct(
  [
    ["accountDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
    ["expiration", beet159__namespace.i64],
    ["bump", beet159__namespace.u8]
  ],
  ExecuteHash.fromArgs,
  "ExecuteHash"
);
var ulnConfigBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["confirmations", beet159__namespace.u64],
    ["requiredDvnCount", beet159__namespace.u8],
    ["optionalDvnCount", beet159__namespace.u8],
    ["optionalDvnThreshold", beet159__namespace.u8],
    ["requiredDvns", beet159__namespace.array(beetSolana85__namespace.publicKey)],
    ["optionalDvns", beet159__namespace.array(beetSolana85__namespace.publicKey)]
  ],
  "UlnConfig"
);
...
var ReceiveConfig = class _ReceiveConfig {
  ...
  static gpaBuilder(programId = new web314__namespace.PublicKey(
    ...
    return beetSolana85__namespace.GpaBuilder.fromStruct(programId, receiveConfigBeet);
  }
  /**
...
var receiveConfigBeet = new beet159__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
    ["bump", beet159__namespace.u8],
    ["uln", ulnConfigBeet]
...
var closeExecuteParamsBeet = new beet159__namespace.BeetArgsStruct(
  [["digestHash", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)]],
  "CloseExecuteParams"
);

// src/generated/dvn/instructions/closeExecute.ts
var closeExecuteStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var initDvnParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["vid", beet159__namespace.u32],
    ["msglibs", beet159__namespace.array(beetSolana85__namespace.publicKey)],
    ["priceFeed", beetSolana85__namespace.publicKey],
...
var initDvnStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var transactionAccountBeet = new beet159__namespace.BeetArgsStruct(
  [
...
var executeTransactionDigestBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["vid", beet159__namespace.u32],
    ["programId", beetSolana85__namespace.publicKey],
    ["accounts", beet159__namespace.array(transactionAccountBeet)],
    ["data", beet159__namespace.bytes],
    ["expiration", beet159__namespace.i64]
  ],
...
var invokeParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["digest", executeTransactionDigestBeet],
    ["signatures", beet159__namespace.array(beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 65))]
  ],
  "InvokeParams"
);

// src/generated/dvn/instructions/invoke.ts
var invokeStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var lzOptionBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["optionType", beet159__namespace.u8],
    ["params", beet159__namespace.bytes]
  ],
  "LzOption"
);

// src/generated/dvn/types/QuoteDvnParams.ts
var quoteDvnParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["msglib", beetSolana85__namespace.publicKey],
    ["dstEid", beet159__namespace.u32],
    ["sender", beetSolana85__namespace.publicKey],
    ["packetHeader", beet159__namespace.bytes],
    ["payloadHash", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
    ["confirmations", beet159__namespace.u64],
    ["options", beet159__namespace.array(lzOptionBeet)]
  ],
  "QuoteDvnParams"
);

// src/generated/dvn/instructions/quoteDvn.ts
var quoteDvnStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var adminConfigBeet = beet159__namespace.dataEnum([
  [
    "Admins",
    new beet159__namespace.FixableBeetArgsStruct(
      [["fields", beet159__namespace.tuple([beet159__namespace.array(beetSolana85__namespace.publicKey)])]],
  ...
  [
    ...
    new beet159__namespace.BeetArgsStruct(
      [["fields", beet159__namespace.fixedSizeTuple([beet159__namespace.u16])]],
  ...
  [
    "DstConfigs",
    new beet159__namespace.FixableBeetArgsStruct(
      [["fields", beet159__namespace.tuple([beet159__namespace.array(dstConfigBeet)])]],
...
var setConfigParamsBeet3 = new beet159__namespace.FixableBeetArgsStruct(
  [["config", adminConfigBeet]],
  "SetConfigParams"
);

// src/generated/dvn/instructions/setConfig.ts
var setConfigStruct3 = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var verifiableParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["packetHeader", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 81)],
    ["payloadHash", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)]
  ],
  "VerifiableParams"
);
...
var verifiableStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var withdrawFeeParamsBeet = new beet159__namespace.BeetArgsStruct(
  [["amount", beet159__namespace.u64]],
  "WithdrawFeeParams"
);

// src/generated/dvn/instructions/withdrawFee.ts
var withdrawFeeStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var multisigConfigBeet = beet159__namespace.dataEnum([
  [
    "Admins",
    new beet159__namespace.FixableBeetArgsStruct(
      [["fields", beet159__namespace.tuple([beet159__namespace.array(beetSolana85__namespace.publicKey)])]],
  ...
  [
    "Paused",
    new beet159__namespace.BeetArgsStruct(
      [["fields", beet159__namespace.fixedSizeTuple([beet159__namespace.bool])]],
  ...
  [
    "Quorum",
    new beet159__namespace.BeetArgsStruct(
      [["fields", beet159__namespace.fixedSizeTuple([beet159__namespace.u8])]],
  ...
  [
    ...
    new beet159__namespace.FixableBeetArgsStruct(
      [
        [
          "fields",
          beet159__namespace.tuple([beet159__namespace.array(beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 64))])
        ]
      ],
...
var verificationStateBeet = beet159__namespace.fixedScalarEnum(
  VerificationState
);

// src/generated/dvn/index.ts
var PROGRAM_ADDRESS3 = "HtEYV4xB4wvsj5fgTkcfuChYpvGYzgzwvNhgDZQNh7wW";
var PROGRAM_ID3 = new web314.PublicKey(PROGRAM_ADDRESS3);
...
var adminConfigSetEventBeet = new beet159__namespace.FixableBeetArgsStruct(
  [["config", adminConfigBeet]],
  "AdminConfigSetEvent"
);
var feeWithdrawnEventBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana85__namespace.publicKey],
    ["amount", beet159__namespace.u64]
  ],
...
var multisigConfigSetEventBeet = new beet159__namespace.FixableBeetArgsStruct(
...
var DVN = class {
  ...
  createSetQuorumInstruction(quorum) {
    ...
    return new web314.TransactionInstruction({
...
var aclBeet2 = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["allowList", beet159__namespace.array(beetSolana85__namespace.publicKey)],
    ["denyList", beet159__namespace.array(beetSolana85__namespace.publicKey)]
  ],
...
var dstConfigBeet2 = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["eid", beet159__namespace.u32],
    ["lzReceiveBaseGas", beet159__namespace.u32],
    ["lzComposeBaseGas", beet159__namespace.u32],
    ["multiplierBps", beet159__namespace.coption(beet159__namespace.u16)],
    ["floorMarginUsd", beet159__namespace.coption(beet159__namespace.u128)],
    ["nativeDropCap", beet159__namespace.u128]
  ],
  "DstConfig"
);
...
var ExecutorConfig = class _ExecutorConfig {
  ...
  static gpaBuilder(programId = new web314__namespace.PublicKey(
    ...
    return beetSolana85__namespace.GpaBuilder.fromStruct(programId, executorConfigBeet);
  }
  /**
...
var executorConfigBeet = new beet159__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
    ["bump", beet159__namespace.u8],
    ["owner", beetSolana85__namespace.publicKey],
    ["acl", aclBeet2],
    ["admins", beet159__namespace.array(beetSolana85__namespace.publicKey)],
    ["executors", beet159__namespace.array(beetSolana85__namespace.publicKey)],
    ["msglibs", beet159__namespace.array(beetSolana85__namespace.publicKey)],
    ["paused", beet159__namespace.bool],
    ["defaultMultiplierBps", beet159__namespace.u16],
    ["priceFeed", beetSolana85__namespace.publicKey],
    ["dstConfigs", beet159__namespace.array(dstConfigBeet2)]
  ],
...
var Nonce2 = class _Nonce {
  ...
  static gpaBuilder(programId = new web314__namespace.PublicKey(
    ...
    return beetSolana85__namespace.GpaBuilder.fromStruct(programId, nonceBeet2);
  }
  /**
   * Deserializes the {@link Nonce} from the provided data Buffer.
   * @returns a tuple of the account data and the offset up to which the buffer was read to obtain it.
...
var nonceBeet2 = new beet159__namespace.BeetStruct(
  [
    ["accountDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
    ["bump", beet159__namespace.u8],
    ["outboundNonce", beet159__namespace.u64],
...
var nativeDropRequestBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana85__namespace.publicKey],
    ["amount", beet159__namespace.u64]
  ],
...
var nativeDropAppliedEventBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["srcEid", beet159__namespace.u32],
    ["sender", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
    ["nonce", beet159__namespace.u64],
    ["dstEid", beet159__namespace.u32],
    ["oapp", beetSolana85__namespace.publicKey],
    ["nativeDropRequests", beet159__namespace.array(nativeDropRequestBeet)],
    ["successes", beet159__namespace.array(beet159__namespace.bool)]
  ],
...
var adminSetConfigParamsBeet = beet159__namespace.dataEnum([
  [
    "PriceFeed",
    new beet159__namespace.BeetArgsStruct(
      [["fields", beet159__namespace.fixedSizeTuple([beetSolana85__namespace.publicKey])]],
  ...
  [
    "DstConfigs",
    new beet159__namespace.FixableBeetArgsStruct(
      [["fields", beet159__namespace.tuple([beet159__namespace.array(dstConfigBeet2)])]],
...
var adminSetConfigStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var lzComposeParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["from", beetSolana85__namespace.publicKey],
    ["to", beetSolana85__namespace.publicKey],
    ["guid", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
...
var composeParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
...
var composeStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var executableParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana85__namespace.publicKey],
    ["srcEid", beet159__namespace.u32],
    ["sender", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
...
var executableStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var lzReceiveParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["srcEid", beet159__namespace.u32],
    ["sender", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
    ["nonce", beet159__namespace.u64],
...
var executeParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["receiver", beetSolana85__namespace.publicKey],
...
var executeStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var initExecutorParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["owner", beetSolana85__namespace.publicKey],
    ["admins", beet159__namespace.array(beetSolana85__namespace.publicKey)],
    ["executors", beet159__namespace.array(beetSolana85__namespace.publicKey)],
...
var initExecutorStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var nativeDropParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["srcEid", beet159__namespace.u32],
    ["sender", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
    ["nonce", beet159__namespace.u64],
...
var nativeDropStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var ownerSetConfigParamsBeet = beet159__namespace.dataEnum([
  [
    "Admins",
    new beet159__namespace.FixableBeetArgsStruct(
      [["fields", beet159__namespace.tuple([beet159__namespace.array(beetSolana85__namespace.publicKey)])]],
...
var ownerSetConfigStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var lzOptionBeet2 = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["optionType", beet159__namespace.u8],
    ["params", beet159__namespace.bytes]
  ],
...
var quoteExecutorParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["msglib", beetSolana85__namespace.publicKey],
    ["dstEid", beet159__namespace.u32],
    ["sender", beetSolana85__namespace.publicKey],
    ["calldataSize", beet159__namespace.u64],
    ["options", beet159__namespace.array(lzOptionBeet2)]
  ],
  "QuoteExecutorParams"
);

// src/generated/executor/instructions/quoteExecutor.ts
var quoteExecutorStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var executionStateBeet = beet159__namespace.fixedScalarEnum(
  ExecutionState
);
var AddressType = beet159.uniformFixedSizeArray(beet159.u8, 32);
...
var LzReceiveAccountBeet = new beet159.BeetArgsStruct(
  [
    ["pubkey", beetSolana85__namespace.publicKey],
...
var adminTransferredEventBeet2 = new beet159__namespace.BeetArgsStruct(
  [["newAdmin", beetSolana85__namespace.publicKey]],
  "AdminTransferredEvent"
);
var ulnConfigBeet2 = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["confirmations", beet159__namespace.u64],
    ["requiredDvnCount", beet159__namespace.u8],
    ["optionalDvnCount", beet159__namespace.u8],
...
var executorConfigBeet2 = new beet159__namespace.BeetArgsStruct(
  [
    ["maxMessageSize", beet159__namespace.u32],
    ["executor", beetSolana85__namespace.publicKey]
  ],
  "ExecutorConfig"
);
...
var configBeet = beet159__namespace.dataEnum([
  [
    "SendUln",
    new beet159__namespace.FixableBeetArgsStruct(
      [["fields", beet159__namespace.tuple([ulnConfigBeet2])]],
  ...
  [
    "Executor",
    new beet159__namespace.BeetArgsStruct(
      [["fields", beet159__namespace.fixedSizeTuple([executorConfigBeet2])]],
...
var configSetEventBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["oapp", beetSolana85__namespace.publicKey],
    ["eid", beet159__namespace.u32],
    ["config", configBeet]
...
var defaultConfigSetEventBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["eid", beet159__namespace.u32],
    ["sendUlnConfig", beet159__namespace.coption(ulnConfigBeet2)],
    ["receiveUlnConfig", beet159__namespace.coption(ulnConfigBeet2)],
    ["executorConfig", beet159__namespace.coption(executorConfigBeet2)]
  ],
  "DefaultConfigSetEvent"
);
var workerFeeBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["worker", beetSolana85__namespace.publicKey],
    ["fee", beet159__namespace.u64]
  ],
  "WorkerFee"
);
var treasuryFeeBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["treasury", beetSolana85__namespace.publicKey],
    ["fee", beet159__namespace.u64],
    ["payInLzToken", beet159__namespace.bool]
  ],
  "TreasuryFee"
...
var feesPaidEventBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["executor", workerFeeBeet],
    ["dvns", beet159__namespace.array(workerFeeBeet)],
    ["treasury", beet159__namespace.coption(treasuryFeeBeet)]
  ],
  "FeesPaidEvent"
);
var payloadVerifiedEventBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["dvn", beetSolana85__namespace.publicKey],
    ["header", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 81)],
    ["confirmations", beet159__namespace.u64],
    ["proofHash", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)]
  ],
  "PayloadVerifiedEvent"
);
var rentWithdrawnEventBeet2 = new beet159__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana85__namespace.publicKey],
    ["amount", beet159__namespace.u64]
  ],
...
var lzTokenTreasuryBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana85__namespace.publicKey],
    ["fee", beet159__namespace.u64]
  ],
...
var treasuryBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["admin", beet159__namespace.coption(beetSolana85__namespace.publicKey)],
    ["nativeReceiver", beetSolana85__namespace.publicKey],
    ["nativeFeeBps", beet159__namespace.u64],
    ["lzToken", beet159__namespace.coption(lzTokenTreasuryBeet)]
  ],
  "Treasury"
);

// src/generated/uln/events/TreasurySetEvent.ts
var treasurySetEventBeet = new beet159__namespace.FixableBeetArgsStruct(
  [["treasury", beet159__namespace.coption(treasuryBeet)]],
  "TreasurySetEvent"
);
...
async function extractEventFromTransactionSignature(connection, program, signature, eventBeet, commitment, unsafeParseErr = false) {
  ...
  for (const instruction of tx.meta?.innerInstructions ?? []) {
    for (const innerInstruction of instruction.instructions) {
      ...
      const decoded = base58__default.default.decode(inst.data);
...
async function generateAddressLookupTable(connection, payer, authority, addresses) {
  ...
  const [createInstruction, lookupTableAddress] = web314.AddressLookupTableProgram.createLookupTable({
    payer,
    authority,
    recentSlot: slot
  });
  const extendInstruction = web314.AddressLookupTableProgram.extendLookupTable({
    payer,
    authority,
...
function deactivateLookupTable(authority, lookupTable) {
  return web314.AddressLookupTableProgram.deactivateLookupTable({
    authority,
    lookupTable
  });
}
function closeLookupTable(recipient, authority, lookupTable) {
  return web314.AddressLookupTableProgram.closeLookupTable({
    authority,
    recipient,
    lookupTable
  });
...
async function txWithAddressLookupTable(connection, payer, instructions, recentBlockHash, tableAddr) {
  ...
  if (!tableAddr) {
    return new web314.VersionedTransaction(
      new web314.TransactionMessage({
        instructions,
        payerKey: payer,
...
async function createNonceAccountTX(connection, auth, lamportsForRent) {
  const nonceAccount = web314.Keypair.generate();
  const lamports = lamportsForRent ?? await connection.getMinimumBalanceForRentExemption(web314.NONCE_ACCOUNT_LENGTH);
  const tx = new web314.Transaction();
  tx.add(
    ...
    web314.SystemProgram.createAccount({
      ...
      lamports,
      space: web314.NONCE_ACCOUNT_LENGTH,
      programId: web314.SystemProgram.programId
    }),
    // init nonce account
    web314.SystemProgram.nonceInitialize({
...
async function txWithNonce(connection, noncePubkey, instructions, nonceInfo) {
  ...
  if (!nonceInfo) {
    ...
    if (accountInfo) {
      nonceInfo = web314.NonceAccount.fromAccountData(accountInfo.data);
    } else {
      return null;
    }
  }
  tx.add(
    ...
    web314.SystemProgram.nonceAdvance({
      noncePubkey,
...
async function buildMessageV0(connection, payerKey, instructions, commitmentOrConfig = "confirmed", blockhash) {
  return new web314.TransactionMessage({
    payerKey,
...
async function getLzReceiveAccounts(connection, payer, receiver, receiverProgram, params, commitmentOrConfig = "confirmed") {
  const lzReceiveTypesAccounts = await (async () => {
    ...
    if (info) {
      ...
      for (let i = 8; i < len; i += 32) {
        ...
        accounts.push({
          pubkey: new web314.PublicKey(address),
          isSigner: false,
          isWritable: false
        });
      }
  ...
  const [data] = LzReceiveParamsBeet.serialize(params);
  const lzReceiveTypesIx = new web314.TransactionInstruction({
    programId: receiverProgram,
...
async function getLzComposeAccountMeta(connection, payer, to, composerProgram, params, commitmentOrConfig = "confirmed") {
  ...
  const [data] = LzComposeParamsBeet.serialize(params);
  const lzComposeTypesIx = new web314.TransactionInstruction({
...
function retrieveAccountFromSimulatedResp(resp, payer) {
  const result = beet159.array(LzReceiveAccountBeet);
...
var PROGRAM_ID4 = new web314.PublicKey(PROGRAM_ADDRESS4);
...
var Confirmations = class _Confirmations {
  ...
  static gpaBuilder(programId = new web314__namespace.PublicKey(
    ...
    return beetSolana85__namespace.GpaBuilder.fromStruct(programId, confirmationsBeet);
  }
  /**
...
var confirmationsBeet = new beet159__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
    ["value", beet159__namespace.coption(beet159__namespace.u64)],
    ["bump", beet159__namespace.u8]
  ],
...
var ReceiveConfig2 = class _ReceiveConfig {
  ...
  static gpaBuilder(programId = new web314__namespace.PublicKey(
    ...
    return beetSolana85__namespace.GpaBuilder.fromStruct(programId, receiveConfigBeet2);
  }
  /**
   * Deserializes the {@link ReceiveConfig} from the provided data Buffer.
   * @returns a tuple of the account data and the offset up to which the buffer was read to obtain it.
...
var receiveConfigBeet2 = new beet159__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
    ["bump", beet159__namespace.u8],
    ["uln", ulnConfigBeet2]
...
var SendConfig = class _SendConfig {
  ...
  static gpaBuilder(programId = new web314__namespace.PublicKey(
    ...
    return beetSolana85__namespace.GpaBuilder.fromStruct(programId, sendConfigBeet);
  }
  /**
...
var sendConfigBeet = new beet159__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
    ["bump", beet159__namespace.u8],
    ["uln", ulnConfigBeet2],
...
var UlnSettings = class _UlnSettings {
  ...
  static gpaBuilder(programId = new web314__namespace.PublicKey(
    ...
    return beetSolana85__namespace.GpaBuilder.fromStruct(programId, ulnSettingsBeet);
  }
  /**
...
var ulnSettingsBeet = new beet159__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
    ["eid", beet159__namespace.u32],
    ["endpoint", beetSolana85__namespace.publicKey],
...
var closeVerifyParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["packetHeaderHash", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
    ["payloadHash", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)]
  ],
  "CloseVerifyParams"
);
...
var closeVerifyStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var commitVerificationParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["packetHeader", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 81)],
    ["payloadHash", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)]
  ],
...
var commitVerificationStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var initConfigParamsBeet3 = new beet159__namespace.BeetArgsStruct(
  [
    ["oapp", beetSolana85__namespace.publicKey],
    ["eid", beet159__namespace.u32]
  ],
...
var initConfigStruct3 = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var initDefaultConfigParamsBeet2 = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["eid", beet159__namespace.u32],
...
var initDefaultConfigStruct2 = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var initUlnParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["eid", beet159__namespace.u32],
    ["endpoint", beetSolana85__namespace.publicKey],
    ["endpointProgram", beetSolana85__namespace.publicKey],
...
var initUlnStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var initVerifyParamsBeet2 = new beet159__namespace.BeetArgsStruct(
  [
    ["packetHeader", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 81)],
    ["payloadHash", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
    ["dvn", beetSolana85__namespace.publicKey]
...
var initVerifyStruct2 = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var packetBeet2 = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["nonce", beet159__namespace.u64],
    ["srcEid", beet159__namespace.u32],
    ["sender", beetSolana85__namespace.publicKey],
...
var quoteParamsBeet3 = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["packet", packetBeet2],
    ["options", beet159__namespace.bytes],
    ["payInLzToken", beet159__namespace.bool]
...
var quoteStruct3 = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var sendParamsBeet3 = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["packet", packetBeet2],
    ["options", beet159__namespace.bytes],
    ["nativeFee", beet159__namespace.u64]
...
var sendStruct3 = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var sendWithLzTokenParamsBeet2 = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["packet", packetBeet2],
    ["options", beet159__namespace.bytes],
    ["nativeFee", beet159__namespace.u64],
...
var sendWithLzTokenStruct2 = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var setConfigParamsBeet4 = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["oapp", beetSolana85__namespace.publicKey],
    ["eid", beet159__namespace.u32],
    ["configType", beet159__namespace.u32],
...
var setConfigStruct4 = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var setDefaultConfigParamsBeet2 = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["eid", beet159__namespace.u32],
    ["sendUlnConfig", beet159__namespace.coption(ulnConfigBeet2)],
    ["receiveUlnConfig", beet159__namespace.coption(ulnConfigBeet2)],
...
var setDefaultConfigStruct2 = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var setTreasuryParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [["treasury", beet159__namespace.coption(treasuryBeet)]],
  "SetTreasuryParams"
);

// src/generated/uln/instructions/setTreasury.ts
var setTreasuryStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var transferAdminParamsBeet3 = new beet159__namespace.BeetArgsStruct(
  [["admin", beetSolana85__namespace.publicKey]],
  "TransferAdminParams"
);

// src/generated/uln/instructions/transferAdmin.ts
var transferAdminStruct3 = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var verifyParamsBeet2 = new beet159__namespace.BeetArgsStruct(
  [
    ["packetHeader", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 81)],
    ["payloadHash", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 32)],
    ["confirmations", beet159__namespace.u64]
...
var verifyStruct2 = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var versionStruct2 = new beet159__namespace.BeetArgsStruct(
  [["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)]],
  "VersionInstructionArgs"
);
...
var withdrawRentParamsBeet2 = new beet159__namespace.BeetArgsStruct(
  [["amount", beet159__namespace.u64]],
  "WithdrawRentParams"
);

// src/generated/uln/instructions/withdrawRent.ts
var withdrawRentStruct2 = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var messagingFeeBeet3 = new beet159__namespace.BeetArgsStruct(
  [
    ["nativeFee", beet159__namespace.u64],
    ["lzTokenFee", beet159__namespace.u64]
  ],
...
var versionBeet2 = new beet159__namespace.BeetArgsStruct(
  [
    ["major", beet159__namespace.u64],
    ["minor", beet159__namespace.u8],
    ["endpointVersion", beet159__namespace.u8]
...
var PROGRAM_ID5 = new web314.PublicKey(PROGRAM_ADDRESS5);
    ...
    return createVerifyInstruction2(
      ...
      },
      {
        params: {
          packetHeader: Array.from(Uint8Array.from(Buffer.from(packet.header().slice(2), "hex"))),
          payloadHash: Array.from(payloadHashBytes),
          confirmations: typeof confirmations === "string" ? new BN__default.default(confirmations) : confirmations
        }
      },
      this.program
    );
...
var modelTypeBeet = beet159__namespace.dataEnum([
  [
    "Arbitrum",
    new beet159__namespace.BeetArgsStruct(
      [
        ["gasPerL2Tx", beet159__namespace.u64],
        ["gasPerL1CalldataByte", beet159__namespace.u32]
      ],
...
var priceBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["eid", beet159__namespace.u32],
    ["priceRatio", beet159__namespace.u128],
    ["gasPriceInUnit", beet159__namespace.u64],
    ["gasPerByte", beet159__namespace.u32],
    ["modelType", beet159__namespace.coption(modelTypeBeet)]
  ],
  "Price"
);
...
var PriceFeed = class _PriceFeed {
  ...
  static gpaBuilder(programId = new web314__namespace.PublicKey(
    ...
    return beetSolana85__namespace.GpaBuilder.fromStruct(programId, priceFeedBeet);
  }
  /**
...
var priceFeedBeet = new beet159__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
    ["admin", beetSolana85__namespace.publicKey],
    ["updaters", beet159__namespace.array(beetSolana85__namespace.publicKey)],
    ["priceRatioDenominator", beet159__namespace.u128],
    ["arbitrumCompressionPercent", beet159__namespace.u128],
    ["nativeTokenPriceUsd", beet159__namespace.coption(beet159__namespace.u128)],
    ["prices", beet159__namespace.array(priceBeet)],
    ["bump", beet159__namespace.u8]
  ],
  PriceFeed.fromArgs,
  "PriceFeed"
...
var getFeeParamsBeet = new beet159__namespace.BeetArgsStruct(
  [
    ["dstEid", beet159__namespace.u32],
    ["calldataSize", beet159__namespace.u64],
    ["totalGas", beet159__namespace.u128]
  ],
  "GetFeeParams"
);

// src/generated/pricefeed/instructions/getFee.ts
var getFeeStruct = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var initPriceFeedParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["admin", beetSolana85__namespace.publicKey],
    ["updaters", beet159__namespace.array(beetSolana85__namespace.publicKey)]
  ],
...
var initPriceFeedStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var priceParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["priceRatio", beet159__namespace.u128],
    ["gasPriceInUnit", beet159__namespace.u64],
    ["gasPerByte", beet159__namespace.u32],
...
var setPriceParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["dstEid", beet159__namespace.u32],
    ["params", beet159__namespace.coption(priceParamsBeet)]
  ],
  "SetPriceParams"
);

// src/generated/pricefeed/instructions/setPrice.ts
var setPriceStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var setPriceFeedParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["updaters", beet159__namespace.array(beetSolana85__namespace.publicKey)],
    ["priceRatioDenominator", beet159__namespace.u128],
    ["arbitrumCompressionPercent", beet159__namespace.u128]
...
var setPriceFeedStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var setSolPriceParamsBeet = new beet159__namespace.FixableBeetArgsStruct(
  [["nativeTokenPriceUsd", beet159__namespace.coption(beet159__namespace.u128)]],
  "SetSolPriceParams"
);

// src/generated/pricefeed/instructions/setSolPrice.ts
var setSolPriceStruct = new beet159__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var transferAdminParamsBeet4 = new beet159__namespace.BeetArgsStruct(
  [["admin", beetSolana85__namespace.publicKey]],
  "TransferAdminParams"
);

// src/generated/pricefeed/instructions/transferAdmin.ts
var transferAdminStruct4 = new beet159__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet159__namespace.uniformFixedSizeArray(beet159__namespace.u8, 8)],
...
var PROGRAM_ID6 = new web314.PublicKey(PROGRAM_ADDRESS6);
...
function getProgramKeypair(network, program) {
  ...
  return new web314.PublicKey(deployment.address);
}
...
exports.BaseOApp = BaseOApp;
exports.BlockedMessageLibProgram = blocked_messagelib_exports;
exports.COMPOSED_MESSAGE_HASH_SEED = COMPOSED_MESSAGE_HASH_SEED;
exports.CONFIRMATIONS_SEED = CONFIRMATIONS_SEED;
exports.COUNT_SEED = COUNT_SEED;
exports.DVNDeriver = DVNDeriver;
exports.DVNProgram = dvn_exports2;
exports.DVN_CONFIG_SEED = DVN_CONFIG_SEED;
exports.DvnProgram = dvn_exports;
exports.ENDPOINT_SEED = ENDPOINT_SEED;
exports.ENFORCED_OPTIONS_SEED = ENFORCED_OPTIONS_SEED;
exports.EVENT_SEED = EVENT_SEED;
exports.EXECUTOR_CONFIG_SEED = EXECUTOR_CONFIG_SEED;
exports.EndpointPDADeriver = EndpointPDADeriver;
exports.EndpointProgram = endpoint_exports;
exports.EventPDADeriver = EventPDADeriver;
exports.ExecutorOptionType = ExecutorOptionType;
exports.ExecutorPDADeriver = ExecutorPDADeriver;
exports.ExecutorProgram = executor_exports;
exports.FAUCET_URL = FAUCET_URL;
exports.IdlTypes = IdlTypes;
exports.LZ_COMPOSE_TYPES_SEED = LZ_COMPOSE_TYPES_SEED;
exports.LZ_RECEIVE_TYPES_SEED = LZ_RECEIVE_TYPES_SEED;
exports.LzComposeParamsBeet = LzComposeParamsBeet;
exports.LzReceiveAccountBeet = LzReceiveAccountBeet;
exports.LzReceiveParamsBeet = LzReceiveParamsBeet;
exports.MESSAGE_LIB_SEED = MESSAGE_LIB_SEED;
...
exports.MessageLibPDADeriver = MessageLibPDADeriver;
...
exports.PRICE_FEED_SEED = PRICE_FEED_SEED;
exports.PriceFeedPDADeriver = PriceFeedPDADeriver;
exports.PriceFeedProgram = pricefeed_exports;
exports.RECEIVE_CONFIG_SEED = RECEIVE_CONFIG_SEED;
exports.RECEIVE_LIBRARY_CONFIG_SEED = RECEIVE_LIBRARY_CONFIG_SEED;
exports.REMOTE_SEED = REMOTE_SEED;
exports.SEND_CONFIG_SEED = SEND_CONFIG_SEED;
exports.SEND_LIBRARY_CONFIG_SEED = SEND_LIBRARY_CONFIG_SEED;
...
exports.ULN_CONFIG_SEED = ULN_CONFIG_SEED;
exports.ULN_SEED = ULN_SEED;
exports.UlnPDADeriver = UlnPDADeriver;
exports.UlnProgram = uln_exports;
exports.WORKER_SEED = WORKER_SEED;
...
exports.deriveLzComposeTypesAccountsPDA = deriveLzComposeTypesAccountsPDA;
exports.deriveLzReceiveTypesAccountsPDA = deriveLzReceiveTypesAccountsPDA;
...
exports.extractSentPacketEventByTxHash = extractSentPacketEventByTxHash;
