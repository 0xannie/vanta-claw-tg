...
var TronWeb__default = /*#__PURE__*/_interopDefault(TronWeb);
      ...
      contract: [
        {
          parameter: {
            value: {
              ...
              contract_address: TronWeb__default.default.address.toHex(txn.to),
