...
var pick = require('ramda/es/pick');
...
var init_assets_script = __esm({
  "src/pages/overview/assets/assets.script.ts"() {
    useAssetScript = () => {
      const { connect, namespace } = hooks.useWalletConnector();
      const { state, isMainAccount } = hooks.useAccount();
      const { totalValue, freeCollateral } = hooks.useCollateral();
      ...
      const [visible, setVisible] = hooks.useLocalStorage("orderly_assets_visible", true);
...
var AssetsHeader;
var init_assetsHeader = __esm({
  "src/pages/overview/assets/assetsHeader.tsx"() {
    AssetsHeader = (props) => {
      const { t } = i18n.useTranslation();
      return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "between", children: [
        /* @__PURE__ */ jsxRuntime.jsx(ui.CardTitle, { children: t("common.overview") }),
        /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 3, children: [
          props.isMainAccount && /* @__PURE__ */ jsxRuntime.jsx(
            ui.Button,
            {
              disabled: props.disabled,
              size: "md",
              onClick: () => props.onDeposit?.(),
              icon: /* @__PURE__ */ jsxRuntime.jsx(ui.ArrowDownSquareFillIcon, { className: "oui-text-primary-contrast" }),
              "data-testid": "oui-testid-portfolio-assets-deposit-btn",
              children: t("common.deposit")
            }
          ),
          props.hasSubAccount && /* @__PURE__ */ jsxRuntime.jsx(
            ui.Button,
            {
              disabled: props.disabled,
              size: "md",
              ...
              icon: /* @__PURE__ */ jsxRuntime.jsx(ui.ArrowLeftRightIcon, { className: "oui-text-base-contrast" }),
          ...
          props.isMainAccount && /* @__PURE__ */ jsxRuntime.jsx(
            ui.Button,
            {
              ...
              icon: /* @__PURE__ */ jsxRuntime.jsx(ui.ArrowUpSquareFillIcon, { className: "oui-text-base-contrast" }),
...
var AssetsUI, NoValue, AssetStatistic;
var init_assets_ui = __esm({
  "src/pages/overview/assets/assets.ui.tsx"() {
    init_assetsHeader();
    AssetsUI = (props) => {
      const { t } = i18n.useTranslation();
        ...
        ui.Card,
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              ui.Statistic,
              {
                label: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 1, children: [
                  /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 54, children: t("common.totalValue") }),
                  /* @__PURE__ */ jsxRuntime.jsx(
                    "button",
                    {
                      onClick: () => {
                      ...
                      children: props.visible ? /* @__PURE__ */ jsxRuntime.jsx(ui.EyeIcon, { size: 16, color: "white" }) : /* @__PURE__ */ jsxRuntime.jsx(ui.EyeCloseIcon, { size: 16, color: "white" })
                    }
                  )
                ] }),
                children: /* @__PURE__ */ jsxRuntime.jsx(ui.Either, { value: props.canTrade, left: /* @__PURE__ */ jsxRuntime.jsx(NoValue, {}), children: /* @__PURE__ */ jsxRuntime.jsx(
                  ui.Text.numeral,
                  {
            ...
            /* @__PURE__ */ jsxRuntime.jsx(ui.Divider, { className: "oui-my-4", intensity: 8 }),
            /* @__PURE__ */ jsxRuntime.jsx(uiConnector.AuthGuard, { buttonProps: { size: "lg", fullWidth: true }, children: /* @__PURE__ */ jsxRuntime.jsx(
              AssetStatistic,
              {
    ...
    NoValue = () => {
      return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 1, className: "oui-h-9", children: [
        /* @__PURE__ */ jsxRuntime.jsx(ui.Text.gradient, { color: "brand", weight: "bold", children: "--" }),
...
var AssetWidget;
var init_assets_widget = __esm({
  "src/pages/overview/assets/assets.widget.tsx"() {
    init_assets_script();
    init_assets_ui();
    AssetWidget = () => {
...
// src/pages/overview/assets/index.ts
var assets_exports = {};
__export(assets_exports, {
  AssetWidget: () => AssetWidget,
  AssetsUI: () => AssetsUI,
  useAssetScript: () => useAssetScript
});
...
var useAssetHistoryColumns;
var init_column = __esm({
  "src/pages/overview/assetHistory/column.tsx"() {
    useAssetHistoryColumns = (options) => {
      ...
      const columns = React12.useMemo(() => {
        const txIdColumn = {
          ...
          render: (value, record) => {
            if (!value) {
              return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-text-base-contrast-54", children: "-" });
            }
            ...
            return /* @__PURE__ */ jsxRuntime.jsx("a", { href, target: "_blank", rel: "noreferrer", children: /* @__PURE__ */ jsxRuntime.jsx(
              ui.Text.formatted,
              {
                copyable: !!value,
                rule: "txId",
        ...
        const accountIdColumn = {
          ...
          width: 120,
          render: (value, record) => {
            const accountId = isDeposit ? record.from_account_id : record.to_account_id;
            return /* @__PURE__ */ jsxRuntime.jsx(ui.Text.formatted, { rule: "address", copyable: !!accountId, onCopy, children: accountId });
          }
        };
        return [
          {
            ...
            render: (value) => {
              return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gapX: 1, children: [
                /* @__PURE__ */ jsxRuntime.jsx(ui.TokenIcon, { name: value, size: "xs" }),
          ...
          isWeb3Wallet ? txIdColumn : accountIdColumn,
          {
            ...
            render: (value, recoed) => {
              ...
              const statusMap = {
                [types.AssetHistoryStatusEnum.NEW]: t("assetHistory.status.pending"),
                [types.AssetHistoryStatusEnum.PENDING]: t("assetHistory.status.pending"),
                [types.AssetHistoryStatusEnum.CONFIRM]: t("assetHistory.status.confirm"),
                [types.AssetHistoryStatusEnum.PROCESSING]: t(
                  "assetHistory.status.processing"
                ),
                [types.AssetHistoryStatusEnum.COMPLETED]: t(
                  "assetHistory.status.completed"
                ),
                [types.AssetHistoryStatusEnum.FAILED]: t("assetHistory.status.failed")
              };
              return statusMap[value] || ui.capitalizeFirstLetter(value?.toLowerCase());
            }
          },
          {
            ...
            rule: "price",
            render: (value, record) => {
              const netAmount = new utils.Decimal(value).minus(record.fee ?? 0);
              return /* @__PURE__ */ jsxRuntime.jsx(
                ui.Text.numeral,
                {
                  dp: record.decimals,
                  ...
                  showIdentifier: true,
                  padding: false,
                  children: isDeposit ? netAmount.toNumber() : netAmount.neg().toNumber()
                }
              );
            }
          }
...
var parseDateRangeForFilter;
var init_date = __esm({
  "src/pages/overview/helper/date.ts"() {
    parseDateRangeForFilter = (dateRange) => {
      const { from, to = /* @__PURE__ */ new Date() } = dateRange;
      const diff = dateFns.differenceInDays(from, to);
      if (diff === 0) {
        return [from, dateFns.setHours(to, 23)];
      }
      return [from, to];
    };
  }
});
var useAssetHistoryScript;
var init_assetHistory_script = __esm({
  "src/pages/overview/assetHistory/assetHistory.script.ts"() {
    init_date();
    useAssetHistoryScript = (options) => {
      ...
      const { startTime, endTime } = React12.useMemo(() => {
        ...
        return { startTime: startTime2, endTime: endTime2 };
      }, [dateRange]);
      const [assetData, { meta: assetMeta, isLoading: assetLoading }] = hooks.useAssetsHistory(
        {
          startTime,
          endTime,
          page,
      ...
      const [transferData, { isLoading: transferLoading, meta: transferMeta }] = hooks.useTransferHistory({
      ...
      const { data: chainsInfo } = hooks.useChainInfo();
...
var AssetHistory;
var init_assetHistory_ui = __esm({
  "src/pages/overview/assetHistory/assetHistory.ui.tsx"() {
    init_assetHistory_script();
    init_column();
    AssetHistory = (props) => {
      const { dataSource: dataSource2, queryParameter, onFilter, isLoading } = props;
...
var AssetHistoryMobile;
var init_assetHistory_ui_mobile = __esm({
  "src/pages/overview/assetHistory/assetHistory.ui.mobile.tsx"() {
    init_assetHistory_script();
    AssetHistoryMobile = (props) => {
      const {
        dataSource: dataSource2,
        queryParameter,
        onFilter,
      ...
      const getStatusText = (item) => {
        ...
        const statusMap = {
          ...
          [types.AssetHistoryStatusEnum.PENDING]: t("assetHistory.status.pending"),
          [types.AssetHistoryStatusEnum.CONFIRM]: t("assetHistory.status.confirm"),
          [types.AssetHistoryStatusEnum.PROCESSING]: t("assetHistory.status.processing"),
          [types.AssetHistoryStatusEnum.COMPLETED]: t("assetHistory.status.completed"),
          [types.AssetHistoryStatusEnum.FAILED]: t("assetHistory.status.failed")
        };
        return statusMap[status] || ui.capitalizeFirstLetter(status?.toLowerCase());
      };
      const renderHistoryItem = (item) => {
        const formattedAmount = isDeposit ? `+${item.amount - (item.fee ?? 0)}` : -(item.amount - (item.fee ?? 0));
        const getTxLink = () => {
          if (!item.tx_id) {
            return void 0;
          }
          const chainInfo = chainsInfo && Array.isArray(chainsInfo) ? chainsInfo.find(
            (chain) => parseInt(item.chain_id) === parseInt(chain.chain_id)
          ) : void 0;
        ...
        const txIdView = item.tx_id ? /* @__PURE__ */ jsxRuntime.jsx("a", { href: getTxLink(), target: "_blank", rel: "noreferrer", children: /* @__PURE__ */ jsxRuntime.jsx(
          ui.Text.formatted,
          {
            copyable: !!item.tx_id,
            className: "oui-underline oui-decoration-line-16 oui-decoration-dashed oui-underline-offset-4",
        ...
        ) }) : /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 54, children: "-" });
        const accountId = isDeposit ? item.from_account_id : item.to_account_id;
        const accountIdView = /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gapX: 1, children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 36, size: "xs", children: isDeposit ? t("transfer.internalTransfer.from") : t("transfer.internalTransfer.to") }),
          /* @__PURE__ */ jsxRuntime.jsx(
            ui.Text.formatted,
            {
              rule: "address",
        ...
        return /* @__PURE__ */ jsxRuntime.jsxs(
          ui.Flex,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { justify: "between", width: "100%", height: "18px", children: isWeb3Wallet ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
                amountView,
                statusView
              ...
              /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "between", width: "100%", height: "18px", children: [
                timeView,
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(
          ui.ListView,
          {
            ...
            isLoading,
            className: "oui-px-1",
            emptyView: /* @__PURE__ */ jsxRuntime.jsxs(
              ui.Flex,
              {
                direction: "column",
                height: "100%",
                ...
                mt: 3,
                children: [
                  /* @__PURE__ */ jsxRuntime.jsx(ui.EmptyDataState, {}),
                  dataSource2?.length == 0 && /* @__PURE__ */ jsxRuntime.jsxs(
                    ui.Flex,
                    {
                      direction: "row",
                      itemAlign: "center",
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { color: "primary", size: "2xs", children: t("common.deposit") }),
                        /* @__PURE__ */ jsxRuntime.jsx(
...
var AssetHistoryWidget;
var init_assetHistory_widget = __esm({
  "src/pages/overview/assetHistory/assetHistory.widget.tsx"() {
    init_assetHistory_script();
    init_assetHistory_ui();
    init_assetHistory_ui_mobile();
    AssetHistoryWidget = (props) => {
      const state = useAssetHistoryScript({ side: props.side });
      const { isMobile } = ui.useScreen();
      if (isMobile) {
        return /* @__PURE__ */ jsxRuntime.jsx(AssetHistoryMobile, { ...state });
      }
      return /* @__PURE__ */ jsxRuntime.jsx(AssetHistory, { ...state });
    };
  }
});

// src/pages/overview/assetHistory/index.tsx
var assetHistory_exports = {};
__export(assetHistory_exports, {
  AssetHistory: () => AssetHistory,
  AssetHistoryWidget: () => AssetHistoryWidget,
  useAssetHistoryColumns: () => useAssetHistoryColumns,
  useAssetHistoryScript: () => useAssetHistoryScript
});
var init_assetHistory = __esm({
  "src/pages/overview/assetHistory/index.tsx"() {
    init_column();
    init_assetHistory_script();
    init_assetHistory_ui();
          ...
          },
          {
            ...
            render: (value, record) => {
              return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 1, children: [
                /* @__PURE__ */ jsxRuntime.jsx(ui.Text.numeral, { rule: "percentages", dp: 6, children: record.funding_rate }),
                /* @__PURE__ */ jsxRuntime.jsx("span", { children: "/" }),
                /* @__PURE__ */ jsxRuntime.jsx(ui.Text.numeral, { rule: "percentages", dp: 6, children: record.annual_rate })
              ] });
            }
          },
          {
...
var FundingHistoryDesktop;
var init_fundingHistory_ui = __esm({
  "src/pages/overview/funding/fundingHistory.ui.tsx"() {
    init_column2();
    FundingHistoryDesktop = (props) => {
      const { dataSource: dataSource2, queryParameter, onFilter, isLoading } = props;
      ...
      const renderHistoryItem = (item) => {
        return /* @__PURE__ */ jsxRuntime.jsxs(
          ui.Flex,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "row", justify: "between", width: "100%", height: "20px", children: [
                /* @__PURE__ */ jsxRuntime.jsx(
                  ui.Text.formatted,
                  {
                    rule: "symbol",
              ...
              /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "row", justify: "between", width: "100%", children: [
                /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", children: [
                  /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-base-contrast-36 oui-text-2xs", children: t("funding.fundingRate") }),
                  /* @__PURE__ */ jsxRuntime.jsx(
                    ui.Text.numeral,
                    {
                      rule: "percentages",
                ...
                /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", children: [
                  /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-base-contrast-36 oui-text-2xs", children: t("funding.annualRate") }),
                  /* @__PURE__ */ jsxRuntime.jsx(
                    ui.Text.numeral,
                    {
                      rule: "percentages",
                ...
                /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", children: [
                  /* @__PURE__ */ jsxRuntime.jsxs(ui.Text, { className: "oui-text-base-contrast-36 oui-text-2xs", children: [
                    ...
                    " ",
                    /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-base-contrast-20", children: "(USDC)" })
                  ] }),
                  /* @__PURE__ */ jsxRuntime.jsx(
                    ui.Text.numeral,
                    {
                      ...
                      children: Number(item.funding_fee) * -1
                    }
                  )
                ] })
              ] })
...
var useFundingHistoryHook;
var init_useDataSource_script = __esm({
...
var FundingHistoryWidget;
var init_fundingHistory_widget = __esm({
  "src/pages/overview/funding/fundingHistory.widget.tsx"() {
    init_fundingHistory_ui();
    init_fundingHistory_ui_mobile();
    init_useDataSource_script();
    FundingHistoryWidget = () => {
      const state = useFundingHistoryHook();
      const { isMobile } = ui.useScreen();
      if (isMobile) {
        return /* @__PURE__ */ jsxRuntime.jsx(FundingHistoryMobile, { ...state });
      }
      return /* @__PURE__ */ jsxRuntime.jsx(FundingHistoryDesktop, { ...state });
    };
  }
});

// src/pages/overview/funding/index.tsx
var funding_exports = {};
__export(funding_exports, {
  FundingHistoryDesktop: () => FundingHistoryDesktop,
  FundingHistoryMobile: () => FundingHistoryMobile,
  FundingHistoryWidget: () => FundingHistoryWidget,
  useFundingHistoryColumns: () => useFundingHistoryColumns,
  useFundingHistoryHook: () => useFundingHistoryHook
});
var init_funding = __esm({
  "src/pages/overview/funding/index.tsx"() {
    init_fundingHistory_widget();
    init_fundingHistory_ui();
    init_fundingHistory_ui_mobile();
    init_column2();
    init_useDataSource_script();
        ...
        return [
          {
            ...
            // rule: "symbol",
            render: (value, record) => {
              return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gapX: 2, children: [
                /* @__PURE__ */ jsxRuntime.jsx(ui.TokenIcon, { name: value, size: "xs" }),
                /* @__PURE__ */ jsxRuntime.jsx("span", { children: value })
              ] });
            }
...
var DistributionHistoryDesktop;
var init_distribution_ui = __esm({
  "src/pages/overview/distribution/distribution.ui.tsx"() {
    init_column3();
    DistributionHistoryDesktop = (props) => {
      const { dataSource: dataSource2, queryParameter, onFilter, isLoading, isValidating } = props;
...
var DistributionHistoryMobile;
var init_distribution_ui_mobile = __esm({
  "src/pages/overview/distribution/distribution.ui.mobile.tsx"() {
    DistributionHistoryMobile = (props) => {
      const { dataSource: dataSource2, queryParameter, onFilter, isLoading, pagination } = props;
      const { type, dateRange } = queryParameter;
      const { t } = i18n.useTranslation();
      const TYPES = React12.useMemo(() => {
          ...
          ui.Flex,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "row", justify: "between", width: "100%", height: "20px", children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-sm oui-text-base-contrast-80", children: getStatusText(item.status) })
              ] }),
              /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-h-px oui-w-full oui-bg-base-6" }),
              /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "row", justify: "between", width: "100%", children: [
                /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", children: [
                  /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-2xs oui-text-base-contrast-36", children: t("common.token") }),
                  /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gapX: 2, children: [
                    /* @__PURE__ */ jsxRuntime.jsx(ui.TokenIcon, { name: item.token, size: "xs" }),
                    /* @__PURE__ */ jsxRuntime.jsx("span", { className: "oui-text-xs oui-text-base-contrast-80", children: item.token })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", children: [
                  /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-2xs oui-text-base-contrast-36", children: t("common.type") }),
                  /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-xs oui-text-base-contrast-80", children: getTypeText(item.type) })
                ] }),
                /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", children: [
                  /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-2xs oui-text-base-contrast-36", children: t("common.amount") }),
                  /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-xs oui-text-base-contrast-80", children: item.amount })
                ] })
              ] })
            ]
          }
...
var useDistributionHistoryHook;
var init_useDataSource_script2 = __esm({
...
var DistributionHistoryWidget;
var init_distribution_widget = __esm({
  "src/pages/overview/distribution/distribution.widget.tsx"() {
    init_distribution_ui();
    init_distribution_ui_mobile();
    init_useDataSource_script2();
    DistributionHistoryWidget = () => {
      const state = useDistributionHistoryHook();
      const { isMobile } = ui.useScreen();
      if (isMobile) {
        return /* @__PURE__ */ jsxRuntime.jsx(DistributionHistoryMobile, { ...state });
      }
      return /* @__PURE__ */ jsxRuntime.jsx(DistributionHistoryDesktop, { ...state });
    };
  }
});

// src/pages/overview/distribution/index.tsx
var distribution_exports = {};
__export(distribution_exports, {
  DistributionHistoryDesktop: () => DistributionHistoryDesktop,
  DistributionHistoryMobile: () => DistributionHistoryMobile,
  DistributionHistoryWidget: () => DistributionHistoryWidget
});
var init_distribution = __esm({
  "src/pages/overview/distribution/index.tsx"() {
    init_distribution_widget();
    init_distribution_ui_mobile();
    init_distribution_ui();
  }
});
        ...
        return [
          {
            ...
            render(val) {
              return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gapX: 2, children: [
                /* @__PURE__ */ jsxRuntime.jsx(ui.TokenIcon, { name: val, size: "xs" }),
                /* @__PURE__ */ jsxRuntime.jsx("span", { children: val })
              ] });
            }
          },
          {
          ...
          },
          {
            ...
            render(val) {
              ...
              return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { itemAlign: "start", py: 2, gap: 1, direction: "column", children: [
                /* @__PURE__ */ jsxRuntime.jsx(ui.Text.formatted, { onCopy, copyable: true, rule: "address", children: val }),
                /* @__PURE__ */ jsxRuntime.jsx(ui.Badge, { className: "oui-select-none", color: "neutral", size: "xs", children: isMainAccount ? t("common.mainAccount") : subAccount?.description || t("common.subAccount") })
              ] });
            }
          },
          {
...
var TransferHistoryUI;
var init_transfer_ui = __esm({
  "src/pages/overview/TransferHistory/transfer.ui.tsx"() {
    init_column4();
    TransferHistoryUI = (props) => {
      const {
        dataSource: dataSource2,
        queryParameter,
        state,
...
var useTransferHistoryHook;
var init_useDataSource_script3 = __esm({
  "src/pages/overview/TransferHistory/useDataSource.script.ts"() {
    init_date();
    init_transfer_ui();
      ...
      const filteredData = React12__default.default.useMemo(() => {
        return data.filter((item) => {
          ...
          if (selectedAccount === "Main accounts" /* MAIN */) {
            return item.from_account_id === state.mainAccountId || item.to_account_id === state.mainAccountId;
          } else {
            return item.from_account_id === selectedAccount || item.to_account_id === selectedAccount;
          }
        });
...
// src/pages/overview/TransferHistory/index.tsx
...
var init_TransferHistory = __esm({
  "src/pages/overview/TransferHistory/index.tsx"() {
    init_transfer_widget();
    init_transfer_ui();
  }
});
        ...
        return immer.produce(subAccounts, (draft) => {
          ...
          if (isMainAccount) {
            draft.unshift({
              ...
              children: Array.isArray(holding) && holding.length ? holding.map((item) => ({
                ...item,
                account_id: state.mainAccountId
              })) : [
                {
...
var isNumber, calculateTotalHolding, useAssetTotalValue;
var init_useAssetTotalValue = __esm({
  "src/hooks/useAssetTotalValue.ts"() {
    init_useAccountsData();
    isNumber = (val) => {
      return typeof val === "number" && !Number.isNaN(val);
    };
    calculateTotalHolding = (data, getIndexPrice) => {
      let total = new utils.Decimal(0);
        ...
        if (Array.isArray(item.holding)) {
          for (const hol of item.holding) {
            if (isNumber(hol.holding)) {
              ...
              total = total.plus(new utils.Decimal(hol.holding).mul(indexPrice));
            }
          }
        } else if (isNumber(item.holding) && "token" in item) {
          const indexPrice = getIndexPrice(item.token);
          total = total.plus(new utils.Decimal(item.holding).mul(indexPrice));
        }
      }
      return total;
    };
...
var init_assets_ui_desktop = __esm({
  "src/pages/assets/assetsPage/assets.ui.desktop.tsx"() {
    ...
    TotalValueInfo = (props) => {
      const { totalValue, visible, onToggleVisibility } = props;
      const { t } = i18n.useTranslation();
      const Icon = visible ? ui.EyeIcon : ui.EyeCloseIcon;
      return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", gap: 1, className: "oui-text-2xs", itemAlign: "start", children: [
        /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 1, justify: "start", itemAlign: "center", children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "2xs", color: "neutral", weight: "semibold", children: t("common.totalValue") }),
          /* @__PURE__ */ jsxRuntime.jsx("button", { onClick: onToggleVisibility, children: /* @__PURE__ */ jsxRuntime.jsx(Icon, { size: 18, className: ui.cn("oui-text-base-contrast-54") }) })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "start", itemAlign: "end", gap: 1, children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            ui.Text.numeral,
            {
              visible,
              weight: "bold",
              size: "2xl",
              className: ui.gradientTextVariants({ color: "brand" }),
              as: "div",
              padding: false,
              dp: 2,
              children: totalValue ?? "--"
    ...
    DepositAndWithdrawButton = (props) => {
      const { t } = i18n.useTranslation();
            ...
            /* @__PURE__ */ jsxRuntime.jsxs(
              ui.Button,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { children: t("common.deposit") })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntime.jsxs(
              ui.Button,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { children: t("common.withdraw") })
                ]
              }
            )
          ]
    ...
    AssetsDataTable = (props) => {
      const { columns, dataSource: dataSource2, dataTableClassNames, classNames } = props;
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { width: "100%", height: "100%", direction: "column", className: root, children: [
        ...
        dataSource2?.map((item, index) => {
          return /* @__PURE__ */ jsxRuntime.jsxs(
            ui.Flex,
            {
              className: ui.cn("oui-rounded-xl oui-bg-base-9 oui-p-6", scrollRoot),
              direction: "column",
              itemAlign: "start",
              justify: "between",
              my: 4,
              children: [
                /* @__PURE__ */ jsxRuntime.jsx(
                  ui.Text,
                  {
                    className: ui.cn("oui-mb-4", desc),
                    intensity: 98,
                    weight: "semibold",
                    size: "lg",
                    children: item?.description || ui.formatAddress(item?.id ?? "")
                  }
                ),
                /* @__PURE__ */ jsxRuntime.jsx(
                  uiConnector.AuthGuardDataTable,
        ...
        ui.Card,
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsxs(
            ui.Tabs,
            {
              ...
              size: "lg",
              children: [
                /* @__PURE__ */ jsxRuntime.jsxs(ui.TabPanel, { value: "assets", className: "", title: t("common.assets"), children: [
                  /* @__PURE__ */ jsxRuntime.jsxs(
                    ui.Flex,
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntime.jsx(
                          TotalValueInfo,
                          {
                            ...pick__default.default(["totalValue", "visible", "onToggleVisibility"], props)
                          }
                        ),
                        /* @__PURE__ */ jsxRuntime.jsx(
                          DepositAndWithdrawButton,
                          {
                            ...pick__default.default(["isMainAccount", "onDeposit", "onWithdraw"], props)
                          }
                        )
                      ]
                    }
                  ...
                  /* @__PURE__ */ jsxRuntime.jsx(
                    AssetsDataTable,
                    {
                      ...
                      classNames: {
                        scrollRoot: "oui-max-h-[700px] oui-overflow-y-auto oui-custom-scrollbar oui-w-full"
                      }
                    }
                  )
                ] }),
...
var init_useAccountFilter = __esm({
  "src/hooks/useAccountFilter.ts"() {
    init_assets_ui_desktop();
  }
});
var useAssetsAccountFilter, useAssetsMultiFilter;
var init_useAssetsAccountFilter = __esm({
  "src/hooks/useAssetsAccountFilter.ts"() {
    init_assets_ui_desktop();
    ...
    useAssetsMultiFilter = (data) => {
      ...
      const filteredData = React12.useMemo(() => {
        ...
        if (selectedAsset && selectedAsset !== "all") {
          accountFiltered = accountFiltered.map((account2) => {
            if (account2.children) {
              const filteredChildren = account2.children.filter(
                (child) => child.token === selectedAsset
              );
              return filteredChildren.length > 0 ? { ...account2, children: filteredChildren } : null;
            }
            return account2;
          }).filter(Boolean);
        }
...
var init_hooks = __esm({
  "src/hooks/index.ts"() {
    init_useAssetTotalValue();
    init_useAccountFilter();
    init_useAssetsAccountFilter();
    init_useAccountsData();
  }
});
var useConvertScript;
var init_convert_script = __esm({
  "src/pages/assets/convertPage/convert.script.ts"() {
    init_hooks();
    init_date();
    useConvertScript = () => {
      const { t } = i18n.useTranslation();
      ...
      const onFilter = React12__default.default.useCallback(
        (filter) => {
          const { name, value } = filter;
          if (name === "account") {
            onAccountFilter(filter);
          } else if (name === "status") {
            setStatusFilter(value);
            setPage(1);
          } else if (name === "converted_asset") {
            setConvertedAssetFilter(value);
            setPage(1);
          } else if (name === "time" || name === "dateRange") {
            setDateRange(
              parseDateRangeForFilter(value)
            );
            setPage(1);
          }
        },
      ...
      const { data, isLoading } = hooks.useSubAccountQuery(queryUrl, {
      ...
      const summary = React12.useMemo(() => {
        ...
        const totalFees = dataRows.reduce(
          (sum, record) => sum + record.details.reduce(
      ...
      return {
        // Data
        dataSource: data?.rows || types.EMPTY_LIST,
        summary,
        pagination,
...
var ConvertedAssetColumn, useConvertColumns, useConvertDetailColumns;
var init_convert_column = __esm({
  "src/pages/assets/convertPage/convert.column.tsx"() {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsxs(
                ui.Flex,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntime.jsx("div", { children: t("common.assets") }),
                    /* @__PURE__ */ jsxRuntime.jsx("div", { children: t("common.qty") })
                  ]
                }
              ),
              assets.map((asset) => /* @__PURE__ */ jsxRuntime.jsxs(
                ui.Flex,
                {
                  itemAlign: "center",
                  justify: "between",
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { itemAlign: "center", gap: 1, children: [
                      /* @__PURE__ */ jsxRuntime.jsx(ui.TokenIcon, { size: "xs", name: asset }),
                      /* @__PURE__ */ jsxRuntime.jsx(ui.Text.formatted, { children: asset })
                    ] }),
                    /* @__PURE__ */ jsxRuntime.jsx("div", { children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text.formatted, { children: convertedAssets[asset] }) })
                  ]
                },
                asset
              ))
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { itemAlign: "center", gap: 2, children: [
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-relative oui-flex", children: assets.slice(0, 3).map((asset, index) => /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(ui.TokenIcon, { size: "xs", name: asset })
          },
          asset
        )) }),
        /* @__PURE__ */ jsxRuntime.jsx(ui.Tooltip, { content: tooltipContent, children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Text.formatted, { className: "oui-cursor-pointer oui-underline oui-decoration-line-16 oui-decoration-dashed oui-underline-offset-4", children: [
        ...
        return [
          {
            ...
            width: 200,
            maxWidth: 200,
            render(convertedAssets) {
              return /* @__PURE__ */ jsxRuntime.jsx(ConvertedAssetColumn, { convertedAssets });
            }
          },
          {
            ...
            width: 150,
            render(qty) {
              return /* @__PURE__ */ jsxRuntime.jsx(ui.Text.numeral, { dp: 6, padding: false, children: qty });
            }
          },
          {
            title: t("common.fee"),
            ...
            render(details) {
              ...
              return /* @__PURE__ */ jsxRuntime.jsx(ui.Text.numeral, { dp: 6, padding: false, children: totalHaircut });
            }
          },
          {
            title: t("common.type"),
            ...
            width: 150,
            render(type) {
              return /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { children: type.charAt(0).toUpperCase() + type.slice(1) });
            }
          },
          {
            ...
            width: 150,
            render(convertId) {
              return /* @__PURE__ */ jsxRuntime.jsx(ui.Text.formatted, { onCopy, copyable: true, children: convertId });
            }
          },
          {
            title: t("common.time"),
          ...
          },
          {
            ...
            width: 150,
            render(status) {
              return /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { children: status.charAt(0).toUpperCase() + status.slice(1) });
            }
          },
          {
            title: "",
            ...
            render(convertId, record) {
              return /* @__PURE__ */ jsxRuntime.jsx(
                ui.Button,
                {
                  ...
                  children: t("portfolio.overview.column.convert.details")
                }
              );
            }
          }
        ...
        return [
          {
            ...
            render(asset) {
              return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { itemAlign: "center", gap: 2, children: [
                /* @__PURE__ */ jsxRuntime.jsx(ui.TokenIcon, { name: asset }),
                asset
              ] });
            }
          },
          ...
          },
          {
            ...
            width: 100,
            render(haircut) {
              return /* @__PURE__ */ jsxRuntime.jsx(ui.Text.numeral, { dp: 6, padding: false, children: haircut });
            }
          },
          {
            title: t("common.txId"),
          ...
          },
          {
            ...
            width: 150,
            render(venue, record) {
              return /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { children: options.chainsInfo.find(
          ...
          },
          {
            ...
            width: 100,
            render(result) {
              return /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { children: result?.charAt(0).toUpperCase() + result?.slice(1) });
            }
          }
        ];
      }, []);
  ...
  "src/pages/assets/convertPage/convert.ui.desktop.tsx"() {
        ...
        ui.SimpleDialog,
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx(
            ui.DataTable,
            {
              ...
              generatedRowKey: (record) => record.transaction_id || Math.random().toString()
            }
          )
        }
      );
    ...
    ConvertDesktopUI = ({
      ...
      const handleDetailsClick = (convertId) => {
        ...
        if (record) {
          ui.modal.show(ConvertDetailsModal, {
            record,
            indexPrices: convertState.indexPrices,
            chainsInfo: convertState.chainsInfo
          });
        }
      };
...
var ConvertMobileUI, ConvertMobileField, ConvertMobileItem, ConverHistoryItemDetailsDialog;
var init_convert_ui_mobile = __esm({
  "src/pages/assets/convertPage/convert.ui.mobile.tsx"() {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx(ui.Text.formatted, { rule, copyable, onCopy, children: value || "-" })
          ]
        }
      );
    };
    ConvertMobileItem = (props) => {
      const { item } = props;
      const { t } = i18n.useTranslation();
      if (!item) {
        return null;
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-flex oui-flex-col oui-gap-2 oui-rounded-xl oui-bg-base-9 oui-p-2", children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-flex oui-justify-between", children: [
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-flex oui-items-center oui-text-xs oui-font-semibold oui-text-base-contrast-80", children: [
            /* @__PURE__ */ jsxRuntime.jsx(ConvertedAssetColumn, { convertedAssets: item.converted_asset }),
            /* @__PURE__ */ jsxRuntime.jsx(
              "div",
              {
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-grid oui-grid-cols-3 oui-gap-2", children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            ConvertMobileField,
            {
          ...
          /* @__PURE__ */ jsxRuntime.jsx(ConvertMobileField, { label: t("common.fee"), value: totalHaircut }),
          /* @__PURE__ */ jsxRuntime.jsx(
            ConvertMobileField,
            {
    ...
    ConverHistoryItemDetailsDialog = ui.modal.create((props) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsx(
        ui.SimpleSheet,
        {
          ...
          open: visible,
          onOpenChange,
          children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-flex oui-h-[300px] oui-flex-col oui-gap-3 oui-overflow-y-auto oui-rounded-lg oui-bg-base-7 oui-p-2", children: item.details.map((detail, index) => /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-flex oui-flex-col oui-gap-2", children: [
              /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-flex oui-items-center oui-gap-1", children: [
                /* @__PURE__ */ jsxRuntime.jsx(ui.TokenIcon, { name: detail.converted_asset, size: "xs" }),
                /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-text-xs oui-text-base-contrast-80", children: detail.converted_asset })
              ] }),
              /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-grid oui-grid-cols-3 oui-gap-2", children: [
                /* @__PURE__ */ jsxRuntime.jsx(
                  ConvertMobileField,
                ...
                /* @__PURE__ */ jsxRuntime.jsx(ConvertMobileField, { label: "Fee", value: detail.haircut }),
                /* @__PURE__ */ jsxRuntime.jsx(
                  ConvertMobileField,
                  {
                    label: t("common.txId"),
                    ...
                    onClick: () => {
                      if (detail.tx_id) {
                        const chainInfo = chainsInfo.find(
                          (item2) => item2.chain_id == detail.chain_id
                        );
                        if (chainInfo?.explorer_base_url) {
                          window.open(
                ...
                /* @__PURE__ */ jsxRuntime.jsx(
                  ConvertMobileField,
                  {
                    ...
                    value: detail.result ? detail.result.charAt(0).toUpperCase() + detail.result.slice(1) : "-"
                  }
                )
              ] })
            ] }),
            index < item.details.length - 1 && /* @__PURE__ */ jsxRuntime.jsx(ui.Divider, {})
          ] })) })
        }
      );
    });
    ...
    HistoryDataGroupMobile = (props) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(
        ui.Tabs,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(ui.TabPanel, { title: t("common.deposits"), value: "deposit", children: /* @__PURE__ */ jsxRuntime.jsx(AssetHistoryWidget, { side: types.AssetHistorySideEnum.DEPOSIT }) }),
            /* @__PURE__ */ jsxRuntime.jsx(ui.TabPanel, { title: t("common.withdrawals"), value: "withdraw", children: /* @__PURE__ */ jsxRuntime.jsx(AssetHistoryWidget, { side: types.AssetHistorySideEnum.WITHDRAW }) }),
            /* @__PURE__ */ jsxRuntime.jsx(ui.TabPanel, { title: t("common.funding"), value: "funding", children: /* @__PURE__ */ jsxRuntime.jsx(FundingHistoryWidget, {}) }),
            /* @__PURE__ */ jsxRuntime.jsx(
              ui.TabPanel,
              {
                title: t("portfolio.overview.distribution"),
            ...
            /* @__PURE__ */ jsxRuntime.jsx(
              ui.TabPanel,
              {
                title: t("portfolio.overview.tab.convert.history"),
                value: "convert",
                children: /* @__PURE__ */ jsxRuntime.jsx(ConvertHistoryWidget, {})
              }
            ),
            /* @__PURE__ */ jsxRuntime.jsx(ui.TabPanel, { title: t("common.vaults"), value: "vaults", children: /* @__PURE__ */ jsxRuntime.jsx(VaultsHistoryWidget, {}) })
          ]
        }
      );
    };
...
var HistoryDataGroupWidget;
var init_historyDataGroup_widget = __esm({
  "src/pages/overview/historyDataGroup/historyDataGroup.widget.tsx"() {
    init_historyDataGroup_script();
    init_historyDataGroup_ui_desktop();
    init_historyDataGroup_ui_mobile();
    HistoryDataGroupWidget = () => {
      const state = useHistoryDataGroupScript();
      const { isMobile } = ui.useScreen();
      if (isMobile) {
        return /* @__PURE__ */ jsxRuntime.jsx(HistoryDataGroupMobile, { ...state });
      }
      return /* @__PURE__ */ jsxRuntime.jsx(HistoryDataGroupDesktop, { ...state });
    };
  }
});

// src/pages/overview/historyDataGroup/index.ts
var historyDataGroup_exports = {};
__export(historyDataGroup_exports, {
  HistoryDataGroupWidget: () => HistoryDataGroupWidget
});
var init_historyDataGroup = __esm({
  "src/pages/overview/historyDataGroup/index.ts"() {
    init_historyDataGroup_widget();
  }
});
...
var useAssetsChartScript;
var init_assetsChart_script = __esm({
  "src/pages/overview/assetChart/assetsChart.script.ts"() {
    init_overviewContext();
    useAssetsChartScript = () => {
      const assetHistory = useOverviewContext();
      const { wrongNetwork, disabledConnect } = reactApp.useAppContext();
      const { state } = hooks.useAccount();
      const filteredData = reactApp.useDataTap(assetHistory.data, {
        accountStatus: state.status === types.AccountStatusEnum.EnableTradingWithoutConnected ? types.AccountStatusEnum.EnableTradingWithoutConnected : types.AccountStatusEnum.EnableTrading,
      ...
      const invisible = wrongNetwork || disabledConnect || !assetHistory.data.length;
      return {
        ...assetHistory,
        data: _data,
        invisible
...
function getUTCStr(date) {
  const year = date.getUTCFullYear();
  const month = `0${date.getUTCMonth() + 1}`.slice(-2);
  const day = `0${date.getUTCDate()}`.slice(-2);
  return `${year}-${month}-${day}`;
}
var PeriodType, useAssetsHistoryData;
var init_useAssetHistory = __esm({
  "src/pages/overview/shared/useAssetHistory.ts"() {
    PeriodType = /* @__PURE__ */ ((PeriodType2) => {
      PeriodType2["WEEK"] = "7D";
      PeriodType2["MONTH"] = "30D";
      PeriodType2["QUARTER"] = "90D";
      return PeriodType2;
    })(PeriodType || {});
    useAssetsHistoryData = (localKey2, options) => {
      ...
      const [period, setPeriod] = hooks.useLocalStorage(
        localKey2,
        "7D" /* WEEK */
      );
      const convertToUSDCAndOperate = React12.useCallback(
        (inputs) => {
          ...
          if (token.toUpperCase() === "USDC") {
            ...
            if (indexPrice) {
              const delta = new utils.Decimal(amount).mul(indexPrice);
      ...
      const periodLabel = React12.useMemo(() => {
        return {
          ...
          ["90D" /* QUARTER */]: t("common.select.90d")
        };
      }, [t]);
      const { totalValue } = hooks.useCollateral();
      const getStartDate = (value) => {
        switch (value) {
          case "30D" /* MONTH */:
            return dateFns.subDays(today, 35);
          case "90D" /* QUARTER */:
            return dateFns.subDays(today, 95);
          default:
      ...
      const { data: transferInHistory, mutate: mutateTransferIn } = hooks.usePrivateQuery(
        `/v1/internal_transfer_history?page=1&size=200&side=IN&start_t=${startDate.getTime()}&end_t=${endDate.getTime()}`,
        {
          revalidateOnFocus: false
        }
      );
      const [data] = hooks.useStatisticsDaily(
        {
      ...
      const refreshTransferHistory = React12.useCallback(() => {
        ...
        mutateTransferOut?.(void 0, true);
        mutateTransferIn?.(void 0, true);
      }, [mutateTransferOut, mutateTransferIn]);
      hooks.useBalanceTopic({
        onMessage: () => {
          refreshTransferHistory();
        }
      });
      const [assetHistory] = hooks.useAssetsHistory({
        startTime: dateFns.subDays(today, 2).getTime(),
        endTime: endDate.getTime(),
        pageSize: 50
      });
      const [allDepositHistory] = hooks.useAssetsHistory({
        side: "DEPOSIT",
        startTime: dateFns.subDays(today, periodValue).getTime(),
        endTime: endDate.getTime(),
        pageSize: 200
      });
      ...
      const totalTransferInForROI = React12.useMemo(() => {
        ...
        return transferInHistory?.filter((item) => item.status === "COMPLETED").reduce((acc, item) => {
          return acc.add(
            convertToUSDCAndOperate({
              token: item.token,
              amount: item.amount,
      ...
      const totalTransferIn = React12.useMemo(() => {
        ...
        if (lastItem == null || transferInHistory?.length === 0 || typeof lastItem.snapshot_time === "undefined") {
          return utils.zero;
        }
        const list = transferInHistory?.filter((item) => {
          return item.status === "COMPLETED" && item.created_time > lastItem?.snapshot_time;
        });
      ...
      const totalTransferOut = React12.useMemo(() => {
        ...
        if (lastItem == null || transferOutHistory?.length === 0 || typeof lastItem.snapshot_time === "undefined") {
          return utils.zero;
        }
      ...
      const calculateLastPnl = (inputs) => {
        ...
        let value = new utils.Decimal(totalValue).sub(inputs.lastItem.account_value);
        if (Array.isArray(inputs.assetHistory) && inputs.assetHistory.length > 0 && typeof inputs.lastItem.snapshot_time !== "undefined") {
          const list = [];
      ...
      const mergeData = (data2, totalValue2, totalTransferIn2, totalTransferOut2) => {
        ...
        if (data2[data2.length - 1].date === getUTCStr(today)) {
          return data2;
        }
        return data2.concat([
...
// src/pages/overview/shared/periodHeader.tsx
var periodHeader_exports = {};
__export(periodHeader_exports, {
  PeriodTitle: () => PeriodTitle
});
var PeriodTitle;
var init_periodHeader = __esm({
  "src/pages/overview/shared/periodHeader.tsx"() {
    ...
    PeriodTitle = (props) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { itemAlign: "center", justify: "between", children: [
        /* @__PURE__ */ jsxRuntime.jsx(ui.CardTitle, { children: props.title }),
...
var AssetsChartWidget;
var init_assetsChart_widget = __esm({
  "src/pages/overview/assetChart/assetsChart.widget.tsx"() {
    init_assetsChart_script();
    init_assetsChart_ui();
    AssetsChartWidget = () => {
      const state = useAssetsChartScript();
      return /* @__PURE__ */ jsxRuntime.jsx(AssetsChart, { ...state });
    };
  }
});

// src/pages/overview/assetChart/index.ts
var assetChart_exports = {};
__export(assetChart_exports, {
  AssetsChart: () => AssetsChart,
  AssetsChartWidget: () => AssetsChartWidget,
  useAssetsChartScript: () => useAssetsChartScript
});
var init_assetChart = __esm({
  "src/pages/overview/assetChart/index.ts"() {
    init_assetsChart_widget();
    init_assetsChart_script();
    init_assetsChart_ui();
  }
});
  ...
  "src/pages/overview/performance/performance.ui.tsx"() {
    ...
    PerformanceUI = (props) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(
        ui.Card,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsxs(ui.Grid, { cols: 3, gap: 4, children: [
              /* @__PURE__ */ jsxRuntime.jsx(
                ui.Box,
                {
                  gradient: "neutral",
                  ...
                  children: /* @__PURE__ */ jsxRuntime.jsx(
                    ui.Statistic,
                    {
                      ...
                      children: invisible ? "--" : aggregateValue.roi
                    }
                  )
                }
              ),
                ...
                ui.Box,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntime.jsx(
                    ui.Statistic,
                    {
                      ...
                      children: invisible ? "--" : aggregateValue.pnl
                    }
                  )
                }
              ),
                ...
                ui.Box,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntime.jsx(
                    ui.Statistic,
                    {
                      ...
                      label: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "between", children: [
        ...
        ui.Tooltip,
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx(
            ui.Text,
            {
              ...
              intensity: 36,
              className: ui.cn(
                hint && "oui-cursor-pointer oui-border-b oui-border-dashed oui-border-line-12"
              ),
              children: label
            }
          )
    ...
    CumulativePnlChart = (props) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(ui.Box, { mt: 4, children: [
        /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { as: "div", size: "sm", className: "oui-mb-3", children: t("portfolio.overview.performance.cumulativePnl") }),
        /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { r: "md", className: "oui-h-[188px] oui-border oui-border-line-4", children: /* @__PURE__ */ jsxRuntime.jsx(
          chart.PnlAreaChart,
          {
            data: props.data,
...
// src/pages/assets/type.ts
var ORDERLY_ASSETS_VISIBLE_KEY;
var init_type = __esm({
  "src/pages/assets/type.ts"() {
    ORDERLY_ASSETS_VISIBLE_KEY = "orderly_assets_visible";
  }
});
var usePerformanceScript;
var init_performance_script = __esm({
  "src/pages/overview/performance/performance.script.ts"() {
    init_type();
    init_overviewContext();
    usePerformanceScript = () => {
      ...
      const { wrongNetwork, disabledConnect } = reactApp.useAppContext();
      const { state } = hooks.useAccount();
      const filteredData = reactApp.useDataTap(ctx?.data, {
        accountStatus: state.status === types.AccountStatusEnum.EnableTradingWithoutConnected ? types.AccountStatusEnum.EnableTradingWithoutConnected : types.AccountStatusEnum.EnableTrading,
      ...
      const invisible = wrongNetwork || disabledConnect || state.status < types.AccountStatusEnum.EnableTrading && state.status !== types.AccountStatusEnum.EnableTradingWithoutConnected;
      return {
        ...ctx,
        data: _data,
        invisible,
...
var init_performance_widget = __esm({
  "src/pages/overview/performance/performance.widget.tsx"() {
    init_performance_script();
    init_performance_ui();
    PerformanceWidget = () => {
      const state = usePerformanceScript();
      return /* @__PURE__ */ jsxRuntime.jsx(PerformanceUI, { ...state });
    };
  }
});

// src/pages/overview/performance/index.ts
var performance_exports = {};
__export(performance_exports, {
  PerformanceUI: () => PerformanceUI,
  PerformanceWidget: () => PerformanceWidget,
  usePerformanceScript: () => usePerformanceScript
});
var init_performance = __esm({
  "src/pages/overview/performance/index.ts"() {
    init_performance_ui();
    init_performance_widget();
    init_performance_script();
  }
});
var EffectiveFee;
...
// src/pages/feeTier/icons/index.ts
...
var feeTierHeader_exports = {};
__export(feeTierHeader_exports, {
  DesktopHeaderItem: () => DesktopHeaderItem,
...
var useApiManagerScript;
var init_apiManager_script = __esm({
  "src/pages/api/apiManager.script.tsx"() {
    useApiManagerScript = (props) => {
      ...
      const { t } = i18n.useTranslation();
      const canCreateApiKey = !wrongNetwork && !disabledConnect && (state.status === types.AccountStatusEnum.EnableTrading || state.status === types.AccountStatusEnum.EnableTradingWithoutConnected);
      const [
        keys,
        {
          generateOrderlyKey,
      ...
      const doCreate = async (ipRestriction, scope) => {
        try {
          const createdSuccess = (res2, ip) => {
            const { key, secretKey } = res2;
            hideCreateDialog();
            setGenerateKey({
              key,
              screctKey: secretKey,
          ...
          if ((ipRestriction?.length || 0) > 0) {
            ...
            const res2 = await setIPRestriction(key, ipRestriction);
            if (res2.success) {
              createdSuccess(
                generateKeyRes,
                res2.data.ip_restriction_list?.join(",")
              );
            }
          } else {
      ...
      const onCopyApiKeyInfo = () => {
        ...
        ui.toast.success(t("portfolio.apiKey.apiInfo.copied"));
      };
      const doConfirm = () => {
        hideCreatedDialog();
      };
      const doDelete = (item) => {
        return new Promise(async (resolve) => {
          await removeOrderlyKey(item.orderly_key).then(
            async (data) => {
              if (data?.success) {
                ui.toast.success(t("portfolio.apiKey.deleted"));
                refresh();
                const curKey = await account2.keyStore.getOrderlyKey()?.getPublicKey();
                if (item.orderly_key === curKey) {
                  account2.destroyOrderlyKey();
                }
              }
              resolve(1);
            },
      ...
      const doEdit = async (item, ip) => {
        ...
        if (data.success) {
          ui.toast.success(t("portfolio.apiKey.updated"));
          refresh();
      ...
      const onCopyAccountId = () => ui.toast.success(t("portfolio.apiKey.accountId.copied"));
      const onCopyApiKey = (key) => {
        ui.toast.success(t("portfolio.apiKey.column.apiKey.copy"));
      };
      ...
      const verifyIP = (ip) => {
        ...
        return ipRegex.test(ip) ? "" : "The IP restriction format is incorrect. Please use the correct format: [xx.xx.xxx.x],[xx.xxx.xxx.xxx]";
      };
      const accountStatus = state.status === types.AccountStatusEnum.EnableTradingWithoutConnected ? types.AccountStatusEnum.EnableTradingWithoutConnected : types.AccountStatusEnum.EnableTrading;
      const accountId = reactApp.useDataTap(state.accountId, {
        accountStatus
      });
      const userId = reactApp.useDataTap(state.userId, {
        accountStatus
      });
      const { pagination } = ui.usePagination();
      return {
        accountId: accountId ?? "--",
        userId: userId ?? "--",
        onCreateApiKey,
...
var createApiKey_exports = {};
__export(createApiKey_exports, {
  Checkbox: () => Checkbox,
  CreateAPIKeyDialog: () => CreateAPIKeyDialog
});
var CreateAPIKeyDialog, Checkbox;
        ...
        ui.SimpleDialog,
        {
          ...
          actions: {
            primary: {
              ...
              onClick: async () => {
                if (ipText.length > 0) {
                  const hint2 = props.verifyIP(ipText);
                  setHint(hint2);
                  if (hint2.length > 0) {
                    return;
                  }
          ...
          classNames: {
            ...
            content: "oui-bg-base-8 oui-w-[300px] lg:oui-w-[360px] oui-font-semibold"
          },
          children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", gap: 6, children: [
            /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", gap: 1, width: "100%", itemAlign: "start", children: [
              /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 54, size: "2xs", children: t("portfolio.apiKey.create.ipRestriction") }),
              /* @__PURE__ */ jsxRuntime.jsx(
                "textarea",
                {
              ...
              hint.length > 0 && /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 1, className: "oui-relative", children: [
                /* @__PURE__ */ jsxRuntime.jsx(
                  "div",
                  {
                    className: ui.cn(
            ...
            /* @__PURE__ */ jsxRuntime.jsx(
              ui.Statistic,
              {
                label: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "xs", intensity: 54, children: t("portfolio.apiKey.permissions") }),
                className: "oui-w-full",
                children: /* @__PURE__ */ jsxRuntime.jsxs(
                  ui.Flex,
                  {
    ...
    Checkbox = (props) => {
      return /* @__PURE__ */ jsxRuntime.jsxs(
        "button",
        {
          ...
          className: "oui-flex oui-items-center oui-gap-2 disabled:oui-cursor-not-allowed disabled:oui-opacity-50",
...
// src/pages/api/dialog/createdApiKey.tsx
var createdApiKey_exports = {};
__export(createdApiKey_exports, {
  CreatedAPIKeyDialog: () => CreatedAPIKeyDialog
});
var CreatedAPIKeyDialog;
var init_createdApiKey = __esm({
  "src/pages/api/dialog/createdApiKey.tsx"() {
        ...
        ui.SimpleDialog,
        {
          ...
          actions: {
            ...
            secondary: {
              ...
              className: "oui-w-[120px] lg:oui-w-[154px] oui-bg-primary-darken hover:oui-opacity-80",
              size: "md",
              onClick: async () => {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", gap: 4, itemAlign: "start", children: [
            /* @__PURE__ */ jsxRuntime.jsx(ui.Statistic, { label: t("common.accountId"), children: /* @__PURE__ */ jsxRuntime.jsx(
              ui.Text.formatted,
              {
                size: "sm",
                intensity: 80,
                ...
                children: props.accountId
              }
            ) }),
            /* @__PURE__ */ jsxRuntime.jsx(ui.Statistic, { label: t("portfolio.apiKey.column.apiKey"), children: /* @__PURE__ */ jsxRuntime.jsx(
              ui.Text.formatted,
              {
                size: "sm",
                intensity: 80,
                ...
                "data-testid": "oui-testid-apiKey-createdApiKey-dialog-key-span",
                children: props.generateKey?.key
              }
            ) }),
            /* @__PURE__ */ jsxRuntime.jsxs(ui.Statistic, { label: t("portfolio.apiKey.secretKey"), children: [
              /* @__PURE__ */ jsxRuntime.jsx(
                ui.Text.formatted,
                {
                  size: "sm",
            ...
            /* @__PURE__ */ jsxRuntime.jsx(ui.Statistic, { label: t("portfolio.apiKey.ip"), children: /* @__PURE__ */ jsxRuntime.jsxs(
              ui.Flex,
              {
                width: 320,
                gap: 1,
                ...
                children: [
                  /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { className: "oui-max-h-[100px] oui-flex-1 oui-overflow-hidden oui-text-ellipsis oui-line-clamp-5 oui-break-all", children: ip }),
                  ip !== "--" && /* @__PURE__ */ jsxRuntime.jsx(
                    ui.Box,
                    {
                      width: 16,
                      height: 16,
            ...
            /* @__PURE__ */ jsxRuntime.jsx(ui.Statistic, { label: t("portfolio.apiKey.permissions"), children: /* @__PURE__ */ jsxRuntime.jsx(
              ui.Text,
              {
                size: "sm",
                intensity: 80,
                "data-testid": "oui-testid-apiKey-createdApiKey-dialog-permissions-span",
                children: props.generateKey?.permissions
              }
            ) }),
            /* @__PURE__ */ jsxRuntime.jsx("div", {}),
            /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { color: "warning", size: "xs", className: "oui-text-center", children: t("portfolio.apiKey.created.warning") })
          ] })
        }
      );
    };
...
// src/pages/api/dialog/deleteApiKey.tsx
var deleteApiKey_exports = {};
__export(deleteApiKey_exports, {
  DeleteAPIKeyDialog: () => DeleteAPIKeyDialog
});
var DeleteAPIKeyDialog;
var init_deleteApiKey = __esm({
  "src/pages/api/dialog/deleteApiKey.tsx"() {
    init_apiManager_ui();
    DeleteAPIKeyDialog = (props) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsx(
        ui.SimpleDialog,
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { className: "oui-text-xs", children: /* @__PURE__ */ jsxRuntime.jsx(
            i18n.Trans,
            {
              i18nKey: "portfolio.apiKey.delete.dialog.description",
              values: { apiKey: formatKey(item?.orderly_key) },
              components: [/* @__PURE__ */ jsxRuntime.jsx(ui.Text, { color: "primary", className: "oui-px-1" })]
            }
          ) })
        }
      );
...
// src/pages/api/dialog/editApiKey.tsx
var editApiKey_exports = {};
__export(editApiKey_exports, {
  EditAPIKeyDialog: () => EditAPIKeyDialog
});
var EditAPIKeyDialog;
var init_editApiKey = __esm({
  "src/pages/api/dialog/editApiKey.tsx"() {
    init_createApiKey();
...
var LazyCreateAPIKeyDialog, LazyCreatedAPIKeyDialog, LazyDeleteAPIKeyDialog, LazyEditAPIKeyDialog, APIManager, AccountInfo, Subtitle, KeyList, EditButton, DeleteButton;
            ...
            /* @__PURE__ */ jsxRuntime.jsxs(
              ui.Flex,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntime.jsx(Subtitle, { ...props })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsxs(
              ui.Flex,
              {
                ...
                className: "oui-w-1/2",
                children: [
                  /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "xs", intensity: 36, children: t("common.accountId") }),
                  /* @__PURE__ */ jsxRuntime.jsx(
                    ui.Text.formatted,
                    {
                      size: "base",
            ...
            /* @__PURE__ */ jsxRuntime.jsxs(
              ui.Flex,
              {
                ...
                className: "oui-w-1/2",
                children: [
                  /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "xs", intensity: 36, children: t("portfolio.apiKey.uid") }),
                  /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "base", inlist: 80, children: props.userId })
                ]
              }
            )
          ]
    ...
    Subtitle = (props) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(
        ui.Flex,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", itemAlign: "start", width: "100%", gap: 1, children: [
              /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 54, children: t("portfolio.apiKey.description") }),
              /* @__PURE__ */ jsxRuntime.jsxs(
                ui.Flex,
                {
                  itemAlign: "center",
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { children: t("portfolio.apiKey.readApiGuide") }),
                    /* @__PURE__ */ jsxRuntime.jsx(
                      "svg",
                      {
                        width: "16",
    ...
    KeyList = (props) => {
      ...
      const columns = [
        ...
        },
        {
          ...
          dataIndex: "scope",
          render: (value) => value?.split(",").map((e) => capitalizeFirstChar(`${e}`)).join(", ")
        },
        {
          ...
          render: (value) => {
            ...
            return /* @__PURE__ */ jsxRuntime.jsx(ui.Tooltip, { content: ip, className: "oui-max-w-[200px] oui-break-all", children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 1, children: [
              /* @__PURE__ */ jsxRuntime.jsx("div", { className: " oui-overflow-ellipsis oui-overflow-hidden", children: ip }),
              ip !== "--" && /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { width: 16, height: 16, className: "oui-cursor-pointer", children: /* @__PURE__ */ jsxRuntime.jsx(
                ui.CopyIcon,
                {
                  color: "white",
                  opacity: 0.54,
        ...
        },
        {
          ...
          render: (value) => /* @__PURE__ */ jsxRuntime.jsx(ui.Text.formatted, { rule: "date", formatString: "yyyy-MM-dd", children: value })
        },
        {
          title: "",
          type: "action",
          ...
          width: 120,
          render: (_, item) => {
            return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "row", gap: 2, children: [
              /* @__PURE__ */ jsxRuntime.jsx(
                EditButton,
                {
                  item,
              ...
              /* @__PURE__ */ jsxRuntime.jsx(DeleteButton, { item, onDelete: props.doDelete })
            ] });
          }
        }
      ];
      return /* @__PURE__ */ jsxRuntime.jsx(
        uiConnector.AuthGuardDataTable,
        {
          ...
          emptyView: /* @__PURE__ */ jsxRuntime.jsx(uiConnector.AuthGuardEmpty, {}),
          pagination: props.pagination,
...
var PortfolioLeftSidebarPath = /* @__PURE__ */ ((PortfolioLeftSidebarPath2) => {
  PortfolioLeftSidebarPath2["Overview"] = "/portfolio";
  PortfolioLeftSidebarPath2["Positions"] = "/portfolio/positions";
  PortfolioLeftSidebarPath2["Orders"] = "/portfolio/orders";
  PortfolioLeftSidebarPath2["Assets"] = "/portfolio/assets";
  PortfolioLeftSidebarPath2["FeeTier"] = "/portfolio/feeTier";
  PortfolioLeftSidebarPath2["ApiKey"] = "/portfolio/apiKey";
  PortfolioLeftSidebarPath2["Setting"] = "/portfolio/setting";
  PortfolioLeftSidebarPath2["History"] = "/portfolio/history";
  return PortfolioLeftSidebarPath2;
  ...
  const items = React12.useMemo(() => {
    return [
      ...
      },
      {
        ...
        href: "/portfolio/positions" /* Positions */,
        icon: /* @__PURE__ */ jsxRuntime.jsx(
          "svg",
          {
            width: "18",
      ...
      },
      {
        ...
        href: "/portfolio/feeTier" /* FeeTier */,
        icon: /* @__PURE__ */ jsxRuntime.jsx(
          "svg",
          {
            width: "18",
      ...
      },
      {
        ...
        href: "/portfolio/setting" /* Setting */,
        icon: /* @__PURE__ */ jsxRuntime.jsx(
          "svg",
          {
            width: "18",
      ...
      },
      {
        ...
        href: "/portfolio/history" /* History */,
        hide: true
      }
    ];
  }, [t]);
...
var PortfolioLayout = (props) => {
  const { children, leftSideProps, classNames, ...rest } = props;
  return /* @__PURE__ */ jsxRuntime.jsx(
    uiScaffold.Scaffold,
    {
      leftSidebar: props.hideSideBar ? null : /* @__PURE__ */ jsxRuntime.jsx(
        LeftSidebar,
        {
      ...
      classNames: {
        ...classNames,
        content: ui.cn("oui-my-6 oui-px-3", classNames?.content),
        topNavbar: ui.cn("oui-bg-base-9", classNames?.topNavbar),
        leftSidebar: ui.cn(
...
var LeftSidebar = (props) => {
  const { expanded, setExpand } = uiScaffold.useScaffoldContext();
  const { t } = i18n.useTranslation();
  return /* @__PURE__ */ jsxRuntime.jsx(
    uiScaffold.SideBar,
    {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(LayoutProvider, { ...props, children: /* @__PURE__ */ jsxRuntime.jsxs(
    ui.Flex,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { className: "oui-scaffold-container oui-min-h-[calc(100vh-44px-64px-env(safe-area-inset-bottom))] oui-w-full", children: props.children }),
...
var PortfolioLayoutWidget = (props) => {
  const state = usePortfolioLayoutScript({
    current: props.leftSideProps?.current
  });
  const { isMobile } = ui.useScreen();
  return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: isMobile ? (
    // @ts-ignore
    /* @__PURE__ */ jsxRuntime.jsx(PortfolioLayoutMobile, { ...state, ...props })
  ) : /* @__PURE__ */ jsxRuntime.jsx(PortfolioLayout, { ...state, ...props }) });
};
...
__export(overview_exports, {
  ...
  PerformanceMobileDialogId: () => PerformanceMobileDialogId,
  PerformanceMobileSheetId: () => PerformanceMobileSheetId,
  PerformanceMobileUI: () => PerformanceMobileUI,
  PerformanceMobileWidget: () => PerformanceMobileWidget,
  PerformanceUI: () => PerformanceUI,
  PerformanceWidget: () => PerformanceWidget,
  useAssetHistoryColumns: () => useAssetHistoryColumns,
  useAssetHistoryScript: () => useAssetHistoryScript,
...
init_assets();
init_historyDataGroup();
init_assetChart();
init_assetHistory();
init_performance();

// src/pages/overview/performanceMobileDialog/performance.ui.tsx
init_useAssetHistory();
var responsiveProps = {
  width: "100%",
  minHeight: 144,
...
var PerformanceMobileUI = (props) => {
  ...
  const mergedData = data.length ? data : createFakeData?.(
    { account_value: 0, pnl: 0 },
    { account_value: 500, pnl: 500 }
  );
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "between", itemAlign: "center", gap: 2, my: 4, children: [
      /* @__PURE__ */ jsxRuntime.jsxs(
        ui.Flex,
        {
          gap: 1,
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-truncate", intensity: 36, size: "2xs", children: t("portfolio.overview.performance.roi", { period: curPeriod }) }),
            /* @__PURE__ */ jsxRuntime.jsx(ui.Text.numeral, { size: "sm", visible, rule: "percentages", coloring: true, children: invisible ? "--" : aggregateValue.roi })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntime.jsxs(
        ui.Flex,
        {
          ...
          className: "oui-w-1/3 oui-rounded-lg oui-bg-base-7 oui-px-2 oui-py-1.5",
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-truncate", intensity: 36, size: "2xs", children: t("portfolio.overview.performance.pnl", { period: curPeriod }) }),
            /* @__PURE__ */ jsxRuntime.jsx(ui.Text.numeral, { size: "sm", visible, coloring: true, showIdentifier: true, children: invisible ? "--" : aggregateValue.pnl })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntime.jsxs(
        ui.Flex,
        {
          ...
          className: "oui-w-1/3 oui-rounded-lg oui-bg-base-7 oui-px-2 oui-py-1.5",
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-truncate", intensity: 36, size: "2xs", children: t("portfolio.overview.performance.volume", { period: curPeriod }) }),
            /* @__PURE__ */ jsxRuntime.jsx(ui.Text.numeral, { size: "sm", visible, coloring: false, children: invisible ? "--" : aggregateValue.vol })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntime.jsxs(ui.Tabs, { defaultValue: "dailyPnl", children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        ui.TabPanel,
        {
          value: "dailyPnl",
...
// src/pages/overview/mobile/useRewardsData.script.ts
init_overviewContext();
var useRewardsData = ({ type = hooks.TWType.normal }) => {
  const totalOrderClaimedReward = hooks.useGetClaimed(
    type === hooks.TWType.mm ? hooks.DistributionId.mmOrder : hooks.DistributionId.order
  );
  const [curEpochEstimate] = hooks.useCurEpochEstimate(type);
  const [brokers] = hooks.useAllBrokers();
  const { state } = hooks.useAccount();
  const { data, mutate } = hooks.usePrivateQuery(
    "/v1/referral/info",
    { revalidateOnFocus: true, errorRetryCount: 3, ...hooks.noCacheConfig }
  );
...
var useRewardsDataScript = () => {
  ...
  const isSignIn = state.status === types.AccountStatusEnum.EnableTrading || state.status === types.AccountStatusEnum.EnableTradingWithoutConnected;
  return {
    totalOrderClaimedReward,
    curEpochEstimate,
    epochList,
...
// src/pages/overview/provider/overviewProvider.tsx
init_useAssetHistory();
init_overviewContext();
var localKey = "portfolio_performance_period";
var OverviewProvider = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(OverviewContext.Provider, { value: memoizedValue, children });
};

// src/pages/overview/performanceMobileDialog/performance.widget.tsx
init_useAssetHistory();
var PerformanceMobileWidget = () => {
  const state = useAssetsHistoryData(localKey, { isRealtime: true });
...
var PerformanceMobileSheetId = "PerformanceMobileSheetId";
var PerformanceMobileDialogId = "PerformanceMobileDialogId";
ui.registerSimpleSheet(PerformanceMobileSheetId, PerformanceMobileWidget, {
  title: () => i18n.i18n.t("portfolio.overview.performance")
});
ui.registerSimpleDialog(PerformanceMobileDialogId, PerformanceMobileWidget, {
  title: () => i18n.i18n.t("portfolio.overview.performance"),
  classNames: {
    content: "oui-w-[420px]"
  }
...
var PortfolioChartsMobileWidget = () => {
  const { data, invisible } = useAssetsChartScript();
  const state = usePortfolioChartsState();
  return /* @__PURE__ */ jsxRuntime.jsx(
    PortfolioChartsMobileUI,
    {
      data: data || types.EMPTY_LIST,
      invisible,
      ...state
    }
  );
};
var useCurrentStatus = () => {
  const { state, account: account2 } = hooks.useAccount();
  const { wrongNetwork, disabledConnect, connectWallet } = reactApp.useAppContext();
  const { t } = i18n.useTranslation();
  const statusText = {
    wrongNetwork: {
...
function EVMChainPopover({ children }) {
  const [chains] = hooks.useChains("mainnet", {
    pick: "network_infos"
  });
  const { t } = i18n.useTranslation();
  const showDialog = () => {
    ui.modal.dialog({
      ...
      size: "xs",
      content: /* @__PURE__ */ jsxRuntime.jsx("div", { children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-p-1 oui-grid oui-grid-cols-2 oui-gap-x-2 oui-gap-y-3 oui-text-2xs oui-text-base-contrast-54", children: chains.map((item, key) => /* @__PURE__ */ jsxRuntime.jsxs(
        "div",
        {
          className: "oui-flex oui-items-center oui-justify-start oui-gap-1",
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(ui.ChainIcon, { chainId: item.chain_id, size: "2xs" }),
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("button", { onClick: showDialog, children });
}
...
var EVMChains = () => {
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-relative oui-flex oui-items-center oui-justify-center", children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-relative oui-left-[-9px] oui-flex oui-items-center oui-justify-center oui-gap-1", children: [
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-flex oui-size-[18px] oui-items-center oui-justify-center oui-rounded-full oui-bg-[#282e3a]", children: /* @__PURE__ */ jsxRuntime.jsx(EVMChainPopover, { children: /* @__PURE__ */ jsxRuntime.jsx(
        MoreIcon,
        {
      ...
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-text-2xs oui-font-semibold oui-text-base-contrast", children: "Evm" })
    ] })
  ] });
};
var ShowAccount = () => {
  ...
  const leftNode = React12.useMemo(() => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { className: "oui-text-base oui-text-base-contrast", gapX: 2, children: [
      ui.formatAddress(state.address ?? ""),
      /* @__PURE__ */ jsxRuntime.jsx(
        "button",
        {
  ...
  const rightNode = React12.useMemo(() => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gapX: 1, itemAlign: "center", className: "oui-text-2xs", children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        "img",
        {
...
var AccountStatusMobile = () => {
  ...
  const alreadyShowAccount = React12.useMemo(() => {
    ...
    return state.status >= types.AccountStatusEnum.EnableTrading;
  }, [state.status, wrongNetwork]);
  if (alreadyShowAccount) {
    return /* @__PURE__ */ jsxRuntime.jsx(ShowAccount, {});
  }
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
...
function getLinkDeviceStorage() {
  try {
    ...
    const json = linkDeviceStorage ? hooks.parseJSON(linkDeviceStorage) : null;
    return json;
  } catch (err) {
  }
}
...
var AffiliateCardMobile = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    ui.Flex,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { className: "oui-w-full oui-flex-row oui-justify-between oui-items-center", children: [
          /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { className: "oui-flex-col oui-items-start", children: [
            /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-base-contrast oui-text-base oui-font-semibold", children: t("affiliate.asAffiliate.affilates") }),
            /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-2xs oui-font-normal oui-text-base-contrast-54", children: t("affiliate.commission") })
          ] }),
          /* @__PURE__ */ jsxRuntime.jsx(ui.AffiliateIcon, {})
        ] }),
        /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { className: "oui-mt-auto oui-w-full oui-flex-row oui-items-center oui-gap-1", children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            "img",
            {
          ...
          /* @__PURE__ */ jsxRuntime.jsx(
            ui.Text,
            {
              className: ui.cn(
                ...
                isNumber2(rebate) && rebate !== 0 ? "oui-text-base-contrast" : "oui-text-base-contrast-36"
              ),
              children: utils.commifyOptional(rebate, { fix: 2, fallback: "--" })
            }
          ),
          /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-xs oui-font-semibold oui-text-base-contrast-36", children: "(30D)" }),
          /* @__PURE__ */ jsxRuntime.jsx(
            ui.ChevronRightIcon,
            {
              size: 18,
...
var PortfolioHandleMobile = (props) => {
  const { t } = i18n.useTranslation();
  const onGotoHistory = () => {
    props.routerAdapter?.onRouteChange({
      href: "/portfolio/history" /* History */,
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    ui.Flex,
    {
      ...
      children: [
        props.isMainAccount && /* @__PURE__ */ jsxRuntime.jsxs(
          ui.Flex,
          {
            direction: "column",
            gapY: 2,
            ...
            onClick: props?.onDeposit,
            children: [
              /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-flex oui-size-[48px] oui-items-center oui-justify-center oui-rounded-xl oui-bg-base-9", children: /* @__PURE__ */ jsxRuntime.jsx(ui.ArrowDownSquareFillIcon, { size: 28, color: "white", opacity: 1 }) }),
              /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-base-80 oui-text-2xs", children: t("common.deposit") })
            ]
          }
        ),
        props.hasSubAccount && /* @__PURE__ */ jsxRuntime.jsxs(
          ui.Flex,
          {
            direction: "column",
            gapY: 2,
            ...
            onClick: props?.onTransfer,
            children: [
              /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-flex oui-size-[48px] oui-items-center oui-justify-center oui-rounded-xl oui-bg-base-9", children: /* @__PURE__ */ jsxRuntime.jsx(ui.ArrowLeftRightIcon, { size: 28, color: "white", opacity: 1 }) }),
              /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-base-80 oui-text-2xs", children: t("common.transfer") })
            ]
          }
        ),
        props.isMainAccount && /* @__PURE__ */ jsxRuntime.jsxs(
          ui.Flex,
          {
            ...
            onClick: props?.onWithdraw,
            children: [
              /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-flex oui-size-[48px] oui-items-center oui-justify-center oui-rounded-xl oui-bg-base-9", children: /* @__PURE__ */ jsxRuntime.jsx(ui.ArrowUpSquareFillIcon, { size: 28, color: "white", opacity: 1 }) }),
              /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-base-80 oui-text-2xs", children: t("common.withdraw") })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntime.jsxs(
          ui.Flex,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-base-80 oui-text-2xs", children: t("trading.history") })
            ]
          }
        )
      ]
...
var PortfolioValueMobile = (props) => {
  ...
  const currentNamespace = React12.useMemo(() => {
    ...
    if (state.status === types.AccountStatusEnum.EnableTradingWithoutConnected) {
      return getLinkDeviceStorage2()?.chainNamespace;
    }
    return null;
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    ui.Flex,
    {
      ...
      className: ui.cn([
        ...
        currentNamespace === types.ChainNamespace.evm && "oui-bg-[#283BEE]",
        currentNamespace === types.ChainNamespace.solana && "oui-bg-[#630EAD]"
      ]),
      p: 4,
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "row", gapX: 1, itemAlign: "center", children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-sm oui-text-base-contrast-54", children: t("portfolio.overview.handle.title") }),
          /* @__PURE__ */ jsxRuntime.jsx(
            ui.EyeIcon,
            {
              size: 16,
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(
          ui.Flex,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-base oui-font-bold oui-text-base-contrast-80", children: "USDC" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntime.jsxs(
        ...
        /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(ui.ArrowRightShortIcon, { size: 18, color: "white", opacity: 0.54 })
          }
        )
      ]
    }
...
function getLinkDeviceStorage2() {
  try {
    const linkDeviceStorage = localStorage.getItem("orderly_link_device");
    const json = linkDeviceStorage ? hooks.parseJSON(linkDeviceStorage) : null;
    return json;
...
var SettingRouterMobile = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    ui.Flex,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(ui.SettingFillIcon, { size: 18, opacity: 0.98, color: "white" }),
        /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-base oui-font-semibold oui-text-base-contrast-80", children: t("portfolio.setting") }),
        /* @__PURE__ */ jsxRuntime.jsx(
          ui.ChevronRightIcon,
          {
            className: "oui-ml-auto",
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    ui.Flex,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { className: "oui-w-full oui-flex-row oui-justify-between oui-items-center", children: [
          /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { className: "oui-flex-col oui-items-start", children: [
            /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-base-contrast oui-text-base oui-font-semibold", children: t("affiliate.trader.rebates") }),
            /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-2xs oui-font-normal oui-text-base-contrast-54", children: t("affiliate.trader.tradingRebates") })
          ] }),
          /* @__PURE__ */ jsxRuntime.jsx(ui.TraderMobileIcon, {})
        ] }),
        /* @__PURE__ */ jsxRuntime.jsxs(
          ui.Flex,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx(
                ui.Text,
                {
                  className: ui.cn(
                    "oui-text-xs oui-font-semibold",
                    isNumber3(rebate) && rebate !== 0 ? "oui-text-base-contrast" : "oui-text-base-contrast-36"
                  ),
                  children: utils.commifyOptional(rebate, { fix: 2, fallback: "--" })
                }
              ),
...
var MobileOverview = (props) => {
  ...
  const { onRouteChange } = reactApp.useAppContext();
  hooks.useGetEnv();
  const navigateToPortfolioHistory = typeof onRouteChange === "function" ? () => {
    onRouteChange({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-my-1 oui-px-3", children: /* @__PURE__ */ jsxRuntime.jsx(AccountStatusMobile, {}) }),
    /* @__PURE__ */ jsxRuntime.jsxs(
      ui.Flex,
      {
        direction: "column",
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", width: "100%", gapY: 2, children: [
            /* @__PURE__ */ jsxRuntime.jsx(
            ...
            /* @__PURE__ */ jsxRuntime.jsx(uiTransfer.DepositStatusWidget, { onClick: navigateToPortfolioHistory }),
            /* @__PURE__ */ jsxRuntime.jsx(PortfolioChartsMobileWidget, {})
          ] }),
          /* @__PURE__ */ jsxRuntime.jsx(
          ...
          (!hideAffiliateCard || !hideTraderCard) && /* @__PURE__ */ jsxRuntime.jsx(
            ui.Flex,
            {
              direction: "row",
              width: "100%",
              height: "100%",
              className: "oui-gap-3",
              children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "row", className: "oui-flex-1 oui-gap-3", children: [
                !hideAffiliateCard && /* @__PURE__ */ jsxRuntime.jsx(
                  AffiliateCardMobile,
                  {
                ...
                !hideTraderCard && /* @__PURE__ */ jsxRuntime.jsx(
                  TraderCardMobile,
                  {
                    referralInfo: rewardsData.referralInfo,
                    routerAdapter: layoutContext?.routerAdapter
          ...
          /* @__PURE__ */ jsxRuntime.jsx(SettingRouterMobile, { routerAdapter: layoutContext?.routerAdapter })
        ]
      }
    )
  ] });
...
var OverviewPage = (props) => {
  const { isMobile } = ui.useScreen();
  return /* @__PURE__ */ jsxRuntime.jsx(OverviewProvider, { children: isMobile ? /* @__PURE__ */ jsxRuntime.jsx(
    MobileOverview,
    {
...
// src/pages/feeTier/index.tsx
var feeTier_exports = {};
__export(feeTier_exports, {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ui.Box,
    {
      className: ui.cn(
        ...
        isMobile ? "oui-mt-2 oui-rounded-xl oui-bg-base-9" : void 0
      ),
      children: /* @__PURE__ */ jsxRuntime.jsx(
        ui.DataTable,
        {
...
var CardTitle3 = () => {
  ...
  const { isMobile } = ui.useScreen();
  if (isMobile) {
    return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { itemAlign: "center", justify: "center", gap: 2, children: [
      /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "xs", intensity: 54, children: t("portfolio.feeTier.updatedDailyBy") }),
      /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "xs", intensity: 80, children: "~2:15 UTC" })
    ] });
  }
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { itemAlign: "center", justify: "between", children: [
    /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "lg", children: t("portfolio.feeTier") }),
...
var FeeTier = (props) => {
  const { columns, dataSource: dataSource2, tier, vol, headerDataAdapter, onRow, onCell } = props;
  const { isMobile } = ui.useScreen();
  return /* @__PURE__ */ jsxRuntime.jsxs(
    ui.Card,
    {
      title: /* @__PURE__ */ jsxRuntime.jsx(CardTitle3, {}),
...
var FeeTierWidget = (props) => {
  const state = useFeeTierScript(props);
  return /* @__PURE__ */ jsxRuntime.jsx(FeeTier, { ...state });
};
var FeeTierPage = (props) => {
  return /* @__PURE__ */ jsxRuntime.jsx(FeeTierWidget, { ...props });
};
var textStyle = {
      ...
      },
      {
        ...
        render: (val, record) => {
          ...
          if (!volume_min && !volume_max) {
            return /* @__PURE__ */ jsxRuntime.jsx("div", { style: textStyle, children: "--" });
          }
          if (volume_min && !volume_max) {
            return t("portfolio.feeTier.column.30dVolume.above", {
              volume: utils.numberToHumanStyle(
                volume_min,
                volume_min === 25e5 ? 1 : 0
              )
            });
          ...
          return /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
            volume_min && utils.numberToHumanStyle(volume_min, volume_min === 25e5 ? 1 : 0),
            ` - `,
            volume_max && utils.numberToHumanStyle(volume_max, volume_max === 25e5 ? 1 : 0)
          ] });
        }
      },
      {
...
// src/pages/feeTier/dataSource.ts
var dataSource = [
  {
    tier: 1,
    volume_min: 0,
...
// src/pages/feeTier/feeTier.script.ts
var findCurrentTier = (feeList, data) => {
  const { futures_taker_fee_rate = 0, futures_maker_fee_rate = 0 } = data;
  const takerRate = new utils.Decimal(futures_taker_fee_rate).mul(0.01);
  const makerRate = new utils.Decimal(futures_maker_fee_rate).mul(0.01);
  const findItem = feeList.find((item) => {
    ...
    return itemTakerRate === `${takerRate.toNumber()}%` && itemMakerRate === `${makerRate.toNumber()}%`;
  });
...
var useFeeTierScript = (options) => {
  ...
  React12.useEffect(() => {
    ...
    setTier(findCurrentTier(dataSource2, data));
  }, [data, isLoading, dataSource2]);
  const authData = reactApp.useDataTap(
    {
      tier,
...
var PositionsPage = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    ui.Flex,
    {
      ...
      height: "100%",
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "lg", children: t("common.positions") }) }),
        /* @__PURE__ */ jsxRuntime.jsx(ui.Divider, { className: "oui-w-full" }),
        /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { width: "100%", className: "oui-h-[calc(100%_-_59px)]", children: /* @__PURE__ */ jsxRuntime.jsxs(
          ui.Tabs,
          {
            value: tab,
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(ui.TabPanel, { value: "Positions" /* positions */, title: t("common.positions"), children: isMainAccount ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
                /* @__PURE__ */ jsxRuntime.jsx(
                  ui.DataFilter,
                  {
                    onFilter: onAccountFilter,
                ...
                /* @__PURE__ */ jsxRuntime.jsx(
                  uiPositions.CombinePositionsWidget,
                  {
                    selectedAccount,
                    ...props
                  }
                )
              ] }) : /* @__PURE__ */ jsxRuntime.jsx(uiPositions.PositionsWidget, { ...props, enableSortingStorage: false }) }),
              /* @__PURE__ */ jsxRuntime.jsx(
                ui.TabPanel,
                {
                  value: "Position history" /* positionHistory */,
                  title: t("positions.positionHistory"),
                  children: /* @__PURE__ */ jsxRuntime.jsx(uiPositions.PositionHistoryWidget, { ...props, enableSortingStorage: false })
                }
              ),
              /* @__PURE__ */ jsxRuntime.jsx(ui.TabPanel, { value: "Liquidation" /* liquidation */, title: /* @__PURE__ */ jsxRuntime.jsx(LiquidationTab, {}), children: /* @__PURE__ */ jsxRuntime.jsx(uiPositions.LiquidationWidget, {}) })
            ]
          }
        ) })
      ]
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      ui.Tooltip,
      {
        ...
        content: /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-text-pretty", children: t("positions.Liquidation.tooltip.liquidation") }),
          /* @__PURE__ */ jsxRuntime.jsx("div", { children: /* @__PURE__ */ jsxRuntime.jsx(
            "a",
            {
              ...
              className: "oui-text-primary",
              children: t("positions.Liquidation.tooltip.viewMore")
            }
          ) })
        ] }),
        arrow: {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx("button", { className: "oui-hidden group-data-[state=active]:oui-block", children: /* @__PURE__ */ jsxRuntime.jsx(ui.InfoCircleIcon, {}) })
      }
    )
  ] });
};
...
var OrdersPage = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    ui.Flex,
    {
      ...
      height: "100%",
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { width: "100%", justify: "between", children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "lg", children: t("common.orders") }),
          /* @__PURE__ */ jsxRuntime.jsx(ui.Tooltip, { content: t("orders.download.tooltip"), children: /* @__PURE__ */ jsxRuntime.jsxs(
            ui.Button,
            {
              color: "gray",
              size: "sm",
        ...
        /* @__PURE__ */ jsxRuntime.jsx(ui.Divider, { className: "oui-w-full" }),
        /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { width: "100%", className: "oui-h-[calc(100%_-_59px)]", children: /* @__PURE__ */ jsxRuntime.jsx(uiOrders.OrdersWidget, { ref: ordersRef, sharePnLConfig }) })
      ]
    }
  );
};
  ...
  (props, ref) => {
    return /* @__PURE__ */ jsxRuntime.jsx(
      "svg",
      {
        ...
        ref,
        ...props,
        children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M5.999 1.007a5 5 0 1 0 0 10 5 5 0 0 0 0-10m0 2.5a.5.5 0 1 1 0 1 .5.5 0 0 1 0-1m0 1.5a.5.5 0 0 1 .5.5v2.5a.5.5 0 0 1-1 0v-2.5a.5.5 0 0 1 .5-.5" })
      }
    );
  }
);
...
__export(api_exports, {
  APIManagerPage: () => APIManagerPage,
  APIManagerWidget: () => APIManagerWidget
});

// src/pages/api/apiManager.widget.tsx
init_apiManager_ui();
init_apiManager_script();
var APIManagerWidget = (props) => {
  const state = useApiManagerScript(props);
  return /* @__PURE__ */ jsxRuntime.jsx(APIManager, { ...state });
};
var APIManagerPage = (props) => {
  const { filterTags, keyStatus = "ACTIVE" } = props;
  return /* @__PURE__ */ jsxRuntime.jsx(APIManagerWidget, { filterTags, keyStatus });
};
...
var useSettingScript = () => {
  ...
  const updateCheckState = hooks.useDebouncedCallback((value) => {
    update({
      ...
      if (data2.success) {
        ui.toast.success(value ? "Opened" : "Closed");
      } else {
        setChecked(!value);
      }
    });
  }, 300);
  const setMaintainConfig = (maintenance_cancel_order_flag) => {
    setChecked(maintenance_cancel_order_flag);
    updateCheckState(maintenance_cancel_order_flag);
  };
  const { state } = hooks.useAccount();
  const canTouch = !wrongNetwork && !disabledConnect && (state.status === types.AccountStatusEnum.EnableTrading || state.status === types.AccountStatusEnum.EnableTradingWithoutConnected);
  return {
    maintenance_cancel_orders: checked,
    //data?.maintenance_cancel_orders,
    setMaintainConfig,
    isSetting: false,
    canTouch,
    soundAlert,
      ...
      ui.Card,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs(
          ui.Flex,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", itemAlign: "start", className: "oui-flex-1", children: [
                /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 80, size: "base", children: t("portfolio.setting.cancelOpenOrders") }),
                /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 54, size: "sm", children: t("portfolio.setting.cancelOpenOrders.description") })
              ] }),
          ...
          ui.Flex,
          {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsxs(
              ui.Flex,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 80, size: "xs", children: t("portfolio.setting.cancelOpenOrders") }),
                  /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 36, size: "2xs", className: "oui-font-normal", children: t("portfolio.setting.cancelOpenOrders.description") }),
                  /* @__PURE__ */ jsxRuntime.jsx(uiConnector.AuthGuardTooltip, { children: /* @__PURE__ */ jsxRuntime.jsx(
                    ui.Switch,
                    {
                      className: "oui-mt-1",
                      checked: props.maintenance_cancel_orders,
          ...
          ui.Flex,
          {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsxs(
              ui.Flex,
              {
                ...
                className: "oui-flex-1 oui-gap-2",
                children: [
                  /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 36, size: "2xs", className: "oui-font-normal", children: t("portfolio.setting.soundAlerts.description") }),
                  /* @__PURE__ */ jsxRuntime.jsx(uiConnector.AuthGuardTooltip, { children: /* @__PURE__ */ jsxRuntime.jsx(
                    ui.Switch,
                    {
                      className: "oui-mt-1",
...
var Setting = (props) => {
  const { isMobile } = ui.useScreen();
  if (isMobile) {
    return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-px-3", children: /* @__PURE__ */ jsxRuntime.jsx(SettingMobile, { ...props }) });
  }
  return /* @__PURE__ */ jsxRuntime.jsx(SettingDesktop, { ...props });
};
var SettingWidget = () => {
  const state = useSettingScript();
  return /* @__PURE__ */ jsxRuntime.jsx(Setting, { ...state });
};
var SettingPage = () => {
  return /* @__PURE__ */ jsxRuntime.jsx(SettingWidget, {});
};
...
__export(assets_exports2, {
  ...
  AssetsDataTableWidget: () => AssetsDataTableWidget,
  AssetsPage: () => AssetsPage,
  AssetsTable: () => AssetsTable,
  AssetsTableMobile: () => AssetsTableMobile,
  AssetsWidget: () => AssetsWidget
});

// src/pages/assets/assetsPage/assets.script.ts
init_hooks();
init_useAssetTotalValue();
init_type();
var useAssetsColumns = (options) => {
  const { t } = i18n.useTranslation();
  const tokensInfo = hooks.useAppStore((state) => state.tokensInfo);
  const { namespace } = hooks.useWalletConnector();
    ...
    return [
      ...
      },
      {
        ...
        render(val, record) {
          ...
          return /* @__PURE__ */ jsxRuntime.jsx(ui.Text.numeral, { dp: findToken?.decimals ?? 6, padding: false, children: val });
        }
      },
      {
        ...
        width: 140,
        render(val) {
          return /* @__PURE__ */ jsxRuntime.jsx(ui.Text.numeral, { rule: "price", dp: 6, currency: "$", padding: false, children: val });
        }
      },
      {
        ...
        width: 140,
        render(val) {
          return /* @__PURE__ */ jsxRuntime.jsx(ui.Text.assetValue, { rule: "price", dp: 6, currency: "$", padding: false, children: val });
        }
      },
      {
        ...
        width: 140,
        render(val) {
          return /* @__PURE__ */ jsxRuntime.jsx(ui.Text.numeral, { dp: 2, suffix: "%", children: val * 100 });
        }
      },
      {
        ...
        width: 140,
        render(val) {
          return /* @__PURE__ */ jsxRuntime.jsx(ui.Text.collateral, { rule: "price", dp: 6, currency: "$", padding: false, children: val });
        }
      },
      {
        title: null,
        ...
        render(id, record) {
          const { token } = record;
          return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { itemAlign: "center", justify: "end", gap: 3, children: [
            token !== "USDC" && namespace !== types.ChainNamespace.solana && typeof onConvert === "function" && /* @__PURE__ */ jsxRuntime.jsx(
              ui.Button,
              {
                size: "sm",
                variant: "outlined",
            ...
            typeof onTransfer === "function" && /* @__PURE__ */ jsxRuntime.jsx(
              ui.Button,
              {
                size: "sm",
                variant: "outlined",
...
var useAssetsScript = () => {
  ...
  const { state, subAccount, isMainAccount } = hooks.useAccount();
  const { holding = [] } = hooks.useCollateral();
  const { getIndexPrice } = hooks.useIndexPricesStream();
  const tokensInfo = hooks.useAppStore((state2) => state2.tokensInfo);
  const subAccounts = state.subAccounts ?? [];
    ...
    return filtered.map((accountData) => {
      const enhancedChildren = accountData.children?.map((holding2) => {
        const tokenInfo = tokensInfo?.find(
          (item) => item.token === holding2.token
        );
        const indexPrice = getIndexPrice(holding2.token);
        const assetValue = new utils.Decimal(holding2.holding).mul(indexPrice).toNumber();
        const collateralRatio = tokenInfo ? perp.account.collateralRatio({
          ...
          collateralQty: holding2.holding,
          collateralCap: tokenInfo?.user_max_qty ?? holding2.holding,
          indexPrice
        }) : utils.zero;
  ...
  const handleConvert = (accountId, token) => {
    ui.modal.show("ConvertDialogId", {
      accountId,
      token
    });
  };
  ...
  return {
    ...
    onWithdraw,
    holding,
    assetsOptions: assetsOptions ?? types.EMPTY_LIST,
    canTrade
  };
};

// src/pages/assets/assetsPage/assets.widget.tsx
init_assets_ui_desktop();

// src/pages/assets/assetsPage/assets.ui.mobile.tsx
init_assets_ui_desktop();
var AccountTag = ({ name }) => {
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-mt-2 oui-flex oui-h-[18px] oui-w-fit oui-items-center oui-rounded oui-bg-white/[0.06] oui-px-2 oui-text-2xs oui-font-semibold oui-text-base-contrast-36", children: name });
};
var AssetMobileItem = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-flex oui-flex-col oui-gap-2 oui-rounded-xl oui-bg-base-9 oui-p-2", children: [
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsxs(
            ui.Flex,
            {
              ...
              direction: "column",
              children: [
                /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-text-2xs oui-font-semibold oui-text-base-contrast-36", children: t("common.token") }),
                /* @__PURE__ */ jsxRuntime.jsxs(
                  ui.Flex,
                  {
                    gap: 1,
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(
            ui.Flex,
            {
              ...
              direction: "column",
              children: [
                /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-text-2xs oui-font-semibold oui-text-base-contrast-36", children: t("common.qty") }),
                /* @__PURE__ */ jsxRuntime.jsx(
                  ui.Text.numeral,
                  {
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(
            ui.Flex,
            {
              ...
              direction: "column",
              children: [
                /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-w-full oui-text-end oui-text-2xs oui-font-semibold oui-text-base-contrast-36", children: t("common.indexPrice") }),
                /* @__PURE__ */ jsxRuntime.jsxs(
                  ui.Flex,
                  {
                    gap: 1,
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntime.jsx(
                        ui.Text.numeral,
                        {
                          ...
                          currency: "$",
                          padding: false,
                          children: item.indexPrice
                        }
                      ),
                      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-text-end oui-text-2xs oui-text-base-contrast-36", children: "USDC" })
                    ]
                  }
                )
              ]
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsxs(
            ui.Flex,
            {
              ...
              direction: "column",
              children: [
                /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-text-2xs oui-font-semibold oui-text-base-contrast-36", children: t("portfolio.overview.column.assetValue") }),
                /* @__PURE__ */ jsxRuntime.jsx(
                  ui.Text.assetValue,
                  {
                    size: "xs",
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(
            ui.Flex,
            {
              ...
              direction: "column",
              children: [
                /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-text-2xs oui-font-semibold oui-text-base-contrast-36", children: t("portfolio.overview.column.collateralRatio") }),
                /* @__PURE__ */ jsxRuntime.jsx(ui.Text.numeral, { size: "xs", dp: 2, suffix: "%", children: item.collateralRatio * 100 })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntime.jsxs(
            ui.Flex,
            {
              ...
              direction: "column",
              children: [
                /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-w-full oui-text-end oui-text-2xs oui-font-semibold oui-text-base-contrast-36", children: t("transfer.deposit.collateralContribution") }),
                /* @__PURE__ */ jsxRuntime.jsxs(
                  ui.Flex,
                  {
                    gap: 1,
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntime.jsx(
                        ui.Text.collateral,
                        {
                          ...
                          currency: "$",
                          padding: false,
                          children: item.collateralContribution
                        }
                      ),
                      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-text-end oui-text-2xs oui-text-base-contrast-36", children: "USDC" })
                    ]
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "between", itemAlign: "center", gap: 2, children: [
      item.token !== "USDC" && namespace !== types.ChainNamespace.solana && /* @__PURE__ */ jsxRuntime.jsx(
        ui.Button,
        {
          fullWidth: true,
          variant: "outlined",
  ...
  if (!props.canTrade) {
    return /* @__PURE__ */ jsxRuntime.jsx(
      ui.Flex,
      {
        ...
        justify: "center",
        mt: 10,
        children: /* @__PURE__ */ jsxRuntime.jsx(ui.EmptyDataState, {})
      }
    );
  }
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: ui.cn("oui-flex oui-flex-col oui-gap-1 oui-px-1 oui-pb-4"), children: [
    isMainAccount && /* @__PURE__ */ jsxRuntime.jsx(
      ui.DataFilter,
      {
        onFilter,
    ...
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-flex oui-flex-col oui-gap-1", children: dataSource2?.map((assets, index) => {
      return /* @__PURE__ */ jsxRuntime.jsxs(React12__default.default.Fragment, { children: [
        ...
        Array.isArray(assets.children) && assets.children.map((child) => /* @__PURE__ */ jsxRuntime.jsx(
          ...
          `${child.token}-${child.account_id}`
        ))
      ] }, `item-${index}`);
    }) })
  ] });
};
var AssetsDataTableWidget = (props) => {
  const assetsState = useAssetsScript();
  const accountState = hooks.useAccount();
  return /* @__PURE__ */ jsxRuntime.jsx(AssetsDataTable, { ...assetsState, ...accountState, ...props });
};
var AssetsWidget = () => {
  const assetsState = useAssetsScript();
  const accountState = hooks.useAccount();
  const { isMobile } = ui.useScreen();
  if (isMobile) {
    return /* @__PURE__ */ jsxRuntime.jsx(AssetsTableMobile, { ...assetsState, ...accountState });
  }
  return /* @__PURE__ */ jsxRuntime.jsx(AssetsTable, { ...assetsState, ...accountState });
};
var AssetsPage = () => {
  return /* @__PURE__ */ jsxRuntime.jsx(AssetsWidget, {});
};
...
init_historyDataGroup();
var HistoryWidget = () => {
  return /* @__PURE__ */ jsxRuntime.jsx(HistoryDataGroupWidget, {});
};
var HistoryPage = () => {
  return /* @__PURE__ */ jsxRuntime.jsx(HistoryDataGroupWidget, {});
};

exports.APIManagerModule = api_exports;
exports.AssetsModule = assets_exports2;
exports.FeeTierModule = feeTier_exports;
exports.HistoryModule = history_exports;
exports.OrdersModule = page_exports2;
exports.OverviewModule = overview_exports;
exports.PortfolioLayout = PortfolioLayout;
exports.PortfolioLayoutWidget = PortfolioLayoutWidget;
exports.PortfolioLeftSidebarPath = PortfolioLeftSidebarPath;
