...
import { parseISO, subDays, isBefore, addDays, isAfter, differenceInDays, format, isWithinInterval } from 'date-fns';
import { sortWith, descend } from 'ramda';
import { usePrivateQuery, noCacheConfig, useMemoizedFn, useConfig, useQuery, useAccount, useInfiniteQuery, useMutation } from '@orderly.network/hooks';
import { jsxs, jsx, Fragment } from 'react/jsx-runtime';
import { useEmblaCarousel, ChevronLeftIcon, ChevronRightIcon, cn, Text, useScreen, usePagination, Box, Divider, Flex, DataTable, Spinner, Input, CloseCircleFillIcon, DataFilter, ScrollIndicator, toast, Tabs, TabPanel, Button, useLongPress, modal, InfoCircleIcon, Tooltip } from '@orderly.network/ui';
...
var TradingLeaderboardContext = createContext(
  {}
);
var TradingLeaderboardProvider = (props) => {
  ...
  const { data: generateCode, mutate: generateCodeMutate } = usePrivateQuery("/v1/referral/info", {
  ...
  const filteredCampaigns = useMemo(() => {
    return campaigns ? sortWith(
      [descend((campaign) => parseISO(campaign.end_time))],
      campaigns
    ) : campaigns;
  }, [campaigns]);
  const memoCampaignChange = useMemoizedFn((id) => {
    onCampaignChange?.(id);
  });
  ...
  return /* @__PURE__ */ jsx(TradingLeaderboardContext.Provider, { value: memoizedValue, children });
};
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (value) => {
          ...
          return /* @__PURE__ */ jsx(Text.numeral, { prefix: "$", rule: "price", dp: 2, children: value });
        },
        width: 105
      },
      {
        ...
        render: (value) => {
          ...
          return /* @__PURE__ */ jsx(Text.pnl, { prefix: "$", rule: "price", dp: 2, coloring: true, children: value });
        },
        width: 90
      },
      {
...
function useCampaignRankingScript(options) {
  ...
  const { data: userDataRes } = useQuery(getUserUrl(), {
    revalidateOnFocus: false
  });
  const getAddressRank = useCallback(
    (address) => {
...
var LeaderboardFilter = (props) => {
  ...
  const weeklyView = /* @__PURE__ */ jsx(Flex, { gap: 3, className: cn(isMobile ? "oui-h-[24px]" : "oui-h-[53px]"), children: weeklyRanges.map((range) => /* @__PURE__ */ jsxs(
    "button",
    {
      className: "oui-relative oui-w-fit oui-whitespace-nowrap oui-px-2 oui-py-[2px] oui-text-sm",
      children: [
        /* @__PURE__ */ jsx("div", { className: "oui-z-10", children: /* @__PURE__ */ jsx(
          Text.gradient,
          {
  ...
  const input = /* @__PURE__ */ jsx(
    Input,
    {
      ...
      suffix: props.searchValue && /* @__PURE__ */ jsx(Box, { mr: 2, children: /* @__PURE__ */ jsx(
        CloseCircleFillIcon,
        {
          size: 14,
  ...
  const dateRangeView = props.filterItems.length > 0 && /* @__PURE__ */ jsx(
    DataFilter,
    {
  ...
  if (isMobile) {
    return /* @__PURE__ */ jsxs(
      Flex,
      {
        ...
        children: [
          input,
          useCampaignDateRange ? /* @__PURE__ */ jsx(Flex, { gap: 3, className: "oui-w-full oui-py-3", children: /* @__PURE__ */ jsx(ScrollIndicator, { className: "oui-w-full", children: weeklyView }) }) : /* @__PURE__ */ jsxs(Flex, { gap: 3, className: "oui-w-full", children: [
            dateRangeView,
            /* @__PURE__ */ jsx(ScrollIndicator, { className: "oui-w-full", children: /* @__PURE__ */ jsx(Flex, { gap: 3, children: filterDayView }) })
          ] })
        ]
      }
    );
...
var SearchIcon = (props) => /* @__PURE__ */ jsx(
  "svg",
  {
    ...
    xmlns: "http://www.w3.org/2000/svg",
    ...props,
    children: /* @__PURE__ */ jsx("path", { d: "M5.841 1.14a4.667 4.667 0 0 0 0 9.333 4.74 4.74 0 0 0 2.875-.975l2.54 2.56a.6.6 0 0 0 .838 0 .6.6 0 0 0 0-.838L9.537 8.677a4.72 4.72 0 0 0 .971-2.871 4.667 4.667 0 0 0-4.667-4.667m0 1.166a3.5 3.5 0 1 1 0 7 3.5 3.5 0 0 1 0-7" })
  }
);
        ...
        updateTime && /* @__PURE__ */ jsxs(
          Flex,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("span", { children: updateTime })
            ]
          }
        )
      ]
  ...
  if (isMobile) {
    return /* @__PURE__ */ jsxs(
      Box,
      {
        ...
        style: props.style,
        children: [
          /* @__PURE__ */ jsx(LeaderboardFilter, { ...props }),
          /* @__PURE__ */ jsx(
            LeaderboardTabs,
            {
              isMobile,
...
var NormalPricePoolUI = ({
  ...
  const tooltipContent = useMemo(() => {
    ...
    return /* @__PURE__ */ jsx("div", { className: "oui-flex oui-min-w-[240px] oui-flex-col oui-gap-1", children: campaign?.prize_pools?.map((pool) => {
      return /* @__PURE__ */ jsxs(
        "div",
        {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "oui-overflow-hidden oui-rounded-2xl oui-border oui-border-solid oui-border-base-contrast/[0.08]", children: [
    /* @__PURE__ */ jsxs(
      "div",
      {
        className: cn([
    ...
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "oui-flex oui-items-center oui-gap-6", children: [
                  ...
                  Tooltip,
                  {
                    ...
                    children: /* @__PURE__ */ jsx(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ jsx(InfoCircleIcon, { className: "oui-cursor-pointer" })
                      }
                    )
                  }
                )
            ...
            (ticketPrizePool || highlightPool) && /* @__PURE__ */ jsxs("div", { className: "oui-flex oui-flex-col", children: [
              /* @__PURE__ */ jsx("div", { className: "oui-flex oui-items-center oui-gap-1", children: /* @__PURE__ */ jsx(
                Text,
                {
                  size: isMobile ? "2xs" : "xs",
                  weight: "semibold",
          ...
          isMobile && campaign?.rule_url && /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx(ChevronRightIcon, { size: 16, className: "oui-text-base-contrast-36" })
              ]
            }
          ),
          /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                !isMobile && campaign?.rule_url && /* @__PURE__ */ jsx(
                  Button,
                  {
                    size: "md",
                    variant: "outlined",
                ...
                (shouldShowJoinButton || showTradeButton) && /* @__PURE__ */ jsx("div", { className: "oui-w-full", children: /* @__PURE__ */ jsxs(
                  AuthGuard,
                  {
                    buttonProps: {
                      fullWidth: true,
                    ...
                    children: [
                      shouldShowJoinButton && /* @__PURE__ */ jsx(
                        Button,
                        {
                          size: isMobile ? "sm" : "md",
                          variant: "gradient",
...
var PricePoolDesktopUI = ({
  ...
  const renderButton = () => {
    if (shouldShowJoinButton || showTradeButton) {
      return /* @__PURE__ */ jsx("div", { className: "oui-w-full", children: /* @__PURE__ */ jsxs(
        AuthGuard,
        {
          buttonProps: {
            size: "md",
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "oui-flex oui-items-center", children: [
          /* @__PURE__ */ jsxs("div", { className: "oui-flex oui-flex-1 oui-flex-col", children: [
            /* @__PURE__ */ jsx("div", { className: "oui-text-xs oui-font-semibold oui-text-base-contrast-54", children: "Current total prize pool" }),
            /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(
              Text.gradient,
              {
                weight: "bold",
          ...
          (ticketPrizePool || highlightPool) && /* @__PURE__ */ jsxs("div", { className: "oui-flex oui-flex-1 oui-flex-col", children: [
            /* @__PURE__ */ jsx("div", { className: "oui-text-xs oui-font-semibold oui-text-base-contrast-54", children: highlightPool?.label || "Raffle prize" }),
            /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(
              Text.gradient,
              {
                weight: "bold",
        ...
        /* @__PURE__ */ jsx("div", { className: "oui-mb-3 oui-mt-4", children: /* @__PURE__ */ jsx(
        ...
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              isMobile && campaign?.rule_url && /* @__PURE__ */ jsx("div", { className: "oui-w-full", children: /* @__PURE__ */ jsx(
                Button,
                {
                  fullWidth: true,
                  size: "md",
...
var PricePoolProgress = ({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "oui-absolute oui-flex oui-h-6 oui-w-[calc(100%-64px)] oui-items-center", children: /* @__PURE__ */ jsxs(
          "div",
          {
            className: cn([
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx(
                      "div",
                      {
                        ...
                        style: { left },
                        children: isCurrentTier ? /* @__PURE__ */ jsx(Text.gradient, { color: "brand", weight: "bold", children: /* @__PURE__ */ jsx(Text.numeral, { dp: 0, prefix: "$", children: prizePool[0].total_prize }) }) : /* @__PURE__ */ jsx(
                          Text.numeral,
                          {
                            dp: 0,
                            prefix: "$",
...
var PricePoolWidget = (props) => {
  ...
  return /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(PricePoolDesktopUI, { ...state, ...props }) });
};
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        showTieredPricePool ? /* @__PURE__ */ jsx(
          PricePoolWidget,
          {
            onLearnMore,
            onTradeNow,
...
var useCampaignsScript = () => {
  ...
  const { state } = useAccount();
  const { data: userCampaigns, mutate: refreshUserCampaigns } = useQuery(
  ...
  const [doJoinCampaign, { isMutating: isJoining, error: joinError }] = useMutation(`/v1/client/campaign/sign_up`, "POST");
  ...
  const canTrade = useMemo(() => {
    ...
    return currentCampaign?.start_time < (/* @__PURE__ */ new Date()).toISOString() && currentCampaign?.end_time > (/* @__PURE__ */ new Date()).toISOString() && state.status >= AccountStatusEnum.EnableTrading;
...
var CampaignsAxis = ({ points }) => {
  ...
  if (points.length === 1) {
    return /* @__PURE__ */ jsx("div", { className: "oui-flex oui-w-full oui-justify-center", children: /* @__PURE__ */ jsxs("div", { className: "oui-flex oui-flex-col oui-items-center", children: [
      /* @__PURE__ */ jsx(AxisPoint, { type: points[0].type }),
      /* @__PURE__ */ jsxs("div", { className: "oui-mt-4 oui-flex oui-flex-col oui-items-center oui-text-center", children: [
        /* @__PURE__ */ jsx("div", { className: "oui-trading-leaderboard-title oui-mb-1 oui-whitespace-nowrap oui-text-sm oui-font-medium oui-text-base-contrast-54", children: points[0].title }),
        /* @__PURE__ */ jsx("div", { className: "oui-whitespace-nowrap oui-text-xs oui-text-base-contrast-36", children: points[0].time })
      ] })
    ] }) });
  }
  ...
  return /* @__PURE__ */ jsx("div", { className: "oui-flex oui-w-full", style: { width: widthPercentage }, children: points.map((point, index) => {
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "oui-relative oui-flex oui-w-full oui-items-center", children: [
            /* @__PURE__ */ jsx(
              "div",
              {
                className: cn([
            ...
            /* @__PURE__ */ jsx("div", { className: "oui-z-10 oui-shrink-0", children: /* @__PURE__ */ jsx(AxisPoint, { type: point.type }) }),
            /* @__PURE__ */ jsx(
              "div",
              {
                className: cn([
          ...
          /* @__PURE__ */ jsxs("div", { className: "oui-mt-4 oui-flex oui-flex-col oui-items-center oui-text-center", children: [
            /* @__PURE__ */ jsx("div", { className: "oui-trading-leaderboard-title oui-mb-1 oui-whitespace-nowrap oui-text-sm oui-font-medium oui-text-base-contrast-54", children: point.title }),
            /* @__PURE__ */ jsx("div", { className: "oui-whitespace-nowrap oui-text-xs oui-text-base-contrast-36", children: point.type !== "active" && point.time })
          ] })
        ]
      },
      index
...
var CampaignsAxisMobile = ({ points }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "oui-flex oui-w-full oui-flex-col oui-items-center oui-gap-10", children: points.map((point, index) => {
    const isFirst = index === 0;
    const isLast = index === points.length - 1;
    return /* @__PURE__ */ jsx("div", { className: cn(["oui-relative"]), children: /* @__PURE__ */ jsxs("div", { className: "oui-flex oui-h-10 oui-items-start oui-gap-4", children: [
      /* @__PURE__ */ jsxs(
        "div",
        {
          className: cn([
          ...
          children: [
            /* @__PURE__ */ jsx(AxisPoint, { type: point.type }),
            !isLast && /* @__PURE__ */ jsx(
              "div",
              {
                className: cn([
      ...
      /* @__PURE__ */ jsxs("div", { className: "oui-flex oui-flex-col oui-justify-start", children: [
        /* @__PURE__ */ jsx("div", { className: "oui-trading-leaderboard-title oui-mb-1 oui-text-sm oui-font-medium oui-text-base-contrast-54", children: point.title }),
        /* @__PURE__ */ jsx("div", { className: "oui-min-w-[160px] oui-text-xs oui-text-base-contrast-36", children: point.type !== "active" && point.time })
      ] })
    ] }) }, index);
  }) });
};
...
var Circle = () => /* @__PURE__ */ jsx("div", { className: "oui-w-1 oui-h-1 oui-rounded-full oui-bg-white/[0.16]" });
var TimeUnit = ({ value, label, isMobile }) => /* @__PURE__ */ jsxs(
  "div",
  {
    className: cn([
...
var CampaignsCountdown = ({ campaign, isMobile }) => {
  ...
  if (currentTime > endTime) {
    return /* @__PURE__ */ jsxs("div", { className: "oui-w-full oui-flex oui-items-center oui-justify-center oui-gap-4", children: [
      /* @__PURE__ */ jsx(
        "div",
        {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: timeUnits.map((unit, index) => /* @__PURE__ */ jsxs(
                "div",
                {
                  className: cn([
                    "oui-flex oui-items-center",
                  ...
                  children: [
                    ...
                    index < timeUnits.length - 1 && /* @__PURE__ */ jsx(Circle, {})
                  ]
                },
                unit.label
              ))
...
var CampaignsTimeDesktopUI = ({ campaign, isMobile }) => {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx(CampaignsCountdown, { campaign, isMobile }),
        isMobile ? /* @__PURE__ */ jsx(CampaignsAxisMobile, { points: timelineData }) : /* @__PURE__ */ jsx(CampaignsAxis, { points: timelineData })
      ]
    }
  );
};
...
var CampaignItemUI = ({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx(CampaignTag, { tag, active, classNames: classNames?.tag }),
        /* @__PURE__ */ jsx(PriceTag, { price: formattedPrice, active }),
        /* @__PURE__ */ jsx(
          "div",
          {
            className: cn([
        ...
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              campaign.referral_codes && /* @__PURE__ */ jsx(
                Text,
                {
                  className: cn([
                    "oui-text-base-contrast-54",
...
var CampaignTag = ({ tag, active, classNames }) => {
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: tag === "ended" /* ENDED */ ? /* @__PURE__ */ jsx(
        Text,
        {
          size: "2xs",
          weight: "semibold",
...
var PriceTag = ({ price, active }) => {
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx(LeaderboardTotalPrice, {}),
        /* @__PURE__ */ jsx(
          Text,
          {
            size: "2xs",
...
var CampaignsHeaderUI = ({ campaigns, currentCampaignId, onCampaignChange, backgroundSrc }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "oui-flex oui-w-full oui-items-center oui-gap-2 oui-px-6", children: [
    /* @__PURE__ */ jsx("div", { className: "oui-shrink-0", children: /* @__PURE__ */ jsx(
      DefaultCampaign,
      {
        currentCampaignId,
        onCampaignChange,
    ...
    /* @__PURE__ */ jsx("div", { className: "oui-h-[78px] oui-w-px oui-bg-white/[0.16]" }),
    /* @__PURE__ */ jsx(
      "button",
      {
        onClick: scrollPrev,
    ...
    /* @__PURE__ */ jsx("div", { className: "oui-min-w-0 oui-flex-1 oui-overflow-hidden", children: /* @__PURE__ */ jsx("div", { ref: emblaRef, children: /* @__PURE__ */ jsx("div", { className: "oui-flex oui-gap-2", children: campaigns?.map((campaign) => /* @__PURE__ */ jsx(
      "div",
      {
...
var CampaignsHeaderMobileUI = memo(({ campaigns, currentCampaignId, onCampaignChange, backgroundSrc }) => {
  const [canScrollPrev, setCanScrollPrev] = useState(false);
  const [canScrollNext, setCanScrollNext] = useState(false);
  ...
  return /* @__PURE__ */ jsxs("div", { className: "oui-flex oui-w-full oui-items-center oui-gap-2 oui-px-3", children: [
    /* @__PURE__ */ jsx(
      "button",
      {
        onClick: scrollPrev,
    ...
    /* @__PURE__ */ jsx("div", { className: "oui-min-w-0 oui-flex-1 oui-overflow-hidden", children: /* @__PURE__ */ jsx("div", { ref: emblaRef, children: /* @__PURE__ */ jsxs("div", { className: "oui-flex oui-gap-2", children: [
      /* @__PURE__ */ jsx(
        DefaultCampaign,
        {
          currentCampaignId,
      ...
      campaigns?.map((campaign) => /* @__PURE__ */ jsx(
        "div",
        {
          className: "oui-shrink-0",
          style: slideStyle,
...
var CampaignsHeaderWidget = (props) => {
  const { isMobile } = useScreen();
  return isMobile ? /* @__PURE__ */ jsx(CampaignsHeaderMobileUI, { ...props }) : /* @__PURE__ */ jsx(CampaignsHeaderUI, { ...props });
};
var CampaignsWidget = (props) => {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      style: props.style,
      children: [
        !props.hideCampaignsBanner && /* @__PURE__ */ jsx(
        ...
        state.currentCampaign && /* @__PURE__ */ jsx(
...
var RewardsDesktopUI = ({
  ...
  const ticketTooltipContent = useMemo(() => {
    ...
    if (ticketRules.mode === "linear") {
      return /* @__PURE__ */ jsx("div", { children: t("tradingLeaderboard.earnTickets", {
        ticket: ticketRules?.linear?.tickets,
        amount: commify(ticketRules?.linear?.every || 0)
      }) });
    }
    return /* @__PURE__ */ jsx("div", { className: "oui-flex oui-min-w-[240px] oui-flex-col oui-gap-1", children: ticketRules?.tiers?.map((tier) => {
      return /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "oui-text-base-contrast", children: [
              tier.tickets,
              " tickets"
            ] })
          ]
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              campaign?.rule_url && /* @__PURE__ */ jsx(
                Button,
                {
                  size: isMobile ? "md" : "lg",
                  variant: "outlined",
              ...
              !shouldShowJoinButton && canTrade && /* @__PURE__ */ jsx(
                Button,
                {
                  size: isMobile ? "md" : "lg",
                  variant: "gradient",
...
var RewardItem = (props) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "oui-flex oui-flex-1 oui-flex-col oui-items-center oui-justify-center oui-rounded-2xl oui-bg-base-9 oui-px-5 oui-py-4", children: [
    /* @__PURE__ */ jsx(
      "div",
      {
        className: cn([
    ...
    /* @__PURE__ */ jsxs("div", { className: "oui-flex oui-items-center oui-gap-2", children: [
      ...
      props.showTooltip && /* @__PURE__ */ jsx(Tooltip, { content: props.tooltip, ...tooltipProps, children: /* @__PURE__ */ jsx(
        "div",
        {
          className: "oui-flex oui-size-4 oui-items-center oui-justify-center",
    ...
    props.showExtraInfo && /* @__PURE__ */ jsx(
      "div",
      {
        className: cn([
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "oui-flex oui-flex-col oui-items-center oui-gap-1 oui-text-2xs oui-font-semibold oui-text-base-contrast-36", children: [
          /* @__PURE__ */ jsx(
            "div",
            {
              className: cn([
          ...
          /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: props.extraInfo.atMax ? /* @__PURE__ */ jsx(Trans, { i18nKey: "tradingLeaderboard.maxTicketsAchieved" }) : /* @__PURE__ */ jsx(
                Trans,
                {
                  i18nKey: "tradingLeaderboard.tradeForMoreTickets",
                  components: [
                    /* @__PURE__ */ jsxs("span", { className: "oui-text-base-contrast", children: [
                      "$",
...
var parseRichText = (text) => {
  ...
  for (const { type, match: match2 } of allMatches) {
    if (match2.index !== void 0 && match2.index > currentIndex) {
      ...
      if (beforeText) {
        parts.push(/* @__PURE__ */ jsx("span", { children: beforeText }, key++));
      }
    }
    switch (type) {
      case "bold":
  ...
  if (currentIndex < text.length) {
    ...
    if (remainingText) {
      parts.push(/* @__PURE__ */ jsx("span", { children: remainingText }, key++));
    }
  }
  return parts.length > 0 ? parts : [/* @__PURE__ */ jsx("span", { children: text }, 0)];
};
var DescriptionContent = ({ description, config }) => {
  const renderContent = (contents, level = 0) => {
    ...
    if (!hasListItems && contents.length === 1) {
      ...
      return /* @__PURE__ */ jsx("div", { className: cn("oui-mb-2", content.className), children: renderContentItem(content) });
    }
    return /* @__PURE__ */ jsx(
      "ul",
      {
          ...
          return /* @__PURE__ */ jsxs(
            "li",
            {
              ...
              children: [
                ...
                content?.children?.length && /* @__PURE__ */ jsx("div", { className: "oui-mt-2 oui-text-sm oui-text-base-contrast-36", children: renderContent(content.children, level + 1) })
              ]
            },
  ...
  const renderContentItem = (content) => {
    ...
    return /* @__PURE__ */ jsx("div", { className: "rich-text-content inline", children: parseRichText(content.content) });
  };
  return /* @__PURE__ */ jsx(
    "div",
    {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(DescriptionContent, { description: rules || [], config: ruleConfig })
      ]
    }
  );
};
var CampaignTermsUI = ({
  ...
  const { t } = useTranslation();
  return /* @__PURE__ */ jsxs("div", { className: cn("oui-mx-auto oui-max-w-[992px] oui-py-10", className), children: [
    /* @__PURE__ */ jsx(
      LeaderboardTitle,
      {
        isMobile,
    ...
    /* @__PURE__ */ jsx(DescriptionContent, { description: termsConfig || EMPTY_LIST })
  ] });
};
var RuleWidget = () => {
  const state = useCampaignsScript();
...
var LeaderboardPage = (props) => {
  ...
  return /* @__PURE__ */ jsx(TradingLeaderboardProvider, { ...rest, children: /* @__PURE__ */ jsxs(
    "div",
    {
      style: {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(RewardsWidget, {}),
        /* @__PURE__ */ jsx(LeaderboardSection, { ...props }),
        /* @__PURE__ */ jsx(RuleWidget, {})
      ]
    }
  ) });
};
var LeaderboardSection = (props) => {
  ...
  if (currentCampaignId === "general") {
    return /* @__PURE__ */ jsxs(Box, { px: 3, className: cn("oui-mix-blend-screen"), children: [
      ...
      /* @__PURE__ */ jsx(GeneralLeaderboardWidget, { ...props, className: "oui-mt-10" })
    ] });
  }
  if (currentCampaign && currentCampaignId != "general") {
    return /* @__PURE__ */ jsxs(Box, { px: 3, children: [
      ...
      /* @__PURE__ */ jsx(CampaignLeaderboardWidget, { ...props, campaignId: currentCampaignId })
    ] });
  }
  return null;
};
...
export { CampaignLeaderboard, CampaignLeaderboardWidget, CampaignRankingWidget, CampaignTagEnum, CampaignsHeaderWidget, GeneralLeaderboard, GeneralLeaderboardWidget, GeneralRankingWidget, LeaderboardBackground, LeaderboardPage, LeaderboardSection, LeaderboardTitle, TradingLeaderboardContext, TradingLeaderboardProvider, useCampaignLeaderboardScript, useCampaignRankingScript, useGeneralLeaderboardScript, useGeneralRankingScript, useTradingLeaderboardContext };
