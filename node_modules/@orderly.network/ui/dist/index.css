...
@property --gradientAngle { syntax: "<angle>"; inherits: false; initial-value: 0deg; }
...
.oui-bg-\[linear-gradient\(270deg\,rgb\(var\(--oui-gradient-brand-end\)\)_0\%\,rgb\(var\(--oui-gradient-brand-start\)\)_100\%\)\] {
  background-image:
    linear-gradient(
      270deg,
      rgb(var(--oui-gradient-brand-end)) 0%,
      rgb(var(--oui-gradient-brand-start)) 100%);
}
...
.oui-gradient-primary {
  background-image:
    linear-gradient(
      var(--oui-gradient-primary-angle, 28.29deg),
      rgb(var(--oui-gradient-primary-start)) var(--oui-gradient-primary-stop-start,0%),
      rgb(var(--oui-gradient-primary-end)) var(--oui-gradient-primary-stop-end,100%));
}
.oui-gradient-secondary {
  background-image:
    linear-gradient(
      var(--oui-gradient-secondary-angle, 0deg),
      rgb(var(--oui-gradient-secondary-start)) var(--oui-gradient-secondary-stop-start,0%),
      rgb(var(--oui-gradient-secondary-end)) var(--oui-gradient-secondary-stop-end,100%));
}
.oui-gradient-success {
  background-image:
    linear-gradient(
      var(--oui-gradient-success-angle, 28.29deg),
      rgb(var(--oui-gradient-success-start)) var(--oui-gradient-success-stop-start,0%),
      rgba(var(--oui-gradient-success-end)) var(--oui-gradient-success-stop-end,100%));
}
.oui-gradient-warning {
  background-image:
    linear-gradient(
      var(--oui-gradient-warning-angle, 28.29deg),
      rgb(var(--oui-gradient-warning-start)) var(--oui-gradient-warning-stop-start,0%),
      rgb(var(--oui-gradient-warning-end)) var(--oui-gradient-warning-stop-end,100%));
}
.oui-gradient-danger {
  background-image:
    linear-gradient(
      var(--oui-gradient-danger-angle, 28.29deg),
      rgb(var(--oui-gradient-danger-start)) var(--oui-gradient-danger-stop-start,0%),
      rgb(var(--oui-gradient-danger-end)) var(--oui-gradient-danger-stop-end,100%));
}
.oui-gradient-neutral {
  background-image:
    linear-gradient(
      var(--oui-gradient-neutral-angle, 28.29deg),
      rgb(var(--oui-gradient-neutral-start)) var(--oui-gradient-neutral-stop-start,0%),
      rgb(var(--oui-gradient-neutral-end)) var(--oui-gradient-neutral-stop-end,100%));
}
.oui-gradient-brand {
  background-image:
    linear-gradient(
      var(--oui-gradient-brand-angle, 17.44deg),
      rgb(var(--oui-gradient-brand-start)) var(--oui-gradient-brand-stop-start,0%),
      rgb(var(--oui-gradient-brand-end)) var(--oui-gradient-brand-stop-end,100%));
}
@keyframes enter {
  from {
...
.before\:oui-bg-\[linear-gradient\(90deg\,rgba\(var\(--oui-color-base-10\)_\/_0\.80\)_0\%\,rgba\(var\(--oui-color-base-10\)_\/_0\.36\)_65\%\,rgba\(var\(--oui-color-base-10\)_\/_0\.00\)_100\%\)\]::before {
  content: var(--tw-content);
  background-image:
    linear-gradient(
      90deg,
      rgba(var(--oui-color-base-10) / 0.80) 0%,
      rgba(var(--oui-color-base-10) / 0.36) 65%,
      rgba(var(--oui-color-base-10) / 0.00) 100%);
}
...
.data-\[state\=checked\]\:oui-text-\[rgba\(0\,0\,0\,0\.88\)\][data-state=checked] {
  color: rgba(0, 0, 0, 0.88);
}
