...
var init_useTradingLocalStorage = __esm({
  "src/hooks/useTradingLocalStorage.ts"() {
    exports.useTradingLocalStorage = (props) => {
      const [unPnlPriceBasis, setUnPnlPriceBasic] = hooks.useLocalStorage(
        "unPnlPriceBasis",
        "markPrice"
      );
      const [pnlNotionalDecimalPrecision, setPnlNotionalDecimalPrecision] = hooks.useLocalStorage(
        "pnlNotionalDecimalPrecision",
        props?.pnlNotionalDecimalPrecision ?? 2
      );
      const [showAllSymbol, setShowAllSymbol] = hooks.useLocalStorage(
        "showAllSymbol",
        true
      );
      const [hideAssets, setHideAssets] = hooks.useLocalStorage("hideAssets", false);
      return {
        unPnlPriceBasis,
        setUnPnlPriceBasic,
        pnlNotionalDecimalPrecision,
...
exports.usePositionsCount = void 0;
var init_usePositionsCount = __esm({
  "src/hooks/usePositionsCount.ts"() {
...
exports.usePendingOrderCount = void 0;
var init_usePendingOrderCount = __esm({
      ...
      const [pendingOrders] = hooks.useOrderStream(
        {
          ...
          excludes: [types.AlgoOrderRootType.POSITIONAL_TP_SL, types.AlgoOrderRootType.TP_SL],
...
var init_hooks = __esm({
  "src/hooks/index.ts"() {
    init_useTradingLocalStorage();
    init_usePositionsCount();
    init_usePendingOrderCount();
  }
});
...
// src/components/desktop/dataList/dataList.script.tsx
var useDataListScript;
var init_dataList_script = __esm({
  "src/components/desktop/dataList/dataList.script.tsx"() {
    init_hooks();
    init_tradingPageContext();
    useDataListScript = (inputs) => {
      const {
        current,
        pnlNotionalDecimalPrecision,
        sharePnLConfig,
      ...
      const localStorage2 = exports.useTradingLocalStorage({ pnlNotionalDecimalPrecision });
      ...
      return {
        ...
        sharePnLConfig,
        symbol,
        calcMode: localStorage2.unPnlPriceBasis,
        includedPendingOrder,
        ...localStorage2,
        positionCount,
        pendingOrderCount,
...
var Setting, UnPnlPriceBasisCheckBox, DecimalPrecisionCheckbox, RadioButton, SelIcon, UnselIcon;
var init_setting_ui = __esm({
  "src/components/desktop/dataList/setting/setting.ui.tsx"() {
    ...
    DecimalPrecisionCheckbox = (props) => {
      const { value, onValueChange } = props;
      return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 2, children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          RadioButton,
...
var SettingWidget;
var init_setting_widget = __esm({
  "src/components/desktop/dataList/setting/setting.widget.tsx"() {
    init_setting_script();
    init_setting_ui();
    SettingWidget = (props) => {
...
// src/components/desktop/dataList/setting/index.ts
var setting_exports = {};
...
var init_positionHeader_ui = __esm({
  "src/components/base/positionHeader/positionHeader.ui.tsx"() {
    ...
    DesktopLayout = (props) => {
      return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { py: 2, px: 3, gap: 6, width: "100%", justify: "between", children: [
    ...
    UnrealPnL = (props) => {
      const { t } = i18n.useTranslation();
      const unrealPnLClsName = typeof props.unrealPnL === "number" ? props.unrealPnL >= 0 ? "oui-text-trade-profit" : "oui-text-trade-loss" : "oui-text-base-contrast-80";
      const unrealPnLROIClsName = typeof props.unrealPnL === "number" && props.unrealPnlROI ? props.unrealPnlROI >= 0 ? "oui-text-success-darken" : "oui-text-danger-darken" : "oui-text-base-contrast-80";
      return /* @__PURE__ */ jsxRuntime.jsx(ui.Statistic, { label: t("common.unrealizedPnl"), classNames: props.classNames, children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 1, children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          ui.Text.pnl,
          {
        ...
        typeof props.unrealPnlROI !== "undefined" && /* @__PURE__ */ jsxRuntime.jsx(
          ui.Text.roi,
          {
            prefix: "(",
            suffix: ")",
    ...
    Notional = (props) => {
      const { t } = i18n.useTranslation();
      return /* @__PURE__ */ jsxRuntime.jsx(ui.Statistic, { label: t("common.notional"), classNames: props.classNames, children: /* @__PURE__ */ jsxRuntime.jsx(
        ui.Text.numeral,
        {
          dp: props.pnlNotionalDecimalPrecision,
          rm: utils.Decimal.ROUND_DOWN,
          intensity: 80,
          children: props.notional ?? "--"
        }
      ) });
    };
  }
});
var usePositionHeaderScript;
var init_positionHeader_script = __esm({
  "src/components/base/positionHeader/positionHeader.script.tsx"() {
    ...
    usePositionHeaderScript = (inputs) => {
      ...
      const aggregated = reactApp.useDataTap(data.aggregated);
      const unrealPnL = aggregated?.total_unreal_pnl;
      const unrealPnlROI = aggregated?.unrealPnlROI;
      const notional = aggregated?.notional;
      const { showAllSymbol, setShowAllSymbol } = exports.useTradingLocalStorage();
      return {
        pnlNotionalDecimalPrecision,
        unrealPnL,
        unrealPnlROI,
...
var PositionHeaderWidget;
var init_positionHeader_widget = __esm({
  "src/components/base/positionHeader/positionHeader.widget.tsx"() {
    init_positionHeader_script();
    init_positionHeader_ui();
    PositionHeaderWidget = (props) => {
      const state = usePositionHeaderScript(props);
      return /* @__PURE__ */ jsxRuntime.jsx(PositionHeader, { ...state });
    };
  }
});

// src/components/base/positionHeader/index.ts
var positionHeader_exports = {};
__export(positionHeader_exports, {
  PositionHeader: () => PositionHeader,
  PositionHeaderWidget: () => PositionHeaderWidget
});
var init_positionHeader = __esm({
  "src/components/base/positionHeader/index.ts"() {
    init_positionHeader_ui();
    init_positionHeader_widget();
  }
});
  ...
  "src/components/desktop/dataList/dataList.ui.tsx"() {
    ...
    PositionsView = (props) => {
      return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", width: "100%", height: "100%", children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(ui.Divider, { className: "oui-w-full" }),
        /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { className: "oui-h-[calc(100%_-_60px)]", width: "100%", children: /* @__PURE__ */ jsxRuntime.jsx(
          uiPositions.PositionsWidget,
          {
            symbol: !!props.showAllSymbol ? void 0 : props.symbol,
            pnlNotionalDecimalPrecision: props.pnlNotionalDecimalPrecision,
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-flex oui-space-x-1", children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(
          ui.Tooltip,
          {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx("span", { className: "oui-hidden group-data-[state=active]:oui-block oui-cursor-pointer", children: /* @__PURE__ */ jsxRuntime.jsx(ui.InfoCircleIcon, {}) })
          }
        )
      ] });
    };
    exports.DataList = (props) => {
      const { t } = i18n.useTranslation();
      const {
        positionCount = 0,
        pendingOrderCount = 0,
      ...
      const tabPanelItems = [
        {
          ...
          content: /* @__PURE__ */ jsxRuntime.jsx(PositionsView, { ...props })
        },
        {
          value: "Pending" /* pending */,
          title: `${t("orders.status.pending")} ${pendingOrderCount > 0 ? `(${pendingOrderCount})` : ""}`,
          content: /* @__PURE__ */ jsxRuntime.jsx(
            uiOrders.DesktopOrderListWidget,
            {
              type: uiOrders.TabType.pending,
              ordersStatus: types.OrderStatus.INCOMPLETE,
              symbol: showAllSymbol ? void 0 : symbol,
              onSymbolChange,
        ...
        },
        {
          ...
          content: /* @__PURE__ */ jsxRuntime.jsx(
            uiOrders.DesktopOrderListWidget,
            {
              type: uiOrders.TabType.filled,
              symbol: showAllSymbol ? void 0 : symbol,
              pnlNotionalDecimalPrecision,
              ordersStatus: types.OrderStatus.FILLED,
              onSymbolChange,
        ...
        },
        {
          ...
          content: /* @__PURE__ */ jsxRuntime.jsx(
            uiPositions.PositionHistoryWidget,
            {
              pnlNotionalDecimalPrecision,
              symbol: showAllSymbol ? void 0 : symbol,
              onSymbolChange,
        ...
        {
          value: "Order history" /* orderHistory */,
          title: t("orders.orderHistory"),
          content: /* @__PURE__ */ jsxRuntime.jsx(
            uiOrders.DesktopOrderListWidget,
            {
              type: uiOrders.TabType.orderHistory,
              pnlNotionalDecimalPrecision,
              symbol: showAllSymbol ? void 0 : symbol,
              onSymbolChange,
        ...
        {
          value: "Liquidation" /* liquidation */,
          title: /* @__PURE__ */ jsxRuntime.jsx(LiquidationTab, {}),
          content: /* @__PURE__ */ jsxRuntime.jsx(uiPositions.LiquidationWidget, { symbol: showAllSymbol ? void 0 : symbol })
        },
        {
          value: "Assets" /* assets */,
          ...
          content: /* @__PURE__ */ jsxRuntime.jsx(
            ui.Flex,
            {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsx(
                portfolio.AssetsModule.AssetsDataTableWidget,
                {
                  classNames: {
...
exports.DataListWidget = void 0;
var init_dataList_widget = __esm({
  "src/components/desktop/dataList/dataList.widget.tsx"() {
    init_dataList_script();
    init_dataList_ui();
    exports.DataListWidget = (props) => {
      const state = useDataListScript(props);
      return /* @__PURE__ */ jsxRuntime.jsx(exports.DataList, { ...state });
    };
  }
});
...
var init_lastTrades_ui = __esm({
  "src/components/base/lastTrades/lastTrades.ui.tsx"() {
    exports.LastTrades = (props) => {
      return /* @__PURE__ */ jsxRuntime.jsxs(
        ui.Box,
        {
          className: ui.cn(
      ...
      return (
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(
          ui.Grid,
          {
            ...
            gapX: 2,
            width: "100%",
            className: ui.cn("oui-text-xs oui-tabular-nums", classNames?.root),
            children: [
        ...
        ui.ListView,
        {
          ...
          renderItem: (item, index) => {
            return /* @__PURE__ */ jsxRuntime.jsx(
              Row,
              {
                left: /* @__PURE__ */ jsxRuntime.jsx(ui.Text.formatted, { rule: "date", formatString: "HH:mm:ss", children: item?.ts }),
                mid: utils.commifyOptional(item?.price, { fix: props.quoteDp }),
                right: utils.commifyOptional(item?.size, { fix: props.baseDp }),
                classNames: {
                  left: ui.cn("oui-text-base-contrast-80", props.classNames?.left),
                  right: ui.cn(
                    item.side === types.OrderSide.BUY ? "oui-text-trade-profit" : "oui-text-trade-loss",
...
var useLastTradesScript;
var init_lastTrades_script = __esm({
  "src/components/base/lastTrades/lastTrades.script.tsx"() {
    useLastTradesScript = (symbol) => {
      const { data, isLoading } = hooks.useMarketTradeStream(symbol);
      const config = hooks.useSymbolsInfo()?.[symbol];
...
exports.LastTradesWidget = void 0;
var init_lastTrades_widget = __esm({
  "src/components/base/lastTrades/lastTrades.widget.tsx"() {
    init_lastTrades_script();
    init_lastTrades_ui();
    exports.LastTradesWidget = (props) => {
      const state = useLastTradesScript(props.symbol);
      return /* @__PURE__ */ jsxRuntime.jsx(exports.LastTrades, { ...state, classNames: props.classNames, style: props.style });
    };
  }
});

// src/components/base/lastTrades/index.ts
var lastTrades_exports = {};
__export(lastTrades_exports, {
  LastTrades: () => exports.LastTrades,
  LastTradesWidget: () => exports.LastTradesWidget
});
var init_lastTrades = __esm({
  "src/components/base/lastTrades/index.ts"() {
    init_lastTrades_ui();
    init_lastTrades_widget();
  }
});
function FaucetUi(props) {
  const { t } = i18n.useTranslation();
  if (!props.showFaucet) {
    return null;
  }
...
var init_faucet_ui = __esm({
  "src/components/desktop/assetView/faucet/faucet.ui.tsx"() {
  }
});
function useFaucetScript() {
  ...
  const getFaucet = () => {
    ...
    const message = t("trading.faucet.getTestUSDC.success", {
      quantity: namespace === types.ChainNamespace.solana ? "100" : "1,000"
    });
    return getTestUSDC({
      ...
      (res) => {
        ...
        res.message && ui.toast.error(res.message);
      },
      (error) => {
...
var init_faucet_script = __esm({
  "src/components/desktop/assetView/faucet/faucet.script.tsx"() {
  }
});
function FaucetWidget() {
  const state = useFaucetScript();
  return /* @__PURE__ */ jsxRuntime.jsx(FaucetUi, { ...state });
}
var init_faucet_widget = __esm({
  "src/components/desktop/assetView/faucet/faucet.widget.tsx"() {
    init_faucet_ui();
    init_faucet_script();
  }
});
var calculateTextColor, useCurrentStatusText, TooltipContent, TotalValue, AssetDetail, LTVDetail, AssetValueList; exports.AssetView = void 0;
var init_assetView_ui = __esm({
  "src/components/desktop/assetView/assetView.ui.tsx"() {
    init_faucet_widget();
    calculateTextColor = (val) => {
      if (val >= 0 && val < 50) {
      ...
      return React12.useMemo(() => {
        const statusText = {
          ...
          connectWallet: {
            ...
            titleClsName: "oui-text-transparent oui-bg-clip-text oui-gradient-brand"
          },
          createAccount: {
    ...
    TooltipContent = (props) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-min-w-[204px] oui-max-w-[240px] oui-text-2xs oui-leading-normal oui-text-base-contrast-80", children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(ui.Divider, { className: "oui-border-white/10", my: 2 }),
        ...
        ui.Flex,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 1, itemAlign: "center", children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx("button", { onClick: onToggleVisibility, children: visible ? /* @__PURE__ */ jsxRuntime.jsx(ui.EyeIcon, { size: 18, className: "oui-text-base-contrast-54" }) : /* @__PURE__ */ jsxRuntime.jsx(ui.EyeCloseIcon, { size: 18, className: "oui-text-base-contrast-54" }) })
            ] })
          ]
        }
      );
    ...
    AssetDetail = (props) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "between", children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          ...
          {
            className: "",
            content: /* @__PURE__ */ jsxRuntime.jsx(TooltipContent, { description, formula }),
            children: /* @__PURE__ */ jsxRuntime.jsx(
              ui.Text,
              {
                size: "2xs",
    ...
    LTVDetail = (props) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "between", children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          ui.Tooltip,
          {
            className: ui.cn("oui-bg-base-6 oui-p-2"),
            content: /* @__PURE__ */ jsxRuntime.jsx(uiOrderEntry.LTVRiskTooltipWidget, {}),
            children: /* @__PURE__ */ jsxRuntime.jsx(
              ui.Text,
              {
                size: "2xs",
    ...
    AssetValueList = (props) => {
      ...
      const [optionsOpen, setOptionsOpen] = hooks.useLocalStorage(
      ...
      const showLTV = typeof currentLtv === "number" && !Number.isNaN(currentLtv) && currentLtv > 0;
      return /* @__PURE__ */ jsxRuntime.jsxs(ui.Box, { className: "oui-group", children: [
        /* @__PURE__ */ jsxRuntime.jsxs(
          ui.Flex,
          {
            justify: "center",
            ...
            onClick: toggleOpen,
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(ui.Divider, { className: "oui-flex-1" }),
              /* @__PURE__ */ jsxRuntime.jsx(
                ui.ChevronDownIcon,
                {
                  size: 12,
                  color: "white",
                  className: ui.cn("oui-transition-transform", open && "oui-rotate-180")
                }
              ),
              /* @__PURE__ */ jsxRuntime.jsx(ui.Divider, { className: "oui-flex-1" })
            ]
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(
                AssetDetail,
                {
                  ...
                  visible,
                  value: freeCollateral === 0 ? "0" : freeCollateral,
                  unit: "USDC"
                }
              ),
              /* @__PURE__ */ jsxRuntime.jsx(
    ...
    exports.AssetView = ({
      ...
      const transferButton = hasSubAccount && /* @__PURE__ */ jsxRuntime.jsx(
        ui.Button,
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { children: t("common.transfer") })
        }
      );
      const depositButton = isMainAccount && /* @__PURE__ */ jsxRuntime.jsxs(
        ui.Button,
        {
          ...
          onClick: onDeposit,
          children: [
            !hasSubAccount && /* @__PURE__ */ jsxRuntime.jsx(ui.ArrowDownShortIcon, { opacity: 1, className: "oui-text-primary-contrast" }),
      ...
      const withdrawButton = isMainAccount && /* @__PURE__ */ jsxRuntime.jsxs(
        ui.Button,
        {
          ...
          children: [
            !hasSubAccount && /* @__PURE__ */ jsxRuntime.jsx(
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(ui.Box, { className: "oui-relative", children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(
          uiConnector.AuthGuard,
          {
            ...
            children: isFirstTimeDeposit && isMainAccount ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
              /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", gap: 1, className: "oui-mb-[32px]", children: [
                /* @__PURE__ */ jsxRuntime.jsx(ui.Text.gradient, { size: "lg", weight: "bold", color: "brand", children: t("trading.asset.startTrading") }),
                /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "2xs", color: "neutral", weight: "semibold", children: t("trading.asset.startTrading.description") })
              ] }) }),
              /* @__PURE__ */ jsxRuntime.jsxs(
                ui.Button,
                {
              ...
              /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { className: "oui-mt-3", children: /* @__PURE__ */ jsxRuntime.jsx(FaucetWidget, {}) })
            ] }) : /* @__PURE__ */ jsxRuntime.jsxs(ui.Box, { className: "oui-space-y-4", children: [
              /* @__PURE__ */ jsxRuntime.jsx(
                TotalValue,
                {
                  totalValue,
              ...
              /* @__PURE__ */ jsxRuntime.jsx(
                ui.Flex,
                {
                  ...
                  itemAlign: "center",
                  children: isMainAccount ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
                    depositButton,
                    transferButton,
                    withdrawButton
                  ] }) : transferButton
              ...
              isMainAccount && /* @__PURE__ */ jsxRuntime.jsx(FaucetWidget, {})
            ] })
          }
        ),
        /* @__PURE__ */ jsxRuntime.jsx(
...
var useAssetViewScript;
var init_assetView_script = __esm({
  "src/components/desktop/assetView/assetView.script.tsx"() {
    useAssetViewScript = () => {
      const { t } = i18n.useTranslation();
      const account = hooks.useAccountInstance();
...
exports.AssetViewWidget = void 0;
var init_assetView_widget = __esm({
  "src/components/desktop/assetView/assetView.widget.tsx"() {
    init_assetView_script();
    init_assetView_ui();
    exports.AssetViewWidget = (props) => {
      const state = useAssetViewScript();
      return /* @__PURE__ */ jsxRuntime.jsx(exports.AssetView, { ...state, isFirstTimeDeposit: props.isFirstTimeDeposit });
    };
  }
});

// src/components/desktop/assetView/index.ts
var assetView_exports = {};
__export(assetView_exports, {
  AssetView: () => exports.AssetView,
  AssetViewWidget: () => exports.AssetViewWidget
});
var init_assetView = __esm({
  "src/components/desktop/assetView/index.ts"() {
    init_assetView_ui();
...
// src/components/base/orderBook/types.ts
var init_types = __esm({
  "src/components/base/orderBook/types.ts"() {
  }
});
var CellBar;
var init_cellBar = __esm({
...
var DesktopOrderBookCell;
var init_cell_desktop = __esm({
  "src/components/desktop/orderBook/cell.desktop.tsx"() {
    init_cellBar();
    init_orderContext();
    init_types();
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(
        "div",
        {
          ...
          children: [
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntime.jsx(
                    ...
                    {
                      width,
                      direction: 0 /* LEFT_TO_RIGHT */,
                      className: props.type === "ask" /* ASK */ ? "oui-bg-trade-loss/10" : "oui-bg-trade-profit/10"
                    }
                  )
                ]
              }
            ),
            isPendingOrder && /* @__PURE__ */ jsxRuntime.jsx(
              "div",
              {
                className: ui.cn(
            ...
            props.isHover && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-absolute oui-inset-0 oui-bg-white oui-opacity-[.12]" }),
            currentHover && /* @__PURE__ */ jsxRuntime.jsx(
              "div",
              {
                className: ui.cn(
                  "oui-absolute oui-inset-x-0",
                  props.type === "ask" /* ASK */ && "oui-top-0",
                  props.type === "bid" /* BID */ && "oui-bottom-0"
                ),
                children: /* @__PURE__ */ jsxRuntime.jsx(
                  ui.Divider,
                  {
                    ...
                    className: ui.cn(
                      "oui-w-full",
                      props.type === "bid" /* BID */ && "oui-border-trade-profit",
                      props.type === "ask" /* ASK */ && "oui-border-trade-loss"
                    )
                  }
                )
              }
...
var calcHintInfo, DesktopListBox, Tip, Row2;
var init_listBox_desktop = __esm({
  "src/components/desktop/orderBook/listBox.desktop.tsx"() {
    init_orderContext();
    init_types();
    init_cell_desktop();
    calcHintInfo = (item) => {
      ...
      return {
        sumQty,
        sumQtyAmount,
        avgPrice: sumQtyAmount === 0 || sumQty === 0 ? 0 : new utils.Decimal(sumQtyAmount).div(sumQty).toNumber()
      };
    };
    ...
    Tip = (props) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(ui.TooltipRoot, { open, onOpenChange: setOpen, children: [
        /* @__PURE__ */ jsxRuntime.jsx(ui.TooltipTrigger, { children: /* @__PURE__ */ jsxRuntime.jsx(
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx(
                ui.TooltipArrow,
                {
                  ...
                  style: {
                    transform: type === "ask" /* ASK */ ? "translateX(80%)" : "translateX(-80%)"
                  }
                }
              )
            ]
    ...
    Row2 = (props) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-flex oui-flex-row oui-justify-between oui-gap-4", children: [
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-select-none oui-text-base-contrast-36", children: title }),
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-text-end", children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text.numeral, { dp: contentDp, children: content }) })
      ] });
    };
  }
});
...
var init_depthSelect_desktop = __esm({
  "src/components/desktop/orderBook/depthSelect.desktop.tsx"() {
    DesktopDepthSelect = (props) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { pl: 3, width: 97, className: "oui-py-[10px]", children: /* @__PURE__ */ jsxRuntime.jsx(
        ui.Select.options,
        {
          options,
          size: "xs",
...
var Option, DesktopHeader, Title;
var init_header_desktop = __esm({
  "src/components/desktop/orderBook/header.desktop.tsx"() {
    init_orderContext();
    Option = (props) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(
        ui.Flex,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-overflow-hidden oui-text-ellipsis ", children: `${t("common.total")}(${optimizedItem})` }),
            /* @__PURE__ */ jsxRuntime.jsx(
              "div",
              {
                className: ui.cn(
                  ...
                  coinType === item && "oui-from-[rgb(var(--oui-gradient-brand-start))] oui-to-[rgb(var(--oui-gradient-brand-end))]"
                )
              }
            )
          ]
    ...
    DesktopHeader = (props) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { pl: 3, justify: "between", className: "oui-py-[6px]", children: [
        /* @__PURE__ */ jsxRuntime.jsxs(
          ...
          {
            gap: 1,
            className: ui.cn("oui-basis-7/12", showTotal && "oui-basis-1/2"),
            children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(
          ui.Flex,
          {
            ...
            children: showTotal ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
              /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { className: "oui-text-base-contrast-36", width: "100%", children: /* @__PURE__ */ jsxRuntime.jsx(Title, { id: "oui-order-book-header-total-quote", justifyEnd: true, children: `${t("common.total")}(${optimizedBase})` }) }),
              /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { className: "oui-text-base-contrast-36", width: "100%", children: /* @__PURE__ */ jsxRuntime.jsx(Title, { justifyEnd: true, id: "oui-order-book-header-total-base", children: `${t("common.total")}(${quote})` }) })
            ] }) : /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { width: "100%", children: /* @__PURE__ */ jsxRuntime.jsx(
              ui.Popover,
              {
                open: popoverOpen,
                onOpenChange: setOpen,
                contentProps: { className: ui.cn("oui-w-28 oui-p-1") },
                content: /* @__PURE__ */ jsxRuntime.jsx(
                  ui.Flex,
                  {
                    direction: "column",
                    itemAlign: "start",
                    className: ui.cn("oui-w-full oui-gap-0.5"),
                    children: [base, quote].map((item) => {
                      return /* @__PURE__ */ jsxRuntime.jsx(
                        Option,
                        {
                          item,
                ...
                children: /* @__PURE__ */ jsxRuntime.jsxs(
                  ui.Flex,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntime.jsx(Title, { justifyEnd: true, id: "oui-order-book-header-total-base", children: `${t("common.total")}(${optimizedCoinType})` }),
                      /* @__PURE__ */ jsxRuntime.jsx(
                        TriggerIcon,
                        {
                          color: "inherit",
...
var init_markPrice = __esm({
  "src/components/base/orderBook/markPrice.tsx"() {
    MarkPriceView = (props) => {
      const { isMobile } = ui.useScreen();
      return isMobile ? /* @__PURE__ */ jsxRuntime.jsx(MobileLayout2, { ...props }) : /* @__PURE__ */ jsxRuntime.jsx(DesktopLayout2, { ...props });
    };
    DesktopLayout2 = (props) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsx(
        ui.Tooltip,
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsxs(
            ...
            {
              gap: 1,
              className: ui.cn("oui-cursor-pointer oui-text-2xs", className),
              children: [
                /* @__PURE__ */ jsxRuntime.jsx(FlagIcon, { size: iconSize }),
                /* @__PURE__ */ jsxRuntime.jsx(
                  ui.Text.numeral,
                  {
                    dp: quote_dp,
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(
          ui.SimpleDialog,
          {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { children: t("trading.orderBook.markPrice.tooltip") })
          }
        )
      ] });
    };
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx(MarkPriceView, { markPrice, quote_dp: symbolInfo.quote_dp })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntime.jsx(
        ...
        ui.Tooltip,
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx(
            ui.Text,
            {
              size: "2xs",
              intensity: 36,
              className: "oui-cursor-pointer oui-underline oui-decoration-dashed oui-decoration-1 oui-underline-offset-4 oui-decoration-base-contrast-36",
              children: `${spread}%`
            }
          )
        }
...
exports.FundingRate = void 0;
var init_fundingRate_ui = __esm({
  "src/components/mobile/fundingRate/fundingRate.ui.tsx"() {
    exports.FundingRate = (props) => {
      const { data, onClick } = props;
      const predFundingRate = data.est_funding_rate;
      const countDown = data.countDown;
      const { t } = i18n.useTranslation();
      return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", itemAlign: "start", pb: 2, children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          ui.Text,
          {
            size: "2xs",
            ...
            onClick,
            children: t("trading.fundingRate.predFundingRate")
          }
        ),
  ...
  "src/components/mobile/fundingRateModal/fundingRateModal.script.tsx"() {
    ...
    exports.useFundingRateModalScript = (options) => {
      ...
      const lastFundingRateAnnualized = React12.useMemo(() => {
        ...
        const rate = new utils.Decimal(last_funding_rate).mul(100).toNumber();
...
exports.FundingRateModal = void 0;
var init_fundingRateModal_ui = __esm({
  "src/components/mobile/fundingRateModal/fundingRateModal.ui.tsx"() {
    exports.FundingRateModal = (props) => {
      const { t } = i18n.useTranslation();
      const {
        fundingPeriod,
        capFunding,
      ...
      const renderRow = (label, value, annualizedValue) => {
        ...
        return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "between", itemAlign: "center", width: "100%", children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 54, children: annualizedValue ? `${label}/ ${t("trading.fundingRate.annualized")}` : label }),
          /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { itemAlign: "end", gap: 1, className: "oui-text-base-contrast-80", children: [
            /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 80, children: value }),
            annualizedValue && " / ",
            annualizedValue && annualizedValue
          ] })
        ] });
      };
      return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { width: "100%", itemAlign: "center", direction: "column", gap: 1, children: [
        /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "between", itemAlign: "center", width: "100%", children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 54, children: t("trading.fundingRate.predFundingRate.interval") }),
          /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 80, children: fundingPeriod })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "between", itemAlign: "center", width: "100%", children: [
          /* @__PURE__ */ jsxRuntime.jsxs(ui.Text, { intensity: 54, children: [
            t("trading.fundingRate.predFundingRate.cap"),
            " /",
            t("trading.fundingRate.predFundingRate.floor")
          ] }),
          /* @__PURE__ */ jsxRuntime.jsxs(ui.Text, { intensity: 80, children: [
            capFunding,
            " / ",
            floorFunding
          ] })
...
exports.FundingRateModalWidget = void 0; exports.FundingRateDialogId = void 0; exports.FundingRateSheetId = void 0;
var init_fundingRateModal_widget = __esm({
  "src/components/mobile/fundingRateModal/fundingRateModal.widget.tsx"() {
    init_fundingRateModal_script();
    init_fundingRateModal_ui();
    exports.FundingRateModalWidget = (props) => {
      const state = exports.useFundingRateModalScript(props);
      return /* @__PURE__ */ jsxRuntime.jsx(exports.FundingRateModal, { ...state });
    };
    exports.FundingRateDialogId = "FundingRateDialogId";
    exports.FundingRateSheetId = "FundingRateSheetId";
    ui.registerSimpleDialog(exports.FundingRateDialogId, exports.FundingRateModalWidget, {
      size: "md",
      classNames: { content: "oui-border oui-border-line-6" },
      title: () => i18n.i18n.t("funding.fundingRate")
    });
    ui.registerSimpleSheet(exports.FundingRateSheetId, exports.FundingRateModalWidget, {
      classNames: { content: "oui-text-sm" },
      title: () => i18n.i18n.t("funding.fundingRate")
    });
  }
});
exports.useFundingRateScript = void 0;
var init_fundingRate_script = __esm({
  "src/components/mobile/fundingRate/fundingRate.script.tsx"() {
...
exports.FundingRateWidget = void 0;
var init_fundingRate_widget = __esm({
  "src/components/mobile/fundingRate/fundingRate.widget.tsx"() {
    init_fundingRate_script();
    init_fundingRate_ui();
    exports.FundingRateWidget = (props) => {
      const state = exports.useFundingRateScript(props.symbol);
      return /* @__PURE__ */ jsxRuntime.jsx(exports.FundingRate, { ...state });
    };
  }
});

// src/components/mobile/fundingRate/index.ts
var init_fundingRate = __esm({
  "src/components/mobile/fundingRate/index.ts"() {
    init_fundingRate_ui();
    init_fundingRate_widget();
    init_fundingRate_script();
  }
});
var OrderBookCell;
var init_cell = __esm({
  "src/components/mobile/orderBook/cell.tsx"() {
    init_cellBar();
    init_orderContext();
    init_types();
    OrderBookCell = (props) => {
      ...
      const renderCell = () => {
        switch (coinUnit) {
          case "base":
            return /* @__PURE__ */ jsxRuntime.jsx(ui.Text.numeral, { className: "oui-text-base-contrast-80", dp: base_dp, children: accumulated });
          case "quote":
            return /* @__PURE__ */ jsxRuntime.jsx(ui.Text.numeral, { className: "oui-text-base-contrast-80", dp: 0, children: totalAmount });
          default:
            return /* @__PURE__ */ jsxRuntime.jsx(ui.Text.numeral, { className: "oui-text-base-contrast-80", dp: base_dp, children: Number.isNaN(quantity) ? "-" : quantity });
        }
      };
      return /* @__PURE__ */ jsxRuntime.jsxs(
        ui.Box,
        {
          ...
          children: [
            ...
            Number.isNaN(width) ? null : /* @__PURE__ */ jsxRuntime.jsx(
              CellBar,
              {
                width,
                className: ui.cn(
                  type === "ask" /* ASK */ ? "oui-bg-trade-loss/20" : "oui-bg-trade-profit/20"
                )
              }
            )
          ]
...
var init_listBox = __esm({
  "src/components/mobile/orderBook/listBox.tsx"() {
    init_orderContext();
    init_cell();
    ListBox = (props) => {
      const { data } = props;
...
var Asks;
var init_asks = __esm({
  "src/components/mobile/orderBook/asks.tsx"() {
    init_types();
    init_listBox();
    Asks = (props) => {
      const { data } = props;
      ...
      return /* @__PURE__ */ jsxRuntime.jsx(ListBox, { type: "ask" /* ASK */, data, countQty });
    };
  }
});
var Bids;
var init_bids = __esm({
  "src/components/mobile/orderBook/bids.tsx"() {
    init_types();
    init_listBox();
    Bids = (props) => {
      const { data } = props;
      ...
      return /* @__PURE__ */ jsxRuntime.jsx(ListBox, { type: "bid" /* BID */, data, countQty });
    };
  }
});
var DepthSelect;
var init_depthSelect = __esm({
  "src/components/mobile/orderBook/depthSelect.tsx"() {
    DepthSelect = (props) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { id: "oui-order-book-depth", className: "oui-w-full oui-pt-2", children: /* @__PURE__ */ jsxRuntime.jsx(
        ui.Picker,
        {
          options,
          fullWidth: true,
...
var init_header = __esm({
  "src/components/mobile/orderBook/header.tsx"() {
    init_orderContext();
    Header2 = (props) => {
      const { t } = i18n.useTranslation();
            ...
            /* @__PURE__ */ jsxRuntime.jsx(
              ui.Picker,
              {
                ...
                valueRenderer: (_, { open, data }) => {
                  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "between", itemAlign: "center", gap: 1, children: [
                    Array.isArray(data) && /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", itemAlign: "end", children: [
                      data[0] && /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { children: data[0] }),
                      data[1] && /* @__PURE__ */ jsxRuntime.jsxs(ui.Text, { children: [
                        "(",
                        data[1],
                        ")"
                      ] })
                    ] }),
                    open ? /* @__PURE__ */ jsxRuntime.jsx(ui.CaretUpIcon, { size: 14, color: "inherit" }) : /* @__PURE__ */ jsxRuntime.jsx(ui.CaretDownIcon, { size: 14, color: "inherit" })
                  ] });
                }
              }
            )
...
var MarkPrice;
var init_markPrice2 = __esm({
  "src/components/mobile/orderBook/markPrice.tsx"() {
    init_markPrice();
    init_midPriceView();
    init_orderContext();
    MarkPrice = (props) => {
        ...
        OrderBookProvider,
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsxs(
            ui.Flex,
            {
              ...
              className: ui.cn("oui-relative oui-size-full", props.className),
              justify: "start",
              itemAlign: "start",
              children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx(Bids, { data: props.bids }),
                /* @__PURE__ */ jsxRuntime.jsx(
                  DepthSelect,
                  {
                    depth: props.depths || types.EMPTY_LIST,
                    value: props.activeDepth,
                    onChange: onDepthChange
                  }
                ),
...
var init_orderBook_ui = __esm({
  "src/components/base/orderBook/orderBook.ui.tsx"() {
    init_index_desktop();
    init_orderBook();
    exports.OrderBook = (props) => {
      return /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { className: "oui-font-semibold", width: "100%", height: "100%", children: props.isMobile ? /* @__PURE__ */ jsxRuntime.jsx(
        OrderBook,
        {
          level: props.level,
          asks: props.asks,
...
var init_orderBook_script = __esm({
  "src/components/base/orderBook/orderBook.script.tsx"() {
    ...
    usePendingOrderStream = (symbol) => {
      const [data] = hooks.useOrderStream({
        status: types.OrderStatus.INCOMPLETE,
        symbol
      });
...
var init_orderBook_widget = __esm({
  "src/components/base/orderBook/orderBook.widget.tsx"() {
    init_orderBook_script();
    init_orderBook_ui();
    exports.OrderBookWidget = (props) => {
      const { className, symbol, height } = props;
      const state = exports.useOrderBookScript({ symbol, height });
      return /* @__PURE__ */ jsxRuntime.jsx(exports.OrderBook, { ...state, className });
    };
  }
});
...
var init_riskRate_ui = __esm({
  "src/components/desktop/riskRate/riskRate.ui.tsx"() {
    init_assetView_ui();
    exports.RiskRate = (props) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(ui.Box, { "data-risk": "", className: "oui-space-y-2", children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          ui.Flex,
          {
            itemAlign: "center",
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "row", justify: "between", children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            ui.Tooltip,
            {
              content: /* @__PURE__ */ jsxRuntime.jsx(
...
var getRiskRateColor, useRiskRateScript;
var init_riskRate_script = __esm({
  "src/components/desktop/riskRate/riskRate.script.tsx"() {
    getRiskRateColor = (riskRate) => {
      if (riskRate === null) {
    ...
    useRiskRateScript = () => {
      ...
      const riskRate = React12.useMemo(() => {
        ...
        const calculatedRiskRate = new utils.Decimal(mmr).div(marginRatio).mul(100).todp(2, utils.Decimal.ROUND_UP);
      ...
      const _maxLeverage = reactApp.useDataTap(curLeverage);
      const _riskRate = reactApp.useDataTap(riskRate);
      return {
        riskRate: _riskRate,
        riskRateColor,
        isConnected,
...
exports.RiskRateWidget = void 0;
var init_riskRate_widget = __esm({
  "src/components/desktop/riskRate/riskRate.widget.tsx"() {
    init_riskRate_script();
    init_riskRate_ui();
    exports.RiskRateWidget = () => {
      const state = useRiskRateScript();
      return /* @__PURE__ */ jsxRuntime.jsx(exports.RiskRate, { ...state });
    };
  }
});

// src/components/desktop/riskRate/index.ts
var riskRate_exports = {};
__export(riskRate_exports, {
  RiskRate: () => exports.RiskRate,
  RiskRateWidget: () => exports.RiskRateWidget
});
var init_riskRate = __esm({
  "src/components/desktop/riskRate/index.ts"() {
    init_riskRate_ui();
    init_riskRate_widget();
  }
});
...
var init_orderBookAndTrades_ui = __esm({
  "src/components/desktop/orderBookAndTrades/orderBookAndTrades.ui.tsx"() {
              ...
              ui.Flex,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntime.jsx(React12__default.default.Suspense, { fallback: null, children: /* @__PURE__ */ jsxRuntime.jsx(
                    ...
                    {
                      symbol: props.symbol,
                      height: props.containerSize ? props.containerSize.height - 29 - 24 : void 0
                    }
                  ) })
                ]
              }
    ...
    Title2 = (props) => {
      return /* @__PURE__ */ jsxRuntime.jsx(
        ui.Text,
        {
          size: "base",
          intensity: 80,
          className: ui.cn("oui-pb-[5px]", props.className),
    ...
    exports.OrderBookAndTrades = (props) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsx("div", { ref: containerRef, className: "oui-h-full", children: (containerSize?.width ?? 0) >= 572 ? /* @__PURE__ */ jsxRuntime.jsx(TwoColLayout, { ...props }) : /* @__PURE__ */ jsxRuntime.jsx(TabLayout, { ...props }) });
    };
  }
});
exports.useOrderBookAndTradesScript = void 0;
...
exports.OrderBookAndTradesWidget = void 0;
var init_orderBookAndTrades_widget = __esm({
  "src/components/desktop/orderBookAndTrades/orderBookAndTrades.widget.tsx"() {
    init_orderBookAndTrades_script();
    init_orderBookAndTrades_ui();
    exports.OrderBookAndTradesWidget = (props) => {
      const state = exports.useOrderBookAndTradesScript(props.symbol);
      return /* @__PURE__ */ jsxRuntime.jsx(exports.OrderBookAndTrades, { ...state });
    };
  }
});

// src/components/desktop/orderBookAndTrades/index.ts
var orderBookAndTrades_exports = {};
__export(orderBookAndTrades_exports, {
  OrderBookAndTrades: () => exports.OrderBookAndTrades,
  OrderBookAndTradesWidget: () => exports.OrderBookAndTradesWidget,
  useOrderBookAndTradesScript: () => exports.useOrderBookAndTradesScript
});
var init_orderBookAndTrades = __esm({
  "src/components/desktop/orderBookAndTrades/index.ts"() {
    init_orderBookAndTrades_ui();
    init_orderBookAndTrades_widget();
    init_orderBookAndTrades_script();
  }
});
...
__export(switchLayout_exports, {
  LayoutIcon: () => LayoutIcon,
  MarketBottomIcon: () => MarketBottomIcon,
  MarketHideIcon: () => MarketHideIcon,
  MarketLeftIcon: () => MarketLeftIcon,
  MarketTopIcon: () => MarketTopIcon,
  OrderEntryIcon: () => OrderEntryIcon,
  SwitchLayout: () => SwitchLayout,
  SwitchLayoutDropDown: () => SwitchLayoutDropDown
});
var SwitchLayout, SwitchLayoutDropDown, LayoutIcon, OrderEntryIcon, MarketLeftIcon, MarketTopIcon, MarketBottomIcon, MarketHideIcon;
var init_switchLayout = __esm({
  "src/components/desktop/layout/switchLayout.tsx"() {
    SwitchLayout = (props) => {
      const { t } = i18n.useTranslation();
      return /* @__PURE__ */ jsxRuntime.jsx(SwitchLayoutDropDown, { ...props, children: /* @__PURE__ */ jsxRuntime.jsxs(
        ui.Flex,
        {
          px: 3,
          className: ui.cn(
          ...
          itemAlign: "center",
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(LayoutIcon, {}),
            /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "2xs", weight: "semibold", children: t("trading.layout") })
          ]
        }
      ) });
    };
    SwitchLayoutDropDown = (props) => {
      ...
      const renderMarketItem = (position) => {
        const getIcon = (isHovered) => {
          const isSelected = props.marketLayout === position;
          switch (position) {
            case "left":
              return /* @__PURE__ */ jsxRuntime.jsx(MarketLeftIcon, { isSelected, isHovered });
            case "top":
              return /* @__PURE__ */ jsxRuntime.jsx(MarketTopIcon, { isSelected, isHovered });
            case "bottom":
              return /* @__PURE__ */ jsxRuntime.jsx(MarketBottomIcon, { isSelected, isHovered });
            case "hide":
              return /* @__PURE__ */ jsxRuntime.jsx(MarketHideIcon, { isSelected, isHovered });
            default:
              return /* @__PURE__ */ jsxRuntime.jsx(MarketLeftIcon, { isSelected, isHovered });
          }
        };
        ...
        return /* @__PURE__ */ jsxRuntime.jsxs(
          ui.Flex,
          {
            ...
            className: "oui-group",
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { justify: "center", className: "oui-w-[148px] oui-h-[100px]", children: getIcon(hoveredMarket === position) }),
              /* @__PURE__ */ jsxRuntime.jsx(
                ui.Text,
                {
                  size: "2xs",
      ...
      const content = /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        /* @__PURE__ */ jsxRuntime.jsxs(
          ui.Flex,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "base", intensity: 98, children: t("trading.layout") }),
              /* @__PURE__ */ jsxRuntime.jsx(
                ui.CloseIcon,
                {
                  size: 16,
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", gapY: 2, mt: 5, itemAlign: "start", children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "xs", intensity: 98, children: String(t("trading.layout.markets")) }),
          /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gapX: 6, children: [
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(ui.DropdownMenuRoot, { open, onOpenChange: setOpen, children: [
        /* @__PURE__ */ jsxRuntime.jsx(ui.DropdownMenuTrigger, { asChild: true, children: props.children }),
        /* @__PURE__ */ jsxRuntime.jsx(ui.DropdownMenuPortal, { children: /* @__PURE__ */ jsxRuntime.jsx(
          ui.DropdownMenuContent,
          {
            ...
            align: "end",
            className: ui.cn("oui-bg-base-8 oui-p-5 oui-pt-0 oui-font-semibold"),
            children: content
          }
        ) })
      ] });
    };
    LayoutIcon = (props) => /* @__PURE__ */ jsxRuntime.jsx(
      "svg",
      {
        width: "17",
        height: "16",
    ...
    OrderEntryIcon = (props) => /* @__PURE__ */ jsxRuntime.jsxs(
      "svg",
      {
        ...
        xmlns: "http://www.w3.org/2000/svg",
        children: [
          /* @__PURE__ */ jsxRuntime.jsx("rect", { width: "36", height: "17", rx: "2", fill: "#181C23" }),
          /* @__PURE__ */ jsxRuntime.jsx("rect", { y: "19", width: "36", height: "54", rx: "2", fill: "#181C23" }),
          /* @__PURE__ */ jsxRuntime.jsx("rect", { y: "75", width: "36", height: "9", rx: "2", fill: "#181C23" }),
          /* @__PURE__ */ jsxRuntime.jsx(
            "rect",
            {
              x: "3",
          ...
          /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "3", y: "22", width: "14", height: "6", rx: "2", fill: "#008676" }),
          /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "19", y: "22", width: "14", height: "6", rx: "2", fill: "#D92D6B" }),
          /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "3", y: "11", width: "14", height: "3", rx: "1.5", fill: "#333948" }),
          /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "19", y: "11", width: "14", height: "3", rx: "1.5", fill: "#335FFC" }),
          /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "3", y: "62", width: "30", height: "8", rx: "2", fill: "#008676" }),
          /* @__PURE__ */ jsxRuntime.jsx("defs", { children: /* @__PURE__ */ jsxRuntime.jsxs(
            "linearGradient",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntime.jsx("stop", { stopColor: "#779eff" }),
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(
        "svg",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "8", y: "8", width: "24", height: "84", rx: "2", fill: "#181C23" }),
            /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "16", y: "10", width: "4", height: "2", rx: "1", fill: "#333948" }),
            /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "21", y: "10", width: "4", height: "2", rx: "1", fill: "#333948" }),
            /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "26", y: "10", width: "4", height: "2", rx: "1", fill: "#333948" }),
            /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "10", y: "10", width: "5", height: "2", rx: "1", fill: "#335FFC" }),
            /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "10", y: "14", width: "20", height: "76", rx: "2", fill: "#282E3A" })
          ]
        }
      );
    };
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(
        "svg",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "8", y: "8", width: "132", height: "8", rx: "2", fill: "#181C23" }),
            /* @__PURE__ */ jsxRuntime.jsxs("g", { clipPath: "url(#clip0_31319_74729)", children: [
              /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "10", y: "10", width: "16", height: "4", rx: "2", fill: "#335FFC" }),
              /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "28", y: "10", width: "16", height: "4", rx: "2", fill: "#333948" }),
              /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "46", y: "10", width: "16", height: "4", rx: "2", fill: "#333948" }),
              /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "64", y: "10", width: "16", height: "4", rx: "2", fill: "#333948" }),
              /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "82", y: "10", width: "16", height: "4", rx: "2", fill: "#333948" }),
              /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "100", y: "10", width: "16", height: "4", rx: "2", fill: "#333948" }),
              /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "118", y: "10", width: "16", height: "4", rx: "2", fill: "#333948" }),
              /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "136", y: "10", width: "16", height: "4", rx: "2", fill: "#333948" })
            ] }),
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(
        "svg",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "8", y: "84", width: "132", height: "8", rx: "2", fill: "#181C23" }),
            /* @__PURE__ */ jsxRuntime.jsxs("g", { clipPath: "url(#clip0_31319_74743)", children: [
              /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "10", y: "86", width: "16", height: "4", rx: "2", fill: "#335FFC" }),
              /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "28", y: "86", width: "16", height: "4", rx: "2", fill: "#333948" }),
              /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "46", y: "86", width: "16", height: "4", rx: "2", fill: "#333948" }),
              /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "64", y: "86", width: "16", height: "4", rx: "2", fill: "#333948" }),
              /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "82", y: "86", width: "16", height: "4", rx: "2", fill: "#333948" }),
              /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "100", y: "86", width: "16", height: "4", rx: "2", fill: "#333948" }),
              /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "118", y: "86", width: "16", height: "4", rx: "2", fill: "#333948" }),
              /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "136", y: "86", width: "16", height: "4", rx: "2", fill: "#333948" })
            ] }),
        ...
        "svg",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsxs("g", { clipPath: "url(#clip0_31319_74757)", children: [
              /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "8", y: "8", width: "132", height: "84", rx: "2", fill: "#181C23" }),
              /* @__PURE__ */ jsxRuntime.jsx(
                "rect",
                {
                  x: "66.8789",
...
function useTradingviewScript(props) {
  ...
  const handleTouchStart = React12.useCallback((e) => {
    ...
    e.stopPropagation();
    e.preventDefault();
    const offsetY2 = event.clientY - rect.bottom;
...
var MaxHeight, MinHeight, Key;
var init_tradingview_script = __esm({
  "src/components/mobile/tradingview/tradingview.script.tsx"() {
    MaxHeight = 354;
    MinHeight = 234;
    ...
    TradingviewUI = (props) => {
      return /* @__PURE__ */ jsxRuntime.jsxs(
        "div",
        {
          ...
          ref: props.boxRef,
          children: [
            /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-w-full oui-h-full", children: /* @__PURE__ */ jsxRuntime.jsx(
              uiTradingview.TradingviewWidget,
              {
                symbol: props.symbol,
...
// src/components/mobile/tradingview/tradingview.widget.tsx
var tradingview_widget_exports = {};
__export(tradingview_widget_exports, {
  TradingviewWidget: () => TradingviewWidget3
});
var TradingviewWidget3;
var init_tradingview_widget = __esm({
  "src/components/mobile/tradingview/tradingview.widget.tsx"() {
    init_tradingview_script();
    init_tradingview_ui();
    TradingviewWidget3 = (props) => {
...
// src/components/mobile/lastTrades/lastTrades.widget.tsx
var lastTrades_widget_exports = {};
__export(lastTrades_widget_exports, {
  MWebLastTrades: () => MWebLastTrades
});
var MWebLastTrades;
var init_lastTrades_widget2 = __esm({
  "src/components/mobile/lastTrades/lastTrades.widget.tsx"() {
    init_lastTrades();
    MWebLastTrades = (props) => {
      return /* @__PURE__ */ jsxRuntime.jsx(
        exports.LastTradesWidget,
        {
          symbol: props.symbol,
          classNames: {
            root: "oui-px-3 ",
...
var TradeData, Row3;
var init_tradeData_ui = __esm({
  "src/components/mobile/tradeData/tradeData.ui.tsx"() {
    TradeData = (props) => {
      const { t } = i18n.useTranslation();
    ...
    Row3 = (props) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "between", width: "100%", className: "oui-text-xs", children: [
        /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 36, children: title }),
        /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 1, children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.Text.numeral, { rule, dp, intensity: 80, children: value }),
          showUSDC && /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 36, children: "USDC" })
        ] })
      ] });
    };
  }
});
var useTradeDataScript;
var init_tradeData_script = __esm({
  "src/components/mobile/tradeData/tradeData.script.tsx"() {
    init_tradingPageContext();
    useTradeDataScript = (props) => {
      const { symbol } = props;
      ...
      const vol_24h = React12.useMemo(() => {
        ...
        if (close && volume && !isNaN(close) && !isNaN(volume)) {
          return new utils.Decimal(close).mul(volume).toFixed(symbolInfo.quote_dp, utils.Decimal.ROUND_DOWN);
        }
        return void 0;
      }, [ticker]);
      const openInterest = React12.useMemo(() => {
        ...
        if (markPrice && openInterest2 && !isNaN(markPrice)) {
          return new utils.Decimal(markPrice).mul(Number(openInterest2)).toFixed(symbolInfo.quote_dp, utils.Decimal.ROUND_DOWN);
        }
        return void 0;
      }, [ticker]);
      return {
...
var TradeDataWidget;
var init_tradeData_widget = __esm({
  "src/components/mobile/tradeData/tradeData.widget.tsx"() {
    init_tradeData_script();
    init_tradeData_ui();
    TradeDataWidget = (props) => {
      const state = useTradeDataScript(props);
      return /* @__PURE__ */ jsxRuntime.jsx(TradeData, { ...state });
    };
  }
});

// src/components/mobile/tradeData/index.ts
var tradeData_exports = {};
__export(tradeData_exports, {
  TradeData: () => TradeData,
  TradeDataWidget: () => TradeDataWidget,
  useTradeDataScript: () => useTradeDataScript
});
var init_tradeData = __esm({
  "src/components/mobile/tradeData/index.ts"() {
    init_tradeData_ui();
    init_tradeData_widget();
    init_tradeData_script();
  }
});
var LazyTradingviewWidget, LazyMWebLastTrades, LazyTradeDataWidget, TopTab, ChevronIcon;
var init_topTab_ui = __esm({
  "src/components/mobile/topTab/topTab.ui.tsx"() {
    ...
    TopTab = (props) => {
      const { t } = i18n.useTranslation();
      const { tradingViewConfig } = exports.useTradingPageContext();
      return /* @__PURE__ */ jsxRuntime.jsxs(
        ui.Tabs,
        {
          variant: "contained",
          ...
          style: {
            marginBottom: props.tab === "chart" /* chart */ ? "8px" : 0
          },
          trailing: /* @__PURE__ */ jsxRuntime.jsx("button", { className: "oui-px-5", onClick: props.toggleContentVisible, children: /* @__PURE__ */ jsxRuntime.jsx(
            ChevronIcon,
            {
...
var TopTabWidget;
var init_topTab_widget = __esm({
  "src/components/mobile/topTab/topTab.widget.tsx"() {
    init_topTab_script();
    init_topTab_ui();
    TopTabWidget = (props) => {
      const state = useTopTabScript();
      return /* @__PURE__ */ jsxRuntime.jsx(TopTab, { className: props.className, ...state });
    };
  }
});

// src/components/mobile/topTab/index.ts
var topTab_exports = {};
__export(topTab_exports, {
  TopTab: () => TopTab,
  TopTabWidget: () => TopTabWidget,
  useTopTabScript: () => useTopTabScript
});
var init_topTab = __esm({
  "src/components/mobile/topTab/index.ts"() {
    init_topTab_ui();
    init_topTab_widget();
    init_topTab_script();
...
var OrderBookAndEntryWidget;
var init_orderBookAndEntry_widget = __esm({
  "src/components/mobile/orderBookAndEntry/orderBookAndEntry.widget.tsx"() {
    init_orderBookAndEntry_script();
    init_orderBookAndEntry_ui();
    OrderBookAndEntryWidget = (props) => {
      const state = useOrderBookAndEntryScript();
      return /* @__PURE__ */ jsxRuntime.jsx(OrderBookAndEntry, { className: props.className, ...state });
    };
  }
});

// src/components/mobile/orderBookAndEntry/index.ts
var orderBookAndEntry_exports = {};
__export(orderBookAndEntry_exports, {
  OrderBookAndEntry: () => OrderBookAndEntry,
  OrderBookAndEntryWidget: () => OrderBookAndEntryWidget,
  useOrderBookAndEntryScript: () => useOrderBookAndEntryScript
});
var init_orderBookAndEntry = __esm({
  "src/components/mobile/orderBookAndEntry/index.ts"() {
    init_orderBookAndEntry_ui();
    init_orderBookAndEntry_widget();
    init_orderBookAndEntry_script();
  }
});
...
var init_dataList_ui2 = __esm({
  "src/components/mobile/dataList/dataList.ui.tsx"() {
    ...
    SymbolControlHeader = (props) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(
        ui.Flex,
        {
          ...
          className: "oui-rounded-b-xl oui-bg-base-9",
          children: [
            /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { className: "oui-cursor-pointer oui-gap-[2px]", children: [
              /* @__PURE__ */ jsxRuntime.jsx(
                ui.Checkbox,
                {
                  color: "white",
    ...
    OrdersView = (props) => {
      return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", pb: 2, width: "100%", children: [
        /* @__PURE__ */ jsxRuntime.jsx(ui.Divider, { className: "oui-w-full" }),
        props.type !== uiOrders.TabType.orderHistory && /* @__PURE__ */ jsxRuntime.jsx(SymbolControlHeader, { ...props }),
        /* @__PURE__ */ jsxRuntime.jsx(
          uiOrders.MobileOrderListWidget,
          {
            symbol: props.showAllSymbol ? void 0 : props.symbol,
            onSymbolChange: props.onSymbolChange,
            type: props.type,
            ...
            sharePnLConfig: props.sharePnLConfig,
            showFilter: props.type === uiOrders.TabType.orderHistory,
            filterConfig: { range: { from: void 0, to: void 0 } }
          }
        )
      ] });
    };
    ...
    HistoryTab = (props) => {
      const { t } = i18n.useTranslation();
      return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-min-h-[300px]", children: /* @__PURE__ */ jsxRuntime.jsxs(
        ui.Tabs,
        {
          value: props.subTab,
          onValueChange: (e) => props.setSubTab(e),
          size: "md",
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              ui.TabPanel,
              {
                ...
                value: "Position history" /* positionHistory */,
                children: /* @__PURE__ */ jsxRuntime.jsx(
                  uiPositions.MobilePositionHistoryWidget,
                  {
                    symbol: props.showAllSymbol ? void 0 : props.symbol,
                    onSymbolChange: props.onSymbolChange,
            ...
            /* @__PURE__ */ jsxRuntime.jsx(
              ui.TabPanel,
              {
                title: t("orders.orderHistory"),
                value: "Order history" /* orderHistory */,
                children: /* @__PURE__ */ jsxRuntime.jsx(OrdersView, { type: uiOrders.TabType.orderHistory, ...props })
              }
            )
          ]
        }
      ...
      const tabPanelItems = [
        {
          ...
          content: /* @__PURE__ */ jsxRuntime.jsx(PositionsView2, { ...props })
        },
        {
          title: `${t("orders.status.pending")} ${pendingOrderCount > 0 ? `(${pendingOrderCount})` : ""}`,
          value: "Pending" /* pending */,
        ...
        },
        {
          ...
          content: /* @__PURE__ */ jsxRuntime.jsx(HistoryTab, { ...props })
        },
        {
          title: t("positions.liquidation"),
          value: "Liquidation" /* liquidation */,
          content: /* @__PURE__ */ jsxRuntime.jsx(
            uiPositions.MobileLiquidationWidget,
            {
              enableLoadMore: true,
              symbol: showAllSymbol ? void 0 : symbol,
              classNames: { cell: "oui-p-2 oui-bg-base-9 oui-rounded-xl" }
...
var DataListWidget2;
var init_dataList_widget2 = __esm({
  "src/components/mobile/dataList/dataList.widget.tsx"() {
    init_dataList_script2();
    init_dataList_ui2();
    DataListWidget2 = (props) => {
      const state = useDataListScript2(props);
      return /* @__PURE__ */ jsxRuntime.jsx(DataList2, { ...state, className: props.className });
    };
  }
});

// src/components/mobile/dataList/index.ts
...
// src/components/mobile/bottomNavBar/account/account.script.tsx
init_tradingPageContext();
var HeadIcon = () => {
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx("defs", { children: /* @__PURE__ */ jsxRuntime.jsx("clipPath", { id: "a", children: /* @__PURE__ */ jsxRuntime.jsx("rect", { width: "24", height: "24", rx: "12", fill: "#fff" }) }) })
      ]
    }
  );
};
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx("defs", { children: /* @__PURE__ */ jsxRuntime.jsx("clipPath", { id: "a", children: /* @__PURE__ */ jsxRuntime.jsx("path", { fill: "#fff", d: "M0 0h20v20H0z" }) }) })
      ]
    }
  );
};
var OrderlyIcon = (props) => {
  const { size = 20 } = props;
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "svg",
    {
      ...
      xmlns: "http://www.w3.org/2000/svg",
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs("g", { clipPath: "url(#clip0_6403_64483)", children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            "path",
            {
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("defs", { children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx("clipPath", { id: "clip0_6403_64483", children: /* @__PURE__ */ jsxRuntime.jsx("rect", { width: "20", height: "20", fill: "white" }) })
        ] })
      ]
    }
  );
...
var AccountSheet = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", gap: 4, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 3, width: "100%", justify: "center", children: [
      props.showGetTestUSDC && /* @__PURE__ */ jsxRuntime.jsx(
        ui.Button,
        {
          variant: "outlined",
          size: "md",
      ...
      /* @__PURE__ */ jsxRuntime.jsx(
        ui.Button,
        {
          ...
          children: t("connector.disconnect")
        }
      )
    ] })
  ] });
...
var AccountInfo = (props) => {
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { width: "100%", justify: "between", children: [
    /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 3, children: [
      /* @__PURE__ */ jsxRuntime.jsx(HeadIcon, {}),
      /* @__PURE__ */ jsxRuntime.jsxs(
        ui.Flex,
        {
          direction: "column",
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(ui.Text.formatted, { rule: "address", children: props.address }),
            /* @__PURE__ */ jsxRuntime.jsx(
              ui.Text.formatted,
              {
                size: "2xs",
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "between", width: "100%", children: [
              /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "2xs", children: t("affiliate.referral") }),
              /* @__PURE__ */ jsxRuntime.jsx(ui.ArrowRightShortIcon, { color: "white", opacity: 0.98, size: 16 })
            ] })
          }
        ),
        props.isAffiliate && /* @__PURE__ */ jsxRuntime.jsxs(
          ui.Flex,
          {
            gradient: "primary",
            p: 4,
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", itemAlign: "start", children: [
                /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "xs", children: t("common.affiliate") }),
                /* @__PURE__ */ jsxRuntime.jsxs(ui.Text, { size: "2xs", intensity: 54, children: [
                  "(",
              ...
              /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { className: "oui-gap-[6px]", children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx(
                  ui.Text.numeral,
                  {
                    ...
                    rm: utils.Decimal.ROUND_DOWN,
                    rule: "price",
                    children: props.affiliateCommission30D ?? "--"
                  }
                )
              ] })
            ]
        ...
        props.isTrader && /* @__PURE__ */ jsxRuntime.jsxs(
          ui.Flex,
          {
            gradient: "success",
            p: 4,
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", itemAlign: "start", children: [
                /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "xs", children: t("affiliate.trader") }),
                /* @__PURE__ */ jsxRuntime.jsxs(ui.Text, { size: "2xs", intensity: 54, children: [
                  "(",
                  t("affiliate.commission.30d"),
                  ")"
              ...
              /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { className: "oui-gap-[6px]", children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx(
                  ui.Text.numeral,
                  {
                    ...
                    rm: utils.Decimal.ROUND_DOWN,
                    rule: "price",
                    children: props.traderCommission30D ?? "--"
                  }
                )
              ] })
            ]
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          "button",
          {
            ...
            className: "oui-cursor-pointer oui-w-full",
            children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "between", width: "100%", children: [
              /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 1, className: "oui-text-base-contrast oui-text-2xs", children: [
                /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { children: t("common.tradingRewards") }),
                /* @__PURE__ */ jsxRuntime.jsxs(ui.Text, { intensity: 54, children: [
                  "(",
                  /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { children: `${t("tradingRewards.epoch")?.toLowerCase()} ` }),
                  /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 98, children: props.curEpochId }),
                  " )"
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntime.jsx(ui.ArrowRightShortIcon, { color: "white", opacity: 0.98, size: 16 })
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(
          ui.Flex,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { className: "oui-gap-[6px]", children: [
                /* @__PURE__ */ jsxRuntime.jsx(OrderlyIcon, {}),
                /* @__PURE__ */ jsxRuntime.jsx(
                  ui.Text.numeral,
                  {
                    dp: 2,
...
var useAccountSheetScript = (props) => {
  const { t } = i18n.useTranslation();
  ...
  const [getTestUSDC, { isMutating: gettingTestUSDC }] = hooks.useMutation(
    `${operatorUrl}/v1/faucet/usdc`
  );
  const onGetTestUSDC = () => {
...
function useGetChains(chainId) {
  const [mainChains, { findByChainId }] = hooks.useChains("mainnet", {
    pick: "network_infos",
...
var AccountSheetWidget = (props) => {
  const state = useAccountSheetScript(props);
  return /* @__PURE__ */ jsxRuntime.jsx(AccountSheet, { ...state });
};
var useAccountScript = () => {
  const { t } = i18n.useTranslation();
  const { referral, tradingRewards, bottomSheetLeading } = exports.useTradingPageContext();
  const { account, state } = hooks.useAccount();
  const onShowAccountSheet = () => {
    ui.modal.sheet({
      title: t("common.account"),
      leading: bottomSheetLeading,
      content: /* @__PURE__ */ jsxRuntime.jsx(AccountSheetWidget, { ...referral, ...tradingRewards })
    });
  };
  return {
    onShowAccountSheet,
    ...
    uiConnector.AuthGuard,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx(
        ui.Button,
        {
          ...
          children: ui.formatAddress(props.address, [4, 4])
        }
      )
    }
  );
...
// src/components/mobile/bottomNavBar/balance/balance.script.tsx
var useBalanceScript = () => {
  return {};
};
var BalanceWidget = () => {
  const state = useBalanceScript();
  return /* @__PURE__ */ jsxRuntime.jsx(Balance, { ...state });
};
var Chain = (props) => {
  const { t } = i18n.useTranslation();
  return /* @__PURE__ */ jsxRuntime.jsx(
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Box, { className: "oui-relative oui-rounded-t-[6px] oui-rounded-bl-[6px] oui-rounded-br-[3px] oui-bg-base-5 oui-px-2 oui-h-7 oui-flex oui-items-center", children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-absolute oui-right-0 oui-bottom-0", children: /* @__PURE__ */ jsxRuntime.jsxs(
          "svg",
          {
            ...
            xmlns: "http://www.w3.org/2000/svg",
            children: [
              /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M9 6V0L0 9h6a3 3 0 0 0 3-3", fill: "url(#a)" }),
              /* @__PURE__ */ jsxRuntime.jsx("defs", { children: /* @__PURE__ */ jsxRuntime.jsxs(
                "linearGradient",
                {
                  id: "a",
...
var BottomNavBar = (props) => {
  const renderContent = () => {
    ...
    if (!props.disabledConnect && props.status === types.AccountStatusEnum.EnableTradingWithoutConnected) {
      return /* @__PURE__ */ jsxRuntime.jsx(LinkDevice, { onDisconnect: props.onDisconnect });
    }
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-bg-base-9 oui-border-t oui-border-line-4", children: [
    /* @__PURE__ */ jsxRuntime.jsxs(
      ui.Flex,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(BalanceWidget, {}),
          /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 2, children: [
            showScanQRCode && /* @__PURE__ */ jsxRuntime.jsx(uiScaffold.ScanQRCodeWidget, {}),
            renderContent(),
            /* @__PURE__ */ jsxRuntime.jsx(MobileAccountMenuExtension, {})
          ] })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-h-[env(safe-area-inset-bottom)]" })
  ] });
};
...
var BottomNavBarWidget = () => {
  const state = useBottomNavBarScript();
  return /* @__PURE__ */ jsxRuntime.jsx(BottomNavBar, { ...state });
};

// src/components/mobile/portfolioSheet/portfolioSheet.script.tsx
init_hooks();
var usePortfolioSheetScript = () => {
  const { state, account, isMainAccount } = hooks.useAccount();
  ...
  const onSettlePnL = React12.useCallback(async () => {
    return account.settle().catch((e) => {
      ...
      if (e?.code === "ACTION_REJECTED") {
        ui.toast.error(t("connector.userRejected"));
        return Promise.reject(e);
      }
    }).then((res) => {
      ui.toast.success(t("settle.settlement.requested"));
...
var useAssets = () => {
  const { hideAssets, setHideAssets } = exports.useTradingLocalStorage();
  const toggleHideAssets = () => {
    setHideAssets(!hideAssets);
  };
  const { totalCollateral, freeCollateral, totalValue, availableBalance } = hooks.useCollateral({
    dp: 2
  });
  return {
    hideAssets,
...
var useMarginRatioAndLeverage = () => {
  ...
  const onSave = async (leverage2) => {
    try {
      update({ leverage: leverage2 }).then(
        () => {
...
function getMarginRatioColor(marginRatio, mmr) {
  if (mmr === null) {
...
var PortfolioSheet = (props) => {
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", gap: 4, width: "100%", children: [
...
var Asset = (props) => {
  ...
  const onUnsettleClick = React12.useCallback(() => {
    return ui.modal.confirm({
      ...
      // maxWidth: "xs",
      content: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 54, size: "xs", children: /* @__PURE__ */ jsxRuntime.jsx(i18n.Trans, { i18nKey: "settle.settlePnl.description" }) }),
      onCancel: () => {
  ...
  const clsName = props.totalUnrealizedROI > 0 ? "oui-text-success-darken" : "oui-text-danger-darken";
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", gap: 3, width: "100%", children: [
    /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", itemAlign: "start", width: "100%", children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        ui.Text.formatted,
        {
          size: "2xs",
          intensity: 36,
          suffix: props.hideAssets ? /* @__PURE__ */ jsxRuntime.jsx(
            ui.EyeIcon,
            {
              opacity: 1,
              size: 16,
          ...
          className: "oui-cursor-pointer",
          children: `${t("common.totalValue")} (USDC)`
        }
      ),
      /* @__PURE__ */ jsxRuntime.jsx(
        ui.Text.numeral,
        {
          ...
          children: props.totalValue ?? "--"
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntime.jsxs(ui.Grid, { cols: 2, rows: 1, width: "100%", children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        ui.Statistic,
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 1, children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              ui.Text.pnl,
              {
                ...
                padding: false,
                visible: !props.hideAssets,
                children: props.aggregated.total_unreal_pnl
              }
            ),
            !props.hideAssets && /* @__PURE__ */ jsxRuntime.jsx(
              ui.Text.roi,
              {
                size: "xs",
                dp: 2,
                ...
                suffix: ")",
                className: clsName,
                children: props.totalUnrealizedROI
              }
            )
          ] })
        }
          ...
          children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "between", width: "100%", children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              ui.Text.pnl,
              {
                ...
                padding: false,
                visible: !props.hideAssets,
                children: props.aggregated.total_unsettled_pnl
              }
            ),
            /* @__PURE__ */ jsxRuntime.jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "2xs", color: "primary", children: t("settle.settlePnl") })
                ]
              }
            )
          ] })
...
var MarginRatio = (props) => {
  const { t } = i18n.useTranslation();
  const { high, mid, low } = getMarginRatioColor(
    props.marginRatioVal,
    props.mmr
  );
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Grid, { cols: 2, rows: 1, width: "100%", children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      ui.Statistic,
      {
        label: t("trading.asset.marginRatio"),
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 2, children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            ui.Text.numeral,
            {
              ...
              padding: false,
              visible: !props.hideAssets,
              children: props.marginRatioVal
            }
          ),
          !props.hideAssets && /* @__PURE__ */ jsxRuntime.jsx(
            RiskIndicator,
            {
              className: low ? "oui-rotate-0" : mid ? "oui-rotate-90" : high ? "oui-rotate-180" : ""
            }
          )
        ] })
      }
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      ui.Statistic,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "start", width: "100%", gap: 1, children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            ui.Text.collateral,
            {
              size: "xs",
          ...
          /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "xs", children: "/" }),
          /* @__PURE__ */ jsxRuntime.jsx(
            ui.Text.collateral,
            {
              size: "xs",
              ...
              padding: false,
              visible: !props.hideAssets,
              children: props.totalCollateral
            }
          )
        ] })
      }
      ...
      ui.Grid,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            ui.Button,
            {
              icon: /* @__PURE__ */ jsxRuntime.jsx(ui.ArrowDownShortIcon, { color: "white", opacity: 0.8 }),
              size: "md",
              fullWidth: true,
          ...
          props.hasSubAccount && /* @__PURE__ */ jsxRuntime.jsx(
            ui.Button,
            {
              icon: /* @__PURE__ */ jsxRuntime.jsx(ui.ArrowLeftRightIcon, { color: "white", opacity: 0.8 }),
              color: "gray",
              size: "md",
          ...
          /* @__PURE__ */ jsxRuntime.jsx(
            ui.Button,
            {
              icon: /* @__PURE__ */ jsxRuntime.jsx(ui.ArrowUpShortIcon, { color: "white", opacity: 0.8 }),
              size: "md",
              fullWidth: true,
...
var PortfolioSheetWidget = () => {
  const state = usePortfolioSheetScript();
  return /* @__PURE__ */ jsxRuntime.jsx(PortfolioSheet, { ...state });
};

// src/index.ts
init_fundingRate();

// src/components/mobile/fundingRateModal/index.ts
init_fundingRateModal_script();
init_fundingRateModal_ui();
init_fundingRateModal_widget();
...
var toastId = "rwaOutsideMarketHoursNotify";
var RwaOutsideMarketHoursNotify = () => {
  const { t } = i18n.useTranslation();
  const closeNotify = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { r: "lg", className: "oui-bg-base-6 oui-relative oui-max-w-[348px]", children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      ui.Flex,
      {
        direction: "column",
    ...
    /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { p: 4, mr: 1, children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "sm", intensity: 80, weight: "semibold", children: t("trading.rwa.outsideMarketHours.notify") }) }),
    /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
...
var showRwaOutsideMarketHoursNotify = () => {
  ui.toast.custom(/* @__PURE__ */ jsxRuntime.jsx(RwaOutsideMarketHoursNotify, {}), {
    id: toastId,
    duration: 3e3
  });
};
...
var useSplitPersistent = (key, defaulValue, dep) => {
  ...
  const setSize = (size2) => {
    localStorage.setItem(key, size2);
  };
  return [size, setSize];
};

// src/pages/trading/trading.script.tsx
init_hooks();
init_tradingPageContext();
var useFirstTimeDeposit = () => {
  const { state } = hooks.useAccount();
  const { wrongNetwork, disabledConnect } = reactApp.useAppContext();
  const { totalValue } = hooks.useCollateral({
    dp: 2
  ...
  const { startTime, endTime } = React12.useMemo(() => {
    ...
    const endTime2 = today.getTime();
    const startTime2 = endTime2 - 90 * 24 * 60 * 60 * 1e3;
    return {
      startTime: startTime2,
      endTime: endTime2
    };
  }, []);
  const [_, { meta }] = hooks.useAssetsHistory(
    {
      startTime,
      endTime,
      page: 1,
      pageSize: 5,
      side: types.AssetHistorySideEnum.DEPOSIT,
      status: types.AssetHistoryStatusEnum.COMPLETED
    },
    {
      shouldUpdateOnWalletChanged: (data) => data.side === types.AssetHistorySideEnum.DEPOSIT && data.transStatus === types.AssetHistoryStatusEnum.COMPLETED
    }
  );
...
var topBarHeight = 48;
var bottomBarHeight = 29;
var space = 8;
var symbolInfoBarHeight = 54;
var orderEntryMinWidth = 280;
var orderEntryMaxWidth = 360;
var orderbookMinWidth = 280;
var orderbookMaxWidth = 732;
var orderbookMinHeight = 464;
var orderbookMaxHeight = 728;
var tradindviewMinHeight = 320;
var tradingViewMinWidth = 540;
var dataListMaxHeight = 800;
var dataListInitialHeight = 350;
...
var useTradingScript = () => {
  ...
  const { state } = hooks.useAccount();
  const { t } = i18n.useTranslation();
  const { wrongNetwork, disabledConnect, restrictedInfo, onRouteChange } = reactApp.useAppContext();
  const { hideAssets, setHideAssets } = exports.useTradingLocalStorage();
  const isFirstTimeDeposit = useFirstTimeDeposit();
  const { totalValue } = hooks.useCollateral();
  const total = reactApp.useDataTap(totalValue);
  const max2XL = hooks.useMediaQuery("(max-width: 1279px)");
  const min3XL = hooks.useMediaQuery("(min-width: 1440px)");
  const max4XL = hooks.useMediaQuery("(max-width: 1680px)");
  const [layout, setLayout] = hooks.useLocalStorage(
    ORDERLY_ORDER_ENTRY_SIDE_MARKETS_LAYOUT,
    "right"
  );
  const [marketLayout, setMarketLayout] = hooks.useLocalStorage(
  ...
  const onShowPortfolioSheet = () => {
    if (canTrade) {
      ui.modal.sheet({
        ...
        content: /* @__PURE__ */ jsxRuntime.jsx(PortfolioSheetWidget, {})
      });
    }
  };
  ...
  const navigateToPortfolio = typeof onRouteChange === "function" ? () => onRouteChange({ href: "/portfolio", name: t("common.portfolio") }) : void 0;
  const map = {
    layout,
    onLayout: setLayout,
    marketLayout,
...
var useOrderEntryPositions = (options) => {
  const { canTrade, isFirstTimeDeposit } = options;
  const [positions, setPositions] = hooks.useLocalStorage(
    "orderly_assets_orderEntry_margin_positions",
    [0, 1, 2]
  );
  const updatePositions = (currentIdx, targetIdx) => {
    const pos2 = [...positions];
    if (currentIdx === 0 && targetIdx === pos2.length - 1) {
      pos2[targetIdx] = positions[currentIdx];
      for (let i = 0; i < pos2.length - 1; i++) {
        pos2[i] = positions[i + 1];
      }
    } else if (currentIdx === pos2.length - 1 && targetIdx === 0) {
      pos2[targetIdx] = positions[currentIdx];
      for (let i = 1; i < pos2.length; i++) {
        pos2[i] = positions[i - 1];
      }
    } else {
      [pos2[currentIdx], pos2[targetIdx]] = [pos2[targetIdx], pos2[currentIdx]];
    }
    setPositions(pos2);
  };
...
var useSplitSize = (options) => {
  ...
  const [orderBookSplitHeightSM, setOrderbookSplitHeightSM] = useSplitPersistent("orderly_orderbook_split_height_sm", "280px");
  return {
    orderBookSplitSize,
...
function getOffsetSizeNum(size) {
  if (size) {
...
function useExtraHeight(options) {
  ...
  const space2 = 10 + 12;
  const [dataListHeight, setDataListHeight] = hooks.useLocalStorage(
    "orderly_trading_data_list_height",
    dataListMinHeight
  );
  const onTradingviewAndOrderbookDragging = (preSize, nextSize) => {
    ...
    const orderEntryHeight = options.orderEntryViewRef.current?.clientHeight || 0;
    ...
    } else if (tradingviewHeight + orderbookHeight < tradindviewMaxHeight + orderbookMaxHeight) {
      const height = tradingviewHeight + orderbookHeight + space2 + symbolInfoBarHeight;
      const offset = Math.max(0, height - orderEntryHeight);
      setExtraHeight(extraHeight + offset);
    }
  };
  const onDataListSplitHeightDragging = (preSize, nextSize) => {
    const boxHeight = max2XLSplitRef?.current?.boxHeight;
    if (!boxHeight) {
      return;
    }
    const splitDataListHeight = boxHeight * nextSize / 100;
    if (splitDataListHeight >= dataListMinHeight && splitDataListHeight <= dataListMaxHeight) {
...
var DesktopLayout4 = (props) => {
  ...
  function handleDragEnd(event) {
    ...
    if (active.id !== over?.id && over) {
      ...
      if (oldIndex !== -1 && newIndex !== -1) {
        const newItems = sortable.arrayMove(sortableItems, oldIndex, newIndex);
  ...
  const horizontalMarketsView = /* @__PURE__ */ jsxRuntime.jsx(
    markets.HorizontalMarketsWidget,
    {
      symbol: props.symbol,
      onSymbolChange: props.onSymbolChange,
      maxItems: -1,
  ...
  const stickyHorizontalMarketsView = /* @__PURE__ */ jsxRuntime.jsx(
    ui.Box,
    {
      ...
      style: {
        bottom: 0,
        minWidth: (max2XL ? 1024 : 1440) - scrollBarWidth - containerPaddingX * 2
      },
  ...
  const symbolInfoBarView = /* @__PURE__ */ jsxRuntime.jsx(
    ui.Box,
    {
      ...
      style: {
        ...
        height: symbolInfoBarHeight2
      },
      children: /* @__PURE__ */ jsxRuntime.jsx(
        markets.SymbolInfoBarFullWidget,
        {
          symbol: props.symbol,
          onSymbolChange: props.onSymbolChange,
          closeCountdown,
  ...
  const tradingviewWidget = /* @__PURE__ */ jsxRuntime.jsx(
    uiTradingview.TradingviewWidget,
    {
      classNames: {
        root: ui.cn(
    ...
    return {
      ...
      assets: {
        ...
        element: /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(
            uiTransfer.DepositStatusWidget,
            {
  ...
  const orderEntryView = /* @__PURE__ */ jsxRuntime.jsx(
    ui.Flex,
    {
      ...
      children: sortableItems.map((key) => {
        return /* @__PURE__ */ jsxRuntime.jsx(
          SortablePanel,
          {
            id: key,
            showIndicator: showPositionIcon,
            className: orderInteractionWidgets[key].className,
            children: orderInteractionWidgets[key].element
          },
          key
        );
      })
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(
          SplitLayout,
          {
            style: {
              ...
              maxHeight: `calc(100% - ${symbolInfoBarHeight2}px - ${space}px)`
            },
            className: "oui-w-full",
            mode: "vertical",
  ...
  const onSizeChange = (width) => layout === "left" ? setMainSplitSize(getOffsetSizeNum(width)) : setMainSplitSize(width);
  if (max2XL) {
    return /* @__PURE__ */ jsxRuntime.jsxs(
      core.DndContext,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            sortable.SortableContext,
            {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Box, { height: "100%", children: [
                marketLayout === "top" && /* @__PURE__ */ jsxRuntime.jsx(
                  ui.Box,
                  {
                    className: ui.cn("oui-mt-2 oui-max-h-8 oui-px-3", props.className),
                    children: horizontalMarketsView
                  }
                ),
                /* @__PURE__ */ jsxRuntime.jsxs(
                            ...
                            /* @__PURE__ */ jsxRuntime.jsxs(
                              ui.Flex,
                              {
                                ...
                                children: [
                                  ...
                                  /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { height: props.extraHeight })
                                ]
                              }
                            )
                          ]
          ...
          /* @__PURE__ */ jsxRuntime.jsx(core.DragOverlay, { dropAnimation: dropAnimationConfig, children: activeId ? /* @__PURE__ */ jsxRuntime.jsx(
            SortablePanel,
            {
              id: activeId,
              showIndicator: showPositionIcon,
              dragOverlay: true,
              className: `${orderInteractionWidgets[activeId].className} oui-shadow-lg oui-shadow-base-9`,
              children: orderInteractionWidgets[activeId].element
            }
          ) : null })
        ]
      }
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(
          core.DragOverlay,
          {
            ...
            children: activeId ? /* @__PURE__ */ jsxRuntime.jsx(
              SortablePanel,
              {
                id: activeId,
                showIndicator: showPositionIcon,
...
var Countdown = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { className: "oui-text-base-contrast-54 oui-text-xs oui-font-normal", children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      ui.Box,
      {
        ml: 2,
...
function breakDownSeconds(total) {
  ...
  const rwaStatusBar = React12.useMemo(() => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      ui.Flex,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.NewsFillIcon, { color: "success", size: 16, className: "oui-flex-shrink-0" }),
          /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { className: "oui-flex-1 oui-text-success", children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { children: open ? t("trading.rwa.mWeb.outsideMarketHours.desc") : t("trading.rwa.mWeb.insideMarketHours.desc") }) }),
          /* @__PURE__ */ jsxRuntime.jsx(Countdown, { timeInterval: closeTimeInterval })
        ]
      }
    );
            ...
            /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx(
                "button",
                {
                  ...
                  className: "oui-px-1",
                  children: props.hideAssets ? /* @__PURE__ */ jsxRuntime.jsx(
                    ui.EyeIcon,
                    {
                      color: "primary",
                      opacity: 1,
              ...
              /* @__PURE__ */ jsxRuntime.jsx(MaybeEqual, {})
            ] }),
            /* @__PURE__ */ jsxRuntime.jsx(
              ui.Text.numeral,
              {
                suffix: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 20, children: "\xA0USDC" }),
                dp: 2,
                visible: !props.hideAssets,
                children: props.canTrade ? props.total ?? "--" : "--"
              }
            )
          ]
        }
...
var TradingWidget = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Trading, { ...state });
};

// src/provider/tradingPageProvider.tsx
init_utils();
init_tradingPageContext();
var TradingPageProvider = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(exports.TradingPageContext.Provider, { value: memoizedValue, children });
};
var TradingPage = (props) => {
  return /* @__PURE__ */ jsxRuntime.jsx(
    TradingPageProvider,
    {
      symbol: props.symbol,
      ...
      sharePnLConfig: props.sharePnLConfig,
      children: /* @__PURE__ */ jsxRuntime.jsx(TradingWidget, {})
    }
  );
};
...
exports.BottomNavBarWidget = BottomNavBarWidget;
exports.PortfolioSheet = PortfolioSheet;
exports.PortfolioSheetWidget = PortfolioSheetWidget;
exports.SplitLayout = SplitLayout;
exports.Trading = Trading;
exports.TradingPage = TradingPage;
exports.TradingPageProvider = TradingPageProvider;
exports.TradingWidget = TradingWidget;
