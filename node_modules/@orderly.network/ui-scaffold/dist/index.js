...
var uiNotification = require('@orderly.network/ui-notification');
...
var jsQR__default = /*#__PURE__*/_interopDefault(jsQR);
...
var init_communtiyIcons = __esm({
  "src/components/icons/communtiyIcons.tsx"() {
    CommuntiyTelegramIcon = React6__default.default.forwardRef((props, ref) => {
    ...
    CommuntiyXIcon = React6__default.default.forwardRef((props, ref) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsx(
        "svg",
        {
          ...
          xmlns: "http://www.w3.org/2000/svg",
          ...rest,
          children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: "m4.42 4.73 4.633 6.194-4.662 5.037H5.44l4.082-4.41 3.298 4.41h3.57l-4.893-6.543 4.34-4.689h-1.05l-3.759 4.062-3.037-4.062zm1.543.772h1.64l7.244 9.686h-1.64z" })
        }
      );
    });
...
var init_signal = __esm({
  "src/components/icons/signal.tsx"() {
    SignalIcon = React6__default.default.forwardRef(
      (props, ref) => {
...
var OrderlyLogo;
var init_orderlyLogo = __esm({
  "src/components/icons/orderlyLogo.tsx"() {
    OrderlyLogo = (props) => {
      return /* @__PURE__ */ jsxRuntime.jsxs(
        "svg",
        {
...
exports.RestrictedInfo = void 0;
var init_restrictedInfo_ui = __esm({
  "src/components/restrictedInfo/restrictedInfo.ui.tsx"() {
    init_icons();
    exports.RestrictedInfo = (props) => {
      ...
      if (restrictedOpen && canUnblock && accessRestricted === void 0) {
        return /* @__PURE__ */ jsxRuntime.jsxs(
          ui.SimpleDialog,
          {
            open: canUnblock,
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gapX: 1, pt: 2, children: [
                /* @__PURE__ */ jsxRuntime.jsx(
                  ui.Checkbox,
                  {
                    id: "orderConfirm",
                ...
                /* @__PURE__ */ jsxRuntime.jsx("label", { htmlFor: "orderConfirm", className: "oui-cursor-pointer", children: t("restrictedInfo.accessRestricted.agree") })
              ] })
            ]
          }
        );
      ...
      const renderContent = () => {
        if (typeof content === "function") {
          return /* @__PURE__ */ jsxRuntime.jsx("span", { children: content({ ip, brokerName }) });
        }
        return content || /* @__PURE__ */ jsxRuntime.jsx("span", { children: t("restrictedInfo.description.default", {
          brokerName,
          ip
        }) });
      };
        ...
        ui.Flex,
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsxs(
            ui.Flex,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntime.jsx(InfoIcon, { size: 20, className: "oui-size-4 oui-shrink-0 lg:oui-size-5" }),
                renderContent()
              ]
            }
          )
...
exports.useRestrictedInfoScript = void 0;
var init_restrictedInfo_script = __esm({
  "src/components/restrictedInfo/restrictedInfo.script.tsx"() {
    exports.useRestrictedInfoScript = () => {
      const { restrictedInfo } = reactApp.useAppContext();
      const brokerName = hooks.useConfig("brokerName");
      const container = React6.useRef(null);
      const [mutiLine, setMutiLine] = React6.useState(false);
      const [agree, setAgree] = React6.useState(false);
      const [canUnblock, setCanUnblock] = hooks.useLocalStorage(
        "orderly_unblock_restricted",
        true
      );
      ui.useObserverElement(container.current, (entry) => {
...
exports.RestrictedInfoWidget = void 0;
var init_restrictedInfo_widget = __esm({
  "src/components/restrictedInfo/restrictedInfo.widget.tsx"() {
    init_restrictedInfo_script();
    init_restrictedInfo_ui();
    exports.RestrictedInfoWidget = (props) => {
      const state = exports.useRestrictedInfoScript();
      return /* @__PURE__ */ jsxRuntime.jsx(exports.RestrictedInfo, { ...props, ...state });
    };
  }
});

// src/components/restrictedInfo/index.ts
var restrictedInfo_exports = {};
__export(restrictedInfo_exports, {
  RestrictedInfo: () => exports.RestrictedInfo,
  RestrictedInfoWidget: () => exports.RestrictedInfoWidget,
  useRestrictedInfoScript: () => exports.useRestrictedInfoScript
});
var init_restrictedInfo = __esm({
  "src/components/restrictedInfo/index.ts"() {
    init_restrictedInfo_ui();
    init_restrictedInfo_widget();
    init_restrictedInfo_script();
  }
});
exports.BottomNav = void 0;
var init_bottomNav_ui_mobile = __esm({
  "src/components/bottomNav/bottomNav.ui.mobile.tsx"() {
    exports.BottomNav = (props) => {
      const { mainMenus, current, onRouteChange } = props;
      const isSubmenu = React6.useMemo(() => {
        return mainMenus?.every((menu) => menu.href !== current);
      }, [mainMenus, current]);
      const menus = React6.useMemo(() => {
        return mainMenus?.map((menu) => {
          const isActive = current === menu.href;
          const isExternalLink = menu.href.startsWith("http://") || menu.href.startsWith("https://");
          return /* @__PURE__ */ jsxRuntime.jsxs(
            ui.Flex,
            {
              direction: "column",
              ...
              children: [
                /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { children: isActive ? menu.activeIcon : menu.inactiveIcon }),
                /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "2xs", intensity: isActive ? 98 : 36, children: menu.name })
              ]
            },
            menu.name
          );
...
exports.BottomNavWidget = void 0;
var init_bottomNav_widget = __esm({
  "src/components/bottomNav/bottomNav.widget.tsx"() {
    init_bottomNav_ui_mobile();
    exports.BottomNavWidget = (props) => {
      const { isMobile } = ui.useScreen();
      const { mainMenus, ...rest } = props;
      return isMobile ? /* @__PURE__ */ jsxRuntime.jsx(exports.BottomNav, { mainMenus, ...rest }) : null;
    };
  }
});
var TradingMenuChoice, BottomNavTradingMenu;
var init_tradingMenu_ui = __esm({
  "src/components/bottomNav/tradingMenu.ui.tsx"() {
    TradingMenuChoice = (props) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(
        ui.Flex,
        {
          ...
          onClick,
          children: [
            /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 2, itemAlign: "center", children: [
              icon,
              /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "sm", intensity: 80, weight: "semibold", children: label })
            ] }),
            /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { className: "oui-ml-auto", children: selected ? /* @__PURE__ */ jsxRuntime.jsx(ui.SelectedChoicesFillIcon, { size: 14 }) : null })
          ]
        }
      );
    };
    BottomNavTradingMenu = (props) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(ui.PopoverRoot, { open: open2, onOpenChange: setOpen, children: [
        /* @__PURE__ */ jsxRuntime.jsx(ui.PopoverTrigger, { asChild: true, children: !open2 ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            ui.Flex,
            {
              width: 48,
        ...
        /* @__PURE__ */ jsxRuntime.jsx(
          ui.PopoverContent,
          {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", className: "oui-gap-1 oui-w-full", children: [
              /* @__PURE__ */ jsxRuntime.jsx(
                TradingMenuChoice,
                {
                  icon: /* @__PURE__ */ jsxRuntime.jsx(ui.SpotIcon, { size: 20 }),
                  label: "Spot",
                  onClick: () => {
              ...
              /* @__PURE__ */ jsxRuntime.jsx(
                TradingMenuChoice,
                {
                  icon: /* @__PURE__ */ jsxRuntime.jsx(ui.PerpsIcon, { size: 20 }),
                  label: "Perps",
                  selected: true,
...
__export(bottomNav_exports, {
  BottomNav: () => exports.BottomNav,
  BottomNavTradingMenu: () => BottomNavTradingMenu,
  BottomNavWidget: () => exports.BottomNavWidget
});
var init_bottomNav = __esm({
  "src/components/bottomNav/index.ts"() {
    init_bottomNav_widget();
    init_bottomNav_ui_mobile();
    init_tradingMenu_ui();
  }
});
var AccountMenu = (props) => {
  const { t } = i18n.useTranslation();
  const {
    accountState: state,
    onDisconnect,
  ...
  if (!disabled && (state.status === types.AccountStatusEnum.EnableTrading || state.status === types.AccountStatusEnum.EnableTradingWithoutConnected)) {
    return /* @__PURE__ */ jsxRuntime.jsx(
      WalletMenu,
      {
  ...
  if (state.status <= types.AccountStatusEnum.NotSignedIn) {
    return /* @__PURE__ */ jsxRuntime.jsx(ui.Button, { size: "md", onClick: () => props.onCrateAccount(), children: t("connector.createAccount") });
  }
  if (state.status <= types.AccountStatusEnum.DisabledTrading) {
    return /* @__PURE__ */ jsxRuntime.jsx(
      ui.Button,
      {
        size: "md",
        onClick: () => {
          props.onCreateOrderlyKey().then((r) => void 0).catch((e) => void 0);
        },
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.DropdownMenuRoot, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(ui.DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsx(
      ui.Button,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text.formatted, { rule: "address", className: "oui-text-[rgba(0,0,0,.88)]", children: address })
      }
    ) }),
    /* @__PURE__ */ jsxRuntime.jsx(ui.DropdownMenuPortal, { children: /* @__PURE__ */ jsxRuntime.jsxs(
      ui.DropdownMenuContent,
      {
        ...
        sideOffset: 12,
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.DropdownMenuGroup, { children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { px: 4, children: [
            /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 2, className: "oui-flex-1", children: [
              /* @__PURE__ */ jsxRuntime.jsx(ui.EVMAvatar, { address, size: "md" }),
              /* @__PURE__ */ jsxRuntime.jsx(ui.Text.formatted, { rule: "address", size: "base", children: address })
            ] }),
            /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 2, children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx("button", { onClick: () => props.onOpenExplorer(), children: /* @__PURE__ */ jsxRuntime.jsx(
                "svg",
                {
                  xmlns: "http://www.w3.org/2000/svg",
                  width: "18",
          ...
          /* @__PURE__ */ jsxRuntime.jsx(ui.Divider, { className: "oui-mx-4 oui-my-3", intensity: 8 }),
          /* @__PURE__ */ jsxRuntime.jsx(ui.DropdownMenuGroup, { children: /* @__PURE__ */ jsxRuntime.jsx(
            ui.DropdownMenuItem,
            {
              size: "xl",
              onSelect: (event) => {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 2, className: "oui-text-danger-light", children: [
                /* @__PURE__ */ jsxRuntime.jsx(
                  "svg",
                  {
                    xmlns: "http://www.w3.org/2000/svg",
                ...
                /* @__PURE__ */ jsxRuntime.jsx("span", { children: t("connector.disconnect") })
              ] })
            }
          ) })
        ]
...
var useAccountMenu = () => {
  const { t } = i18n.useTranslation();
  const { disconnect, connectedChain } = hooks.useWalletConnector();
  const { account, state } = hooks.useAccount();
  const { connectWallet, disabledConnect, wrongNetwork, setCurrentChainId } = reactApp.useAppContext();
  const [, { findByChainId }] = hooks.useChains();
  const { isMobile } = ui.useScreen();
  const onCrateAccount = async () => {
    const modalId = isMobile ? uiConnector.WalletConnectorSheetId : uiConnector.WalletConnectorModalId;
  ...
  const switchChain = () => {
    ...
    ui.modal.show(uiChainSelector.ChainSelectorDialogId).then(
      (r) => {
        if (!r.wrongNetwork) {
          if (state.status < types.AccountStatusEnum.EnableTrading) {
  ...
  const statusChangeHandler = (nextState) => {
    if (nextState.validating || nextState.status <= types.AccountStatusEnum.Connected) {
      return;
    }
    if (nextState.status < types.AccountStatusEnum.SignedIn) {
      onCrateAccount();
    }
    if (nextState.status < types.AccountStatusEnum.EnableTrading) {
      onCreateOrderlyKey();
    }
  };
  const onOpenExplorer = React6.useCallback(() => {
    if (!connectedChain) {
      return;
    }
  ...
  const onSwitchNetwork = () => {
    const modalId = isMobile ? uiChainSelector.ChainSelectorSheetId : uiChainSelector.ChainSelectorDialogId;
    ui.modal.show(modalId, {
...
var WalletConnectButtonExtension = () => {
  return /* @__PURE__ */ jsxRuntime.jsx(ui.ExtensionSlot, { position: ui.ExtensionPositionEnum.AccountMenu });
};
var useChainMenuScript = () => {
  ...
  const { currentChainId, wrongNetwork, disabledConnect, setCurrentChainId } = reactApp.useAppContext();
...
var ChainMenu = (props) => {
      ...
      ui.Tooltip,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(
          ui.Button,
          {
            ...
            size: "md",
            onClick: () => {
              ui.modal.show(uiChainSelector.ChainSelectorDialogId, {
                networkId: props.networkId
              }).then(
                (r) => {
                  if (!r.wrongNetwork && props.accountStatus < types.AccountStatusEnum.EnableTrading) {
                    ui.modal.show(uiConnector.WalletConnectorModalId, {
                      title: /* @__PURE__ */ jsxRuntime.jsx(ModalTitle2, {})
                    }).then(
                      (r2) => void 0,
                      (error) => void 0
                    );
  ...
  const renderIcon = () => {
    if (props.loading) {
      return /* @__PURE__ */ jsxRuntime.jsx(ui.Spinner, { className: "oui-w-[18px] oui-h-[18px]" });
    }
    if (props.currentChainId) {
      return /* @__PURE__ */ jsxRuntime.jsx(ui.ChainIcon, { chainId: props.currentChainId, size: "xs" });
    }
  };
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.DropdownMenuRoot, { open: props.open, onOpenChange: props.onOpenChange, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(ui.DropdownMenuPortal, { children: /* @__PURE__ */ jsxRuntime.jsx(
      ui.DropdownMenuContent,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(
          uiChainSelector.ChainSelectorWidget,
          {
            close: props.hide,
...
var ChainMenuUiMobile = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "button",
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Box, { className: "oui-relative oui-rounded-t-[6px] oui-rounded-bl-[6px] oui-rounded-br-[3px] oui-bg-base-5 oui-px-2 oui-h-8 oui-w-8 oui-flex oui-items-center oui-justify-center", children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          ui.ChainIcon,
          {
...
var ChainMenuWidget = () => {
  ...
  const { isMobile } = ui.useScreen();
  if (isMobile) {
    return /* @__PURE__ */ jsxRuntime.jsx(ChainMenuUiMobile, { ...state });
  }
  return /* @__PURE__ */ jsxRuntime.jsx(ChainMenu, { ...state });
};
var useLanguageSwitcherScript = (options) => {
  const [open2, setOpen] = React6.useState(false);
  const [loading, setLoading] = React6.useState(false);
  const [selectedLang, setSelectedLang] = React6.useState(i18n.i18n.language);
  const { languages, onLanguageBeforeChanged, onLanguageChanged, popup } = i18n.useLocaleContext();
  const { track, setIdentify } = hooks.useTrack();
  const { isMobile } = ui.useScreen();
  const onOpenChange = React6.useCallback(
    (open3) => {
      if (typeof options?.onOpenChange === "function") {
        options.onOpenChange(open3);
      } else {
        setOpen(open3);
      }
    },
  ...
  const onLangChange = async (lang, displayName) => {
    setLoading(true);
    ...
    onOpenChange(false);
    setLoading(false);
    track(types.TrackerEventName.switchLanguage, {
  ...
  const _popup = React6.useMemo(
    () => ({
      ...popup,
      ...options?.popup,
      mode: options?.popup?.mode || popup?.mode || (isMobile ? "sheet" : "modal")
    }),
    [popup, options?.popup, isMobile]
  );
  const _open = React6.useMemo(() => {
...
var LanguageSwitcher = (props) => {
  ...
  const trigger = /* @__PURE__ */ jsxRuntime.jsx(ui.Tooltip, { content: t("languageSwitcher.tooltip"), children: /* @__PURE__ */ jsxRuntime.jsx(
    LanguageIcon,
    {
      className: ui.cn(
  ...
  const header = /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { weight: "semibold", children: t("languageSwitcher.language") });
  const languageList = languages.map((item) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      ...
      {
        className: ui.cn(
          ["modal", "sheet"].includes(popup.mode ?? "") && "oui-w-[calc((100%_-_4px)/2)] lg:oui-w-[calc((100%_-_8px)/3)]"
        ),
        selected,
        item,
  ...
  const context = /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { gap: 1, className: "oui-flex-wrap", children: languageList });
  const footer = /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { mt: 4, children: /* @__PURE__ */ jsxRuntime.jsx(
    ui.Text,
    {
      size: "2xs",
      intensity: 54,
      ...
      children: t("languageSwitcher.tips")
    }
  ) });
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(
        ui.SimpleSheet,
        {
          ...
          classNames: {
            content: ui.cn("oui-px-5 oui-pb-5", popup?.className),
  ...
  if (popup?.mode === "dropdown") {
    const context2 = /* @__PURE__ */ jsxRuntime.jsx(
      ui.Box,
      {
        mt: 4,
        className: ui.cn(
...
var LanguageItem = (props) => {
  ...
  const renderTrailing = () => {
    ...
    if (props.selected) {
      return /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { gradient: "brand", r: "full", width: 4, height: 4 });
    }
    return null;
  };
  return /* @__PURE__ */ jsxRuntime.jsx(
    "button",
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "between", className: "oui-h-10", px: 3, children: [
        /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { itemAlign: "center", width: "100%", className: "oui-gap-x-[6px]", children: /* @__PURE__ */ jsxRuntime.jsx(
          ui.Text,
          {
            size: "2xs",
            className: ui.cn(
...
var LanguageIcon = React6.forwardRef((props, ref) => {
  const { size = 20, ...rest } = props;
  return /* @__PURE__ */ jsxRuntime.jsx(
    "svg",
    {
...
// src/components/main/mainLogo.tsx
init_icons();
var MainLogo = (props) => {
  const { appIcons } = reactApp.useAppConfig();
  if (props.src) {
    return /* @__PURE__ */ jsxRuntime.jsx(ui.Logo, { src: props.src, alt: props.alt });
  }
  const { main } = appIcons || {};
  if (main?.img) {
    return /* @__PURE__ */ jsxRuntime.jsx("img", { src: main?.img });
  }
  if (main?.component) {
    return main.component;
  }
  return /* @__PURE__ */ jsxRuntime.jsx(OrderlyLogo, {});
};
var useAccountValue = (mainAccountId) => {
  const [accountValue, setAccountValue] = React6.useState({});
  const {
    data: newPositions = [],
    isLoading: isPositionLoading,
    mutate: mutatePositions
  } = hooks.useSubAccountQuery("/v1/client/aggregate/positions", {
    // formatter: (data) => data,
    errorRetryCount: 3,
  ...
  React6.useEffect(() => {
    ...
    const value = newPositions.reduce(
      (acc, position) => {
        ...
        if (acc[accountId]) {
          acc[accountId] = new utils.Decimal(acc[accountId]).plus(position.unsettled_pnl).toNumber();
        } else {
          acc[accountId] = new utils.Decimal(position.unsettled_pnl).toNumber();
        }
        return acc;
      },
      {}
...
var SubAccountScript = () => {
  const [open2, setOpen] = React6.useState(false);
  const [mainAccountHolding, setMainAccountHolding] = React6.useState(
    []
  );
  const { wallet, connectedChain } = hooks.useWalletConnector();
  const { data: indexPrices } = hooks.useIndexPricesStream();
  const { isMobile } = ui.useScreen();
  const { state, account, subAccount, switchAccount } = hooks.useAccount();
  const { t } = i18n.useTranslation();
  ...
  const hasRefreshedRef = React6.useRef(false);
  const userAddress = React6.useMemo(() => {
  ...
  const subAccounts = React6.useMemo(() => {
  ...
  const doCreatSubAccount = React6.useCallback(
    (nickName) => {
      return subAccount.create(nickName);
    },
    [subAccount]
  );
  const onSwitch = React6.useCallback(
    (accountId) => {
  ...
  const accountsWithValues = React6.useMemo(() => {
    ...
    const mainAccount = mainAccountId && state.address ? {
      ...
      accountValue: calculateAccountValue(
        ...
        indexPrices || types.EMPTY_OBJECT
      )
    } : void 0;
    const updatedSubAccounts = subAccounts.map((subAccount2) => {
      ...
      return {
        ...subAccount2,
        accountValue: calculateAccountValue(
          subAccount2.holding || types.EMPTY_LIST,
...
var SubAccountIcon = React6.forwardRef(
  (props, ref) => {
    const { size = 20, ...rest } = props;
    return /* @__PURE__ */ jsxRuntime.jsx(
      "svg",
...
var SwapIcon = React6.forwardRef((props, ref) => {
  const { size = 20, ...rest } = props;
  return /* @__PURE__ */ jsxRuntime.jsx(
    "svg",
    {
      ...
      ref,
      ...rest,
      children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M6 16L2 12L6 8L7.0625 9.0625L4.875 11.25H11V12.75H4.875L7.0625 14.9375L6 16ZM14 11L12.9375 9.9375L15.125 7.75H9V6.25H15.125L12.9375 4.0625L14 3L18 7L14 11Z" })
    }
  );
});
var AddIcon = React6.forwardRef((props, ref) => {
  const { size = 20, ...rest } = props;
  return /* @__PURE__ */ jsxRuntime.jsx(
    "svg",
    {
...
var AccountIdForCopy = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    ui.Flex,
    {
      ...
      itemAlign: "center",
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs(ui.Text, { className: "oui-w-full oui-break-all oui-text-2xs oui-text-base-contrast-36", children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-base-contrast", children: info.leading }),
          /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { children: info.middle }),
          /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-base-contrast", children: info.trailing })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx(
          ui.CopyIcon,
          {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(
          ui.Flex,
          {
            ...
            className: "oui-z-[2]",
            children: [
              props.isMainAccount ? /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-xs oui-leading-3 oui-text-base-contrast", children: ui.formatAddress(props.userAddress ?? "") }) : /* @__PURE__ */ jsxRuntime.jsxs(
                ui.Flex,
                {
                  justify: "start",
                  itemAlign: "center",
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-xs oui-leading-3 oui-text-base-contrast", children: props.description }),
                    /* @__PURE__ */ jsxRuntime.jsx(EditIcon, { className: "oui-fill-base-contrast-54 hover:oui-fill-base-contrast" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntime.jsx(ui.Tooltip, { content: /* @__PURE__ */ jsxRuntime.jsx(AccountIdForCopy, { accountId: props.accountId }), children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Text, { className: "oui-text-2xs oui-leading-3 oui-text-base-contrast-36 hover:oui-text-base-contrast", children: [
                "ID: ",
                ui.formatAddress(props.accountId)
              ] }) })
            ]
          },
          props.accountId
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(
          ui.Flex,
          {
            ...
            gap: 1,
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(ui.Text.numeral, { rule: "price", dp: 2, children: props.accountValue ?? 0 }),
...
var NickNameTextField = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ui.TextField,
    {
      ...
      formatters: [
        ui.inputFormatter.createRegexInputFormatter(/[^a-zA-Z0-9@,\s_-]/g)
      ],
      classNames: {
...
var CreateSubAccount = (props) => {
  ...
  const { isMobile } = ui.useScreen();
  const [open2, setOpen] = React6.useState(false);
  const [nickName, setNickName] = React6.useState(void 0);
  const { state } = hooks.useAccount();
  const [invalid, setInvalid] = React6.useState(false);
  const [loading, setLoading] = React6.useState(false);
  const { widgetConfigs } = reactApp.useAppContext();
  const maxSubAccountCount = React6.useMemo(() => {
    return widgetConfigs?.subAccount?.maxSubAccountCount ?? MAX_SUB_ACCOUNT_COUNT;
  }, [widgetConfigs]);
  const subAccountCount = React6.useMemo(() => {
    return state.subAccounts?.length ?? 0;
  }, [state]);
  const trigger = React6.useMemo(() => {
    return subAccountCount >= maxSubAccountCount ? /* @__PURE__ */ jsxRuntime.jsx(
      ui.Tooltip,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(
          AddIcon,
          {
            className: ui.cn("oui-cursor-not-allowed oui-fill-base-contrast-20")
          }
        )
      }
    ) : /* @__PURE__ */ jsxRuntime.jsx(
  ...
  const header = /* @__PURE__ */ jsxRuntime.jsxs(
    ui.Flex,
    {
      ...
      width: "100%",
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { weight: "semibold", children: t("subAccount.modal.create.title") }),
        /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-2xs oui-text-base-contrast-36", children: t("subAccount.modal.create.description", {
          subAccountCount,
  ...
  const doCreatSubAccount = (nickName2) => {
    ...
    props.create(_nickName).then((res) => {
      reset();
      ui.toast.success(t("subAccount.modal.create.success.description"));
      setOpen(false);
    }).catch((e) => {
      ui.toast.error(t("subAccount.modal.create.failed.description"));
    }).finally(() => {
      setLoading(false);
    });
  };
...
var EditNickNameDialog = (props) => {
  const { subAccount } = hooks.useAccount();
  const [loading, setLoading] = React6.useState(false);
  const { t } = i18n.useTranslation();
  const [newNickName, setNewNickName] = React6.useState(void 0);
  const [invalid, setInvalid] = React6.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ui.SimpleDialog,
    {
      title: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { children: t("subAccount.modal.edit.title") }),
      open: props.open,
      onOpenChange: props.onOpenChange,
      classNames: {
        content: "oui-w-[360px]"
        ...
        primary: {
          ...
          onClick: () => {
            ...
            subAccount?.update({
              ...
              ui.toast.error(t("subAccount.modal.edit.failed.description"));
            }).then((res) => {
              ui.toast.success(t("subAccount.modal.edit.success.description"));
...
function SubAccountUI(props) {
  ...
  const onMouseEnter = React6.useCallback(() => {
    if (timer.current) {
      clearTimeout(timer.current);
      timer.current = null;
    }
  }, []);
  const header = /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { weight: "semibold", children: t("subAccount.modal.title") });
  const trigger = React6.useMemo(() => {
    if (props.customTrigger && isMobile) {
      return /* @__PURE__ */ jsxRuntime.jsx("div", { onClick: () => props.onOpenChange(true), children: props.customTrigger });
    }
    if (isMobile) {
      return /* @__PURE__ */ jsxRuntime.jsx(
        ui.Flex,
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(SubAccountIcon, { className: ui.cn("oui-cursor-pointer") });
  }, [isMobile, props.customTrigger]);
  const [editDialogOpen, setEditDialogOpen] = React6.useState(false);
  const [editAccountItem, setEditAccountItem] = React6.useState(void 0);
  const noSubAccount = /* @__PURE__ */ jsxRuntime.jsx(
    ui.Flex,
    {
      direction: "column",
      itemAlign: "start",
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-center oui-text-xs oui-font-semibold oui-text-base-contrast-36", children: t("subAccount.modal.noAccount.description") })
    }
  );
  const renderSubAccount = () => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(ui.ScrollArea, { className: "oui-custom-scrollbar oui-max-h-[200px] oui-w-full oui-overflow-y-auto", children: /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { direction: "column", gap: 2, itemAlign: "start", width: "100%", children: props.subAccounts.map((subAccount) => /* @__PURE__ */ jsxRuntime.jsx(
      AccountItem,
      {
  ...
  const content = /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", gap: 5, itemAlign: "start", width: "100%", children: [
      !isMobile && header,
      /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", gap: 5, itemAlign: "start", width: "100%", children: [
        /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", gap: 2, itemAlign: "start", width: "100%", children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-xs oui-leading-3 oui-text-base-contrast-54", children: t("subAccount.modal.mainAccount.title") }),
          /* @__PURE__ */ jsxRuntime.jsx(
            AccountItem,
            {
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", gap: 2, itemAlign: "start", width: "100%", children: [
          /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "between", itemAlign: "center", width: "100%", gap: 2, children: [
            /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-xs oui-leading-3 oui-text-base-contrast-54", children: t("subAccount.modal.subAccounts.title") }),
            /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "end", gap: 2, children: [
              props.subAccounts.length > 0 && /* @__PURE__ */ jsxRuntime.jsx(
                SwapIcon,
                {
              ...
              /* @__PURE__ */ jsxRuntime.jsx(CreateSubAccount, { create: props.createSubAccount })
            ] })
          ] }),
          renderSubAccount()
        ] })
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.PopoverRoot, { open: props.open, onOpenChange: props.onOpenChange, children: [
    /* @__PURE__ */ jsxRuntime.jsx(ui.PopoverAnchor, { children: /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        onMouseEnter: () => {
...
var SubAccountWidget = (props) => {
  const state = SubAccountScript();
  return /* @__PURE__ */ jsxRuntime.jsx(SubAccountUI, { ...state, customTrigger: props?.customTrigger });
};
var CommunityDiscord = (props) => {
  const { width = 20, height = 20, className } = props;
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "orderly-fill-base-contrast-54 hover:orderly-fill-base-contrast", children: /* @__PURE__ */ jsxRuntime.jsx(
    "svg",
    {
      xmlns: "http://www.w3.org/2000/svg",
      width: "24",
...
var LeftNavUI = (props) => {
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { onClick: props.showSheet, className: props?.className, children: /* @__PURE__ */ jsxRuntime.jsx(ui.VectorIcon, {}) }),
    /* @__PURE__ */ jsxRuntime.jsx(LeftNavSheet, { ...props })
  ] });
};
var LeftNavSheet = (props) => {
  const { state } = hooks.useAccount();
  const { t } = i18n.useTranslation();
  ...
  const showSubAccount = React6.useMemo(
    () => state.status >= types.AccountStatusEnum.EnableTrading,
    [state.status]
  );
  ...
  const subAccountTrigger = React6.useMemo(() => {
    const name = state.accountId === state.mainAccountId ? state.address : state.subAccounts?.find((item) => item.id === state.accountId)?.description || "";
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-flex oui-w-full oui-cursor-pointer oui-items-center oui-gap-2 oui-rounded-xl oui-bg-base-5 oui-p-3", children: [
      /* @__PURE__ */ jsxRuntime.jsx("div", { children: /* @__PURE__ */ jsxRuntime.jsx(ui.PeopleIcon, {}) }),
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-flex oui-flex-col oui-gap-1 oui-font-semibold", children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          ui.Text.formatted,
          {
            rule: "address",
        ...
        /* @__PURE__ */ jsxRuntime.jsx(
          ui.Text.formatted,
          {
            ...
            children: `ID: ${state.accountId}`
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-ml-auto", children: /* @__PURE__ */ jsxRuntime.jsx(ui.SwapHorizIcon, {}) })
    ] });
  }, [state, t]);
  const openExternalLink = (url) => {
    window.open(url, "_blank");
  };
  return /* @__PURE__ */ jsxRuntime.jsx(ui.Sheet, { open: props.open, onOpenChange: props.onOpenChange, children: /* @__PURE__ */ jsxRuntime.jsx(
    ui.SheetContent,
    {
      side: "left",
      ...
      closeableSize: 24,
      closeOpacity: 0.54,
      children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-relative oui-flex oui-h-full oui-flex-col oui-gap-3", children: [
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-mt-[6px] oui-flex oui-h-[44px] oui-items-center [&_img]:!oui-h-[18px]", children: /* @__PURE__ */ jsxRuntime.jsx(MainLogo, { ...props?.logo }) }),
        props?.leading,
        showSubAccount && /* @__PURE__ */ jsxRuntime.jsx(SubAccountWidget, { customTrigger: subAccountTrigger }),
        (primaryMenus.length > 0 || secondaryMenus.length > 0) && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-flex oui-h-[calc(100vh-260px)] oui-flex-col oui-items-start oui-overflow-y-auto", children: [
          primaryMenus.map((item) => /* @__PURE__ */ jsxRuntime.jsx(
            NavItem,
            {
              item,
          ...
          secondaryMenus.length > 0 && primaryMenus.length > 0 && /* @__PURE__ */ jsxRuntime.jsx(ui.Divider, { className: "oui-my-1 oui-w-full", intensity: 8 }),
          secondaryMenus.map((item) => /* @__PURE__ */ jsxRuntime.jsx(
            NavItem,
            {
              item,
              onClick: onRouteChange
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-z-60 oui-absolute oui-bottom-6 oui-flex oui-w-full oui-flex-col oui-gap-4 oui-bg-base-8", children: [
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-flex oui-items-center oui-justify-around", children: [
            props.telegramUrl && /* @__PURE__ */ jsxRuntime.jsx(
              "div",
              {
                onClick: () => openExternalLink(props.telegramUrl),
                children: /* @__PURE__ */ jsxRuntime.jsx(CommunityTG, { width: 24, height: 24 })
              }
            ),
            props.twitterUrl && /* @__PURE__ */ jsxRuntime.jsx(
              "div",
              {
                onClick: () => openExternalLink(props.twitterUrl),
                children: /* @__PURE__ */ jsxRuntime.jsx(CommunityX, { width: 24, height: 24 })
              }
            ),
            props.discordUrl && /* @__PURE__ */ jsxRuntime.jsx(
              "div",
              {
                onClick: () => openExternalLink(props.discordUrl),
                children: /* @__PURE__ */ jsxRuntime.jsx(CommunityDiscord, { width: 24, height: 24 })
              }
            ),
            props.duneUrl && /* @__PURE__ */ jsxRuntime.jsx(
              "div",
              {
                onClick: () => openExternalLink(props.duneUrl),
                className: "oui-mb-1",
                children: /* @__PURE__ */ jsxRuntime.jsx(CommunityDune, {})
              }
            )
          ] }),
          props.feedbackUrl && /* @__PURE__ */ jsxRuntime.jsx(
            "div",
            {
...
var NavItem = ({ item, onClick }) => {
  ...
  const onItemClick = () => {
    ...
    if (target) {
      ...
      onClick?.({ href, name, scope: "leftNav" });
    }
  };
  if (typeof customRender === "function") {
    return /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        ...
        onClick: onItemClick,
        children: customRender({ name, href })
      }
    );
  }
  ...
  const textClassName = isSecondary ? "oui-text-xs oui-font-normal oui-text-base-contrast-54" : "oui-text-base oui-font-semibold oui-text-base-contrast-80";
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: textClassName, children: name }),
        trailing
      ]
    }
  );
};
var LeftNavWidget = (props) => {
  const state = useLeftNavScript();
  return /* @__PURE__ */ jsxRuntime.jsx(LeftNavUI, { ...props, ...state });
};
var useScanQRCodeScript = () => {
  const [open2, setOpen] = React6.useState(false);
  const { widgetConfigs } = reactApp.useAppContext();
  const timerRef = React6.useRef(null);
  const [showScanTooltip, setShowScanTooltip] = hooks.useLocalStorage(
...
var QRCODE_WIDTH = 320;
var QRCODE_HEIGHT = 320;
var RATIO = 2;
var QRCodeScanner = (props) => {
  const videoRef = React6.useRef(null);
  ...
  const tick = () => {
    ...
    if (video.readyState === video.HAVE_ENOUGH_DATA) {
      ...
      const res = jsQR__default.default(imageData.data, imageData.width, imageData.height, {
...
var ScanQRCode = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      ...
      ui.Tooltip,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(
          ui.Flex,
          {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(ScanIcon, { className: "oui-text-base-contrast-80" })
          }
        )
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsx(
      ui.SimpleDialog,
      {
        title: /* @__PURE__ */ jsxRuntime.jsx(MainLogo, {}),
        open: props.open,
        onOpenChange: props.onOpenChange,
        size: "sm",
        children: /* @__PURE__ */ jsxRuntime.jsx(ScanQRCodeContent, { ...props })
      }
    )
  ] });
};
var ScanQRCodeContent = (props) => {
  const { t } = i18n.useTranslation();
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "center", direction: "column", gapY: 5, children: [
    /* @__PURE__ */ jsxRuntime.jsxs(ui.Box, { width: QRCODE_WIDTH, height: QRCODE_HEIGHT, className: "oui-relative", children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx("span", { className: "oui-px-3 oui-text-center", children: /* @__PURE__ */ jsxRuntime.jsx(
      ui.Text,
      {
        size: "2xs",
        intensity: 54,
...
var ScanIcon = (props) => /* @__PURE__ */ jsxRuntime.jsx(
  "svg",
  {
    width: "18",
    height: "18",
...
var LinkDeviceIcon = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "svg",
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M19.167 7.583a1.74 1.74 0 0 0-1.731-1.75h-4.038a1.74 1.74 0 0 0-1.731 1.75v8.167c0 .967.775 1.75 1.73 1.75h4.039a1.74 1.74 0 0 0 1.73-1.75zm-1.154 0v7.584H12.82V7.583A.58.58 0 0 1 13.398 7h4.038a.58.58 0 0 1 .577.583m-2.02 8.75a.58.58 0 0 1-.576.584.58.58 0 0 1-.577-.584.58.58 0 0 1 .577-.583.58.58 0 0 1 .577.583" }),
        /* @__PURE__ */ jsxRuntime.jsx(
          "path",
          {
            fillRule: "evenodd",
...
var ScanQRCodeWidget = () => {
  const state = useScanQRCodeScript();
  return /* @__PURE__ */ jsxRuntime.jsx(ScanQRCode, { ...state });
};
var ExpireSeconds = 60;
function useLinkDeviceScript() {
  const [open2, setOpen] = React6.useState(false);
  const [loading, setLoading] = React6.useState(true);
  const [confirm, setConfirm] = React6.useState(false);
  const [seconds, setSeconds] = React6.useState(ExpireSeconds);
  const [secretKey, setSecretKey] = React6.useState("");
  const [url, setUrl] = React6.useState("");
  const ee = hooks.useEventEmitter();
  const { track } = hooks.useTrack();
  const { state, account } = hooks.useAccount();
  const [_, { findByChainId }] = hooks.useChains(void 0, {
    pick: "network_infos",
    filter: (chain) => chain.network_infos?.bridge_enable || chain.network_infos?.bridgeless
  });
  const createTrackParams = () => {
    const chain = findByChainId(account.chainId);
    return {
      wallet: state?.connectWallet?.name,
      network: chain?.network_infos.name
    };
  };
  const getOrderlyKey = React6.useCallback(async () => {
    try {
      const res = await account.createApiKey(30);
      setSecretKey(res.secretKey);
      setLoading(false);
      track(types.TrackerEventName.signLinkDeviceMessageSuccess, createTrackParams());
    } catch (e) {
  ...
  const showDialog = React6.useCallback(() => {
    setOpen(true);
    getOrderlyKey();
    track(types.TrackerEventName.clickLinkDeviceButton, createTrackParams());
  }, [account]);
  const hideDialog = React6.useCallback(() => {
    setOpen(false);
  }, []);
  const onConfirm = React6.useCallback(() => {
    setConfirm(true);
    track(types.TrackerEventName.linkDeviceModalClickConfirm, {});
  }, []);
  const copyUrl = React6.useCallback(() => {
  ...
  React6.useEffect(() => {
    if (confirm && secretKey) {
      const timestamp = Math.floor(Date.now() / 1e3) + ExpireSeconds;
      const params = {
        k: secretKey,
        t: timestamp,
        a: account.address,
...
var LinkDevice = (props) => {
  const { t } = i18n.useTranslation();
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(ui.Tooltip, { content: t("linkDevice.tooltip"), children: /* @__PURE__ */ jsxRuntime.jsx(
      LinkDeviceIcon2,
      {
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      ui.SimpleDialog,
      {
        title: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { weight: "semibold", children: t("common.confirm") }),
        open: props.open,
        onOpenChange: props.onOpenChange,
        size: "sm",
        contentProps: {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(LinkDeviceContent, { ...props })
      }
    )
  ] });
};
var LinkDeviceContent = (props) => {
  if (props.loading) {
...
var QRCode = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", gapY: 3, children: [
    /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "base", intensity: 98, children: t("linkDevice.scanQRCode") }),
    /* @__PURE__ */ jsxRuntime.jsx(
      ui.Text,
      {
        size: "2xs",
        ...
        weight: "regular",
        className: "oui-text-center",
        children: /* @__PURE__ */ jsxRuntime.jsx(i18n.Trans, { i18nKey: "linkDevice.createQRCode.success.description" })
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsxs(ui.Text, { size: "sm", intensity: 54, children: [
      `${t("common.countdown")}: `,
      /* @__PURE__ */ jsxRuntime.jsxs(ui.Text.gradient, { color: "brand", className: "oui-tabular-nums", children: [
        props.seconds,
        "s"
      ] })
    ] }),
      ...
      ui.Flex,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(
          ui.Flex,
          {
            ...
            justify: "center",
            itemAlign: "center",
            children: /* @__PURE__ */ jsxRuntime.jsx(QRCodeCanvas, { width: 196, height: 196, content: props.url })
          }
        )
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsxs(
      ui.Flex,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "2xs", weight: "regular", children: t("linkDevice.createQRCode.success.copyUrl") })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsx(
      ui.SimpleDialogFooter,
      {
        actions,
...
var QRCodeCanvas = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("canvas", { width: props.width, height: props.height, ref: canvasRef });
};
var LinkDeviceConfirm = (props) => {
  const { t } = i18n.useTranslation();
  const actions = {
    secondary: {
      label: t("common.cancel"),
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", children: [
    /* @__PURE__ */ jsxRuntime.jsx(MainLogo, {}),
    /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "base", intensity: 98, className: "oui-mt-5", children: t("linkDevice.createQRCode.linkMobileDevice") }),
    /* @__PURE__ */ jsxRuntime.jsx(
      ui.Text,
      {
        size: "2xs",
...
var Loading = () => {
  const { t } = i18n.useTranslation();
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", gap: 5, children: [
    /* @__PURE__ */ jsxRuntime.jsx(Spinner3, {}),
    /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "sm", intensity: 98, children: t("linkDevice.createQRCode.loading.description") })
  ] });
};
var Spinner3 = () => {
  return /* @__PURE__ */ jsxRuntime.jsxs(
...
var LinkDeviceIcon2 = React6.forwardRef(
  (props, ref) => {
    const { size = 20, viewBox, ...rest } = props;
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "svg",
...
var Dot = () => {
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { className: "oui-gap-x-px oui-px-px", children: [
...
var LinkDeviceWidget = () => {
  const { isMobile } = ui.useScreen();
  const state = useLinkDeviceScript();
  if (isMobile) {
    return /* @__PURE__ */ jsxRuntime.jsx(LinkDeviceMobile, { ...state });
  }
  return /* @__PURE__ */ jsxRuntime.jsx(LinkDevice, { ...state });
};
var MainNavMobile = (props) => {
  const { wrongNetwork, disabledConnect } = reactApp.useAppContext();
  const { state } = hooks.useAccount();
  const currentMenu = React6.useMemo(() => {
  ...
  const title = React6.useMemo(() => {
    if (currentMenu?.isHomePageInMobile) {
      return /* @__PURE__ */ jsxRuntime.jsx(MainLogo, { ...props?.logo });
    }
    return /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-2xl oui-font-bold oui-text-base-contrast", children: currentMenu?.name });
  }, [currentMenu, props?.logo]);
  const isSub = React6.useMemo(() => {
    return Boolean(!currentMenu || currentMenu.isSubMenuInMobile);
  }, [currentMenu]);
  const subTitle = React6.useMemo(() => {
    if (currentMenu?.isSubMenuInMobile) {
      return currentMenu?.name;
    }
    if (props?.subItems?.some((item) => item.href === props?.current)) {
      return props?.subItems?.find((item) => item.href === props?.current)?.name;
    }
    return null;
  ...
  const onBack = () => {
    ...
    props?.routerAdapter?.onRouteChange(target);
  };
  const showLinkDevice = state.status === types.AccountStatusEnum.EnableTradingWithoutConnected;
  const showChainMenu = !showLinkDevice && !wrongNetwork;
  const showQrcode = state.status === types.AccountStatusEnum.NotConnected;
  const showSubAccount = React6.useMemo(
    () => state.status >= types.AccountStatusEnum.EnableTrading,
    [state.status]
  );
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      ui.Flex,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-base oui-font-bold oui-text-base-contrast", children: subTitle })
        ]
      }
    );
  }
  const renderContent = () => {
    const languageSwitcher = /* @__PURE__ */ jsxRuntime.jsx(LanguageSwitcherWidget, {});
    const scanQRCode = showQrcode && /* @__PURE__ */ jsxRuntime.jsx(ScanQRCodeWidget, {});
    const subAccount = showSubAccount && /* @__PURE__ */ jsxRuntime.jsx(SubAccountWidget, {});
    const linkDevice = showLinkDevice && /* @__PURE__ */ jsxRuntime.jsx(LinkDeviceWidget, {});
    const chainMenu = showChainMenu && /* @__PURE__ */ jsxRuntime.jsx(ChainMenuWidget, {});
    const walletConnect = /* @__PURE__ */ jsxRuntime.jsx(WalletConnectButtonExtension, {});
    const leftNav = props.leftNav && /* @__PURE__ */ jsxRuntime.jsx(
      LeftNavWidget,
      {
        ...props.leftNav,
        logo: props?.logo,
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ui.Flex,
    {
      ...
      px: 3,
      itemAlign: "center",
      className: ui.cn(props.className, props.classNames?.root),
      children: renderContent()
    }
  );
};
var ScaffoldContext = React6.createContext(
  {}
);
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          "header",
          {
            ...
            children: topBar ?? /* @__PURE__ */ jsxRuntime.jsx(MainNavMobile, { ...mainNavProps, routerAdapter })
          }
        ),
        /* @__PURE__ */ jsxRuntime.jsxs(
          ui.Box,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(React6__default.default.Suspense, { fallback: null, children: /* @__PURE__ */ jsxRuntime.jsx(LazyRestrictedInfoWidget, { className: "oui-mx-1 oui-mb-1 oui-bg-base-6" }) }),
              /* @__PURE__ */ jsxRuntime.jsx(
                ui.Box,
                {
                  height: "100%",
                  width: "100%",
                  className: ui.cn("oui-scaffold-content", classNames?.content),
                  children
                }
              )
            ]
        ...
        /* @__PURE__ */ jsxRuntime.jsx(
          "footer",
          {
            ...
            children: bottomNav ?? /* @__PURE__ */ jsxRuntime.jsx(React6__default.default.Suspense, { fallback: null, children: /* @__PURE__ */ jsxRuntime.jsx(
              LazyBottomNav,
              {
...
var useScaffoldScript = (options) => {
  const { restrictedInfo, showAnnouncement } = reactApp.useAppContext();
  ...
  const [expand, setExpand] = hooks.useLocalStorage(
...
var useRefAndHeight = (defaultHeight, deps = []) => {
  ...
  const [height, setHeight] = React6.useState(defaultHeight);
  ui.useObserverElement(ref.current, (entry) => {
...
var Footer = (props) => {
  const { t } = i18n.useTranslation();
  const signalClsName = React6.useMemo(() => {
    switch (props.wsStatus) {
      case hooks.WsNetworkStatus.Connected:
        return "oui-fill-success-light oui-text-success-light";
      case hooks.WsNetworkStatus.Disconnected:
        return "oui-fill-danger-light oui-text-danger-light";
      case hooks.WsNetworkStatus.Unstable:
    ...
    ui.Flex,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { children: [
          /* @__PURE__ */ jsxRuntime.jsxs(
            ui.Flex,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "2xs", children: t("scaffold.footer.operational") })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntime.jsx(
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 2, children: [
            /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 54, size: "2xs", children: t("scaffold.footer.joinCommunity") }),
            ...
            typeof props?.trailing !== "undefined" && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
              /* @__PURE__ */ jsxRuntime.jsx(
                ui.Divider,
                {
                  direction: "vertical",
...
var useFooterScript = () => {
  const wsStatus = hooks.useWsStatus();
  return {
    wsStatus
  };
};
var FooterWidget = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Footer, { ...state, ...props });
};

// src/components/scaffold/scaffold.ui.tsx
init_restrictedInfo();
var menuItemVariants = ui.tv({
  slots: {
    button: [
      "oui-min-h-10",
      "oui-px-3",
...
var MenuItem = React6__default.default.memo((props) => {
  ...
  const children = /* @__PURE__ */ jsxRuntime.jsx(
    "button",
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { itemAlign: "center", gap: 2, as: "span", children: [
        /* @__PURE__ */ jsxRuntime.jsx("div", { children: item.icon }),
        props.open && /* @__PURE__ */ jsxRuntime.jsx(
          ui.Text.gradient,
          {
  ...
  if (props.open) {
    return /* @__PURE__ */ jsxRuntime.jsx("li", { className: "oui-min-w-[120px]", children });
  }
  return /* @__PURE__ */ jsxRuntime.jsx("li", { children: /* @__PURE__ */ jsxRuntime.jsx(ui.Tooltip, { content: item.name, side: "right", align: "center", sideOffset: 20, children }) });
});
MenuItem.displayName = "LeftMenuItem";
var SideMenus = (props) => {
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Box, { py: 6, children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      "svg",
      {
        width: "18",
    ...
    /* @__PURE__ */ jsxRuntime.jsx("ul", { className: "oui-space-y-4", children: props.menus?.map((item, index) => {
      if (item?.hide) {
        return null;
      }
      return /* @__PURE__ */ jsxRuntime.jsx(
...
var SideBarHeader = (props) => {
  const { title } = props;
  const titleElemet = typeof title === "string" ? /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 54, size: "xs", children: title }) : title;
  const iconProps = {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    ui.Flex,
    {
      ...
      children: [
        ...
        props.open ? /* @__PURE__ */ jsxRuntime.jsx(CollapseIcon, { ...iconProps }) : /* @__PURE__ */ jsxRuntime.jsx(ExpandIcon, { ...iconProps })
      ]
    }
  );
};
var SideBar = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    ui.Box,
    {
      ...
      className: ui.cn("oui-group/bar", props.className),
      style: props.style,
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          SideBarHeader,
...
var useSideNavBuilder = (props) => {
  const [current, setCurrent] = React6.useState(props?.items?.[0].href || "/");
...
var SideNavbarWidget = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(SideBar, { ...state });
};
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          ui.Box,
          {
            ...
            children: topBar ?? /* @__PURE__ */ jsxRuntime.jsx(MainNavWidget, { ...mainNavProps })
          }
        ),
        /* @__PURE__ */ jsxRuntime.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { px: 2, ref: announcementRef, children: /* @__PURE__ */ jsxRuntime.jsx(
              ...
              !hasLeftSidebar ? (
                ...
                /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { height: "100%", className: ui.cn(classNames?.content), children })
              ) : (
                ...
                /* @__PURE__ */ jsxRuntime.jsxs(
                  ui.Grid,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntime.jsx("div", { className: ui.cn(classNames?.leftSidebar), children: React6.isValidElement(leftSidebar) ? leftSidebar : /* @__PURE__ */ jsxRuntime.jsx(SideNavbarWidget, { ...leftSideProps }) }),
                      /* @__PURE__ */ jsxRuntime.jsx(
                        ui.Box,
                        {
                          width: "100%",
                          className: ui.cn("oui-overflow-hidden", classNames?.content),
                          children
                        }
                      )
                    ]
...
var ScaffoldProvider = (props) => {
  ...
  const [chains] = hooks.useChains();
  const { networkId } = React6.useContext(hooks.OrderlyContext);
  const announcementState = uiNotification.useAnnouncement();
  const checkChainSupportHandle = hooks.useMemoizedFn((chainId) => {
    return checkChainSupport(
      chainId,
      networkId === "testnet" ? chains.testnet : chains.mainnet
    );
  });
  const memoizedValue = React6.useMemo(() => {
    return {
      routerAdapter,
      expanded,
      setExpand,
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(ScaffoldContext.Provider, { value: memoizedValue, children });
};
var Scaffold = (props) => {
  const state = useScaffoldScript(props);
  const renderContent = () => {
    if (state.isMobile) {
      return /* @__PURE__ */ jsxRuntime.jsx(MobileScaffold, { ...props, ...state, children: props.children });
    }
    return /* @__PURE__ */ jsxRuntime.jsx(DesktopScaffold, { ...props, ...state, children: props.children });
  };
  return /* @__PURE__ */ jsxRuntime.jsx(
    ScaffoldProvider,
    {
...
var CampaignPositionEnum = /* @__PURE__ */ ((CampaignPositionEnum3) => {
  ...
  CampaignPositionEnum3["navTailing"] = "navTailing";
  return CampaignPositionEnum3;
})(CampaignPositionEnum || {});
var useMainNavScript = (props) => {
  const { onItemClick, campaignPosition = "navTailing" /* navTailing */ } = props;
  const { state } = hooks.useAccount();
  const { routerAdapter } = useScaffoldContext();
  const { connectedChain } = hooks.useWalletConnector();
  const { wrongNetwork, disabledConnect } = reactApp.useAppContext();
  ...
  const mainNavConfig = React6.useMemo(() => {
    const config = {
      leading: null,
      trailing: null,
      logo: {},
    ...
    if (props.campaigns) {
      if (campaignPosition === "menuTailing" /* menuTailing */) {
        config.mainMenus = [...config.mainMenus, props.campaigns];
      } else if (campaignPosition === "menuLeading" /* menuLeading */) {
  ...
  const { mainMenus, campaigns } = React6.useMemo(() => {
    const converted = {};
    ...
    ui.Flex,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 1, itemAlign: "center", children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 54, className: "oui-whitespace-nowrap", children: t("common.totalValue") }),
          visibleAvailable && /* @__PURE__ */ jsxRuntime.jsx("button", { onClick: () => onToggleVisibility?.(), children: visible ? /* @__PURE__ */ jsxRuntime.jsx(
            ui.EyeIcon,
            {
              size: 12,
...
var FreeCollateral = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    ui.Flex,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 1, itemAlign: "center", children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 54, className: "oui-whitespace-nowrap", children: t("trading.asset.freeCollateral") }),
          visibleAvailable && /* @__PURE__ */ jsxRuntime.jsx("button", { onClick: () => onToggleVisibility?.(), children: visible ? /* @__PURE__ */ jsxRuntime.jsx(
            ui.EyeIcon,
            {
              size: 12,
...
var UnrealPnL = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    ui.Flex,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 1, itemAlign: "center", children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 54, className: "oui-whitespace-nowrap", children: t("common.unrealizedPnl") }),
          visibleAvailable && /* @__PURE__ */ jsxRuntime.jsx("button", { onClick: () => onToggleVisibility?.(), children: visible ? /* @__PURE__ */ jsxRuntime.jsx(
            ui.EyeIcon,
            {
              size: 12,
...
var AccountInfoPopover = (props) => {
  const { totalValue, keys, elementKeys } = props;
  const { t } = i18n.useTranslation();
  const onSetToTop = (key) => (event) => {
    event.preventDefault();
    event.stopPropagation();
  ...
  const elements = elementKeys.map((key) => {
    switch (key) {
      case "totalValue":
        return /* @__PURE__ */ jsxRuntime.jsxs(DropdownMenu, { onSetTop: onSetToTop("totalValue"), children: [
          /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { className: "oui-text-base-contrast-54", gapX: 2, children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx("span", { children: t("common.totalValue") })
          ] }),
          /* @__PURE__ */ jsxRuntime.jsx(
            ui.Text.numeral,
            {
      ...
      case "freeCollateral":
        return /* @__PURE__ */ jsxRuntime.jsxs(DropdownMenu, { onSetTop: onSetToTop("freeCollateral"), children: [
          /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { className: "oui-text-base-contrast-54", gapX: 2, children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              IdentityButton,
              {
            ...
            /* @__PURE__ */ jsxRuntime.jsx("span", { children: t("trading.asset.freeCollateral") })
          ] }),
          /* @__PURE__ */ jsxRuntime.jsx(
            ui.Text.numeral,
            {
      ...
      case "unrealPnL":
        return /* @__PURE__ */ jsxRuntime.jsxs(DropdownMenu, { onSetTop: onSetToTop("unrealPnL"), children: [
          /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { className: "oui-text-base-contrast-54", gapX: 2, children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              IdentityButton,
              {
            ...
            /* @__PURE__ */ jsxRuntime.jsx("span", { children: t("common.unrealizedPnl") })
          ] }),
          /* @__PURE__ */ jsxRuntime.jsx(
            ui.Text.pnl,
            {
              ...
              suffix: /* @__PURE__ */ jsxRuntime.jsx(
                ui.Text.roi,
                {
                  ...
                  suffix: ")",
                  rule: "percentages",
                  children: props.unrealized_pnl_ROI ?? "-"
                }
              ),
              children: props.unrealPnL ?? "-"
            }
      ...
      case "currentLeverage":
        return /* @__PURE__ */ jsxRuntime.jsxs(DropdownMenu, { onSetTop: onSetToTop("currentLeverage"), children: [
          /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { className: "oui-text-base-contrast-54", gapX: 2, children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              IdentityButton,
              {
            ...
            /* @__PURE__ */ jsxRuntime.jsx("span", { children: t("leverage.currentLeverage") })
          ] }),
          /* @__PURE__ */ jsxRuntime.jsx(
            ui.Text.numeral,
            {
...
var DropdownMenu = (props) => {
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-group oui-relative oui-w-full oui-rounded oui-px-[6px] oui-py-1 hover:oui-bg-base-6", children: [
    /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { justify: "between", width: "100%", children: props.children }),
    /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
...
var IdentityButton = (props) => {
  return /* @__PURE__ */ jsxRuntime.jsx("button", { onClick: props.onClick, children: props.active ? /* @__PURE__ */ jsxRuntime.jsx(
    "svg",
    {
      xmlns: "http://www.w3.org/2000/svg",
      width: "12",
...
var AccountSummary = (props) => {
  ...
  const sizeRef = React6__default.default.useRef(0);
  React6.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-flex oui-items-center oui-gap-6", children: [
    /* @__PURE__ */ jsxRuntime.jsx(Items, { elements }),
    /* @__PURE__ */ jsxRuntime.jsx(
      ui.Popover,
      {
        ...
        arrow: true,
        children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-cursor-pointer oui-group", children: /* @__PURE__ */ jsxRuntime.jsx(Dot2, {}) })
      }
    )
  ] });
};
var Items = (props) => {
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-flex oui-gap-6", children: props.elements.map((Element, index) => /* @__PURE__ */ jsxRuntime.jsx("div", { children: Element }, index)) });
};
var Dot2 = () => {
  return /* @__PURE__ */ jsxRuntime.jsx(
    "svg",
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M10.007 8.335a1.666 1.666 0 1 1 0 3.333 1.666 1.666 0 0 1 0-3.333m-5.84 0a1.666 1.666 0 1 1 0 3.333 1.666 1.666 0 0 1 0-3.333m11.666 0a1.666 1.666 0 1 1 0 3.333 1.666 1.666 0 0 1 0-3.333" })
    }
  );
};
var useTotalValueBuilderScript = () => {
  const [keys, setKeys] = hooks.useLocalStorage("accountSummaryTypes", [
    "totalValue"
  ]);
  const [elementKeys, setElementKeys] = React6.useState([
    "totalValue",
    "freeCollateral",
    "unrealPnL",
    "currentLeverage",
  ...
  const { freeCollateral, totalValue } = hooks.useCollateral({ dp: 2 });
  const { state } = hooks.useAccount();
  const [visible, setVisible] = hooks.useLocalStorage("orderly_assets_visible", true);
  const [{ aggregated, totalUnrealizedROI }] = hooks.usePositionStream();
  const { wrongNetwork, disabledConnect } = reactApp.useAppContext();
  const { currentLeverage } = hooks.useMarginRatio();
  const { maxLeverage } = hooks.useLeverage();
  const onToggleItemByKey = (key) => {
  ...
  const onKeyToTop = (key) => {
    if (!keys.includes(key)) {
      setKeys([key, ...keys]);
      setElementKeys([key, ...elementKeys.filter((k) => k !== key)]);
      return;
    }
    setKeys([key, ...keys.filter((k) => k !== key)]);
    setElementKeys([key, ...elementKeys.filter((k) => k !== key)]);
  };
...
var MessageCenter = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    !!maintenanceDialogInfo && /* @__PURE__ */ jsxRuntime.jsx(ui.Dialog, { open: true, children: /* @__PURE__ */ jsxRuntime.jsxs(
      ui.DialogContent,
      {
        closable: false,
        onOpenAutoFocus: (event) => event.preventDefault(),
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.DialogHeader, { children: /* @__PURE__ */ jsxRuntime.jsx(ui.DialogTitle, { children: t("maintenance.dialog.title") }) }),
          /* @__PURE__ */ jsxRuntime.jsx(ui.Divider, {}),
          /* @__PURE__ */ jsxRuntime.jsx(ui.DialogBody, { className: "oui-text-2xs lg:oui-text-xs", children: maintenanceDialogInfo })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntime.jsx(ui.TooltipProvider, { delayDuration: 250, children: /* @__PURE__ */ jsxRuntime.jsxs(ui.TooltipRoot, { open: popoverOpen ? false : void 0, children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        ui.Popover,
        {
          open: popoverOpen,
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx(ui.TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-relative oui-flex oui-cursor-pointer oui-items-center oui-justify-center", children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              ui.BellIcon,
              {
                color: "white",
      ...
      /* @__PURE__ */ jsxRuntime.jsx(ui.TooltipContent, { side: "bottom", children: t("ui.messageCenter.tooltip") })
    ] }) })
  ] });
};
var MessageCenterWidget = () => {
  const { announcementState } = useScaffoldContext();
  return /* @__PURE__ */ jsxRuntime.jsx(
    MessageCenter,
    {
...
var ActiveIcon = () => /* @__PURE__ */ jsxRuntime.jsxs(
  "svg",
  {
    width: 12,
    height: 12,
...
var ORDERLY_NAV_BUTTON_TOOLTIP_OPEN = "ORDERLY_NAV_BUTTON_TOOLTIP_OPEN";
var NavItem2 = (props) => {
  const { classNames, currentPath, item, onClick, ...buttonProps } = props;
  const { customRender, tooltipConfig, onlyInMainAccount } = item;
  const { isMainAccount } = hooks.useAccount();
  const [showButtonTooltip, setShowButtonTooltip] = hooks.useLocalStorage(
  ...
  const buttonRender = () => {
    ...
    const button = /* @__PURE__ */ jsxRuntime.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "oui-flex oui-items-center", children: [
            /* @__PURE__ */ jsxRuntime.jsx(ItemIcon, { isActive, item }),
            /* @__PURE__ */ jsxRuntime.jsx(
              ui.Text.gradient,
              {
    ...
    if (isObject(tooltipConfig) && tooltipConfig.showOnFirstVisit) {
      return /* @__PURE__ */ jsxRuntime.jsx(
        ui.Tooltip,
        {
          ...
          className: "oui-w-64 oui-max-w-64 oui-bg-base-6 oui-text-2xs oui-font-semibold",
          children: button
        }
      );
    }
...
var SubMenus = (props) => {
  ...
  const classNames = children.props?.className;
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.PopoverRoot, { open: open2, children: [
    /* @__PURE__ */ jsxRuntime.jsx(ui.PopoverAnchor, { children: /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        className: "oui-group",
        ...
        children: React6.cloneElement(children, {
          className: ui.cn(classNames, open2 && "oui-bg-base-7")
        })
      }
    ) }),
    /* @__PURE__ */ jsxRuntime.jsx(
      ...
      children: [
        hasIcon && /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(ItemIcon, { isActive: active ?? false, item })
          }
        ),
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-flex-1", children: [
          /* @__PURE__ */ jsxRuntime.jsx(SubMenuTitle, { item, isActive: active }),
          hasDescription && /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "2xs", as: "div", intensity: 36, children: item.description })
        ] })
      ]
    }
  );
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        ...
        children: props.item.activeIcon || props.item.icon
      }
    )
  ] });
};
var CampaignButton = (props) => {
  return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: /* @__PURE__ */ jsxRuntime.jsx(
    NavItem2,
    {
      ...
      classNames: {
        navItem: ui.cn("oui-text-base-contrast-54 -oui-ml-2", props.className)
      }
    }
  ) });
};
var MainNavMenus = (props) => {
  const { items, classNames } = props;
  if (!Array.isArray(items) || items.length === 0) {
    return null;
  }
  return /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { className: ui.cn("oui-gap-1", classNames?.root), children: items?.map((item, index) => /* @__PURE__ */ jsxRuntime.jsx(
    NavItem2,
    {
      item,
...
var MainNavMenusExtension = (props) => {
  return /* @__PURE__ */ jsxRuntime.jsx(ui.ExtensionSlot, { position: ui.ExtensionPositionEnum.MainMenus, ...props });
};
var MainNav = (props) => {
  const { className, classNames, campaigns, campaignPosition } = props;
  const showCampaignButton = campaignPosition === "navTailing" /* navTailing */ && campaigns;
  const showLinkIcon = !props.wrongNetwork && !props.disabledConnect && props.status >= types.AccountStatusEnum.SignedIn;
  const showSubAccount = props.status >= types.AccountStatusEnum.EnableTrading;
  const hideWalletConnectButton = !props.disabledConnect && props.wrongNetwork && props.isConnected;
  const { isDesktop } = ui.useScreen();
  const children = React6.useMemo(() => {
    if (typeof props.children === "undefined") {
      return null;
    }
    return /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { grow: true, children: props.children });
  }, [props.children]);
  const showChainMenu = isDesktop;
  const renderContent = () => {
    const title = /* @__PURE__ */ jsxRuntime.jsx(MainLogo, { ...props.logo });
    const accountSummary = /* @__PURE__ */ jsxRuntime.jsx(AccountSummaryWidget, {});
    const linkDevice = showLinkIcon && /* @__PURE__ */ jsxRuntime.jsx(LinkDeviceWidget, {});
    const languageSwitcher = /* @__PURE__ */ jsxRuntime.jsx(LanguageSwitcherWidget, {});
    const subAccount = showSubAccount && /* @__PURE__ */ jsxRuntime.jsx(SubAccountWidget, {});
    const chainMenu = showChainMenu && /* @__PURE__ */ jsxRuntime.jsx(ChainMenuWidget, {});
    const notify = /* @__PURE__ */ jsxRuntime.jsx(MessageCenterWidget, {});
    const walletConnect = !hideWalletConnectButton && /* @__PURE__ */ jsxRuntime.jsx(WalletConnectButtonExtension, {});
    const mainNav = /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(
      ...
      !!showCampaignButton && /* @__PURE__ */ jsxRuntime.jsx(
        CampaignButton,
        {
          ...campaigns,
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      ...
      children,
      /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { itemAlign: "center", className: "oui-gap-2", children: [
        accountSummary,
        showLinkIcon && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.Divider, { direction: "vertical", className: "oui-h-8", intensity: 8 }),
          linkDevice
        ] }),
        notify,
        languageSwitcher,
...
var MainNavWidget = (props) => {
  const { children, classNames, ...rest } = props;
  const state = useMainNavScript(rest);
  return /* @__PURE__ */ jsxRuntime.jsx(MainNav, { classNames, ...state, children });
};

// src/index.ts
init_bottomNav();

// src/components/maintenanceTips/ui.tsx
init_icons();
var MaintenanceTipsUI = (props) => {
  const { showTips, showDialog, tipsContent, closeTips, dialogContent } = props;
  const { t } = i18n.useTranslation();
  if (showDialog) {
    return /* @__PURE__ */ jsxRuntime.jsx(ui.Dialog, { open: true, children: /* @__PURE__ */ jsxRuntime.jsxs(
      ui.DialogContent,
      {
        closable: false,
        onOpenAutoFocus: (event) => event.preventDefault(),
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.DialogHeader, { children: /* @__PURE__ */ jsxRuntime.jsx(ui.DialogTitle, { children: t("maintenance.dialog.title") }) }),
          /* @__PURE__ */ jsxRuntime.jsx(ui.Divider, {}),
          /* @__PURE__ */ jsxRuntime.jsx(ui.DialogBody, { className: "oui-text-2xs md:oui-text-xs", children: dialogContent })
        ]
      }
    ) });
  }
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    ui.Flex,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-flex oui-items-start oui-justify-start oui-gap-1 ", children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            InfoIcon,
            {
              size: 20,
          ...
          /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { className: "oui-font-semibold oui-leading-4", children: tipsContent })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx(
          CloseIcon,
          {
...
var useMaintenanceScript = () => {
  const { t } = i18n.useTranslation();
  const [showTips, setShowTips] = React6.useState(false);
  const [showDialog, setShowDialog] = React6.useState(false);
  const { startTime, endTime, status, brokerName } = hooks.useMaintenanceStatus();
  const startDate = React6.useMemo(() => {
    if (!startTime) {
      return "-";
    }
  ...
  React6.useEffect(() => {
    ...
    setShowDialog(false);
    if (startTime) {
      if (startTime < utils.getTimestamp() + oneDay) {
...
var MaintenanceTipsWidget = () => {
  const props = useMaintenanceScript();
  return /* @__PURE__ */ jsxRuntime.jsx(MaintenanceTipsUI, { ...props });
};

// src/index.ts
init_restrictedInfo();

exports.AccountMenuWidget = AccountMenuWidget;
exports.AccountSummaryWidget = AccountSummaryWidget;
exports.CampaignPositionEnum = CampaignPositionEnum;
exports.ChainMenu = ChainMenu;
exports.ChainMenuWidget = ChainMenuWidget;
exports.Footer = Footer;
exports.FooterWidget = FooterWidget;
exports.LanguageSwitcher = LanguageSwitcher;
exports.LanguageSwitcherWidget = LanguageSwitcherWidget;
exports.LeftNavUI = LeftNavUI;
exports.LeftNavWidget = LeftNavWidget;
exports.MainLogo = MainLogo;
exports.MainNavMobile = MainNavMobile;
exports.MainNavWidget = MainNavWidget;
exports.MaintenanceTipsUI = MaintenanceTipsUI;
exports.MaintenanceTipsWidget = MaintenanceTipsWidget;
exports.Scaffold = Scaffold;
exports.ScaffoldContext = ScaffoldContext;
exports.ScanQRCode = ScanQRCode;
exports.ScanQRCodeWidget = ScanQRCodeWidget;
exports.SideBar = SideBar;
exports.SideNavbarWidget = SideNavbarWidget;
exports.SubAccountScript = SubAccountScript;
exports.SubAccountUI = SubAccountUI;
exports.SubAccountWidget = SubAccountWidget;
