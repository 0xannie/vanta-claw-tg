...
var AdditionalInfo = (props) => {
  ...
  const onTypeToggle = (type) => (checked) => {
...
function AdditionalConfigButton(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.PopoverRoot, { open: open2, onOpenChange: setOpen, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(ui.PopoverContent, { side: "top", align: "end", className: "oui-w-[230px]", children: /* @__PURE__ */ jsxRuntime.jsx(AdditionalInfo, { ...props }) })
  ] });
}
              ...
              ui.Flex,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "between", className: "oui-w-full", children: [
                    ...
                    ) : /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-base-contrast", children: "Market" })
                  ] }),
                  /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "between", className: "oui-w-full", children: [
                    /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { children: t("tpsl.totalEstTpPnl") }),
                    /* @__PURE__ */ jsxRuntime.jsx(
                      ui.Text.numeral,
                      {
                        suffix: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-ml-1 oui-text-base-contrast-36", children: symbolInfo.quote }),
            ...
            error && /* @__PURE__ */ jsxRuntime.jsxs(
              ui.Flex,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-danger", children: error })
                ]
              }
            )
          ]
          ...
          children: /* @__PURE__ */ jsxRuntime.jsxs(
            ui.Flex,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "between", className: "oui-w-full", children: [
                  /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { children: t("tpsl.totalEstSlPnl") }),
                  /* @__PURE__ */ jsxRuntime.jsx(
                    ui.Text.numeral,
                    {
                      coloring: true,
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    ui.Flex,
    {
      ...
      children: [
        ...
        renderTp(),
        renderSl(),
        /* @__PURE__ */ jsxRuntime.jsx(ui.Divider, { className: "oui-mb-2 oui-w-full" })
      ]
    }
  );
}
...
var RegularFeesUI = (props) => {
  ...
  const originalTrailingFees = /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { itemAlign: "center", justify: "between", width: "100%", gap: 1, children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { width: "100%", itemAlign: "center", justify: "between", children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(
        uiConnector.AuthGuard,
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 1, children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx("button", { className: "oui-text-2xs", onClick: () => setOpen(), children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { className: "oui-gap-0.5", as: "span", children: [
...
var LTVRiskTooltipUI = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 1, className: "oui-w-72 oui-max-w-72", direction: "column", children: [
...
var Available = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { itemAlign: "center", justify: "between", children: [
    /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "2xs", children: t("common.available") }),
...
var OrderConfirmDialog = (props) => {
  ...
  const header = /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "between", children: [
    /* @__PURE__ */ jsxRuntime.jsx(ui.Text.formatted, { rule: "symbol", showIcon: true, children: order.symbol }),
    /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "end", gapX: 1, children: [
  ...
  const orderConfirmCheckbox = /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gapX: 1, pt: 4, pb: 5, children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      ui.Checkbox,
      {
        id: "orderConfirm",
  ...
  const buttons = /* @__PURE__ */ jsxRuntime.jsxs(ui.Grid, { cols: 2, gapX: 3, children: [
    /* @__PURE__ */ jsxRuntime.jsx(ui.Button, { color: "secondary", size: "md", onClick: () => onCancel(), children: t("common.cancel") }),
    /* @__PURE__ */ jsxRuntime.jsx(ui.Button, { size: "md", onClick: () => onConfirm(), children: t("common.confirm") })
  ] });
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    header,
    /* @__PURE__ */ jsxRuntime.jsx(ui.Divider, { className: "oui-my-4" }),
...
// src/components/dialog/scaledOrderConfirm/scaledOrderConfirm.script.ts
function useScaledOrderConfirmScript(options2) {
...
var CustomInput = React2.forwardRef(
  (props, ref) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      ...
      {
        ref,
        tooltip: errorMsgVisible ? props.error : void 0,
        autoComplete: "off",
        ...
        prefix: props.prefix || /* @__PURE__ */ jsxRuntime.jsx(InputLabel, { id: props.id, className: props.classNames?.prefix, children: props.label }),
        suffix: props.suffix,
    ...
    () => [
      {
        ...
        value: types.BBOOrderType.COUNTERPARTY1
      },
      {
        label: t("orderEntry.bbo.counterparty5"),
        value: types.BBOOrderType.COUNTERPARTY5
      },
      {
        label: t("orderEntry.bbo.queue1"),
        value: types.BBOOrderType.QUEUE1
      },
      {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ui.Select.options,
    {
      ...
      valueFormatter: (value, option) => {
        ...
        return /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "sm", children: item?.label }) });
      }
    }
  );
};
var LimitPriceSuffix = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    ui.Flex,
    {
      direction: "column",
      itemAlign: "end",
      className: ui.cn("oui-order-entry-limit-price-input-suffix", "oui-text-2xs"),
      children: [
        quote,
        /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "end", itemAlign: "center", gap: 2, children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            ui.Flex,
            {
              ...
              onClick: () => {
                if (bbo.bboStatus === "disabled" /* DISABLED */) {
                  ui.modal.dialog({
                    title: t("common.tips"),
                    size: "xs",
                    content: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 54, children: t("orderEntry.bbo.disabled.tips") })
                  });
                } else {
                  bbo.toggleBBO();
                }
...
var PriceInput = (props) => {
  ...
  const readOnly = bbo.bboStatus === "on" /* ON */;
  const suffix = props.order_type === types.OrderType.LIMIT ? /* @__PURE__ */ jsxRuntime.jsx(
    LimitPriceSuffix,
    {
      quote,
      bbo,
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          CustomInput,
          {
            ...
            onFocus: onFocus(1 /* PRICE */),
            onBlur: onBlur(1 /* PRICE */),
            readonly: readOnly,
            ref: priceInputRef,
            classNames: {
              root: ui.cn(readOnly && "focus-within:oui-outline-transparent "),
              input: ui.cn(readOnly && "oui-cursor-auto")
            }
          }
        ),
        bbo.bboStatus === "on" /* ON */ && /* @__PURE__ */ jsxRuntime.jsx("div", { className: ui.cn("oui-absolute oui-bottom-1 oui-left-0"), children: /* @__PURE__ */ jsxRuntime.jsx(
          BBOOrderTypeSelect,
          {
            value: bbo.bboType,
...
var TotalInput = React2.memo((props) => {
  ...
  const [totalType, setTotalType] = hooks.useLocalStorage(
...
var QuantityDistributionInput = React2.memo((props) => {
  ...
  const showHint = () => {
    ui.modal.dialog({
      title: t("common.tips"),
      size: "sm",
      content: /* @__PURE__ */ jsxRuntime.jsx(QuantityDistributionHint, { value: props.distribution_type })
      // classNames: {
...
var QuantityDistributionHint = (props) => {
  ...
  React2.useEffect(() => {
    setType(
      [
        ...
        types.DistributionType.ASCENDING,
        types.DistributionType.DESCENDING
    ...
    return [
      {
        ...
        quantity: /* @__PURE__ */ jsxRuntime.jsx(FlatQuantity, {})
      },
      {
        type: types.DistributionType.ASCENDING,
        title: t("orderEntry.distributionType.ascending"),
        description: t("orderEntry.distributionType.ascending.description"),
        formula: `${t("orderEntry.skew")} > 1`,
        quantity: /* @__PURE__ */ jsxRuntime.jsx(AscendingQuantity, {})
      },
      {
        type: types.DistributionType.DESCENDING,
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-text-2xs oui-font-semibold oui-text-base-contrast-54", children: [
    /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { direction: "column", itemAlign: "start", gapY: 1, children: [
      /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { intensity: 80, children: t("orderEntry.quantityDistribution.description") }),
      /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { children: t("orderEntry.quantityDistribution.formula") })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { intensity: 600, p: 1, r: "base", mt: 3, itemAlign: "start", children: [
      /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { direction: "column", itemAlign: "start", children: content.map((item) => /* @__PURE__ */ jsxRuntime.jsx(
        ui.Box,
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { children: item.title })
        },
        item.title
      )) }),
      /* @__PURE__ */ jsxRuntime.jsxs(
        ui.Flex,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { children: currentContent?.description }),
            /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { width: "100%", justify: "center", children: currentContent?.quantity }),
            /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { width: "100%", gapX: 1, justify: "center", children: [
              /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "oui-text-base-1", children: t("common.price") }),
              /* @__PURE__ */ jsxRuntime.jsx(PriceChart, {})
            ] })
          ]
        }
      )
...
var QuantityDistribution = (props) => {
  ...
  const distributionTypeMap = React2.useMemo(() => {
    return {
      ...
      [types.DistributionType.DESCENDING]: t(
        "orderEntry.distributionType.descending.abbr"
      ),
      [types.DistributionType.CUSTOM]: t("orderEntry.distributionType.custom")
    };
  }, [t]);
  return /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { className: ui.cn("oui-gap-x-[6px] lg:oui-gap-x-2"), wrap: "wrap", children: Object.values(types.DistributionType).map((type) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      CustomInput,
      {
        ...
        formatters: [ui.inputFormatter.dpFormatter(quote_dp)],
        onFocus: onFocus(7 /* START_PRICE */),
        onBlur: onBlur(7 /* START_PRICE */),
        classNames: {
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      CustomInput,
      {
        ...
        formatters: [ui.inputFormatter.dpFormatter(quote_dp)],
        onFocus: onFocus(8 /* END_PRICE */),
        onBlur: onBlur(8 /* END_PRICE */)
      }
    )
  ] });
});
ScaledPriceInput.displayName = "ScaledPriceInput";
var valueRenderer = (value) => {
  return /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "2xs", intensity: 36, children: value });
};
...
var ScaledQuantityInput = React2.memo((props) => {
  ...
  const suffix = /* @__PURE__ */ jsxRuntime.jsx(
    ScaledQuantityUnit,
    {
      base,
      quote,
...
var SkewInput = React2.memo((props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    CustomInput,
    {
      ...
      onFocus: onFocus(10 /* SKEW */),
      onBlur: onBlur(10 /* SKEW */),
      overrideFormatters: [
        ui.inputFormatter.rangeFormatter({ min: 0, max: 100, dp: 2 }),
        ui.inputFormatter.dpFormatter(2)
      ],
      classNames: {
...
var ScaledOrderInput = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-space-y-1", children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(ui.Grid, { cols: 2, className: "oui-group oui-space-x-1", children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        ScaledQuantityInput,
        {
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      QuantityDistributionInput,
      {
        ...
        className: ui.cn(!showSkewInput && "oui-rounded-b-xl")
      }
    ),
...
var TriggerPriceInput = React2.memo((props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-group", children: /* @__PURE__ */ jsxRuntime.jsx(
    CustomInput,
    {
      ...
      formatters: [ui.inputFormatter.dpFormatter(symbolInfo.quote_dp)],
      onFocus: onFocus(2 /* TRIGGER_PRICE */),
      onBlur: onBlur(2 /* TRIGGER_PRICE */)
    }
  ) });
});
...
var ActivePriceInput = React2.memo((props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "oui-group", children: /* @__PURE__ */ jsxRuntime.jsx(
    CustomInput,
    {
      ...
      formatters: [ui.inputFormatter.dpFormatter(symbolInfo.quote_dp)],
      onFocus: onFocus(11 /* ACTIVATED_PRICE */),
      onBlur: onBlur(11 /* ACTIVATED_PRICE */)
    }
  ) });
});
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { gapX: 2, className: props.className, children: percentages.map((item) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsx(
        ui.Flex,
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Text, { size: "2xs", intensity: isActive ? 80 : 36, weight: "semibold", children: [
            item,
            "%"
          ] })
        },
...
var TrailingCallbackInput = React2.memo(
  (props) => {
    ...
    if (callbackType === types.TrailingCallbackType.RATE) {
      return (
        // <Tooltip
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-relative", children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            CustomInput,
            {
              ...
              formatters: [ui.inputFormatter.dpFormatter(1)],
              onFocus: (e) => {
                onFocus(13 /* CALLBACK_RATE */)(e);
              },
              onBlur: (e) => {
                onBlur(13 /* CALLBACK_RATE */)(e);
              },
              classNames: {
                root: "oui-h-[68px]",
                input: "oui-mb-5",
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      CustomInput,
      {
        ...
        formatters: [ui.inputFormatter.dpFormatter(quote_dp)],
        onFocus: onFocus(12 /* CALLBACK_VALUE */),
        onBlur: onBlur(12 /* CALLBACK_VALUE */),
        classNames: {
          input: "!oui-mb-[6px]",
          prefix: "!oui-top-1"
        }
...
function OrderInput(props) {
  ...
  if (type === types.OrderType.SCALED) {
    return /* @__PURE__ */ jsxRuntime.jsx(ScaledOrderInput, { values });
  }
  if (type === types.OrderType.TRAILING_STOP) {
    return /* @__PURE__ */ jsxRuntime.jsx(TrailingStopInput, { values });
  }
  const showTriggerPrice = type === types.OrderType.STOP_LIMIT || type === types.OrderType.STOP_MARKET;
  const showPrice = type === types.OrderType.LIMIT || type === types.OrderType.STOP_LIMIT;
  const triggerPriceInput = showTriggerPrice && /* @__PURE__ */ jsxRuntime.jsx(TriggerPriceInput, { trigger_price: values.trigger_price });
  const priceInput = showPrice && /* @__PURE__ */ jsxRuntime.jsx(
    PriceInput,
    {
...
var QuantitySlider = React2.memo((props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "between", className: "oui-pt-1 xl:oui-pt-2", children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        ui.Text.numeral,
        {
          size: "2xs",
...
var ReduceOnlySwitch = ({
  ...
  const { t } = i18n.useTranslation();
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { itemAlign: "center", gapX: 1, className, children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      ui.Switch,
      {
        "data-testid": testId,
...
var usePNLInputBuilder = (props) => {
  ...
  return {
    ...
    onValueChange,
    quote_dp,
    tips: tipVisible ? tipsEle : void 0,
    setFocus
  };
};
var PNLInput = (props) => {
...
var PNLMenus = (props) => {
  return /* @__PURE__ */ jsxRuntime.jsx(
    ui.SimpleDropdownMenu,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx("button", { className: "oui-p-2", "data-testid": props.testId, children: /* @__PURE__ */ jsxRuntime.jsx(ui.CaretDownIcon, { size: 12, color: "white" }) })
    }
  );
};
var PnlInputWidget = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(PNLInput, { ...state, testIds, quote, type: props.type });
};
var PnlInputProvider = (props) => {
  ...
  const tipsEle = React2.useMemo(() => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { children: [
      /* @__PURE__ */ jsxRuntime.jsx("span", { className: "oui-text-xs oui-text-base-contrast-54", children: mode === "PnL" /* PnL */ ? t("orderEntry.estRoi") : t("orderEntry.estPnL") }),
      mode === "PnL" /* PnL */ ? /* @__PURE__ */ jsxRuntime.jsx(
        ui.Text.numeral,
        {
          rule: "percentages",
          className: ui.cn(
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(PnlInputProvider, { values: props.values.tp, type: "TP", children: /* @__PURE__ */ jsxRuntime.jsx(
          TPSLInputRow,
          {
            type: "TP",
        ...
        /* @__PURE__ */ jsxRuntime.jsx(PnlInputProvider, { values: props.values.sl, type: "SL", children: /* @__PURE__ */ jsxRuntime.jsx(
          TPSLInputRow,
          {
            type: "SL",
...
var TPSLAdvancedButton = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    ui.Flex,
    {
      ...
      className: ui.cn("oui-group oui-cursor-pointer", props.className),
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          ui.Text,
          {
...
var TPSLTriggerPriceInput = (props) => {
  const { t } = i18n.useTranslation();
  const { errorMsgVisible } = useOrderEntryContext();
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ui.Input.tooltip,
    {
      ...
      formatters: [
        ui.inputFormatter.numberFormatter,
        ui.inputFormatter.dpFormatter(props.quote_dp ?? 2),
        ui.inputFormatter.currencyFormatter
      ]
    }
  );
};
var TPSLInputRow = (props) => {
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Grid, { cols: 2, gapX: 1, children: [
    /* @__PURE__ */ jsxRuntime.jsx(
...
var OrderEntry = (props) => {
  ...
  const [pinned, setPinned] = hooks.useLocalStorage(
  ...
  const onSubmit = hooks.useMemoizedFn(async () => {
    ...
    helper.validate(isSlPriceError ? props.slPriceError : void 0).then(
      ...
      (errors2) => {
        if (errors2.slippage) {
          ui.toast.error(t("orderEntry.slippage.error.max"));
        }
        setErrorMsgVisible(true);
  ...
  const onShowTPSLAdvanced = () => {
    helper.validate().then(
      ...
      (errors2) => {
        const tpslKey = /* @__PURE__ */ new Set(["tp_trigger_price", "sl_trigger_price"]);
        if (Object.keys(errors2).every((key) => tpslKey.has(key))) {
          setShowTPSLAdvanced(true);
        }
      }
    );
  ...
  const extraButton = !pinned && /* @__PURE__ */ jsxRuntime.jsx(AdditionalConfigButton, { ...additionalInfoProps });
  return /* @__PURE__ */ jsxRuntime.jsxs(
    OrderEntryProvider,
    {
      errors,
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(
          "div",
          {
            ...
            children: [
              ...
              showSoundSection && /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { justify: "between", itemAlign: "center", children: [
                /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { itemAlign: "center", gapX: 1, children: [
                  /* @__PURE__ */ jsxRuntime.jsx(
                    ui.Switch,
                    {
              ...
              pinned && /* @__PURE__ */ jsxRuntime.jsxs(ui.Box, { p: 2, r: "md", intensity: 700, position: "relative", children: [
...
function useBBOState({
  ...
  const bboStatus = React2.useMemo(() => {
    ...
    return localBBOType && order_type === types.OrderType.LIMIT ? "on" /* ON */ : "off" /* OFF */;
  }, [tpslSwitch, order_type_ext, order_type, localBBOType]);
  const toggleBBO = () => {
    track(types.TrackerEventName.clickBBOButton);
    if (localBBOType) {
      setLocalBBOType(void 0);
      setOrderValues({
        order_type_ext: void 0,
        level: void 0
      });
    } else {
      setLocalBBOType(lastBBOType.current || types.BBOOrderType.COUNTERPARTY1);
    }
  };
  const onBBOChange = (value) => {
  ...
  React2.useEffect(() => {
    if (bboStatus === "disabled" /* DISABLED */) {
      setOrderValues({
        ...
        order_type_ext: isBBOOrder({ order_type_ext }) ? void 0 : order_type_ext,
        level: void 0
      });
    }
...
function useFocusAndBlur(props) {
  ...
  const formatQty = () => {
    ...
    const quantity = hooks.utils.formatNumber(
      order_quantity,
      new utils.Decimal(base_tick || "0").toNumber()
    );
    setValue("order_quantity", quantity, {
      shouldUpdateLastChangedField: false
    });
  };
  const onFocus = (type) => (_) => {
    currentFocusInput.current = type;
    if ([7 /* START_PRICE */, 8 /* END_PRICE */].includes(
      currentFocusInput.current
    )) {
      lastScaledOrderPriceInput.current = type;
    }
    if ([3 /* QUANTITY */, 5 /* TOTAL */, 6 /* MARGIN */].includes(type)) {
  ...
  const onBlur = (type) => (_) => {
    setTimeout(() => {
      ...
      currentFocusInput.current = 0 /* NONE */;
    }, 300);
    if (type === 3 /* QUANTITY */) {
      formatQty();
    }
  ...
  return {
    ...
    lastQuantityInputType,
    onFocus: hooks.useMemoizedFn(onFocus),
    onBlur: hooks.useMemoizedFn(onBlur)
  };
}
...
var useOrderEntryScript = (inputs) => {
  ...
  const [localOrderSide, setLocalOrderSide] = hooks.useLocalStorage(
  ...
  const setOrderValue = hooks.useMemoizedFn(
    (key, value, options2) => {
      ...
      if (key === "reduce_only" && value || key === "order_type" && (value === types.OrderType.STOP_LIMIT || value === types.OrderType.STOP_MARKET)) {
        const data = {
          tp_trigger_price: "",
          sl_trigger_price: "",
          [key]: value
      ...
      if (key === "order_type" && value !== types.OrderType.LIMIT) {
        const data = {
          level: void 0,
          order_type_ext: void 0,
          [key]: value
  ...
  React2.useEffect(() => {
    ...
    const orderBookItemClickHandler = (item) => {
      const price = utils.removeTrailingZeros(item[0]);
      const { order_type, order_type_ext } = formattedOrder;
      if (currentFocusInput.current === 2 /* TRIGGER_PRICE */ && (order_type === types.OrderType.STOP_LIMIT || order_type === types.OrderType.STOP_MARKET)) {
      ...
      if (order_type === types.OrderType.STOP_LIMIT || order_type === types.OrderType.LIMIT) {
        setValue("order_price", price);
        focusInputElement(priceInputRef.current);
        return;
      }
      if (order_type === types.OrderType.STOP_MARKET) {
        setValue("trigger_price", price);
        focusInputElement(triggerPriceInputRef.current);
        return;
      }
      if (order_type === types.OrderType.MARKET) {
        setBBOType(void 0);
        setOrderValues({
      ...
      if (order_type === types.OrderType.SCALED && lastScaledOrderPriceInput.current) {
        const field = lastScaledOrderPriceInput.current === 7 /* START_PRICE */ ? "start_price" : "end_price";
  ...
  const fillMiddleValue = () => {
    ...
    if (formattedOrder.order_type === types.OrderType.LIMIT) {
      const [bestAsk = 0, bestBid = 0] = askAndBid;
      const midPrice = new utils.Decimal(safeNumber(bestAsk)).add(safeNumber(bestBid)).div(2).toNumber();
      requestAnimationFrame(() => {
