...
var Poster = React.forwardRef((props, parentRef) => {
  ...
  const { ref, download, toDataURL, copy, toBlob } = hooks.usePoster(data, {
    ratio: props.ratio
  });
  ...
  switch (pnlType) {
    case "pnl": {
      if (position.pnl != null) {
        positionData["pnl"] = utils.formatNum.pnl(position.pnl)?.toFixed(2);
      }
      break;
    }
    case "roi": {
      if (position.roi != null) {
        positionData["ROI"] = utils.formatNum.roi(position.roi)?.toFixed(2);
      }
      break;
    }
    case "roi_pnl": {
...
function formatFixed(value, dp) {
  return new utils.Decimal(value).toFixed(dp, utils.Decimal.ROUND_DOWN);
}
...
var BottomButtons = (props) => {
  ...
  const { t } = i18n.useTranslation();
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { px: 8, gap: 3, mt: 3, itemAlign: "center", children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(ui.Button, { className: "oui-flex-1 oui-flex oui-gap-1", onClick: onClickCopy, children: [
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { mt: 4, px: 2, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { children: backgroundImages.map((e, index) => /* @__PURE__ */ jsxRuntime.jsx(
          ui.Box,
          {
            onClick: () => {
      ...
      ui.Input,
      {
        ...
        suffix: focus && /* @__PURE__ */ jsxRuntime.jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(ui.CloseCircleFillIcon, { size: 18, color: "white" })
          }
        ),
        ...
        onChange: (e) => {
          if (e.target.value.length > 25) {
            ui.toast.error(t("share.pnl.optionalInfo.message.maxLength"));
            return;
          }
...
var ShareOption = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    ui.Flex,
    {
      itemAlign: "center",
      gap: 1,
      className: ui.cn("hover:oui-cursor-pointer"),
      onClick: () => {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "xs", intensity: 54, children: text })
      ]
    }
  );
};
...
var DesktopSharePnLContent = (props) => {
  ...
  const onCopy = () => {
    posterRef.current?.copy().then(() => {
      props.hide?.();
      ui.toast.success(t("share.pnl.image.copied"));
    }).catch((e) => {
      ui.toast.error(() => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-relative oui-flex oui-size-full oui-flex-col", children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-h-full oui-flex-1 oui-overflow-y-auto", children: [
      /* @__PURE__ */ jsxRuntime.jsxs(ui.Box, { mt: 9, height: 422, children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(
          ...
          {
            backgroundImages: shareOptions?.backgroundImages ?? types.EMPTY_LIST,
            selectedSnap,
            setSelectedSnap
          }
        )
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(
        ui.Flex,
        {
          ...
          width: "100%",
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "sm", intensity: 80, children: t("share.pnl.displayFormat") }),
            /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { pt: 3, gap: 3, itemAlign: "center", children: formats.map((e, index) => /* @__PURE__ */ jsxRuntime.jsx(
              PnlFormatView,
              {
                setPnlFormat,
                type: e,
            ...
            /* @__PURE__ */ jsxRuntime.jsx(ui.Divider, { className: "oui-w-full oui-border-white/10 oui-pt-6" }),
            /* @__PURE__ */ jsxRuntime.jsxs(
              ui.Flex,
              {
                mt: 6,
                ...
                itemAlign: "start",
                children: [
                  /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "sm", intensity: 80, children: t("share.pnl.optionalInfo") }),
                  /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { mt: 3, gap: 4, className: "oui-flex-wrap", children: options.map((item, index) => /* @__PURE__ */ jsxRuntime.jsx(
                    ShareOption,
                    {
                      setShareOption,
                      type: item,
...
var Carousel = React__default.default.forwardRef((originalProps, ref) => {
  ...
  const [carouselRef, api] = ui.useEmblaCarousel(
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(CarouselContext.Provider, { value: memoizedValue, children: /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      ...
      className: ui.cn("oui-relative", className),
      role: "region",
...
var CarouselPrevious = React__default.default.forwardRef((originalProps, ref) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    ui.Button,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(ui.ChevronLeftIcon, { size: 20 }),
...
var CarouselNext = React__default.default.forwardRef((originalProps, ref) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    ui.Button,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(ui.ChevronRightIcon, { size: 20 }),
...
var CarouselIdentifier = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: ui.cn("oui-flex oui-gap-1", props.className), children: scrollSnaps.map((_, index) => {
    return /* @__PURE__ */ jsxRuntime.jsx(
      Dot,
      {
        index,
...
var MobileSharePnLContent = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "oui-w-full", children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(ui.ScrollArea, { className: "oui-custom-scrollbar oui-max-h-[200px] oui-overflow-y-auto", children: [
...
var MyIdentifier = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: ui.cn("oui-flex oui-gap-1"), children: scrollSnaps.map((_, index) => {
    return /* @__PURE__ */ jsxRuntime.jsx(
      Dot,
      {
        index,
